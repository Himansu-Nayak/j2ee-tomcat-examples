...
public final class OpenEJBEnricher {
    ...
    public static void enrich(final Object testInstance, final AppContext appCtx) {
        ...
        if (ctx == null) {
            ctx = AppFinder.findAppContextOrWeb(Thread.currentThread().getContextClassLoader(),
        ...
        if (context != null) {
            ...
            try {
                final InjectionProcessor processor = new InjectionProcessor<>(testInstance, context.getInjections(),
    ...
    private static void doInject(final Object testInstance, final BeanContext context, final BeanManagerImpl bm)
            throws Exception {
