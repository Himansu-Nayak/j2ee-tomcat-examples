...
public class WsRsTest {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, WsRsTest.class.getName().concat(".war")).addClasses(Bean.class)
                ...
                .setWebXML(new StringAsset(Descriptors.create(WebAppDescriptor.class).version(WebAppVersionType._3_0)
                        ...
                        .createInitParam().paramName(Application.class.getName())
                        .paramValue(Application.class.getName()).up().up().getOrCreateServletMapping()
                        .servletName("jaxrs").urlPattern("/api").up().exportAsString()));
    }
    ...
    public void invokeWebService() throws Exception {
        ...
        final String expected = "" + "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
                ...
                + "<return>hola</return>" + "</ns:helloResponse>" + "</soap:Body>" + "</soap:Envelope>";
