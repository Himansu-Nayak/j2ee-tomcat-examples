...
public class JAXRSHttpHeadersTest extends JaxrsTest {
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getAcceptableLanguages()} that if given no acceptable languages, that
     * it will return the server default locale back.
     *
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getAcceptableLanguages()} that if given a language, it will be the only
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getAcceptableLanguages()} that if given multiple languages, all will be
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getAcceptableLanguages()} that if given multiple languages, all will be
     * returned in the list sorted by their quality value.
     *
     * @throws java.io.IOException
     */
    @Test
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getAcceptableMediaTypes()} that if given a single Accept header value,
     * it is returned.
     *
     * @throws java.io.IOException
     */
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getAcceptableMediaTypes()} that if given multiple Accept header values,
     * the values are sorted by q-value.
     *
     * @throws java.io.IOException
     */
    @Test
    public void testAcceptableMediaTypesManyGiven() throws IOException {
        final Map<String, String> headers = headers("Accept",
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getMediaType()} that if given a text/plain, the method will return
     * text/plain.
     *
     * @throws java.io.IOException
     */
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getMediaType()} when a non-standard content type is sent in.
     *
     * @throws java.io.IOException
     */
    @Test
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getLanguage()} when no language is given in the request.
     *
     * @throws java.io.IOException
     */
    @Test
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getLanguage()} when English language is given in the request.
     *
     * @throws java.io.IOException
     */
    @Test
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getLanguage()} when Chinese language is given in the request.
     *
     * @throws java.io.IOException
     */
    @Test
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getRequestHeader(String)} when given a null value.
     *
     * @throws java.io.IOException
     */
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getRequestHeader(String)} when requesting header values for a
     * non-existent header name.
     *
     * @throws java.io.IOException
     */
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getRequestHeader(String)} when requesting header value for a single
     * header name.
     *
     * @throws java.io.IOException
     */
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getRequestHeader(String)} when requesting multiple header value for a
     * single header name.
     *
     * @throws java.io.IOException
     */
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getRequestHeader(String)} when requesting multiple header value for a
     * single header name when using case-insensitive names.
     *
     * @throws java.io.IOException
     */
    @Test
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getRequestHeaders()} when making a basic HttpClient request.
     *
     * @throws java.io.IOException
     */
    @Test
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getRequestHeaders()} when having a custom header.
     *
     * @throws java.io.IOException
     */
    @Test
    ...
    /**
     * Tests {@link javax.ws.rs.core.HttpHeaders#getRequestHeaders()} when having multiple values and multiple custom
     * headers.
     *
     * @throws java.io.IOException
     */
    ...
    public void testRequestHeadersMultipleValues() throws IOException {
        ...
        assertTrue(responseBody,
                responseBody.contains(":fOo=[2bAr, bAr]") || responseBody.contains(":foo=[2bAr, bAr]"));
