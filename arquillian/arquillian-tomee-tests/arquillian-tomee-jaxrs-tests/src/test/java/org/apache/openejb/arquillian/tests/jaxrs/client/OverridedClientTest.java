...
public class OverridedClientTest {
    ...
    public static Archive<?> war() {
        ...
        return ShrinkWrap.create(WebArchive.class, "OverridedClientTest.war")
                ...
                .addAsLibraries(resolver.resolve("org.glassfish.jersey.core:jersey-common:" + jerseyVersion)
                        .withoutTransitivity().asFile())
                .addAsLibraries(resolver.resolve("org.glassfish.jersey.core:jersey-client:" + jerseyVersion)
                        .withoutTransitivity().asFile())
                ...
                .addAsLibraries(
                        resolver.resolve("org.glassfish.jersey.bundles.repackaged:jersey-guava:" + jerseyVersion)
                                .withoutTransitivity().asFile());
    }

    @Test
    public void run() {
        assertEquals("org.glassfish.jersey.client.JerseyClientBuilder",
                ClientBuilder.newBuilder().getClass().getName());
    }
}
