...
public class ResourceTest {
    ...
    public static EnterpriseArchive createDeployment() {
        ...
        final JavaArchive ejbJar = ShrinkWrap.create(JavaArchive.class, "test-ejb.jar")
                .addAsResource("META-INF/resources.xml", "META-INF/resources.xml").addClass(ResourceTest.class)
                .addClass(Destroyable.class).addClass(Hello.class).addClass(TestEjb.class);

        final EnterpriseArchive ear = ShrinkWrap.create(EnterpriseArchive.class, "test.ear").addAsModule(ejbJar);
