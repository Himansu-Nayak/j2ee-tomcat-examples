...
public class SimpleServletTest {
    ...
    public static WebArchive getArchive() {
        return ShrinkWrap.create(WebArchive.class, "ROOT.war").addClass(SimpleServlet.class)
                .addAsWebInfResource(new ClassLoaderAsset(
                        SimpleServletTest.class.getPackage().getName().replace('.', '/').concat("/").concat("web.xml")),
                "web.xml");
