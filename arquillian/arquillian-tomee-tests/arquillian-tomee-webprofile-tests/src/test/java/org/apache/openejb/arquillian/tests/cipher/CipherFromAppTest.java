...
public class CipherFromAppTest {
    ...
    public static Archive<?> war() {
        return ShrinkWrap.create(WebArchive.class, CipherFromAppTest.class.getName() + ".war")
                ...
                .addAsWebInfResource(new StringAsset(MyConstantCipher.class.getName()),
                        "classes/META-INF/" + PasswordCipher.class.getName() + "/constant")
                .addAsWebInfResource(
                        new StringAsset("" + "<resource>" + "   <Resource type=\"DataSource\" id=\"cipher\">"
    ...
    public void checkPassword() {
        ...
        assertEquals(new MyConstantCipher().decrypt(null),
                TomEEDataSourceCreator.TomEEDataSource.class.cast(delegate).getPoolProperties().getPassword());
    }
}
