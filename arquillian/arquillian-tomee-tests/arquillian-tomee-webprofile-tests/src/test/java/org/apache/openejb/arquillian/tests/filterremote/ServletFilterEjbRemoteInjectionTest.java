...
public class ServletFilterEjbRemoteInjectionTest extends TestSetup {
    ...
    public static WebArchive getArchive() {
        return new ServletFilterEjbRemoteInjectionTest().createDeployment(TestRun.class, RemoteServletFilter.class,
    ...
    protected void decorateDescriptor(WebAppDescriptor descriptor) {
        descriptor.createFilter().filterName("filter").filterClass(RemoteServletFilter.class.getName()).up()
