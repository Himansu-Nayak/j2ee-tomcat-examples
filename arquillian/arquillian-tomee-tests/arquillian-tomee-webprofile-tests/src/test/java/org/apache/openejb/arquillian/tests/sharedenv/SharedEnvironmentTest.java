...
public class SharedEnvironmentTest extends TestSetup {
    ...
    public static WebArchive getArchive() {
        WebArchive deployment = new SharedEnvironmentTest().createDeployment(TestRun.class, PojoServletFilter.class,
                Orange.class, Green.class, Environment.class);
    ...
    protected void decorateDescriptor(WebAppDescriptor descriptor) {
        descriptor.createFilter().filterName("filter").filterClass(PojoServletFilter.class.getName()).up()
                .createFilterMapping().filterName("filter").urlPattern("/" + getTestContextName());
