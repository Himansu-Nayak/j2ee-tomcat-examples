...
public class ServletFilterPersistenceInjectionTest extends TestSetup {
    ...
    public static WebArchive getArchive() {
        return new ServletFilterPersistenceInjectionTest().createDeployment(TestRun.class,
                PersistenceServletFilter.class, Address.class);
    }
    ...
    protected void decorateDescriptor(WebAppDescriptor descriptor) {
        descriptor.createFilter().filterName("filter").filterClass(PersistenceServletFilter.class.getName()).up()
