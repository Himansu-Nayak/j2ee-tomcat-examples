...
public class SecurityEJBPropagationTest {
    ...
    public static Archive<?> app() {
        return ShrinkWrap.create(WebArchive.class, "jaspic-ejb.war").addClasses(TheAuthConfigProvider.class,
                TheEJb.class, TheServlet.class, Init.class, TheServerAuthConfig.class, TheServerAuthContext.class,
