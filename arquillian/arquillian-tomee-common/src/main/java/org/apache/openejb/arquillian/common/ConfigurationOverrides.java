...
public class ConfigurationOverrides {
    ...
    public static List<URL> apply(final Object configuration, final Properties systemProperties,
    ...
    public static void apply(final Object configuration, final Properties systemProperties, final List<URL> urls,
            final boolean overrideNotNull, final String... prefixes) {
    ...
    private static void setProperty(final ObjectMap map, final String key, final String property, final String value,
            final Level info, final boolean overrideNotNull) {
        if (value == null) {
