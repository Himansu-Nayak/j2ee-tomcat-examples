...
public class TestClassDiscoverer implements AdditionalBeanDiscoverer {
    private static void addTests(final Set<Class<? extends Annotation>> testMarkers,
            final Set<Class<? extends Annotation>> classMarkers, final IAnnotationFinder finder,
    ...
    public AppModule discover(final AppModule module) {
        ...
        if (module.getClassLoader() != null) {
            addTests(findMarkers(module.getClassLoader()), findClassMarkers(module.getClassLoader()),
        ...
        for (final WebModule web : module.getWebModules()) {
            if (web.getClassLoader() != null && !saw.contains(web.getClassLoader())) {
                ...
                addTests(findMarkers(web.getClassLoader()), findClassMarkers(web.getClassLoader()), web.getFinder(),
                        classes);
        ...
        for (final EjbModule ejb : module.getEjbModules()) {
            if (ejb.getClassLoader() != null && !saw.contains(ejb.getClassLoader())) {
                addTests(findMarkers(ejb.getClassLoader()), findClassMarkers(ejb.getClassLoader()), ejb.getFinder(),
                        testClasses);
        ...
        for (final ConnectorModule connector : module.getConnectorModules()) {
            if (connector.getClassLoader() != null && !saw.contains(connector.getClassLoader())) {
                addTests(findMarkers(connector.getClassLoader()), findClassMarkers(connector.getClassLoader()),
