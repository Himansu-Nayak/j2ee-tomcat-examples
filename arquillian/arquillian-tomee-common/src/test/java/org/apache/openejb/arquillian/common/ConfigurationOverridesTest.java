...
public class ConfigurationOverridesTest extends TestCase {
    ...
    /**
     * This test is to guarantee the order that we find the related properties files. Changing the order would
     * significantly change the logic.
     *
     * Do not change the order
     *
     * Note: the order is guaranteed by
     * org.apache.openejb.arquillian.common.ConfigurationOverrides#apply(java.lang.Object, java.util.Properties,
     * java.lang.String...) because it needs to know if we work on a default or not property file to be able to not
     * override already set properties with defaults ones
     *
     * @throws Exception
     */
