...
public class ManagedExecutorServiceGetPrincipalInTaskTest {
    ...
    public static Archive<?> app() {
        return ShrinkWrap.create(WebArchive.class, "mp.war").addClasses(ConcurrencyServlet.class, User.class)
                .addAsManifestResource(new StringAsset(
                        "<Context>" + "   <Realm className=\"" + MemoryRealm.class.getName() + "\" pathname=\""
