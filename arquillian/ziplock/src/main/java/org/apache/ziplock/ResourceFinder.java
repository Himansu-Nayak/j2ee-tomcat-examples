...
public class ResourceFinder {
     ...
     *             if the class found is not assignable to the specified superclass or interface
     */
    public <T> List<Class<? extends T>> findAllImplementations(final Class<T> interfase)
     ...
     *             if the class found is not assignable to the specified superclass or interface
     */
    public <T> Map<String, Class<? extends T>> mapAllImplementations(final Class<T> interfase)
            throws IOException, ClassNotFoundException {
     ...
     *             if classLoader.getResources throws an exception
     */
    public <T> Map<String, Class<? extends T>> mapAvailableImplementations(final Class<T> interfase)
            throws IOException {
        resourcesNotLoaded.clear();
        final Map<String, Class<? extends T>> implementations = new HashMap<String, Class<? extends T>>();
