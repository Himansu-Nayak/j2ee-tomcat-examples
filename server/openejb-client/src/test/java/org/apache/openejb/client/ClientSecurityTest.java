...
public class ClientSecurityTest extends TestCase {
    ...
    public void testDefaultStrategy() {
        ...
        assertTrue("identityResolver should be an instance of JaasIdentityResolver",
                identityResolver instanceof JaasIdentityResolver);
    }
    ...
    public void testSimpleStrategy() {
        ...
        final IdentityResolver identityResolver = ClientSecurity.getIdentityResolver();
        assertNotNull("identityResolver is null", identityResolver);
        assertTrue("identityResolver should be an instance of ClientSecurity.SimpleIdentityResolver",
                identityResolver instanceof ClientSecurity.SimpleIdentityResolver);
    }
    ...
    public void testLogin() throws FailedLoginException {
        ...
        assertTrue("serverRequest should be an instance of AuthenticationRequest",
                LoginTestUtil.serverRequest instanceof AuthenticationRequest);
        ...
        assertTrue(
                "ClientSecurity.getIdentityResolver() should be an instance of ClientSecurity.SimpleIdentityResolver",
