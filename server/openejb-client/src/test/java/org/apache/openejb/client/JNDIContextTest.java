...
public class JNDIContextTest {
    ...
    private void assertEquals(final JNDIContext jndiContext, final String providerUrl, final String expectedProviderUrl)
            throws Exception {
        final Hashtable<String, String> env = new Hashtable<String, String>();
        ...
        Assert.assertEquals("Expected " + expectedProviderUrl + " but was " + actualProviderUrl, expectedProviderUrl,
                actualProviderUrl);
    }
}
