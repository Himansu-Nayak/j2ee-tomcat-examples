...
public enum RequestType {
    ...
    NOP_REQUEST((byte) -1), EJB_REQUEST((byte) 0), JNDI_REQUEST((byte) 1), AUTH_REQUEST((byte) 2), CLUSTER_REQUEST(
            (byte) 3), LOGOUT_REQUEST((byte) 4), STOP_REQUEST_Quit((byte) 'Q'), STOP_REQUEST_quit(
                    (byte) 'q'), STOP_REQUEST_Stop((byte) 'S'), STOP_REQUEST_stop((byte) 's');
