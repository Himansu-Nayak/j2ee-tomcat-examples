...
public class ClusterMetaDataUpdated {
    ...
    public ClusterMetaDataUpdated(final ServerMetaData serverMetaData, final ClusterMetaData clusterMetaData,
            final ClusterMetaData previousClusterMetaData) {
    ...
    public String toString() {
        return "ClusterMetaDataUpdated{" + "provider=" + serverMetaData.getLocation() + ", version="
                + clusterMetaData.getVersion() + ", uris=" + clusterMetaData.getLocations().length + '}';
    }
}
