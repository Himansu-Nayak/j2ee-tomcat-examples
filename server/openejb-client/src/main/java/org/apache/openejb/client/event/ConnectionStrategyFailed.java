...
public class ConnectionStrategyFailed {
    ...
    public ConnectionStrategyFailed(final ConnectionStrategy strategy, final ClusterMetaData cluster,
            final ServerMetaData server, final Throwable cause) {
    ...
    public String toString() {
        return "ConnectionStrategyFailed{" + "strategy=" + strategy.getClass().getSimpleName() + ", cluster=" + cluster
