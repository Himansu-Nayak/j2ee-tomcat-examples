...
public abstract class EJBHomeHandler extends EJBInvocationHandler implements Externalizable {
    ...
    public EJBHomeHandler(final ThreadPoolExecutor executor, final EJBMetaDataImpl ejb, final ServerMetaData server,
            final ClientMetaData client, final JNDIContext.AuthenticationInfo auth) {
        super(ejb, server, client, auth);
        this.executor = executor;
    }

    public static EJBHomeHandler createEJBHomeHandler(final ThreadPoolExecutor executor, final EJBMetaDataImpl ejb,
            final ServerMetaData server, final ClientMetaData client, final JNDIContext.AuthenticationInfo auth) {
        switch (ejb.type) {
