...
public class StatefulEJBHomeHandler extends EJBHomeHandler {
    ...
    public StatefulEJBHomeHandler(final ThreadPoolExecutor executor, final EJBMetaDataImpl ejb,
    ...
    protected Object removeByPrimaryKey(final Method method, final Object[] args, final Object proxy) throws Throwable {
        throw new ApplicationException(
                new RemoveException("Session objects are private resources and do not have primary keys"));
    }
