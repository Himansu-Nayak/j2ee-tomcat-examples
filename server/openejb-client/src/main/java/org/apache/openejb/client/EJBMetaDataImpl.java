...
public class EJBMetaDataImpl implements javax.ejb.EJBMetaData, java.io.Externalizable {
    ...
    public EJBMetaDataImpl(final Class homeInterface, final Class remoteInterface, final String typeOfBean,
            final InterfaceType interfaceType, final List<Class> businessInterfaces,
    ...
    public EJBMetaDataImpl(final Class homeInterface, final Class remoteInterface, final Class primaryKeyClass,
            final String typeOfBean, final InterfaceType interfaceType, final List<Class> businessInterfaces,
            final Set<String> asynchronousMethodSignatures) {
        this(homeInterface, remoteInterface, typeOfBean, interfaceType, businessInterfaces,
                asynchronousMethodSignatures);
    ...
    public EJBMetaDataImpl(final Class homeInterface, final Class remoteInterface, final Class primaryKeyClass,
            final String typeOfBean, final String deploymentID, final InterfaceType interfaceType,
            final List<Class> businessInterfaces, final Set<String> asynchronousMethodSignatures) {
    ...
    public EJBMetaDataImpl(final Class homeInterface, final Class remoteInterface, final Class primaryKeyClass,
            final String typeOfBean, final String deploymentID, final int deploymentCode,
            final InterfaceType interfaceType, final List<Class> businessInterfaces,
            final Set<String> asynchronousMethodSignatures) {
        this(homeInterface, remoteInterface, primaryKeyClass, typeOfBean, deploymentID, interfaceType,
                businessInterfaces, asynchronousMethodSignatures);
