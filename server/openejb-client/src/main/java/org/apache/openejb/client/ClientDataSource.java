...
public class ClientDataSource implements DataSource {
    ...
    public ClientDataSource(final String jdbcDriver, final String jdbcUrl, final String defaultUserName,
        ...
        try {
            ...
            throw new IllegalStateException(
                    "Cannot use DataSource in client VM without the JDBC Driver in classpath: " + jdbcDriver, e);
        }
    }
