...
public class EntityEJBHomeHandler extends EJBHomeHandler {
    ...
    public EntityEJBHomeHandler(final ThreadPoolExecutor executor, final EJBMetaDataImpl ejb,
    ...
    protected Object findX(final Method method, final Object[] args, final Object proxy) throws Throwable {
        final EJBRequest req = new EJBRequest(RequestMethodCode.EJB_HOME_FIND, ejb, method, args, null,
        ...
        case ResponseCodes.EJB_OK_FOUND:
            ...
            if (primKey == null) {
                ...
                handler = EJBObjectHandler.createEJBObjectHandler(executor, ejb, server, client, primKey,
                        authenticationInfo);
    ...
    protected Object removeByPrimaryKey(final Method method, final Object[] args, final Object proxy) throws Throwable {
        ...
        final EJBRequest req = new EJBRequest(RequestMethodCode.EJB_HOME_REMOVE_BY_PKEY, ejb, method, args, primKey,
                client.getSerializer());
    ...
    protected Object removeWithHandle(final Method method, final Object[] args, final Object proxy) throws Throwable {
        ...
        final EJBRequest req = new EJBRequest(RequestMethodCode.EJB_HOME_REMOVE_BY_HANDLE, ejb, method, args, primKey,
                client.getSerializer());
