...
public class StatefulEJBObjectHandler extends EJBObjectHandler {
    ...
    public StatefulEJBObjectHandler(final ThreadPoolExecutor executorService, final EJBMetaDataImpl ejb,
    ...
    public StatefulEJBObjectHandler(final ThreadPoolExecutor executorService, final EJBMetaDataImpl ejb,
            final ServerMetaData server, final ClientMetaData client, final Object primaryKey,
    ...
    protected Object remove(final Method method, final Object[] args, final Object proxy) throws Throwable {
        ...
        final EJBRequest req = new EJBRequest(RequestMethodCode.EJB_OBJECT_REMOVE, ejb, method, args, primaryKey,
