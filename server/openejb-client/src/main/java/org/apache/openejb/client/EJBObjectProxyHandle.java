...
public class EJBObjectProxyHandle implements Externalizable {
    ...
    public void readExternal(final ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        final JNDIContext.AuthenticationInfo authenticationInfo = JNDIContext.AuthenticationInfo.class
                .cast(in.readObject());

        handler = EJBObjectHandler.createEJBObjectHandler(executorService, ejb, server, client, primaryKey,
                authenticationInfo);
    }
