...
public class ProxyManager {
    ...
    static {
        ...
        try {
            ...
            throw new ClientRuntimeException(
                    "Unable to determine the version of your VM.  No ProxyFactory Can be installed");
        }
        ...
        if (version.startsWith("1.1")) {
            ...
            try {
                ...
                throw new ClientRuntimeException(
                        "No ProxyFactory Can be installed. Unable to load the class org.opentools.proxies.Proxy.  This class is needed for generating proxies in JDK 1.2 VMs.");
            }
            ...
            try {
                ...
                throw new ClientRuntimeException(
                        "No ProxyFactory Can be installed. Unable to load the class org.apache.openejb.client.proxy.Jdk12ProxyFactory.");
            }
        } else {
            ...
            try {
                ...
                throw new ClientRuntimeException(
                        "No ProxyFactory Can be installed. Unable to load the class org.apache.openejb.client.proxy.Jdk13ProxyFactory.");
            }
        }
    ...
    public static Object newProxyInstance(final Class interfaceType, final InvocationHandler h)
            throws IllegalAccessException {
        return newProxyInstance(new Class[] { interfaceType }, h);
    }

    public static Object newProxyInstance(final Class[] interfaces, final InvocationHandler h)
            throws IllegalAccessException {
