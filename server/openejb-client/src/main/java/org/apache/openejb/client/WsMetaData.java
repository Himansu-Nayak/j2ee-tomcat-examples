    ...
    public Object createWebservice() throws Exception {
        ...
        try {
            ...
            if (Service.class.equals(serviceClass)) {
                ...
                try {
                    instance = serviceClass.getConstructor(URL.class, QName.class).newInstance(wsdlLocation,
                            serviceQName);
                } catch (Throwable e) {
        ...
        if (!handlerChains.isEmpty()) {
            ...
            final HandlerResolver handlerResolver = new ClientHandlerResolverImpl(handlerChains, injections,
                    new InitialContext());
