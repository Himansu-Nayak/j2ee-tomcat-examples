...
public final class TypeInfoTestUtil {
    ...
    private static void diffMap(String name, Map<Object, Object> expected, Map<Object, Object> actual,
    ...
    public static void dump(String name, Object value) throws Exception {
        ...
        if (isSimpleValue(value)) {
            ...
            System.out.println(
                    getTypeDecl(value.getClass(), name) + " = new " + value.getClass().getSimpleName() + "();");
