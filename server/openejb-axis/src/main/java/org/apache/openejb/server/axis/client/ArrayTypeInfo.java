...
public class ArrayTypeInfo extends TypeInfo {
    ...
    public ArrayTypeInfo(Class clazz, QName qName, Class serializerClass, Class deserializerClass,
            boolean canSearchParents, FieldDesc[] fields, QName componentType, QName componentQName) {
    ...
    public static class UpdatableArrayTypeInfo extends TypeInfo.UpdatableTypeInfo {
        ...
        public TypeInfo buildTypeInfo() {
            ...
            return new ArrayTypeInfo(clazz, qName, serializerClass, deserializerClass, canSearchParents, fields,
                    componentType, componentQName);
        }
