...
public class ServiceEndpointMethodInterceptor implements MethodInterceptor {
    ...
    private Object doIntercept(Method method, Object[] objects, MethodProxy methodProxy) throws Throwable {
        ...
        Object[] unwrapped = extractFromHolders(objects, parameterDescs,
                operationInfo.getOperationDesc().getNumInParams());
    ...
    private Object[] extractFromHolders(Object[] objects, List parameterDescs, int inParameterCount)
        ...
        if (objects.length != parameterDescs.size()) {
            throw new IllegalArgumentException(
                    "Mismatch parameter count: expected: " + parameterDescs.size() + ", actual: " + objects.length);
        }
    ...
    private void putInHolders(Map outputParameters, Object[] objects, List parameterDescs)
            throws JavaUtils.HolderException {
