...
public class HeavyweightTypeInfoBuilder {
     ...
     */
    private static final Set<String> WebserviceNameSpaces = Collections
            .unmodifiableSet(new LinkedHashSet<String>(Arrays.asList("http://schemas.xmlsoap.org/soap/encoding/", // SOAP 1.1
    ...
    public HeavyweightTypeInfoBuilder(JavaWsdlMapping mapping, XmlSchemaInfo schemaInfo, ClassLoader classLoader,
            Set wrapperElementQNames, Collection<JaxRpcOperationInfo> operations, boolean hasEncoded) {
    ...
    /**
     * Map the (nested) fields of a XML Schema Type to Java Beans properties or public fields of the specified Java
     * Class.
     *
     * @param javaClass
     ...
     * @param xmlTypeInfo
     *            the xml schema for the type
     * @param javaXmlTypeMapping
     *            the java to xml type mapping metadata
     * @param typeInfo
     *            the JaxRpcTypeInfo for this type
     * @throws OpenEJBException
     *             if the XML Schema Type can not be mapped to the Java Class
     */
