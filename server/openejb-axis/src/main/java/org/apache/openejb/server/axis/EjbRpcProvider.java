...
public class EjbRpcProvider extends RPCProvider {
    ...
    public void processMessage(MessageContext msgContext, SOAPEnvelope reqEnv, SOAPEnvelope resEnv, Object obj)
        ...
        try {
            ...
            Object result = container.invoke(ejbDeployment.getDeploymentID(), InterfaceType.SERVICE_ENDPOINT,
                    callInterface, operation.getMethod(), arguments, null);
    ...
    public class AxisRpcInterceptor {
            ...
            try {
                ...
                try {
                    if (handlerChain.handleRequest(messageContext)) {
                        ...
                        /*
                         * The Handler implementation class has the responsibility of setting the response SOAP message
                         * in the handleRequest method and perform additional processing in the handleResponse method.
                         */
                ...
                if (!handlerChain.isEmpty()) {
                    /*
                     * Deserialize the result value from soap msg as handers could have changed it.
                     */
                    try {
        ...
        public Object[] getArguments() {
            try {
                ...
                throw (IllegalStateException) new IllegalStateException(
                        "Cannot demarshal the soap parts into arguments").initCause(e);
            }
        }
        ...
        private Object demarshallResult() throws Exception {
            ...
            /*
             * This is not the most efficient way to deserialize the result but could not find better or more reliable
             * way to do this.
             */
            ...
            DeserializationContext dser = new DeserializationContext(new InputSource(in), resMsg.getMessageContext(),
                    null);
            dser.parse();
        ...
        public void createResult(Object object) {
            ...
            try {
                ...
                RPCElement responseBody = createResponseBody(requestBody, messageContext, operation, serviceDescription,
