    ...
    public BeanContext getDeployment(final EJBRequest req) throws RemoteException {
        ...
        if (req.getDeploymentId() == null) {
            throw new RemoteException(
                    messages.format("invalidDeploymentIdAndCode", req.getDeploymentId(), req.getDeploymentCode()));
        }

        final int idCode = getDeploymentIndex(req.getDeploymentId());
        if (idCode == -1) {
            throw new RemoteException(
                    messages.format("noSuchDeploymentIdAndCode", req.getDeploymentId(), req.getDeploymentCode()));
        }
