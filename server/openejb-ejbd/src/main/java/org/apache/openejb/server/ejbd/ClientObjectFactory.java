...
class ClientObjectFactory implements org.apache.openejb.spi.ApplicationServer {
    ...
    public javax.ejb.Handle getHandle(final ProxyInfo info) {
        ...
        final EJBObjectHandler handler = EJBObjectHandler.createEJBObjectHandler(JNDIContext.globalExecutor(),
    ...
    public javax.ejb.HomeHandle getHomeHandle(final ProxyInfo info) {
        ...
        final EJBHomeHandler hanlder = EJBHomeHandler.createEJBHomeHandler(JNDIContext.globalExecutor(), eMetaData,
    ...
    public javax.ejb.EJBObject getEJBObject(final ProxyInfo info) {
        ...
        final EJBObjectHandler hanlder = EJBObjectHandler.createEJBObjectHandler(JNDIContext.globalExecutor(),
                eMetaData, getServerMetaData(), cMetaData, primKey, null);
    ...
    public Object getBusinessObject(final ProxyInfo info) {
        ...
        final ClientMetaData cMetaData = new ClientMetaData(securityIdentity);
        final EJBMetaDataImpl eMetaData = new EJBMetaDataImpl(null, null, beanContext.getPrimaryKeyClass(),
                beanContext.getComponentType().toString(), beanContext.getDeploymentID().toString(), idCode,
                convert(info.getInterfaceType()), info.getInterfaces(), beanContext.getAsynchronousMethodSignatures());
