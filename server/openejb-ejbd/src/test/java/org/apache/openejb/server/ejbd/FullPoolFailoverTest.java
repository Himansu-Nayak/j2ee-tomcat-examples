...
public class FullPoolFailoverTest extends TestCase {
    ...
    protected void setup(final int statelessPoolSize, final int connectionPoolSize) throws Exception {
        ...
        System.setProperty(org.apache.openejb.client.SocketConnectionFactory.PROPERTY_POOL_SIZE,
                "" + connectionPoolSize);
        ...
        // containers
        StatelessSessionContainerInfo statelessContainerInfo = config
    ...
    private ServiceDaemon createServiceDaemon(final int poolSize, final EjbServer ejbServer, URI uri)
