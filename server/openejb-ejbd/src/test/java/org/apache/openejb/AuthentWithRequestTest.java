...
public class AuthentWithRequestTest {
    ...
    public static void initJAAS() {
        System.setProperty("java.security.auth.login.config",
                AuthentWithRequestTest.class.getResource("/login.config").getFile());
    }
    ...
    public void invoke() throws Exception {
        ...
        OpenEJB.init(new PropertiesBuilder().p(DeploymentsResolver.DEPLOYMENTS_CLASSPATH_PROPERTY, "false").build(),
        ...
        try {
            ...
            final Context context = new InitialContext(new PropertiesBuilder()
                    ...
                    .p(JNDIContext.AUTHENTICATE_WITH_THE_REQUEST, "true").p("java.naming.security.principal", "foo")
                    .p("java.naming.security.credentials", "bar").p("openejb.authentication.realmName", "LM").build());
