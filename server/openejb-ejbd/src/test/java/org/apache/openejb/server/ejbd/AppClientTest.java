...
public class AppClientTest extends TestCase {
    ...
    public void test() throws Exception {
        ...
        final ClientModule clientModule = new ClientModule(new ApplicationClient(), loader, "orange-client",
                OrangeAppClient.class.getName(), "orange-client");
        ...
        final Object global = context
                .lookup("global/testapp/testejbmodule/Orange!" + OrangeBusinessRemote.class.getName());
