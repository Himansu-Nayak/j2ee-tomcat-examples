...
public class SecurityServiceDoesntLeakTest {
    ...
    public void run() throws NamingException {
        ...
        final Properties p = new PropertiesBuilder()
                ...
                .p("java.naming.provider.url", "ejbd://localhost:" + port).p("java.naming.security.principal", "foo")
                .p("java.naming.security.credentials", "bar").p("openejb.authentication.realmName", "PropertiesLogin")
                .build();
        final Context ctx = new InitialContext(p);

        final CallMeRemotely handle = CallMeRemotely.class.cast(ctx
                .lookup("java:global/openejb/CallMe!org.apache.openejb.SecurityServiceDoesntLeakTest$CallMeRemotely"));
