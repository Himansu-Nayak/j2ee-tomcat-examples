...
public class EjbInterceptor {
    ...
    public Object intercept(InvocationContext context) throws Exception {
        ...
        if (binding.getHandlerChain() == null || binding.getHandlerChain().isEmpty()) {
            ...
            /*
             * Since we have to re-do data binding and the XMLStreamReader contents are already consumed by prior data
             * binding step we have to reinitialize the XMLStreamReader from the SOAPMessage created by
             * SAAJInInterceptor.
             */
