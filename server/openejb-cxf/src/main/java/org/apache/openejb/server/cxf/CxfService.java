...
public class CxfService extends WsService {
    ...
    protected HttpListener createEjbWsContainer(URL moduleBaseUrl, PortData port, BeanContext beanContext,
        ...
        try {
            ...
            SystemInstance.get().fireEvent(new ServerCreated(container.getEndpoint().getServer(),
    ...
    protected HttpListener createPojoWsContainer(ClassLoader loader, URL moduleBaseUrl, PortData port, String serviceId,
        ...
        try {
            ...
            PojoWsContainer container = new PojoWsContainer(loader, transportFactory, bus, port, context, target, bdgs,
                    services);
            container.start();
