...
public abstract class CxfEndpoint {
    ...
    public CxfEndpoint(Bus bus, PortData port, Context context, Object implementor,
            DestinationFactory destinationFactory, ServiceConfiguration configuration) {
        this.bus = bus;
        this.port = port;
    ...
    protected static JaxWsServiceFactoryBean configureService(final JaxWsServiceFactoryBean serviceFactory,
    ...
    protected void initHandlers() throws Exception {
        PortInfoImpl portInfo = new PortInfoImpl(implInfo.getBindingType(), serviceFactory.getEndpointName(),
                service.getName());
