...
public class WsJMXTest {
    ...
    public static void beforeClass() throws MalformedObjectNameException {
        ...
        names[0] = new ObjectName(
                "openejb.management:j2eeType=JAX-WS,J2EEServer=openejb,J2EEApplication=<empty>,EndpointType=EJB,name=AnEjbEndpoint");
        names[1] = new ObjectName(
                "openejb.management:j2eeType=JAX-WS,J2EEServer=openejb,J2EEApplication=<empty>,EndpointType=POJO,name=AnPojoEndpoint");
    }
    ...
    public void checkServiceWasDeployed() throws Exception {
        ...
        assertThat(String.class.cast(LocalMBeanServer.get().invoke(names[0], "getWsdl", new Object[0], new String[0])),
                CoreMatchers.containsString(
                        "<soap:address location=\"http://127.0.0.1:" + port + "/app/AnEjbEndpoint\"/>"));
        assertThat(String.class.cast(LocalMBeanServer.get().invoke(names[1], "getWsdl", new Object[0], new String[0])),
                CoreMatchers.containsString(
                        "<soap:address location=\"http://127.0.0.1:" + port + "/app/AnPojoEndpointService\"/>"));
    }
