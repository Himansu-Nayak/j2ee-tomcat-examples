...
public class WebServiceInjectionTest {
    ...
    public Properties props() {
        ...
        .p("properties", "new://Service?class-name=" + MapFactory.class.getName()).p("properties.c", "d")
    ...
    public static class MyWebservice_Service extends Service {
        ...
        public MyWsApi getMyWsApi(final WebServiceFeature... features) {
            return super.getPort(new QName("http://cxf.server.openejb.apache.org/", "myWebservice"), MyWsApi.class,
                    features);
        }
