...
public class WebServiceWithAnUserInterceptorTest {
    ...
    public void test() throws Exception {
        Foo foo = Service.create(new URL("http://localhost:" + port + "/openejb-cxf/FooImpl?wsdl"),
                new QName("http://cxf.server.openejb.apache.org/", "FooImplService")).getPort(Foo.class);
        assertNotNull(foo);
