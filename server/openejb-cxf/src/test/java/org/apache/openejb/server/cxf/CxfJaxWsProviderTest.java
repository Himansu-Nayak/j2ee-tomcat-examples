...
public class CxfJaxWsProviderTest extends TestCase {
    ...
    public void test00_runCheckedException() {
        try {
            AuthenticatorService withHandler = Service
                    .create(new URL("http://localhost:" + port + "/openejb-cxf/AuthenticatorServiceBean?wsdl"),
            ...
            AuthenticatorService noHandler = Service
                    .create(new URL("http://localhost:" + port + "/openejb-cxf/AuthenticatorServiceBeanNoHandler?wsdl"),
