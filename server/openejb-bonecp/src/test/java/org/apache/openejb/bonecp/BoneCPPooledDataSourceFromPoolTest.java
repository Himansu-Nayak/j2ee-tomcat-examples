...
public class BoneCPPooledDataSourceFromPoolTest {
    ...
    public EjbJar app() throws Exception {
        return new EjbJar().enterpriseBean(new SingletonBean(Persister.class).localBean())
    ...
    @LocalBean
    @Singleton
    @DataSourceDefinition(name = "managed", url = URL, user = USER, password = PASSWORD, className = "org.hsqldb.jdbc.JDBCDataSource")
