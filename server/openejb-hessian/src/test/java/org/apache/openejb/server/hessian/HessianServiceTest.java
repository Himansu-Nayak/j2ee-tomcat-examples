...
public class HessianServiceTest {
    ...
    public void client() throws MalformedURLException {
        ...
        final HessianWebService client = HessianWebService.class
                .cast(clientFactory.create(HessianWebService.class, "http://127.0.0.1:" + port
                        + "/HessianServiceTest/hessian/" + MyHessianWebService.class.getSimpleName()));
