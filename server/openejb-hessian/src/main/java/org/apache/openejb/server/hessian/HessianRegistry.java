...
public interface HessianRegistry {
    ...
    String deploy(ClassLoader loader, HessianServer server, String host, String app, String authMethod,
            String transportGuarantee, String realmName, String name) throws URISyntaxException;
