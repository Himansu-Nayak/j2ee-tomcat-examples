...
public class HessianInitialContextFactory implements InitialContextFactory {
    ...
    private static class HessianContext extends ContextWrapper {
        ...
        public HessianContext(final Hashtable<?, ?> environment) {
            ...
            this.allowNonSerializable = environment.get(FORCE_SERIALIZABLE) == null
                    || !"true".equals(String.class.cast(environment.get(FORCE_SERIALIZABLE)));
            ...
            this.connectTimeout = environment.get(CONNECT_TIMEOUT) == null ? -1
                    : Integer.parseInt(String.class.cast(environment.get(CONNECT_TIMEOUT)));
            ...
            try {
                factoryConstructor = loader.loadClass("com.caucho.hessian.client.HessianProxyFactory")
                        .getConstructor(ClassLoader.class);
                serializerConstructor = loader.loadClass("com.caucho.hessian.io.SerializerFactory")
                        .getConstructor(ClassLoader.class);
        ...
        public Object lookup(final String name) throws NamingException {
            try {
                ...
                Reflections.invokeByReflection(clientFactory, "setSerializerFactory",
                        new Class<?>[] { serializerConstructor.getDeclaringClass() }, new Object[] { factory });
                if (user != null) {
