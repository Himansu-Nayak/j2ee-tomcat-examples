...
import org.apache.openejb.server.httpd.*;
...
public class HessianRegistryImpl extends OpenEJBHttpRegistry implements HessianRegistry {
    ...
    @Override
    public String deploy(final ClassLoader loader, final HessianServer listener, final String host, final String app,
            final String authMethod, final String transportGuarantee, final String realmName, final String name) {
    ...
    public void undeploy(String host, String app, String name) {
        SystemInstance.get().getComponent(HttpListenerRegistry.class)
                .removeHttpListener(generateEndpointName(app, name));
    }
