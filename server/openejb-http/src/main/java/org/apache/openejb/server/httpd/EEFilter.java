...
public class EEFilter implements Filter {
    ...
    public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse,
        ...
        WebBeansContext ctx;
        filterChain.doFilter(
                servletRequest.isAsyncSupported() && (ctx = WebBeansContext.currentInstance()) != null ? new CdiRequest(
                        HttpServletRequest.class.cast(servletRequest), ctx, this)
                : (shouldWrap ? new NoCdiRequest(HttpServletRequest.class.cast(servletRequest), this) : servletRequest),
                servletResponse);
    }
    ...
    public static class AsynContextWrapper implements AsyncContext {
        ...
        @Override
        public void addListener(final AsyncListener asyncListener, final ServletRequest servletRequest,
