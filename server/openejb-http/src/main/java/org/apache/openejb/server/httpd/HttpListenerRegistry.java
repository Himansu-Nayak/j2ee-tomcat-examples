...
public class HttpListenerRegistry implements HttpListener {
    ...
    private final boolean cacheResources = "true"
            .equals(SystemInstance.get().getProperty("openejb.http.resource.cache", "false"));
    ...
    public HttpListenerRegistry() {
        ...
        if (systemInstance.getComponent(HttpServletRequest.class) == null) {
            systemInstance.setComponent(HttpServletRequest.class,
                    Proxys.threadLocalProxy(HttpServletRequest.class, request, mock));
        }
        if (systemInstance.getComponent(HttpSession.class) == null) {
            ...
            systemInstance.setComponent(javax.servlet.http.HttpSession.class,
                    Proxys.threadLocalRequestSessionProxy(request, new ServletSessionAdapter(delegate) {
                        @Override
                        public void invalidate() {
                            final Object web = AppFinder.findAppContextOrWeb(
                        ...
                        private void doInvokeSpecificListeners(final String web) {
                            ...
                            if (LightweightWebAppBuilder.class.isInstance(wab)) {
                                final Collection<HttpSessionListener> listeners = LightweightWebAppBuilderListenerExtractor
                                        .findByTypeForContext(web, HttpSessionListener.class);
            ...
            if (!found) {
                ...
                if (servletPath != null) {
                    ...
                    if (url != null) {
                        ...
                        final String pathWithoutSlash = "/".equals(path) || "".equals(servletPath)
                                || "/".equals(servletPath) ? welcomeFile
                    ...
                    if (url != null) {
                        ...
                        if (dot > 0 && dot < servletPath.length() - 1) {
                            ...
                            if (ct != null) {
                                ...
                                final String uct = SystemInstance.get()
                                        .getProperty("openejb.embedded.http.content-type." + ext);
                                if (uct != null) {
