...
public class HttpResponseImpl implements HttpResponse {
    ...
    private static final Logger LOGGER = Logger.getInstance(LogCategory.OPENEJB_SERVER,
            HttpResponseImpl.class.getName());
    private static final String DEFAULT_CONTENT_TYPE = SystemInstance.get()
            .getProperty("openejb.http.default-content-type", "text/html");
    /**
     ...
     *
     * @param code
     *            the HTTP Response code, see
     *            <a href="http://www.ietf.org/rfc/rfc2616.txt">http://www.ietf.org/rfc/rfc2616.txt</a> for these codes
     * @param responseString
     *            the response string to be sent back
     * @param contentType
     *            the content type to be sent back
     */
    ...
    protected static HttpResponseImpl createForbidden(final String ip) {
        ...
        // IP not allowed, etc.
        body.println(
                "IP address: " + ip + " is not registered on this server, please contact your system administrator.");
        body.println("</body>");
        body.println("</html>");
     ...
     *
     * @param code
     *            the code to be sent to the browser
     */
     ...
     *
     * @param type
     *            the type to be sent to the browser (i.e. "text/html")
     */
     ...
     *            the code to be sent to the browser
     * @param responseString
     *            the response string to be sent to the browser
     */
     ...
     * <p/>
     * HTTP/1.1 200 OK Server: Netscape-Enterprise/3.6 SP3 Date: Thu, 07 Jun 2001 17:30:42 GMT Content-Type: text/html
     * Connection: close
     *
     * @param output
     ...
     *
     * @param out
     *            the output stream to write the response line to
     * @throws java.io.IOException
     *             if an exception is thrown
     */
     ...
     *
     * @param out
     *            the output stream to be sent to the browser
     * @throws java.io.IOException
     *             if an exception is thrown
     */
     ...
     *
     * @param in
     *            the input to read the object from
     * @throws java.io.IOException
     *             if an exception is thrown
