...
public class BeginWebBeansListener
    ...
    public BeginWebBeansListener(final WebBeansContext webBeansContext) {
        ...
        this.contextsService = webBeansContext != null
                ? CdiAppContextsService.class.cast(webBeansContext.getService(ContextsService.class)) : null;
    ...
    public void requestDestroyed(final ServletRequestEvent event) {
        ...
        try {
            ...
            if (webBeansContext instanceof WebappWebBeansContext) { // end after child
                ((WebappWebBeansContext) webBeansContext).getParent().getContextsService()
                        .endContext(RequestScoped.class, event);
            }
        } finally {
