...
/**
 * This is the main class for the web administration. It takes care of the processing from the browser, sockets and
 * threading.
 *
 * @since 11/25/2001
 */
public class OpenEJBHttpServer implements HttpServer {
    ...
    public void service(final Socket socket) throws ServiceException, IOException {
        ...
        try {
            ...
            final URI socketURI = new URI(
                    "http://" + socket.getLocalAddress().getHostAddress() + ":" + socket.getLocalPort());
     ...
     */
    private boolean processRequest(final Socket socket, final URI socketURI, final InputStream in,
    ...
    private HttpResponseImpl process(final Socket socket, final URI socketURI, final InputStream in)
