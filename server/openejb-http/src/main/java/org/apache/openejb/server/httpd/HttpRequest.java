...
public interface HttpRequest extends java.io.Serializable, HttpServletRequest {
    ...
    /**
     * If the https server implementation is based on Servlets, the real HttpServletRequest will be registered in the
     * request attributes using this name.
     */
    ...
    //
    /**
     * If the https server implementation is based on Servlets, the real HttpServletResponse will be registered in the
     * request attributes using this name.
     */
    public static final String SERVLET_RESPONSE = HttpRequest.class.getName() + "@ServletResponse";
    /**
     * If the https server implementation is based on Servlets, the real ServletContext will be registered in the
     * request attributes using this name. Note: a ServletContext may not be registered even if HttpServletRequest and
     * HttpServletResponse objects are registered.
     */
