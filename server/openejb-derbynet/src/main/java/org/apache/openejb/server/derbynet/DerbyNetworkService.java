...
public class DerbyNetworkService implements ServerService, SelfManaging {
    ...
    @Override
    public void service(final InputStream inputStream, final OutputStream outputStream)
    ...
    public void start() throws ServiceException {
        ...
        try {
            ...
            if (verbose) {
                LOGGER.info("Starting openejb-derbynet with derby " + serverControl.getRuntimeInfo() + " "
                        + serverControl.getSysinfo());
            }
        } catch (Exception e) {
