...
/**
 * This test aims at testing the filtering feature on services. Basically, this test does not do a lot of stuff except
 * declaring only one service and looking through the service if there is only one service.
 */
@EnableServices
