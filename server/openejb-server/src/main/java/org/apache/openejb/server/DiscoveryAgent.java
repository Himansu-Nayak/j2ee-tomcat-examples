...
public interface DiscoveryAgent {
     ...
     * That process can use this method to notify the DiscoveryAgent of the failure so that other listeners of this
     * DiscoveryAgent can also be made aware of the failure.
     */
