...
public class ServiceManagerExtender extends ServiceManager {
    ...
    static Logger logger = Logger.getInstance(LogCategory.OPENEJB_SERVER_REMOTE,
        ...
        public void start() {
            ...
            if (server != null) {
                try {
                    ...
                    logger.error("Service Start Failed: " + name + " " + server.getIP() + " " + server.getPort()
                            + ". Exception: " + e.getMessage(), e);
                }

                final BundleContext context = bundle.getBundleContext();
                registration = context.registerService(ServerService.class.getName(), server, getServiceProperties());
            }
        }
    ...
    private class ServerServiceTracker implements BundleTrackerCustomizer {
        ...
        private void setClass(final Properties properties, final Bundle bundle, final Class interfase)
