...
/**
 * @version $Rev$ $Date$
 * @org.apache.xbean.XBean element="server" description="OpenEJB Server"
 */
...
public class Server implements Service {
    ...
    public void init(final Properties props) throws Exception {
        ...
        system.setProperty(DeploymentFilterable.CLASSPATH_INCLUDE,
                system.getProperty(DeploymentFilterable.CLASSPATH_INCLUDE, ".*/" + home.getName() + "/lib/.*"));
        system.setProperty(DeploymentFilterable.CLASSPATH_REQUIRE_DESCRIPTOR,
                system.getProperty(DeploymentFilterable.CLASSPATH_REQUIRE_DESCRIPTOR, "true"));
        system.setProperty(DeploymentFilterable.CLASSPATH_FILTER_SYSTEMAPPS,
                system.getProperty(DeploymentFilterable.CLASSPATH_FILTER_SYSTEMAPPS, "false"));
