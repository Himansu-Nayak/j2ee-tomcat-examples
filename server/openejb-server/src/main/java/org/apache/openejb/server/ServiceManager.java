...
public abstract class ServiceManager {
    ...
    public static ServerService manage(final String serviceName, final Properties serviceProperties,
    ...
    protected List<ServerService> initServers(final Map<String, Properties> availableServices) throws IOException {
        ...
        if (enabled) {
            ...
            try {
                ...
                try {
                    ...
                    final ReflectionUtil.StaticFactory factory = ReflectionUtil.findStaticFactory(serviceClass,
                            "createServerService", null, null, serviceProperties.stringPropertyNames(),
                    ...
                    if (factory != null) {
                        ...
                        if (ReflectionUtil.findStaticFactory(serviceClass, "createServerService", null, null) != null) { // old behavior, remove when sure previous check is ok
                        recipe.setFactoryMethod("createServerService");
                    }
                ...
                t.printStackTrace();
                logger.error("service.instantiation.err", t, serviceClass.getName(), t.getClass().getName(),
                        t.getMessage());
            }
        }
    ...
    private void overrideProperties(final String serviceName, final Properties serviceProperties) throws IOException {
        ...
        if (conf.exists()) {
            ...
            if (null == legacy) {
                ...
                final File[] files = conf.listFiles(new FilenameFilter() {
                    ...
                    public boolean accept(final File dir, String name) {
                        ...
                        return name.equals("ejbd.properties") || name.equals("ejbds.properties")
                                || name.equals("admin.properties") || name.equals("httpejbd.properties");
                    }
                });
            ...
            addProperties(conf, legacySchema,
                    new File(conf, SystemInstance.get().currentProfile() + "." + serviceName + ".properties"),
    ...
    private void addProperties(final File conf, final boolean legacySchema, final File path, final Properties fullProps,
            final boolean tryToDump) throws IOException {
     ...
     * <p/>
     * Services should not be started if {@link #stop()} has already been called, in which case a ServiceException
     * should be thrown
     *
     * @param block
     *            A request to block
     * @throws ServiceException
     *             On error or if the manager has been stopped already
     */
