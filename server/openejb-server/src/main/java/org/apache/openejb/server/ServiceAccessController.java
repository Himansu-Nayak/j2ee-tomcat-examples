...
import org.apache.openejb.server.auth.*;
...
public class ServiceAccessController extends ServerServiceFilter {
    ...
    public void checkHostsAuthorization(final InetAddress clientAddress, final InetAddress serverAddress)
        ...
        throw new SecurityException(
                "Host " + clientAddress.getHostAddress() + " is not authorized to access this service.");
    }
    ...
    private void addIPAddressPermissions(final LinkedList<IPAddressPermission> permissions, final String hostname)
