...
public class MultipleApplicationsTest {
    ...
    public void app1() {
        assertEquals("Hi from REST World!",
                WebClient.create("http://localhost:" + port + "/foo/").path("app1/first/hi").get(String.class));
    }

    @Test
    public void app2() {
        assertEquals("hi bar",
                WebClient.create("http://localhost:" + port + "/foo/").path("app2/second/hi2/bar").get(String.class));
    }
