...
public class SortProviderTest {
    ...
    public static class ATestProviderA implements MessageBodyWriter<AtomicReference<String>> {
        ...
        @Override
        public long getSize(AtomicReference<String> t, Class<?> rawType, Type genericType, Annotation[] annotations,
                MediaType mediaType) {
            return -1;
        }
        ...
        @Override
        public void writeTo(AtomicReference<String> t, Class<?> rawType, Type genericType, Annotation[] annotations,
    ...
    public static class ATestProvider11 implements MessageBodyWriter<AtomicReference<?>> {
        @Override
        public long getSize(AtomicReference<?> t, Class<?> rawType, Type genericType, Annotation[] annotations,
                MediaType mediaType) {
            return -1;
        }
        ...
        @Override
        public void writeTo(AtomicReference<?> t, Class<?> rawType, Type genericType, Annotation[] annotations,
                MediaType mediaType, MultivaluedMap<String, Object> httpHeaders, OutputStream entityStream)
                        throws IOException {
