...
public class RsWithInterfaceTest {
    ...
    public void rest() throws IOException {
        final String response = ClientBuilder.newClient().target("http://127.0.0.1:" + port + "/RsWithInterfaceTest/")
                .path("itf/check").request().accept(MediaType.TEXT_PLAIN_TYPE).get(String.class);
