...
public class JAXRSRoutingTest {
    ...
    @Module
    @Classes(cdi = true, value = { RestWithInjections.class, FirstService.class, SimpleEJB.class,
    ...
    public void routing() {
        assertEquals("routing",
                WebClient.create("http://localhost:" + port + "/foo/").path("routing").get(String.class));
    }
