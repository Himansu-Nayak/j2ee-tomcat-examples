...
public class AutoBValTest {
    ...
    public void passing() {
        ...
        payload.setName("ok");
        assertEquals("ok",
                ClientBuilder.newClient().target(base.toExternalForm()).path("openejb/test")
                        .request(MediaType.APPLICATION_JSON_TYPE)
                        .post(Entity.entity(payload, MediaType.APPLICATION_JSON_TYPE), Payload.class).getName());
    }

    @Test
    public void inFailing() {
        final Payload payload = new Payload();
        assertEquals(Response.Status.BAD_REQUEST.getStatusCode(), // thanks to the mapper
                ClientBuilder.newClient().target(base.toExternalForm()).path("openejb/test")
                        .request(MediaType.APPLICATION_JSON_TYPE)
