...
public class CustomContextTest {
    ...
    public void rest() throws IOException {
        final String response = ClientBuilder.newClient().target("http://127.0.0.1:" + port + "/CustomContextTest")
                .path("custom-context/check").request().accept(MediaType.TEXT_PLAIN_TYPE).get(String.class);
