...
public class RsInjectionTest {
    ...
    public void rest() throws IOException {
        final String response = ClientBuilder.newClient().target("http://127.0.0.1:" + port + "/RsInjectionTest/")
                .path("injections/check").request().accept(MediaType.TEXT_PLAIN_TYPE).get(String.class);
    ...
    public static class RsInjection {
        ...
        public boolean check() {
            return providers != null && response != null && request != null
                    && "/RsInjectionTest".equals(request.getContextPath());
        }
    }
}
