...
public class SubResourceTest {
    ...
    public void rest() throws IOException {
        final String response = ClientBuilder.newClient().target("http://127.0.0.1:" + port + "/SubResourceTest/")
                .path("sub1/sub2/value").request().accept(MediaType.TEXT_PLAIN_TYPE).get(String.class);
