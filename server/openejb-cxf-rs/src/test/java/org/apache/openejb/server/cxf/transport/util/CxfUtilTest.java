...
@ContainerProperties({ @ContainerProperties.Property(name = "openejb.cxf.monitoring.jmx", value = "true"),
...
public class CxfUtilTest {
    ...
    public void checkMonitoring() throws IOException, MalformedObjectNameException {
        ...
        final Set<ObjectInstance> mbeans = ManagementFactory.getPlatformMBeanServer()
                .queryMBeans(new ObjectName("*:*,type=Performance.Counter.Server"), null);
