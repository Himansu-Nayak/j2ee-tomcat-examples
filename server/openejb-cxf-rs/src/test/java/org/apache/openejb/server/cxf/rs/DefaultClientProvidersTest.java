...
public class DefaultClientProvidersTest {
    ...
    @Test
    public void json() {
        final Json json = ClientBuilder.newBuilder().build().target(http.toExternalForm())
                .path("openejb/DefaultClientProvidersTest").request().get(Json.class);
        assertNotNull(json);
    ...
    @Test
    public void jsonp() {
        final JsonObject json = ClientBuilder.newBuilder().build().target(http.toExternalForm())
                .path("openejb/DefaultClientProvidersTest").request().get(JsonObject.class);
        assertNotNull(json);
