...
class SaajFactoryFinder {
    ...
    static {
        ...
        SAAJ_FACTORIES.put(SaajUniverse.Type.AXIS2.toString(),
                createSAAJInfo("org.apache.axis2.saaj.MessageFactoryImpl", "org.apache.axis2.saaj.SOAPFactoryImpl",
    ...
    private static Map<String, String> createSAAJInfo(String messageFactory, String soapFactory,
            String soapConnectionFactory, String metaFactory) {
    ...
    private static Object newInstance(String factoryClassName) throws SOAPException {
        try {
            ...
            throw new SOAPException("Provider " + factoryClassName + " could not be instantiated: " + e.getMessage(),
                    e);
        }
    }
}
