...
public class OpenEJBHttpWsRegistry extends OpenEJBHttpRegistry implements WsRegistry {
    ...
    public List<String> setWsContainer(final HttpListener httpListener, final ClassLoader classLoader,
            final String context, final String virtualHost, final ServletInfo servletInfo, final String realmName,
        ...
        return addWsContainer(httpListener, classLoader, context, virtualHost, path, realmName, transportGuarantee,
                authMethod, moduleId);
    }
    ...
    @Override
    public List<String> addWsContainer(final HttpListener inputListener, final ClassLoader classLoader,
            final String context, final String virtualHost, final String path, final String realmName,
            final String transportGuarantee, // ignored
            final String authMethod, final String moduleId) throws Exception {
