...
public class FileIndexer {
    ...
    public FileIndexer(final File base, final File patchedFilesFolder, final Properties configuration,
            final String ignore) {
        ...
        this.filesToRemove = toRemove == null ? Collections.<String> emptyList()
                : new ArrayList<String>(asList(toRemove.split(" *, *")));
