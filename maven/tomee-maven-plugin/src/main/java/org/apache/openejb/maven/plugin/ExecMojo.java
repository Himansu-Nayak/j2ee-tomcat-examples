...
public class ExecMojo extends BuildTomEEMojo {
    ...
    private void createExecutableJar() throws Exception {
        ...
        config.put("command", DEFAULT_SCRIPT.equals(script)
                ? (skipArchiveRootFolder ? "" : catalinaBase.getName() + "/") + DEFAULT_SCRIPT : script);
        ...
        final ArchiveOutputStream os = new ArchiveStreamFactory().createArchiveOutputStream(ArchiveStreamFactory.JAR,
                fileOutputStream);
        ...
        { // Main + utility
            for (final Class<?> clazz : asList(ExecRunner.class, Files.class, Files.PatternFileFilter.class,
                    Files.DeleteThread.class, Files.FileRuntimeException.class, Files.FileDoesNotExistException.class,
                    Files.NoopOutputStream.class, LoaderRuntimeException.class, Pipe.class, IO.class, Zips.class,
                    JarLocation.class, RemoteServer.class, RemoteServer.CleanUpThread.class,
                    OpenEJBRuntimeException.class, Join.class, QuickServerXmlParser.class, Options.class,
                    Options.NullLog.class, Options.TomEEPropertyAdapter.class, Options.NullOptions.class,
                    Options.Log.class)) {
                addToJar(os, clazz);
            }
        }
