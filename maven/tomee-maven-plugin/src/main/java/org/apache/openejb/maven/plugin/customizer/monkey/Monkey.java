...
/**
 * A customizer (see tomee-maven-plugin) allowing to take current project binaries (target/classes) and merge them in
 * tomee for patch cases.
 *
...
public class Monkey implements Runnable {
    ...
    public void run() {
        ...
        final FileIndexer indexer = new FileIndexer(base, classes, configuration, MONKEY_CONFIGURATION_FILE).index()
                .dump(stream);
        stream.println();
