...
public class WsBuilder {
    public static PortData toPortData(final PortInfo port, final Collection<Injection> injections, final URL baseUrl,
    ...
    public static List<HandlerChainData> toHandlerChainData(final List<HandlerChainInfo> chains,
            final ClassLoader classLoader) throws OpenEJBException {
        ...
        for (final HandlerChainInfo handlerChain : chains) {
            ...
            final HandlerChainData handlerChainData = new HandlerChainData(handlerChain.serviceNamePattern,
                    handlerChain.portNamePattern, handlerChain.protocolBindings, handlers);
