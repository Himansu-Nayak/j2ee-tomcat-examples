...
public class EntityEjbHomeHandler extends EjbHomeProxyHandler {
    ...
    public EntityEjbHomeHandler(final BeanContext beanContext, final InterfaceType interfaceType,
    ...
    public Object createProxy(final Object primaryKey, final Class mainInterface) {
        ...
        /*
         * Register the handle with the BaseEjbProxyHandler.liveHandleRegistry If the bean is removed by its home or by
         * an identical proxy, then the this proxy will be automatically invalidated because its properly registered
    ...
    protected Object findX(final Class interfce, final Method method, final Object[] args, final Object proxy)
            throws Throwable {
    ...
    protected Object removeByPrimaryKey(final Class interfce, final Method method, final Object[] args,
        ...
        if (primKey instanceof EJBLocalObject) {
            ...
            throw new RemoveException(
                    "Invalid argument '" + ejbObjectName + "', expected primary key.  Update to ejbLocalHome.remove("
                            + lcfirst(ejbObjectName) + ".getPrimaryKey())");
            ...
            throw new RemoveException(
                    "Invalid argument '" + ejbObjectName + "', expected primary key.  Update to ejbHome.remove("
                            + lcfirst(ejbObjectName) + ".getPrimaryKey())");
        }
    ...
    protected EjbObjectProxyHandler newEjbObjectHandler(final BeanContext beanContext, final Object pk,
