...
public class ActiveMQFactory {
    ...
    private static void init() {
        ...
        synchronized (initialized) {
            ...
            if (!initialized.getAndSet(true)) {
                ...
                try {
                    ...
                    try {
                        ...
                        throw new OpenEJBRuntimeException(
                                "Unable to load ActiveMQFactory: Check ActiveMQ jar files are on classpath", t1);
                    }
                }
                ...
                try {
                    setThreadProperties = clazz.getDeclaredMethod("setThreadProperties",
    ...
    /**
     * Returns the prefix metafile name of the poperties file that ActiveMQ should be provided with. This file is
     * located at META-INF/services/org/apache/activemq/broker/ and defines the BrokerFactoryHandler to load.
     *
    ...
    /**
     * Returns a map of configured brokers. This intended for access upon RA shutdown in order to wait for the brokers
     * to finish.
     *
