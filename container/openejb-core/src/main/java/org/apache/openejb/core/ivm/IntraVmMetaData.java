...
public class IntraVmMetaData implements EJBMetaData, Serializable {
    ...
    public IntraVmMetaData(final Class homeInterface, final Class remoteInterface, final Class primaryKeyClass,
            final BeanType typeOfBean) {
    ...
    public Class getPrimaryKeyClass() {
        if (type.isEntity()) {
            ...
            throw new UnsupportedOperationException(
                    "Session objects are private resources and do not have primary keys");
        }
    }
    ...
    protected Object writeReplace() throws ObjectStreamException {
        ...
        if (IntraVmCopyMonitor.isIntraVmCopyOperation()) {
            ...
            /*
             * If the meta data is referenced by a stateful bean that is being passivated by the container, we allow
             * this object to be serialized.
             */
            ...
            return this;
            /*
             * If the meta data is serialized outside the core container system, we allow the application server to
             * handle it.
             */
        } else {
