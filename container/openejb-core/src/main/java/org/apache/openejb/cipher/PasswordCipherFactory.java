...
public class PasswordCipherFactory {
    /**
     * Create a {@link org.apache.openejb.cipher.PasswordCipher} instance from the passwordCipher class name.
     *
     * @param passwordCipherClass
     *            the password cipher to look for
     * @return the password cipher from the passwordCipher class name optionally set.
     */
    public static PasswordCipher getPasswordCipher(final String passwordCipherClass) {
        ...
        try {
            ...
            try {
                return doInternalPasswordCipher(org.apache.openejb.resource.jdbc.cipher.PasswordCipher.class,
                        passwordCipherClass);
    ...
    private static <T extends PasswordCipher> T doInternalPasswordCipher(final Class<T> intf,
            final String passwordCipherClass) {
        ...
        try {
            ...
            final String message = "Password cipher '" + passwordCipherClass
