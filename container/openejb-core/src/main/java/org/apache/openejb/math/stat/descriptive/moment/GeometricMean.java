...
public class GeometricMean extends AbstractStorelessUnivariateStatistic implements Serializable {
    ...
    /**
     * Copy constructor, creates a new {@code GeometricMean} identical to the {@code original}
     *
     * @param original
     ...
     * @return the geometric mean or Double.NaN if length = 0 or any of the values are &lt;= 0.
    ...
    private void checkEmpty() {
        if (getN() > 0) {
            throw MathRuntimeException
                    .createIllegalStateException("{0} values have been added before statistic is configured", getN());
        }
    }
