...
public final class ClientInjections {
    ...
    public static InjectionProcessor<?> clientInjector(final Object object) throws OpenEJBException {
        ...
        if (injections == null) {
            throw new OpenEJBException("Unable to find injection meta-data for " + object.getClass().getName()
                    + ".  Ensure that class was annotated with @" + LocalClient.class.getName()
                    + " and was successfully discovered and deployed. "
