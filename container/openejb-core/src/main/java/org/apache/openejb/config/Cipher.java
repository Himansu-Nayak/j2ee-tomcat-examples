...
/**
 * Command line tool on top of the {@link PasswordCipher} interface. Basically, it allows end user to encrypt/decrypt a
 * string (ie. a password) using a cipher implementation.
 */
public class Cipher {
    ...
    private static void availableCiphers() {
        try {
            ...
            final Map<String, Class<? extends PasswordCipher>> impls = finder
                    .mapAllImplementations(PasswordCipher.class);
