...
public class CoreUserTransaction implements UserTransaction, Serializable {
    ...
    private static final transient Logger transactionLogger = Logger.getInstance(LogCategory.TRANSACTION,
    ...
    public int getStatus() throws SystemException {
        ...
        if (transactionLogger.isDebugEnabled()) {
            transactionLogger.debug(
                    "User transaction " + transactionManager().getTransaction() + " has status " + getStatus(status));
        }
        return status;
    }
