...
public interface StorelessUnivariateStatistic extends UnivariateStatistic {
    ...
    /**
     * Updates the internal state of the statistic to reflect addition of all values in the values array. Does not clear
     * the statistic first -- i.e., the values are added <strong>incrementally</strong> to the dataset.
     *
     * @param values
    ...
    /**
     * Updates the internal state of the statistic to reflect addition of the values in the designated portion of the
     * values array. Does not clear the statistic first -- i.e., the values are added <strong>incrementally</strong> to
     * the dataset.
     *
     * @param values
     *            array holding the new values to add
     ...
     *
     * @return value of the statistic, <code>Double.NaN</code> if it has been cleared or just instantiated.
     */
    double getResult();
