...
public class ClientModule extends Module implements DeploymentModule {
    ...
    public ClientModule(final ApplicationClient applicationClient, final ClassLoader classLoader,
            final String jarLocation, final String mainClass, final String moduleId) {
    ...
    public String toString() {
        return "ClientModule{" + "moduleId='" + id.getName() + '\'' + ", mainClass='" + mainClass + '\'' + '}';
    }
