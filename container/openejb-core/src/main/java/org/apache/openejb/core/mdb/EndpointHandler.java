...
public class EndpointHandler implements InvocationHandler, MessageEndpoint {
    ...
    public EndpointHandler(final MdbContainer container, final BeanContext deployment,
            final MdbInstanceFactory instanceFactory, final XAResource xaResource) throws UnavailableException {
    ...
    public void beforeDelivery(final Method method) throws ApplicationServerInternalException {
        ...
        case BEFORE_CALLED:
            throw new IllegalStateException(
                    "beforeDelivery can not be called again until message is delivered and afterDelivery is called");
        case METHOD_CALLED:
        case SYSTEM_EXCEPTION:
            throw new IllegalStateException(
                    "The last message delivery must be completed with an afterDeliver before beforeDeliver can be called again");
        }
    ...
    public Object deliverMessage(final Method method, final Object[] args) throws Throwable {
        ...
        case SYSTEM_EXCEPTION:
            throw new IllegalStateException(
                    "The last message delivery must be completed with an afterDeliver before another message can be delivered");
        }
    ...
    public void afterDelivery() throws ApplicationServerInternalException, UnavailableException {
        ...
        case BEFORE_CALLED:
            throw new IllegalStateException(
                    "Exactally one message must be delivered between beforeDelivery and afterDelivery");
        case NONE:
            throw new IllegalStateException(
                    "afterDelivery may only be called if message delivery began with a beforeDelivery call");
        }
    ...
    private static enum State {
        ...
        /**
         * The beforeDelivery method has been called, and the next method called must be a message delivery method or
         * release.
         */
        BEFORE_CALLED,

        /**
         * The message delivery method has been called successfully, and the next method called must be another message
         * delivery method, afterDelivery, or release.
         */
        METHOD_CALLED,

        /**
         * The message delivery threw a system exception, and the next method called must be afterDelivery or release.
         * This state notified the afterDelivery method that the instace must be replaced with a new instance.
         */
        SYSTEM_EXCEPTION,
