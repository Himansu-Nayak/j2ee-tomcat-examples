...
public class Undeploy {
    ...
    public static void undeploy(final String moduleId, final Deployer deployer)
    ...
    private static Option option(final String shortOpt, final String longOpt, final String argName,
        ...
        return OptionBuilder.withLongOpt(longOpt).withArgName(argName).hasArg()
                .withDescription(Undeploy.i18n(description)).create(shortOpt);
    }
