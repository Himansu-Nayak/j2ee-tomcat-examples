...
public class ServiceManagerProxy {
    ...
    public ServiceManagerProxy(final boolean checkAlreadyStarted) throws AlreadyStartedException {
        ...
        try {
            ...
            final String msg = "Enabling option '" + LocalInitialContext.OPENEJB_EMBEDDED_REMOTABLE
                    + "' requires class 'org.apache.openejb.server.ServiceManager' to be available.  Make sure you have the openejb-server-*.jar in your classpath and at least one protocol implementation such as openejb-ejbd-*.jar.";
