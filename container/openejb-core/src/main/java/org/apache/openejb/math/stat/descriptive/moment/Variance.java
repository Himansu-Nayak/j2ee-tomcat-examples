...
public class Variance extends AbstractStorelessUnivariateStatistic implements Serializable, WeightedEvaluation {
    ...
    /**
     * Boolean test to determine if this Variance should also increment the second moment, this evaluates to false when
     * this Variance is constructed with an external SecondMoment as a parameter.
     */
    protected boolean incMoment = true;

    /**
     * Determines whether or not bias correction is applied when computing the value of the statisic. True means that
     * bias is corrected. See {@link Variance} for details on the formula.
     */
     ...
     *            setting for bias correction - true means bias will be corrected and is equivalent to using the
     ...
     *
     * @param isBiasCorrected
     *            setting for bias correction - true means bias will be corrected
     * @param m2
     *            the SecondMoment (Third or Fourth moments work here as well.)
     */
    ...
    /**
     * Copy constructor, creates a new {@code Variance} identical to the {@code original}
     *
     * @param original
    ...
    /**
     * Returns the variance of the entries in the specified portion of the input array, or <code>Double.NaN</code> if
    ...
    /**
     * Returns the variance of the entries in the specified portion of the input array, using the precomputed mean
     * value. Returns <code>Double.NaN</code> if the designated subarray is empty.
     * <p>
     * See {@link Variance} for details on the computing algorithm.
     * </p>
     * <p>
    ...
    /**
     * Returns the variance of the entries in the input array, using the precomputed mean value. Returns
    ...
    /**
     * Returns the weighted variance of the entries in the specified portion of the input array, using the precomputed
     * weighted mean value. Returns <code>Double.NaN</code> if the designated subarray is empty.
     * <p>
     * Uses the formula
     *
     * <pre>
