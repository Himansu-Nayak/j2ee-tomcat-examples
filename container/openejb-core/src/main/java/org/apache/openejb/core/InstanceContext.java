...
public class InstanceContext {
    ...
    /**
     * A slot where the container can put instance-specific data without having to wrap this object
     */
    private Object instanceData;

    public InstanceContext(final BeanContext beanContext, final Object bean, final Map<String, Object> interceptors,
