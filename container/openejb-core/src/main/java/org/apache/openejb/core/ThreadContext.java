...
public class ThreadContext {
    ...
    /**
     * A boolean which keeps track of whether to discard the bean instance after the method invocation. The boolean
     * would be set to true in case of exceptions which mandate bean discard.
     */
    ...
    public String toString() {
        return "ThreadContext{" + "beanContext=" + beanContext.getId() + ", primaryKey=" + primaryKey + ", data="
                + data.size() + ", oldClassLoader=" + oldClassLoader + ", currentOperation=" + currentOperation
                + ", invokedInterface=" + invokedInterface + ", transactionPolicy=" + transactionPolicy
