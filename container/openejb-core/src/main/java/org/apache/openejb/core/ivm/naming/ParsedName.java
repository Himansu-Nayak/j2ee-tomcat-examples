...
public class ParsedName implements Serializable {
    ...
    public String toString() {
        return "ParsedName{" + "path=" + path() + ", component=" + getComponent() + '}';
    }
    ...
    /*
     * Check that the given pathname is normal. If not, invoke the real normalizer on the part of the pathname that
     * requires normalization. This way we iterate through the whole pathname string only once.
     */
