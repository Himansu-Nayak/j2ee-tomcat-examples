...
public class DynamicMBeanWrapper implements DynamicMBean, MBeanRegistration {
    ...
    static {
        ...
        try {
            OPENEJB_API_TO_JAVAX.put(MBean.class,
                    (Class<? extends Annotation>) loader.loadClass("javax.management.MBean"));
            OPENEJB_API_TO_JAVAX.put(Description.class,
                    (Class<? extends Annotation>) loader.loadClass("javax.management.Description"));
            OPENEJB_API_TO_JAVAX.put(ManagedOperation.class,
                    (Class<? extends Annotation>) loader.loadClass("javax.management.ManagedOperation"));
            OPENEJB_API_TO_JAVAX.put(ManagedAttribute.class,
                    (Class<? extends Annotation>) loader.loadClass("javax.management.ManagedAttribute"));
            OPENEJB_API_TO_JAVAX.put(NotificationInfo.class,
                    (Class<? extends Annotation>) loader.loadClass("javax.management.NotificationInfo"));
            OPENEJB_API_TO_JAVAX.put(NotificationInfos.class,
    ...
    public DynamicMBeanWrapper(final WebBeansContext wc, final Object givenInstance) {
        ...
        if (cache == null) {
            ...
            for (final Method m : annotatedMBean.getMethods()) {
                ...
                if (m.getDeclaringClass().equals(Object.class) || !Modifier.isPublic(modifiers)
            ...
            info = new MBeanInfo(annotatedMBean.getName(), description,
                    attributeInfos.toArray(new MBeanAttributeInfo[attributeInfos.size()]), null, // default constructor is mandatory
    ...
    static MBeanParameterInfo[] parameters(final MBeanOperationInfo jvmInfo, final Class<?>[] classes,
    ...
    private static <T extends Annotation> T annotationProxy(final Object javaxAnnotation, final Class<T> clazz) {
        return (T) Proxy.newProxyInstance(DynamicMBeanWrapper.class.getClassLoader(), new Class<?>[] { clazz },
    ...
    private static MBeanNotificationInfo getNotificationInfo(final NotificationInfo n) {
        ...
        return new MBeanNotificationInfo(n.types(), n.notificationClass().getName(), description,
    ...
    private MBeanOperationInfo newMethodDescriptor(final String operationDescr, final Method m) {
        ...
        return new MBeanOperationInfo(m.getName(), operationDescr, methodSignature(jvmInfo, m),
                m.getReturnType().getName(), MBeanOperationInfo.UNKNOWN, jvmInfo.getDescriptor()); // avoid to copy the logic
    }
    ...
    private static final class CacheInfo {
        ...
        private CacheInfo(final MBeanInfo mBeanInfo, final Map<String, Method> getters,
                final Map<String, Method> setters, final Map<String, Method> operations) {
