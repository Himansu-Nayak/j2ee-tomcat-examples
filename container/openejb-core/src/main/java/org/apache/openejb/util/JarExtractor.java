...
public class JarExtractor {
    ...
    /**
     * Extract the Jar file into an unpacked directory structure, and return the absolute pathname to the extracted
     * directory.
     *
     * @param file
     *            Jar file to unpack
    ...
    /**
     * Extract the jar file into the specifiec destination directory. If the destination directory already exists, the
     * jar will not be unpacked.
     *
     * @param file
     *            jar file to unpack
    ...
    /**
     * Extract the specified input stream into the specified directory, creating a file named from the specified
     * relative path.
     *
     * @param input
     *            InputStream to be copied
     * @param docBase
     *            Document base directory into which we are extracting
     * @param name
     ...
     */
    protected static File extract(final InputStream input, final File docBase, final String name) throws IOException {
