...
public class TriggerRunnable extends TriggerTask<Void>implements Runnable {
    ...
    public TriggerRunnable(final ManagedScheduledExecutorServiceImpl es, final Runnable original,
            final Runnable runnable, final Trigger trigger, final Date taskScheduledTime, final String id,
