...
public class OpenEJBErrorHandler {
    ...
    public static void handleUnknownError(final Throwable error, final String systemLocation) {
        ...
        /*
         * An error broadcasting system is under development. At this point an appropriate error would be broadcast to
         * all listeners.
         */
    }
    ...
    public static void propertyFileNotFound(final String propertyfileName, final String systemLocation)
            throws OpenEJBException {

        throw new OpenEJBException(_messages.format("ge0003", propertyfileName, systemLocation));
    }

    public static void propertyNotFound(final String propertyName, final String propertyfileName)
            throws OpenEJBException {
    ...
    public static void propertyValueIsIllegal(final String propertyName, final String value, final String message)
            throws OpenEJBException {
    ...
    public static void classNotIntantiateable(final String systemLocation, final String className)
            throws OpenEJBException {

        throw new OpenEJBException(_messages.format("ge0009", systemLocation, className));
    }

    public static void classNotIntantiateableForUnknownReason(final String systemLocation, final String className,
            final String exceptionClassName, final String message) throws OpenEJBException {

        throw new OpenEJBException(_messages.format("ge0011", systemLocation, className, exceptionClassName, message));
    }

    public static void classNotIntantiateableFromCodebaseForUnknownReason(final String systemLocation,
            final String className, final String codebase, final String exceptionClassName, final String message)
                    throws OpenEJBException {
        throw new OpenEJBException(
                _messages.format("ge0012", systemLocation, className, codebase, exceptionClassName, message));
    }

    public static void classCodebaseNotFound(final String systemLocation, final String className, final String codebase,
            final Exception e) throws OpenEJBException {

        throw new OpenEJBException(_messages.format("ge0010", systemLocation, className, codebase, e.getMessage(), e));
    }

    public static void configurationParsingError(final String messageType, final String message, final String line,
            final String column) {
