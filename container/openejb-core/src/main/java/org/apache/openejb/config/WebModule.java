...
public class WebModule extends Module implements WsModule, RESTModule {
    ...
    public WebModule(final WebApp webApp, String contextRoot, final ClassLoader classLoader, final String jarLocation,
    ...
    public String toString() {
        return "WebModule{" + "moduleId='" + id.getName() + '\'' + ", contextRoot='" + contextRoot + '\'' + '}';
    }
