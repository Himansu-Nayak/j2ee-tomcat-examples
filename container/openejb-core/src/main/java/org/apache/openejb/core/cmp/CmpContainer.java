...
public class CmpContainer implements RpcContainer {
     ...
     * to find the deployment info. This means that when the same type is used multiple ejb deployments a random
     * deployment will be selected to handle the ejb callback.
     */
    ...
    public CmpContainer(final Object id, final TransactionManager transactionManager,
            final SecurityService securityService, final String cmpEngineFactory) throws OpenEJBException {
        this.containerID = id;
    ...
    private void ejbLoad(final EntityBean entityBean) {
        ...
        try {
            ...
            Set<EntityBean> registeredEntities = (LinkedHashSet<EntityBean>) synchronizationRegistry
                    .getResource(ENTITIES_TO_STORE);
            if (registeredEntities == null) {
                ...
                synchronizationRegistry.registerInterposedSynchronization(new Synchronization() {
                    ...
                    public void beforeCompletion() {
                        //noinspection unchecked
                        final Set<EntityBean> registeredEntities = (LinkedHashSet<EntityBean>) synchronizationRegistry
                                .getResource(ENTITIES_TO_STORE);
                        if (registeredEntities == null) {
                            return;
                        }
    ...
    private Object businessMethod(final Method callMethod, final Method runMethod, final Object[] args,
            final ThreadContext callContext, final InterfaceType interfaceType) throws OpenEJBException {
        final BeanContext beanContext = callContext.getBeanContext();

        final TransactionPolicy txPolicy = createTransactionPolicy(
    ...
    private Object homeMethod(final Method callMethod, final Object[] args, final ThreadContext callContext,
    ...
    private ProxyInfo createEJBObject(final Method callMethod, final Object[] args, final ThreadContext callContext,
            final InterfaceType interfaceType) throws OpenEJBException {
        final BeanContext beanContext = callContext.getBeanContext();
    ...
    private Object findByPrimaryKey(final Method callMethod, final Object[] args, final ThreadContext callContext,
            final InterfaceType interfaceType) throws OpenEJBException {
        final BeanContext beanContext = callContext.getBeanContext();
    ...
    private Object findEJBObject(final Method callMethod, final Object[] args, final ThreadContext callContext,
            final InterfaceType interfaceType) throws OpenEJBException {
        final BeanContext beanContext = callContext.getBeanContext();
            ...
            if (callMethod.getReturnType() == Collection.class || callMethod.getReturnType() == Enumeration.class) {
                ...
                if (results.size() != 1) {
                    throw new ObjectNotFoundException(
                            "A Enteprise bean with deployment_id = " + beanContext.getDeploymentID()
    ...
    public Object select(final BeanContext beanContext, final String methodSignature, final String returnType,
        ...
        try {
            ...
            final boolean isSingleValued = !returnType.equals("java.util.Collection")
    ...
    public int update(final BeanContext beanContext, final String methodSignature, final Object... args)
    ...
    private void removeEJBObject(final Method callMethod, final ThreadContext callContext,
            final InterfaceType interfaceType) throws OpenEJBException {
        final BeanContext beanContext = callContext.getBeanContext();
