...
/**
 * Class for generating a class file that implements CMP1 type of persistence.
 */
public class Cmp1Generator implements Opcodes {
    ...
    public byte[] generate() {
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, implClassName, null, beanClassName,
                new String[] { "javax/ejb/EntityBean" });
    ...
    /**
     * Create a default constructor for our bean super class. This is just a forwarding constructor that calls the
     * superclass (the bean implementation class) default constructor.
     */
