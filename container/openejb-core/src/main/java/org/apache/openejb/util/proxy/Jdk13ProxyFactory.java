...
public class Jdk13ProxyFactory implements ProxyFactory {
    ...
    /*
     * Returns an instance of a proxy class for the specified interface that dispatches method invocations to the
     ...
     * specified invocation handler.
     */
    public Object newProxyInstance(final Class[] interfaces, final InvocationHandler handler)
