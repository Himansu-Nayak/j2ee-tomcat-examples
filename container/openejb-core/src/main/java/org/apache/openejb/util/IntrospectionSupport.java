...
public class IntrospectionSupport {
    ...
    public static boolean getProperties(final Object target, final Map<String, String> props, String optionPrefix) {
    ...
    public static boolean setProperties(final Object target, final Map props, final String optionPrefix) {
        boolean rc = false;
        if (target == null) {
            throw new IllegalArgumentException("target was null.");
        }
    ...
    private static void addFields(final Object target, final Class startClass, final Class stopClass,
