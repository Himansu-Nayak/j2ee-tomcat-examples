            ...
            for (final WebModule web : appModule.getWebModules()) {
                ...
                for (final String app : web.getRestApplications()) {
                    ...
                    try {
                        ...
                        /*
                         * don't do it or ensure you have cdi activated! + CXF will catch it later for (final Object
                         * rsSingleton : appInstance.getSingletons()) { classes.add(rsSingleton.getClass().getName()); }
                         */
