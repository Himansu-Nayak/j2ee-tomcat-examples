 ...
 * <p/>
 * URI relativize(URI, URI) added afterwards to deal with the non-functional URI.relativize(URI) method
 */
public class URISupport {

    /**
     * URI absoluteA = new URI("/Users/dblevins/work/openejb3/container/openejb-jee/apple/"); URI absoluteB = new
     ...
     * <p/>
     * URI resolvedB = absoluteA.resolve(relativeB); assertTrue(resolvedB.equals(absoluteB));
     *
     * @param a
     * @param b
     * @return relative b
    ...
    private static void parseComposite(final URI uri, final CompositeData rc, final String ssp)
