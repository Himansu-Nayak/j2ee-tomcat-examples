 ...
 * to be understandable by the SecurityService internally and need not be a publicly usable class type. No part of the
 * outlying system will make any assumptions as to the type of the object. The use of a java generic type is to express
 * the required symmetry in the interface.
 */
public interface SecurityService<T> extends Service {
    ...
    /**
     * Implementors are encouraged to return a java.security.Principal object that implements
     * org.apache.openejb.spi.CallerPrincipal
     * <p/>
     * JAAS LoginModule implementors are encouraged to use the CallerPrincipal interface to denote the best fitting
     * Principal for getCallerPrincipal.
     */
