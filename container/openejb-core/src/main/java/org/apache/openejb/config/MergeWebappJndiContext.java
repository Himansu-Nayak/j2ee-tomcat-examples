...
public class MergeWebappJndiContext implements DynamicDeployer {
        ...
        for (final WebModule webModule : appModule.getWebModules()) {
            ...
            for (final EjbModule ejbModule : appModule.getEjbModules()) {
                ...
                if (ejbModule.getFinder() != webModule.getFinder()) {
                    final String forceMerge = ejbModule.getProperties()
                            .getProperty("openejb.ejbmodule.MergeWebappJndiContext"); // always true is not null
    ...
    private <R extends JndiReference> boolean isPrivateReference(final R a) {
        ...
        final Class[] types = { EJBContext.class, EntityContext.class, SessionContext.class, MessageDrivenContext.class,
    ...
    private <R extends JndiReference> void mergeUserTransaction(final Map<String, R> from, final Map<String, R> to,
