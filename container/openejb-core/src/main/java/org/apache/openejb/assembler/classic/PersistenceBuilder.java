...
public class PersistenceBuilder {
    ...
    public ReloadableEntityManagerFactory createEntityManagerFactory(final PersistenceUnitInfo info,
            final ClassLoader classLoader, final Map<ComparableValidationConfig, ValidatorFactory> validators)
                    throws Exception {
            ...
            if (!SystemInstance.get().hasProperty("openejb.geronimo")) {
                ...
                try {
                    ...
                    try {
                        ...
                        throw new OpenEJBException("Could not lookup <jta-data-source> '" + jtaDataSourceId
                                + "' for unit '" + unitInfo.getPersistenceUnitName() + "'", e);
                    }
                }
            }
        }
        ...
        final PersistenceUnitTransactionType type = Enum.valueOf(PersistenceUnitTransactionType.class,
            ...
            if (!SystemInstance.get().hasProperty("openejb.geronimo")) {
                ...
                try {
                    ...
                    try {
                        ...
                        throw new OpenEJBException("Could not lookup <non-jta-data-source> '" + nonJtaDataSourceId
                                + "' for unit '" + unitInfo.getPersistenceUnitName() + "'", e);
                    }
                }
            }
