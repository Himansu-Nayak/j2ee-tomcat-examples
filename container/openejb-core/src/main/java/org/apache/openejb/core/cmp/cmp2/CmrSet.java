...
public class CmrSet<Bean extends EntityBean, Proxy extends EJBLocalObject> extends AbstractSet {
    ...
    public CmrSet(final EntityBean source, final String sourceProperty, final BeanContext relatedInfo,
            final String relatedProperty, final Collection<Bean> relatedBeans) {
        this.source = source;
        ...
        final TransactionSynchronizationRegistry transactionRegistry = SystemInstance.get()
    ...
    public Iterator<Proxy> iterator() {
        return new Iterator<Proxy>() {
            ...
            public Proxy next() {
                if (relatedBeans == null) {
                    throw new ConcurrentModificationException(
                            "Entity has been deleted therefore this iterator can no longer be used");
                }
            ...
            public void remove() {
                ...
                if (!mutable) {
                    throw new ConcurrentModificationException(
                            "Transaction has completed therefore this cmr collection can no longer be modified");
                }
                iterator.remove();
                if (relatedProperty != null) {
        ...
        if (relatedBeans == null) {
            if (mustExist) {
                throw new IllegalStateException(
                        "Entity has been deleted therefore this cmr collection can no longer be modified");
            }
