...
public class OutputGeneratedDescriptors implements DynamicDeployer {
    ...
    public AppModule deploy(final AppModule appModule) throws OpenEJBException {
        ...
        for (final EjbModule ejbModule : appModule.getEjbModules()) {
            final Options options = new Options(ejbModule.getOpenejbJar().getProperties(),
    ...
    private void writeGeronimoOpenejb(final EjbModule ejbModule) {
        try {
            final GeronimoEjbJarType geronimoEjbJarType = (GeronimoEjbJarType) ejbModule.getAltDDs()
                    .get("geronimo-openejb.xml");
