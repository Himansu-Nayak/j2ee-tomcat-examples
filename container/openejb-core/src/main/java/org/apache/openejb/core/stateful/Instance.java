...
public class Instance implements Serializable, Cache.TimeOut {
    ...
    public Instance(final BeanContext beanContext, final Object primaryKey, final Object containerId, final Object bean,
            final CreationalContext creationalContext, final Map<String, Object> interceptors,
    ...
    public Instance(final Object deploymentId, final Object primaryKey, final Object containerId, final Object bean,
            final CreationalContext creationalContext, final Map<String, Object> interceptors,
            final JtaEntityManagerRegistry.EntityManagerTracker[] entityManagerArray,
            final LockFactory.StatefulLock lock) {
    ...
    private static class Serialization implements Serializable {
        ...
        public Serialization(final Instance i) {
            ...
            if (i.entityManagerArray != null) {
                ...
                entityManagerArray = i.entityManagers.values()
                        .toArray(new JtaEntityManagerRegistry.EntityManagerTracker[i.entityManagers.values().size()]);
            } else {
        ...
        protected Object readResolve() throws ObjectStreamException {
            ...
            final StatefulContainer statefulContainer = StatefulContainer.class
                    .cast(SystemInstance.get().getComponent(ContainerSystem.class).getContainer(containerId));
            return new Instance(deploymentId, primaryKey, containerId, bean, creationalContext, interceptors,
                    entityManagerArray, statefulContainer.getLockFactory().newLock(deploymentId.toString()));
        }
    }
}
