 ...
 * <ol>
 * <li>Let <code>n</code> be the length of the (sorted) array and <code>0 < p <= 100</code> be the desired percentile.
 * </li>
 * <li>If <code> n = 1 </code> return the unique array element (regardless of the value of <code>p</code>); otherwise
 * </li>
 * <li>Compute the estimated percentile position <code> pos = p * (n + 1) / 100</code> and the difference,
 * <code>d</code> between <code>pos</code> and <code>floor(pos)</code> (i.e. the fractional part of <code>pos</code>).
 * If <code>pos >= n</code> return the largest element in the array; otherwise</li>
 * <li>Let <code>lower</code> be the element in position <code>floor(pos)</code> in the array and let <code>upper</code>
 * be the next element in the array. Return <code>lower + d * (upper - lower)</code></li>
 * </ol>
 * </p>
 * <p>
 * To compute percentiles, the data must be (totally) ordered. Input arrays are copied and then sorted using
 * {@link Arrays#sort(double[])}. The ordering used by <code>Arrays.sort(double[])</code> is the one determined by
 * {@link Double#compareTo(Double)}. This ordering makes <code>Double.NaN</code> larger than any other value (including
 * <code>Double.POSITIVE_INFINITY</code>). Therefore, for example, the median (50th percentile) of
 ...
 * or infinite values will often result in <code>NaN<code> or infinite values returned.</p>
 * <p>
...
public class Percentile extends AbstractUnivariateStatistic implements Serializable {
    ...
    /**
     * Copy constructor, creates a new {@code Percentile} identical to the {@code original}
     *
     * @param original
    ...
    /**
     * Returns an estimate of the <code>p</code>th percentile of the values in the <code>values</code> array.
     * <p>
    ...
    /**
     * Returns an estimate of the <code>quantile</code>th percentile of the designated values in the <code>values</code>
     * array. The quantile estimated is determined by the <code>quantile</code> property.
     * <p>
     * <ul>
     * <li>Returns <code>Double.NaN</code> if <code>length = 0</code></li>
     * <li>Returns (for any value of <code>quantile</code>) <code>values[begin]</code> if <code>length = 1 </code></li>
     * <li>Throws <code>IllegalArgumentException</code> if <code>values</code> is null, or <code>start</code> or
     ...
     * with the element in (0-based) position <code>begin</code> in the array and including <code>length</code> values.
     * <p>
     * Calls to this method do not modify the internal <code>quantile</code> state of this statistic.
     * </p>
     * <p>
    ...
    public double evaluate(final double[] values, final int begin, final int length, final double p) {
        ...
        if (p > 100 || p <= 0) {
            throw MathRuntimeException
                    .createIllegalArgumentException("out of bounds quantile value: {0}, must be in (0, 100]", p);
        }
        if (length == 0) {
            return Double.NaN;
        }
    ...
    /**
     * Sets the value of the quantile field (determines what percentile is computed when evaluate() is called with no
     * quantile argument).
     *
     * @param p
