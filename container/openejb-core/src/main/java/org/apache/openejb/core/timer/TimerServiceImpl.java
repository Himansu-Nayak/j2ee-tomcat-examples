...
public class TimerServiceImpl implements TimerService {
    ...
    public Timer createTimer(final Date initialExpiration, final long intervalDuration, final Serializable info)
        ...
        return ejbTimerService.createTimer(primaryKey, ejbTimeout, initialExpiration, intervalDuration,
    ...
    public Timer createTimer(final long initialDuration, final long intervalDuration, final Serializable info)
            throws IllegalArgumentException, IllegalStateException, EJBException {
        return ejbTimerService.createTimer(primaryKey, ejbTimeout, initialDuration, intervalDuration,
                new TimerConfig(info, true));
    }
    ...
    public Timer createIntervalTimer(final long initialDuration, final long intervalDuration,
    ...
    public Timer createIntervalTimer(final Date initialExpiration, final long lintervalDuration,
            final TimerConfig timerConfig) throws IllegalArgumentException, IllegalStateException, EJBException {
        return ejbTimerService.createTimer(primaryKey, ejbTimeout, initialExpiration, lintervalDuration, timerConfig);
    }

    public Timer createCalendarTimer(final ScheduleExpression scheduleExpression)
            throws IllegalArgumentException, IllegalStateException, EJBException {

        return ejbTimerService.createTimer(primaryKey, ejbTimeout, copy(scheduleExpression),
                new TimerConfig(null, true));
    }

    public Timer createCalendarTimer(final ScheduleExpression scheduleExpression, final TimerConfig timerConfig)
            throws IllegalArgumentException, IllegalStateException, EJBException {
    ...
    public Collection<Timer> getAllTimers() throws IllegalStateException, EJBException {
        throw new UnsupportedOperationException(
                "not expecting to call this method from this class, see TimerServiceWrapper");
    }
}
