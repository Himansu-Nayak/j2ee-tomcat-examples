...
public class TransactionManagerWrapper implements TransactionManager {
    ...
    public TransactionManagerWrapper(final TransactionManager delegate, final String name,
    ...
    private static final class TransactionWrapper implements Transaction {
        ...
        private TransactionWrapper(final Transaction transaction, final String name,
                final XAResourceWrapper xaResourceWrapper) {
