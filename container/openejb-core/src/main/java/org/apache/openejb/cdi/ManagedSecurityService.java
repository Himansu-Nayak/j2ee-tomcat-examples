...
public class ManagedSecurityService implements org.apache.webbeans.spi.SecurityService {
    ...
    @Override
    public <T> Constructor<T> doPrivilegedGetDeclaredConstructor(final Class<T> clazz,
    ...
    @Override
    public <T> Method doPrivilegedGetDeclaredMethod(final Class<T> clazz, final String name,
            final Class<?>... parameterTypes) {
    ...
    @Override
    public <T> T doPrivilegedObjectCreate(final Class<T> clazz)
