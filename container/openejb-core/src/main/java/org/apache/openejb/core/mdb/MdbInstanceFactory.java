 ...
 * container would be inefficient. This is true of all known resouce adapters in opensource (ActiveMQ), so if this is a
 * poor assumption for your resource adapter, contact the OpenEJB developers.
 * </p>
...
public class MdbInstanceFactory {
     ...
     *            the transaction manager for this container system
     * @param instanceLimit
     *            the maximal number of instances or <= 0 if unlimited
     */
    public MdbInstanceFactory(final BeanContext beanContext, final SecurityService securityService,
            final int instanceLimit) throws OpenEJBException {
     ...
     *             if the instance limit has been exceeded or if an exception occurs while creating the bean instance
     */
     ...
     * callbacks and decrements the instance count. This method should not be used to disposed of beans that have thrown
     * a system exception. Instead the discardInstance method should be called.
     *
     * @param instance
     *            the bean instance to free
    ...
    public void freeInstance(final Instance instance, final boolean ignoredInstanceCount) {
        ...
        final BaseContext.State[] originalAllowedStates = callContext == null ? null
        ...
        try {
            ...
            final Method remove = instance.bean instanceof MessageDrivenBean
            ...
            MdbInstanceFactory.logger.error("The bean instance " + instance.bean + " threw a system exception:" + re,
                    re);
        } finally {
    ...
    private Object constructBean() throws UnavailableException {
        ...
        try {
            ...
            if (context.getBean() instanceof MessageDrivenBean) {
                ...
                final InterceptorStack ejbCreate = new InterceptorStack(context.getBean(), create, Operation.CREATE,
