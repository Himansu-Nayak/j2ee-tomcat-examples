...
public class DelegatePermissionCollection extends PermissionCollection {
    ...
    public static PermissionCollection getPermissionCollection() {
        try {
            return (PermissionCollection) DelegatePermissionCollection.class.getClassLoader().loadClass(SystemInstance
                    .get().getOptions().get(PERMISSION_COLLECTION_CLASS, FastPermissionCollection.class.getName()))
                    .newInstance();
    ...
    public static class FastPermissionCollection extends PermissionCollection {
        private static final int MAX_CACHE_SIZE = SystemInstance.get().getOptions()
                .get("openejb.permission-collection.cache.size", 3000);
