...
public class SimpleWorkManager implements WorkManager {
    ...
    public void doWork(final Work work, final long startTimeout, final ExecutionContext executionContext,
    ...
    public long startWork(final Work work, final long startTimeout, final ExecutionContext executionContext,
            final WorkListener workListener) throws WorkException {
        if (work == null) {
            throw new NullPointerException("work is null");
        }
    ...
    public void scheduleWork(final Work work, final long startTimeout, final ExecutionContext executionContext,
            final WorkListener workListener) throws WorkException {
        if (work == null) {
            throw new NullPointerException("work is null");
        }
    ...
    private long executeWork(final WorkType workType, final Work work, final long startTimeout,
            final ExecutionContext executionContext, WorkListener workListener) throws WorkException {
        ...
        if (executionContext != null && executionContext.getXid() != null) {
            final WorkRejectedException workRejectedException = new WorkRejectedException(
                    "SimpleWorkManager can not import an XID", WorkException.TX_RECREATE_FAILED);
        ...
        public void run() {
            try {
                ...
                if (startDelay > startTimeout) {
                    workException = new WorkRejectedException(
                            "Work not started within specified timeout " + startTimeout + "ms",
                            WorkException.START_TIMED_OUT);
                    workListener.workRejected(
                            new WorkEvent(this, WorkEvent.WORK_REJECTED, work, workException, startTimeout));
                    return;
                }
                ...
                try {
                    ...
                    workListener.workCompleted(
                            new WorkEvent(SimpleWorkManager.this, WorkEvent.WORK_COMPLETED, work, workException));
                }
            } finally {
