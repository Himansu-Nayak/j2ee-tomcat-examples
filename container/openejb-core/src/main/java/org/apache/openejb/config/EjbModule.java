...
/**
 * Class is to remain "dumb" and should not have deployment logic added to it. Class is intentionally not an interface
 * as that would encourage "smart" implementations
 *
...
public class EjbModule extends Module implements WsModule {
    ...
    public EjbModule(final ClassLoader classLoader, final String moduleId, final String jarURI, final EjbJar ejbJar,
    ...
    public EjbModule(final ClassLoader classLoader, final String jarURI, final EjbJar ejbJar,
            final OpenejbJar openejbJar) {
    ...
    public String toString() {
        return "EjbModule{" + "moduleId='" + id.getName() + '\'' + '}';
    }
