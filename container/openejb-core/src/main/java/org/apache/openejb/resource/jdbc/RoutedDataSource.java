...
public class RoutedDataSource implements DataSource {
    ...
    public void setRouter(final String router) {
        final Object o;
        try {
            o = SystemInstance.get().getComponent(ContainerSystem.class).getJNDIContext()
                    .lookup(OPENEJB_RESOURCE_PREFIX + router);
    ...
    public <T> T unwrap(final Class<T> iface) throws SQLException {
        ...
        return (T) Reflections.invokeByReflection(getTargetDataSource(), "unwrap", new Class<?>[] { Class.class },
                new Object[] { iface });
    }
