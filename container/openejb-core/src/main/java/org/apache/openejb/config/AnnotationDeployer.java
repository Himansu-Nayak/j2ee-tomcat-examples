...
public class AnnotationDeployer implements DynamicDeployer {
    public static final Logger logger = Logger.getInstance(LogCategory.OPENEJB_STARTUP,
    ...
    public static final Set<String> knownResourceEnvTypes = new TreeSet<String>(Arrays.asList("javax.ejb.EJBContext",
            "javax.ejb.SessionContext", "javax.ejb.EntityContext", "javax.ejb.MessageDrivenContext",
            "javax.transaction.UserTransaction", "javax.jms.Queue", "javax.jms.Topic", "javax.xml.ws.WebServiceContext",
            "javax.ejb.TimerService", "javax.enterprise.inject.spi.BeanManager", "javax.validation.Validator",
            "javax.validation.ValidatorFactory"));
    public static final Set<String> knownEnvironmentEntries = new TreeSet<String>(
            Arrays.asList("boolean", "java.lang.Boolean", "char", "java.lang.Character", "byte", "java.lang.Byte",
                    "short", "java.lang.Short", "int", "java.lang.Integer", "long", "java.lang.Long", "float",
                    "java.lang.Float", "double", "java.lang.Double", "java.lang.String", "java.lang.Class"));
    ...
    private static final String[] JSF_CLASSES = new String[] { "javax.faces.application.ResourceDependencies",
            "javax.faces.application.ResourceDependency", "javax.faces.bean.ApplicationScoped",
            "javax.faces.bean.CustomScoped", "javax.faces.bean.ManagedBean", "javax.faces.bean.ManagedProperty",
            "javax.faces.bean.NoneScoped", "javax.faces.bean.ReferencedBean", "javax.faces.bean.RequestScoped",
            "javax.faces.bean.SessionScoped", "javax.faces.bean.ViewScoped", "javax.faces.component.FacesComponent",
            "javax.faces.component.UIComponent", "javax.faces.convert.Converter", "javax.faces.convert.FacesConverter",
            "javax.faces.event.ListenerFor", "javax.faces.event.ListenersFor", "javax.faces.event.NamedEvent",
            "javax.faces.render.FacesBehaviorRenderer", "javax.faces.render.FacesRenderer",
            "javax.faces.render.Renderer", "javax.faces.validator.FacesValidator", "javax.faces.validator.Validator" };
    private static final String[] WEB_CLASSES = new String[] {
            ...
            "javax.websocket.server.ServerEndpoint", "javax.websocket.server.ServerApplicationConfig",
            "javax.websocket.Endpoint" };
    private static final Collection<String> API_CLASSES = new ArrayList<String>(
            WEB_CLASSES.length + JSF_CLASSES.length);
    ...
    public AnnotationDeployer() {
        ...
        processAnnotatedBeans = new ProcessAnnotatedBeans(
                SystemInstance.get().getOptions().get("openejb.jaxws.add-remote", false));
        builtInEnvironmentEntries = new BuiltInEnvironmentEntries(
                SystemInstance.get().getOptions().get("openejb.environment.default", false));
    ...
    private static void mergeApplicationExceptionAnnotation(final AssemblyDescriptor assemblyDescriptor,
            final Class<?> exceptionClass, final ApplicationException annotation) {
        final org.apache.openejb.jee.ApplicationException applicationException = assemblyDescriptor
                .getApplicationException(exceptionClass);
    ...
    public static boolean isShareableJNDINamespace(final String jndiName) {
        return jndiName.startsWith("java:global/") || jndiName.startsWith("java:app/")
    ...
    public static void autoJpa(final EjbModule ejbModule) {
        ...
        if (ejbModule.getAppModule() != null) {
            for (final PersistenceModule pm : ejbModule.getAppModule().getPersistenceModules()) {
                for (final org.apache.openejb.jee.jpa.unit.PersistenceUnit pu : pm.getPersistence()
                        .getPersistenceUnit()) {
    ...
    public static void doAutoJpa(final IAnnotationFinder finder,
            final org.apache.openejb.jee.jpa.unit.PersistenceUnit pu) {
    ...
    private static void failIfCdiProducer(final Member member, final String type) {
        if (FieldMember.class.isInstance(member)
                && FieldMember.class.cast(member).field.getAnnotation(Produces.class) != null) {
            throw new DefinitionException(FieldMember.class.cast(member).field + " is not a " + type);
        }
    }

    private static void addRestClassesToScannedClasses(final WebModule webModule, final Set<Class> classes,
    ...
    private static boolean isEJB(final Class<?> clazz) {
        return clazz.isAnnotationPresent(Stateless.class) || clazz.isAnnotationPresent(Singleton.class)
    ...
    private static Map<String, Set<String>> addWebAnnotatedClassInfo(final Map<String, String> urlByClasses,
            final Map<String, Set<String>> classes, final List<Annotated<Class<?>>> found) {
        for (final Annotated<Class<?>> clazz : found) {
    ...
    /**
     * Small utility interface used to allow polymorphing of java.lang.reflect.Method and java.lang.reflect.Field so
     * that each can be treated as injection targets using the same code.
     */
    ...
    public static class DiscoverAnnotatedBeans implements DynamicDeployer {
        private static void addRestApplicationIfPossible(final WebModule webModule,
        ...
        public AppModule deploy(AppModule appModule) throws OpenEJBException {
            ...
            final AdditionalBeanDiscoverer discoverer = SystemInstance.get()
                    .getComponent(AdditionalBeanDiscoverer.class);
            if (discoverer != null) {
        ...
        public ClientModule deploy(final ClientModule clientModule) throws OpenEJBException {
            ...
            if (clientModule.getFinder() == null && clientModule.getAltDDs().containsKey("application-client.xml")) {
                if (clientModule.getApplicationClient() != null
                        && clientModule.getApplicationClient().isMetadataComplete()) {
                    return clientModule;
                }
            }
        ...
        public ConnectorModule deploy(final ConnectorModule connectorModule) throws OpenEJBException {
            ...
            if (connectorClass != null) {
                ...
                connector.setResourceAdapterVersion(
                        getString(connector.getResourceAdapterVersion(), connectorAnnotation.version()));
                ...
                connector.getLicense().setDescriptions(
                        getTexts(connector.getLicense().getDescriptions(), connectorAnnotation.licenseDescription()));

                final SecurityPermission[] annotationSecurityPermissions = connectorAnnotation.securityPermissions();
                final List<org.apache.openejb.jee.SecurityPermission> securityPermission = connector
                        .getResourceAdapter().getSecurityPermission();
                ...
                final Class<? extends WorkContext>[] annotationRequiredWorkContexts = connectorAnnotation
                ...
                OutboundResourceAdapter outboundResourceAdapter = connector.getResourceAdapter()
                ...
                final List<AuthenticationMechanism> authenticationMechanisms = outboundResourceAdapter
                        .getAuthenticationMechanism();
                final javax.resource.spi.AuthenticationMechanism[] authMechanisms = connectorAnnotation
                        .authMechanisms();
                ...
                if (outboundResourceAdapter.getTransactionSupport() == null) {
                    outboundResourceAdapter.setTransactionSupport(
                            TransactionSupportType.fromValue(connectorAnnotation.transactionSupport().toString()));
                }
            ...
            for (final Class<?> cls : classes) {
                final ConnectionDefinitions connectionDefinitionsAnnotation = cls
                        .getAnnotation(ConnectionDefinitions.class);
            ...
            for (final Class<?> cls : classes) {
                final ConnectionDefinition connectionDefinitionAnnotation = cls
                        .getAnnotation(ConnectionDefinition.class);
            ...
            if (connector.getResourceAdapter() != null
                    && connector.getResourceAdapter().getOutboundResourceAdapter() != null) {
                final List<org.apache.openejb.jee.ConnectionDefinition> connectionDefinitions = connector
                        .getResourceAdapter().getOutboundResourceAdapter().getConnectionDefinition();
                for (final org.apache.openejb.jee.ConnectionDefinition connectionDefinition : connectionDefinitions) {
                    process(connectorModule.getClassLoader(), connectionDefinition.getManagedConnectionFactoryClass(),
            ...
            // activationspec
            if (connector.getResourceAdapter() != null
                    && connector.getResourceAdapter().getInboundResourceAdapter() != null
                    && connector.getResourceAdapter().getInboundResourceAdapter().getMessageAdapter() != null) {
                final List<MessageListener> messageListeners = connector.getResourceAdapter()
                        .getInboundResourceAdapter().getMessageAdapter().getMessageListener();
        ...
        void process(final ClassLoader cl, final String cls, final Object object) {
            ...
            try {
                ...
                configProperties = (List<ConfigProperty>) object.getClass().getDeclaredMethod("getConfigProperty")
                        .invoke(object);
            } catch (final Exception e) {
                // no-op
            }
            ...
            final List<String> allowedTypes = Arrays.asList(new String[] { Boolean.class.getName(),
                    String.class.getName(), Integer.class.getName(), Double.class.getName(), Byte.class.getName(),
                    Short.class.getName(), Long.class.getName(), Float.class.getName(), Character.class.getName() });
            ...
            try {
                        ...
                        if (write != null) {
                            ...
                            if (annotation == null) {
                                try {
                                    ...
                                    annotation = clazz.getDeclaredField(name)
                                            .getAnnotation(javax.resource.spi.ConfigProperty.class);
                ...
                for (final Field field : declaredFields) {
                    final javax.resource.spi.ConfigProperty annotation = field
                            .getAnnotation(javax.resource.spi.ConfigProperty.class);
                    ...
                    if (!containsConfigProperty(configProperties, name)) {
                        ...
                        if (type != null) {
                            ...
                            if (annotation != null) {
                                ...
                                configProperty.setConfigPropertyIgnore(annotation.ignore());
                                configProperty
                                        .setConfigPropertySupportsDynamicUpdates(annotation.supportsDynamicUpdates());
                            }
                        }
                    }
                }
        ...
        private void processConnectionDescription(final ResourceAdapter resourceAdapter,
                final ConnectionDefinition connectionDefinitionAnnotation, final Class<?> cls) {
            ...
            final List<org.apache.openejb.jee.ConnectionDefinition> connectionDefinition = outboundResourceAdapter
            ...
            if (definition.getConnectionFactoryImplClass() == null) {
                definition.setConnectionFactoryImplClass(
                        connectionDefinitionAnnotation.connectionFactoryImpl().getName());
            }
        }
        ...
        public WebModule deploy(final WebModule webModule) throws OpenEJBException {
            ...
            try {
                ...
                startupLogger.warning(
                        "Unable to scrape for @WebService or @WebServiceProvider annotations. AnnotationFinder failed.",
                        e);
                return webModule;
            }
            ...
            try {
                restHandledByTheWebApp = webModule.getClassLoader()
                        .loadClass(Application.class.getName()) != Application.class;
            ...
            if (!restHandledByTheWebApp) {
                ...
                final List<Annotated<Class<?>>> applicationsByAnnotation = finder
                        .findMetaAnnotatedClasses(ApplicationPath.class);
                for (final Annotated<Class<?>> annotatedApp : applicationsByAnnotation) {
                    ...
                    if (!Application.class.isAssignableFrom(app)) {
                        logger.error("class '" + app.getName()
                                + "' is annotated with @ApplicationPath but doesn't implement "
                ...
                if (parentFinder != null) {
                    ...
                    for (final EjbModule module : appModule.getEjbModules()) {
                        ...
                        if (appModule.isWebapp()
                                || module.isWebapp() && !module.getModuleId().equals(webModule.getModuleId())) {
                            continue;
                        }
            ...
            /*
             * Servlet, Filter, Listener... here we can scan by inheritance so do it last
             */
        ...
        private void addJaxRsProviders(final IAnnotationFinder finder, final Collection<String> set,
        ...
        public EjbModule deploy(final EjbModule ejbModule) throws OpenEJBException {
            ...
            try {
                ...
                startupLogger.warning(
                        "Unable to scrape for @Stateful, @Stateless, @Singleton or @MessageDriven annotations. AnnotationFinder failed.",
                        e);
                return ejbModule;
            }
                ...
                if (beans != null) {
                    ...
                    if (ejbModule.getJarLocation() != null
                            && (ejbModule.getJarLocation()
                                    .contains(ejbModule.getModuleId()
                                            + "/target/test-classes".replace("/", File.separator))
                            || ejbModule.getJarLocation().contains(
                                    ejbModule.getModuleId() + "/build/classes/test".replace("/", File.separator)))) {
                    ...
                    final org.apache.openejb.jee.ManagedBean managedBean = new CompManagedBean(name,
                            BeanContext.Comp.class);
        ...
        private void getBeanClasses(final String uri, final IAnnotationFinder finder,
                final Map<URL, List<String>> classes, final Map<URL, List<String>> notManaged,
            ...
            for (final Map.Entry<URL, List<String>> entry : map.entrySet()) {
                ...
                if (beansXml != null) {
                    ...
                    if (discoveredBeans == null) { // lazy init for apps not using it, it slows down the app boot and that should be useless
                        ...
                        try {
                            for (final String name : asList("javax.faces.flow.FlowScoped",
        ...
        public URL hasBeansXml(final URL url, final FolderDDMapper ddMapper) {
            ...
            try {
                ...
                final String[] paths = { "META-INF/beans.xml", "WEB-INF/beans.xml", "/WEB-INF/beans.xml",
                        "/META-INF/beans.xml", };
        ...
        private boolean isValidEjbAnnotationUsage(final Class annotationClass, final Annotated<Class<?>> beanClass,
                final String ejbName, final EjbModule ejbModule) {
            final List<Class<? extends Annotation>> annotations = new ArrayList(
                    Arrays.asList(Singleton.class, Stateless.class, Stateful.class, MessageDriven.class));
            ...
            for (final Class<? extends Annotation> secondAnnotation : annotations) {
                ...
                if (ejbName.equals(secondEjbName)) {
                    ejbModule.getValidation().fail(ejbName, "multiplyAnnotatedAsBean", annotationClass.getSimpleName(),
            ...
            if (beanClass.get().isInterface()) {
                ...
                if (!CheckClasses.isAbstractAllowed(beanClass.get())) {
                    ejbModule.getValidation().fail(ejbName, "abstractAnnotatedAsBean", annotationClass.getSimpleName(),
                            beanClass.get().getName());
                    return false;
                }
            }
    ...
    public static class ProcessAnnotatedBeans implements DynamicDeployer {
            ...
            if (!lookupMissing.contains(name)) {
                try {
                    ...
                    logger.warning("Method 'lookup' is not available for '" + name + "'"
                            + (null != exists ? ". The old API '" + exists + "' was found on the classpath."
        ...
        public ClientModule deploy(final ClientModule clientModule) throws OpenEJBException {
            ...
            if (clientModule.getMainClass() != null) {
                ...
                try {
                    ...
                    /**
                     * Some ClientModule are discovered only because the jar uses a Main-Class entry in the MANIFEST.MF
                     * file. Lots of jars do this that are not used as java ee application clients, so lets not make
                     * this a failure unless it has a META-INF/application-client.xml which tells us it is in fact
            ...
            if (!AnnotationFinder.class.isInstance(finder) && finder != null) {
                ...
                clientModule.getFinderReference()
                        .set(new FinderFactory.OpenEJBAnnotationFinder(new ClassesArchive(loadedClasses)));
            }
        ...
        private void validateRemoteClientRefs(final ClassLoader classLoader, final ApplicationClient client,
                final Set<Class> remoteClients) {
            for (final EjbLocalRef ref : client.getEjbLocalRef()) {
                for (final InjectionTarget target : ref.getInjectionTarget()) {
                    try {
                        final Class<?> targetClass = classLoader
                                .loadClass(realClassName(target.getInjectionTargetClass()));
                        for (final Class remoteClient : remoteClients) {
                            if (targetClass.isAssignableFrom(remoteClient)) {
                                fail(remoteClient.getName(), "remoteClient.ejbLocalRef",
                                        target.getInjectionTargetClass(), target.getInjectionTargetName());
                            }
                        }
            ...
            for (final PersistenceContextRef ref : client.getPersistenceContextRef()) {
                for (final InjectionTarget target : ref.getInjectionTarget()) {
                    try {
                        ...
                        for (final Class remoteClient : remoteClients) {
                            if (targetClass.isAssignableFrom(remoteClient)) {
                                fail(remoteClient.getName(), "remoteClient.persistenceContextRef",
                                        target.getInjectionTargetClass(), target.getInjectionTargetName());
                            }
                        }
                    } catch (final ClassNotFoundException ignore) {
            ...
            /*
             * TODO: still useful? List<String> unusableTypes = new ArrayList<String>(knownResourceEnvTypes);
             * unusableTypes.remove("javax.jms.Topic"); unusableTypes.remove("javax.jms.Queue");
             *
             * for (ResourceEnvRef ref : client.getResourceEnvRef()) {
             *
             * if (!unusableTypes.contains(ref.getType())) continue;
             *
             * for (InjectionTarget target : ref.getInjectionTarget()) { try { Class<?> targetClass =
             * classLoader.loadClass(target.getInjectionTargetClass()); for (Class remoteClient : remoteClients) { if
             * (targetClass.isAssignableFrom(remoteClient)) { fail(remoteClient.getName(),
             * "remoteClient.resourceEnvRef", target.getInjectionTargetClass(), target.getInjectionTargetName(),
             * ref.getType()); } } } catch (ClassNotFoundException ignore) { } } }
             */
        }
        ...
        /**
         * Collects a list of all webapp related classes that are eligible for annotation processing then scans them and
         * fills out the web.xml with the xml version of the annotations.
         *
         * @param webModule
         * @return
        ...
        public WebModule deploy(final WebModule webModule) throws OpenEJBException {
            ...
            for (final Servlet servlet : webApp.getServlet()) {
                ...
                if ("javax.ws.rs.core.Application".equals(servletName)
                        || "javax.ws.rs.Application".equals(servletName)) {
                    // check first if there is a real application as init param
                    boolean done = false;
                    for (final ParamValue pv : servlet.getInitParam()) {
                        if ("javax.ws.rs.core.Application".equals(pv.getParamName())
                                || "javax.ws.rs.Application".equals(pv.getParamName())) {
                    ...
                    if (!"org.apache.openejb.server.rest.OpenEJBRestServlet".equals(servletClass)) {
                        try {
                            ...
                            if (servlet.getServletClass() != null) {
                                ...
                                logger.error("servlet " + servletName
                                        + " has no servlet-class defined and is not a subclass of Application");
                            }
                        }
                    }
            ...
            if (webModule.getWebservices() != null) {
                for (final WebserviceDescription webservice : webModule.getWebservices().getWebserviceDescription()) {
                    for (final PortComponent port : webservice.getPortComponent()) {
                        ...
                        for (final org.apache.openejb.jee.HandlerChain handlerChain : port.getHandlerChains()
                                .getHandlerChain()) {
                                ...
                                if (handlerClass != null) {
                                    try {
                                        ...
                                        throw new OpenEJBException(
                                                "Unable to load webservice handler class: " + handlerClass, e);
                                    }
                                }
                            }
                        }
        ...
        public EjbModule deploy(final EjbModule ejbModule) throws OpenEJBException {
            ...
            for (final EnterpriseBean bean : enterpriseBeans) {
                ...
                if (bean.getTransactionType() == TransactionType.CONTAINER) {
                    processAttributes(new TransactionAttributeHandler(assemblyDescriptor, ejbName), clazz,
                            annotationFinder);
                } else {
                    if (finder == null) {
                        finder = annotationFinder.select(clazz.getName());
                    }
                    checkAttributes(new TransactionAttributeHandler(assemblyDescriptor, ejbName), ejbName, ejbModule,
                ...
                for (final InterceptorBinding binding : assemblyDescriptor.getInterceptorBinding()) {
                    ...
                    for (final String interceptor : list) {
                        if (ejbJar.getInterceptor(interceptor) == null) {
                            logger.debug(
                                    "Adding '<ejb-jar><interceptors><interceptor>' entry for undeclared interceptor "
                                            + interceptor);
                 ...
                 * @Interceptors
                 */
                final List<Annotated<Class<?>>> annotatedClasses = sortClasses(
                 ...
                 */
                final ExcludeDefaultInterceptors excludeDefaultInterceptors = clazz
                        .getAnnotation(ExcludeDefaultInterceptors.class);
                if (excludeDefaultInterceptors != null) {
                    final InterceptorBinding binding = assemblyDescriptor
                            .addInterceptorBinding(new InterceptorBinding(bean));
                    binding.setExcludeDefaultInterceptors(true);
                }

                for (final Annotated<Method> method : annotationFinder
                        .findMetaAnnotatedMethods(ExcludeDefaultInterceptors.class)) {
                    final InterceptorBinding binding = assemblyDescriptor
                            .addInterceptorBinding(new InterceptorBinding(bean));
                    binding.setExcludeDefaultInterceptors(true);
                    binding.setMethod(new NamedMethod(method.get()));
                ...
                for (final Annotated<Method> method : sortMethods(
                ...
                if (bean instanceof RemoteBean) {
                    ...
                    if (remoteBean.getHome() == null) {
                        ...
                        if (remoteHome != null) {
                            ...
                            try {
                                ...
                                logger.error(
                                        "Class annotated as a RemoteHome has no 'create()' method.  Unable to determine remote interface type.  Bean class: "
                                                + clazz.getName() + ",  Home class: " + homeClass.getName());
                            }
                        }
                    }
                    ...
                    if (remoteBean.getLocalHome() == null) {
                        ...
                        if (localHome != null) {
                            ...
                            try {
                                ...
                                logger.error(
                                        "Class annotated as a LocalHome has no 'create()' method.  Unable to determine remote interface type.  Bean class: "
                                                + clazz.getName() + ",  Home class: " + homeClass.getName());
                            }
                        }
                    }
                    ...
                    if (remoteBean instanceof SessionBean) {
                        ...
                        if (!clazz.isInterface()) {
                            for (Class<?> current = clazz.getSuperclass(); !current
                                    .equals(Object.class); current = current.getSuperclass()) {
                        ...
                        if (sessionBean.getSessionType() == SessionType.SINGLETON) {
                            ...
                            if (sessionBean.getConcurrencyManagementType() == null) {
                                final ConcurrencyManagement tx = getInheritableAnnotation(clazz,
                                        ConcurrencyManagement.class);
                            ...
                            if (sessionBean.getConcurrencyManagementType() == ConcurrencyManagementType.CONTAINER) {
                                ...
                                checkAttributes(lockHandler, ejbName, ejbModule, annotationFinder,
                             ...
                             * @AccessTimeout
                             */
                            final AccessTimeoutHandler accessTimeoutHandler = new AccessTimeoutHandler(
                                    assemblyDescriptor, sessionBean, lockHandler.getContainerConcurrency());
                            ...
                            if (sessionBean.getStatefulTimeout() == null) {
                                final StatefulTimeout annotation = getInheritableAnnotation(clazz,
                                        StatefulTimeout.class);
                                if (annotation != null) {
                             ...
                             */
                            final AccessTimeoutHandler accessTimeoutHandler = new AccessTimeoutHandler(
                                    assemblyDescriptor, sessionBean);
                            processAttributes(accessTimeoutHandler, clazz, annotationFinder);
                        ...
                        if (mdb.getMessagingType() == null) {
                            ...
                            if (interfce != null && !interfce.equals(Object.class)) {
                                if (!interfce.isInterface()) {
                                    ...
                                    throw new OpenEJBException(
                                            "MessageListenerInterface property of @MessageDriven is not an interface");
                                }
                    ...
                    if (mdb.getMessagingType() == null) {
                        ...
                        for (final Class<?> intf : clazz.getInterfaces()) {
                            ...
                            if (!name.equals("java.io.Serializable") && !name.equals("java.io.Externalizable")
                                    && !name.startsWith("javax.ejb.") && !intf.isSynthetic()) {
                                interfaces.add(intf);
                            }
                        }

                        if (interfaces.size() != 1) {
                            String msg = "When annotating a bean class as @MessageDriven without declaring messageListenerInterface, the bean must implement exactly one interface, no more and no less. beanClass="
            ...
            for (final Interceptor interceptor : ejbModule.getEjbJar().getInterceptors()) {
                ...
                /**
                 * Interceptors do not have their own section in ejb-jar.xml for resource references so we add them to
                 * the references of each ejb. A bit backwards but more or less mandated by the design of the spec.
                 */
                for (final EnterpriseBean bean : enterpriseBeans) {
            ...
            for (final Method method : clazz.getMethods()) {
                for (final Class<?> exception : method.getExceptionTypes()) {
                    ...
                    if (assemblyDescriptor.getApplicationException(exception) != null) {
                        ...
                        logger.debug(
                                "Found previously undetected application exception {0} listed on a method {1} with annotation {2}",
        ...
        private void processSessionInterfaces(final SessionBean sessionBean, final Class<?> beanClass,
            ...
            /*
             * Collect all interfaces explicitly declared via xml. We will subtract these from the interfaces
             * implemented by the bean and do annotation scanning on the remainder.
             */
            ...
            final List<Class<?>> classes = strict ? new ArrayList(Arrays.asList(beanClass))
                    : Classes.ancestors(beanClass);
            ...
            for (final Class<?> clazz : classes) {
                ...
                /*
                 * These interface types are not eligable to be business interfaces. java.io.Serializable
                 * java.io.Externalizable javax.ejb.*
                 */
                final List<Class<?>> interfaces = new ArrayList<Class<?>>();
                if (!clazz.isInterface()) { // dynamic proxy implementation
                    for (final Class<?> interfce : clazz.getInterfaces()) {
                        final String name = interfce.getName();
                        if (!name.equals("scala.ScalaObject") && !name.equals("groovy.lang.GroovyObject")
                                && !name.equals("java.io.Serializable") && !name.equals("java.io.Externalizable")
                                && !(name.equals(InvocationHandler.class.getName())
                                        && DynamicSubclass.isDynamic(beanClass))
                                && !name.startsWith("javax.ejb.") && !descriptor.contains(interfce.getName())
                ...
                /**
                 * Anything discovered and delcared in a previous loop or at the beginning in the deployment descriptor
                 * is not eligable to be redefined.
                 */
                ...
                /**
                 * This set holds the values of @Local and @Remote when applied to the bean class itself
                 *
                 * These declarations override any similar declaration on the interface.
                 */
                ...
                /**
                 * Anything listed explicitly via @Local or @Remote on the bean class does not need to be investigated.
                ...
                /**
                 * This set holds the list of interfaces that the bean implements that are annotated either as @Local
                 * or @Remote
                 *
                 * If the interface is annotated to the contrary in the bean class the bean class meta data wins,
                 * therefore we track these separately
                 *
                 * Ultimately, the deployment descriptor wins over all, so we have tracked those declarations separately
                 * as well.
                 */
                        ...
                        if (isLocal) {
                            if (strict) {
                                for (final Class si : superInterface) {
                                    ...
                                    if (present) {
                                        validation.fail(ejbName, "ann.remoteOrLocal.converse.parent",
                 ...
                 *
                 * We've already merged in the xml metadata, so that metadata will win over this metadata.
                 */
                 ...
                 *
                 * We've already merged in the xml metadata *and* class metadata, so both of those will win over this
                 * metadata.
                 */
                ...
                if (clazz == beanClass && sessionBean.getLocalBean() == null && sessionBean.getBusinessLocal().isEmpty()
                        && sessionBean.getBusinessRemote().isEmpty() && sessionBean.getHome() == null
                        && sessionBean.getRemote() == null && sessionBean.getLocalHome() == null
                        && sessionBean.getLocal() == null && all.local.isEmpty() && all.remote.isEmpty()) {
                    ...
                    if (interfaces.size() == 0 || DynamicProxyImplFactory.isKnownDynamicallyImplemented(clazz)) {
                        ...
                        validation.fail(ejbName, "too.many.interfaces", ejbName,
                                interfaces.toString().replace("interface ", ""));
                        return;
                    }
                }

                // do it here to not loose the @Local handling (if (interfaces.size() == 1))
                if (webserviceAsRemote && webServiceItf != null && all.remote.isEmpty()) {
        ...
        private void processSecurityAnnotations(final Class<?> beanClass, final String ejbName,
                final EjbModule ejbModule, final AnnotationFinder annotationFinder, final EnterpriseBean bean) {
            final AssemblyDescriptor assemblyDescriptor = ejbModule.getEjbJar().getAssemblyDescriptor();
            ...
            for (final Class<?> clazzz : Classes.ancestors(beanClass)) {
                ...
                if (!classPermissions.contains("*") || !classPermissions.contains(clazz.getName())) {
                     ...
                     * @RolesAllowed
                     */
                    if ((rolesAllowed != null && permitAll != null) || (rolesAllowed != null && denyAll != null)
                    ...
                    if (rolesAllowed != null) {
                        ...
                        methodPermission.getMethod()
                                .add(new org.apache.openejb.jee.Method(ejbName, clazz.getName(), "*"));
         ...
         * @param seen
         */
        private void checkConflictingSecurityAnnotations(final Annotated<Method> method, final String ejbName,
                final EjbModule ejbModule, final List<Method> seen) {
            ...
            for (final Class<? extends Annotation> annotation : Arrays.asList(RolesAllowed.class, PermitAll.class,
                    DenyAll.class)) {
            ...
            if (annotations.size() > 1) {
                ejbModule.getValidation().fail(ejbName, "conflictingSecurityAnnotations", method.get().getName(),
                        Join.join(" and ", annotations), method.get().getDeclaringClass());
            }
        }
        ...
        private void processSchedules(final EnterpriseBean bean, final AnnotationFinder annotationFinder) {
            ...
            for (final Timer timer : timers) {
                ...
                methodsConfiguredInDeploymentXml
                        .add(namedMethod.getMethodName() + (namedMethod.getMethodParams() == null ? ""
                                : Join.join("", namedMethod.getMethodParams().getMethodParam())));
            }
            ...
            for (final Annotated<Method> method : scheduleMethods) {
                ...
                if (methodsConfiguredInDeploymentXml.contains(method.get().getName()
                ...
                for (final Schedule schedule : scheduleAnnotationList) {
                    ...
                    timer.setTimezone(
                            schedule.timezone() == null || schedule.timezone().isEmpty() ? null : schedule.timezone());
                    //Copy TimerSchedule
        ...
        private void processCallbacks(final Lifecycle bean, final AnnotationFinder annotationFinder) {
            ...
            if (bean instanceof TimerConsumer) {
                ...
                if (timerConsumer.getTimeoutMethod() == null) {
                    final List<Annotated<Method>> timeoutMethods = sortMethods(
                    ...
                    if (timeoutMethods.size() >= 1) {
                        ...
                        timerConsumer
                                .setTimeoutMethod(new NamedMethod(timeoutMethods.get(timeoutMethods.size() - 1).get()));
                    }
                }
            }
            ...
            if (bean instanceof Session) {
                 ...
                 */
                for (final Annotated<Method> method : sortMethods(
                        annotationFinder.findMetaAnnotatedMethods(Init.class))) {
                 ...
                 * @Remove
                 */
                final List<Annotated<Method>> removeMethods = sortMethods(
                        annotationFinder.findMetaAnnotatedMethods(Remove.class));
        ...
        public void buildAnnotatedRefs(final JndiConsumer consumer, final IAnnotationFinder annotationFinder,
                final ClassLoader classLoader) throws OpenEJBException {
            //
            // @EJB
            //
            ...
            for (final Annotated<Class<?>> clazz : annotationFinder
                    .findMetaAnnotatedClasses(PersistenceContexts.class)) {
            ...
            for (final Annotated<Class<?>> clazz : annotationFinder
                    .findMetaAnnotatedClasses(PersistenceContext.class)) {
            ...
            for (final Annotated<Class<?>> annotated : annotationFinder
                    .findMetaAnnotatedClasses(DataSourceDefinitions.class)) {
            ...
            for (final Annotated<Class<?>> annotated : annotationFinder
                    .findMetaAnnotatedClasses(DataSourceDefinition.class)) {
            ...
            for (final Annotated<Class<?>> annotated : annotationFinder
                    .findMetaAnnotatedClasses(JMSConnectionFactoryDefinitions.class)) {
                final JMSConnectionFactoryDefinitions defs = annotated
                        .getAnnotation(JMSConnectionFactoryDefinitions.class);
            ...
            for (final Annotated<Class<?>> annotated : annotationFinder
                    .findMetaAnnotatedClasses(JMSConnectionFactoryDefinition.class)) {
                final JMSConnectionFactoryDefinition definition = annotated
                        .getAnnotation(JMSConnectionFactoryDefinition.class);
                buildConnectionFactoryDefinition(consumer, definition);
            }
        }
        ...
        /**
         * Process @Resource into either <resource-ref> or <resource-env-ref> for the given member (field or method) or
         * class
         *
         * @param consumer
         * @param resource
        ...
        private void buildResource(final JndiConsumer consumer, final Resource resource, final Member member) {
            ...
            if (reference == null) {
                ...
                /**
                 * Was @Resource mistakenly used when either @PersistenceContext or @PersistenceUnit should have been
                 * used?
                 */
                ...
                if (knownResourceEnvTypes.contains(type.getName())) {
                    ...
                    if (resourceEnvRef.getResourceEnvRefType() == null
                            || "".equals(resourceEnvRef.getResourceEnvRefType())) {
         ...
         * @throws OpenEJBException
         */
        private void buildPersistenceUnit(final JndiConsumer consumer, final PersistenceUnit persistenceUnit,
                final Member member) throws OpenEJBException {
            ...
            if (refName.length() == 0) {
                 ...
                 */
                if (member == null) {
                    fail(consumer.getJndiConsumerName(), "persistenceUnitAnnotation.onClassWithNoName",
            ...
            if (member != null) {
                ...
                if (EntityManager.class.isAssignableFrom(type)) {
                     ...
                     */
                    fail(consumer.getJndiConsumerName(), "persistenceUnitAnnotation.onNonEntityManagerFactory",
         ...
         * @throws OpenEJBException
         */
        private void buildPersistenceContext(final JndiConsumer consumer,
                final PersistenceContextAnn persistenceContext, final Member member) throws OpenEJBException {
            ...
            if (module != null && org.apache.openejb.jee.jpa.unit.TransactionType.RESOURCE_LOCAL
                    .equals(module.getTransactionType(persistenceContext.unitName()))) {
                ...
                if (name == null || name.isEmpty()) { // search for it
                    try { // get the first one
                        name = module.getPersistenceModules().iterator().next().getPersistence().getPersistenceUnit()
            ...
            if (refName.length() == 0) {
                 ...
                 */
                if (member == null) {
                    fail(consumer.getJndiConsumerName(), "persistenceContextAnnotation.onClassWithNoName",
            ...
            if (persistenceContextRef == null) {
                ...
                if (persistenceContext.synchronization() != null) { // should be the case in "normal" deployments
                    persistenceContextRef.setPersistenceContextSynchronization(PersistenceContextSynchronization
                            .valueOf(persistenceContext.synchronization().toUpperCase(Locale.ENGLISH)));
                }
                ...
                if (persistenceContextRef.getPersistenceContextSynchronization() == null
                        && persistenceContext.synchronization() != null) {
                    persistenceContextRef.setPersistenceContextSynchronization(PersistenceContextSynchronization
                            .valueOf(persistenceContext.synchronization().toUpperCase(Locale.ENGLISH)));
                }
            }
            ...
            if (member != null) {
                ...
                if (EntityManagerFactory.class.isAssignableFrom(type)) {
                     ...
                     */
                    fail(consumer.getJndiConsumerName(), "persistenceContextAnnotation.onEntityManagerFactory",
        ...
        private void buildConnectionFactoryDefinition(final JndiConsumer consumer,
                final JMSConnectionFactoryDefinition definition) {
         ...
         * @throws OpenEJBException
         */
        private void buildWebServiceRef(final JndiConsumer consumer, final WebServiceRef webService,
                final HandlerChain handlerChain, final Member member, final ClassLoader classLoader)
                        throws OpenEJBException {
            ...
            if (serviceRef.getServiceInterface() == null) {
                ...
                if (serviceInterface.equals(Object.class)) {
                    ...
                    if ((Service.class.equals(serviceInterface) || Object.class.equals(serviceInterface))
                            && member != null) {
                ...
                try {
                    ...
                    if (FieldMember.class.isInstance(member)
                        ...
                        throw new DefinitionException(
                                FieldMember.class.cast(member).field + " is not a webservice client");
                    }
                    throw iae;
                }
            }
        ...
        /**
         * Scan for @EJB, @Resource, @WebServiceRef, @PersistenceUnit, and @PersistenceContext on WebService
         * HandlerChain classes
         */
        private void processWebServiceHandlers(final EjbModule ejbModule, final EnterpriseBean bean,
                final AnnotationFinder finder) throws OpenEJBException {
         ...
         * @throws OpenEJBException
         */
        private void processWebServiceClientHandlers(final JndiConsumer consumer, final AnnotationFinder finder,
                final ClassLoader classLoader) throws OpenEJBException {
            if (SystemInstance.get().hasProperty("openejb.geronimo")) {
                return;
            }
            ...
            do {
                ...
                final AnnotationFinder handlerAnnotationFinder = finder != null ? finder.select(handlerClasses)
                        : new FinderFactory.OpenEJBAnnotationFinder(
                                new FinderFactory.DoLoadClassesArchive(classLoader, handlerClasses));
        ...
        private List<String> getDeclaredClassPermissions(final AssemblyDescriptor assemblyDescriptor,
        ...
        private <A extends Annotation> void checkAttributes(final AnnotationHandler<A> handler, final String ejbName,
                final EjbModule ejbModule, final AnnotationFinder annotationFinder, final String messageKey) {
        ...
        private <A extends Annotation> void processAttributes(final AnnotationHandler<A> handler, final Class<?> clazz,
                final AnnotationFinder annotationFinder) {
            final Map<String, List<MethodAttribute>> existingDeclarations = handler.getExistingDeclarations();
            ...
            final List<Annotated<Class<?>>> types = sortClasses(
                    annotationFinder.findMetaAnnotatedClasses(annotationClass));
        ...
        private boolean hasMethodAttribute(final String methodName, final Class clazz,
                final Map<String, List<MethodAttribute>> map) {
            return getMethodAttribute(methodName, clazz, map) != null;
        }

        private MethodAttribute getMethodAttribute(final String methodName, final Class clazz,
                final Map<String, List<MethodAttribute>> map) {
        ...
        /**
         * Searches for an annotation starting at the specified class and working backwards. Searching stops when the
         * annotation is found.
         *
         * @param clazz
        ...
        /**
         * Creates a list of the specified class and all its parent classes then creates a AnnotationFinder from that
         * list which can be used for easy annotation scanning.
         *
         * @param classes
         * @return
         */
         ...
         * @return
         */
        private boolean validateRemoteInterface(final Class interfce, final ValidationContext validation,
                final String ejbName) {
         ...
         * @return
         */
        private boolean validateLocalInterface(final Class interfce, final ValidationContext validation,
                final String ejbName) {
         ...
         * <p/>
         * - classes - derived from javax.ejb.EJBObject - derived from javax.ejb.EJBHome - derived from
         * javax.ejb.EJBLocalObject - derived from javax.ejb.EJBLocalHome
         *
         * @param interfce
         * @param validation
         * @param ejbName
         ...
         * @return
         */
        private boolean isValidInterface(final Class interfce, final ValidationContext validation, final String ejbName,
        ...
        public static class TransactionAttributeHandler implements AnnotationHandler<TransactionAttribute> {
            ...
            public void addClassLevelDeclaration(final TransactionAttribute attribute, final Class type) {
                final ContainerTransaction ctx = new ContainerTransaction(cast(attribute.value()), type.getName(),
                        ejbName, "*");
        ...
        private static class ConcurrentMethodHandler {
            ...
            public ConcurrentMethodHandler(final AssemblyDescriptor assemblyDescriptor, final SessionBean bean,
        ...
        public static class LockHandler extends ConcurrentMethodHandler implements AnnotationHandler<Lock> {
            ...
            public LockHandler(final AssemblyDescriptor assemblyDescriptor, final SessionBean bean) {
        ...
        public static class AccessTimeoutHandler extends ConcurrentMethodHandler
                implements AnnotationHandler<AccessTimeout> {

            public AccessTimeoutHandler(final AssemblyDescriptor assemblyDescriptor, final SessionBean bean) {
                this(assemblyDescriptor, bean, new HashMap<Object, ContainerConcurrency>());
            }
    ...
    public static class FilledMember implements Member {
        ...
        public String toString() {
            return "FilledMember{" + "name='" + name + '\'' + ", type=" + type.getName() + ", declaringClass="
