...
/**
 * This interface is implemented by special wrappers for EJB references and resource references. When the getObject( )
 * method is invoked the Operation is checked to ensure that its is allowed for the bean's current state.
 * <p/>
