...
public abstract class BaseContext implements EJBContext, Serializable {
    ...
    private boolean isAsyncOperation(final ThreadContext threadContext) {
        if (threadContext.getCurrentOperation() == null && threadContext.get(CUTask.Context.class) != null) {
            return true;
        }
        return false;
    }
    ...
    public void setRollbackOnly() throws IllegalStateException {
        ...
        if (di.isBeanManagedTransaction()) {
            throw new IllegalStateException(
                    "bean-managed transaction beans can not access the setRollbackOnly() method");
        }
        ...
        if (txPolicy.getTransactionType() == TransactionType.Never
            ...
            throw new IllegalStateException(
                    "setRollbackOnly accessible only from MANDATORY, REQUIRED, or REQUIRES_NEW");
        }
    ...
    public boolean getRollbackOnly() throws IllegalStateException {
        ...
        if (di.isBeanManagedTransaction()) {
            throw new IllegalStateException(
                    "bean-managed transaction beans can not access the getRollbackOnly() method: deploymentId="
                            + di.getDeploymentID());
        }
        ...
        if (txPolicy.getTransactionType() == TransactionType.Never
                ...
                || txPolicy.getTransactionType() == TransactionType.Supports) {
            throw new IllegalStateException(
                    "getRollbackOnly accessible only from MANDATORY, REQUIRED, or REQUIRES_NEW");
        }
