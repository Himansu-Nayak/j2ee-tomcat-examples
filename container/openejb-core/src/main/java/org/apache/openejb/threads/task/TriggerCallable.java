...
public class TriggerCallable<V> extends TriggerTask<V>implements Callable<V> {
    ...
    public TriggerCallable(final ManagedScheduledExecutorServiceImpl es, final Callable<V> original,
            final Callable<V> wrap, final Trigger trigger, final Date taskScheduledTime, final String id,
