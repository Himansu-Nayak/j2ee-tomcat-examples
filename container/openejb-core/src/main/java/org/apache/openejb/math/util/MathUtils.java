...
public final class MathUtils {
    ...
    /**
     * Returns an exact representation of the <a href="http://mathworld.wolfram.com/BinomialCoefficient.html"> Binomial
     * Coefficient</a>, "<code>n choose k</code>", the number of <code>k</code>-element subsets that can be selected
     * from an <code>n</code>-element set.
     * <p>
     * <Strong>Preconditions</strong>:
     * <ul>
     * <li><code>0 <= k <= n </code> (otherwise <code>IllegalArgumentException</code> is thrown)</li>
     * <li>The result is small enough to fit into a <code>long</code>. The largest value of <code>n</code> for which all
     * coefficients are <code> < Long.MAX_VALUE</code> is 66. If the computed value exceeds <code>Long.MAX_VALUE</code>
     ...
     * "<code>n choose k</code>", the number of <code>k</code>-element subsets that can be selected from an
     * <code>n</code>-element set.
     * <p>
     * <Strong>Preconditions</strong>:
     * <ul>
     * <li><code>0 <= k <= n </code> (otherwise <code>IllegalArgumentException</code> is thrown)</li>
     * <li>The result is small enough to fit into a <code>double</code>. The largest value of <code>n</code> for which
     * all coefficients are < Double.MAX_VALUE is 1029. If the computed value exceeds Double.MAX_VALUE,
    ...
    public static double binomialCoefficientLog(final int n, final int k) {
        ...
        /*
         * Return the log of binomialCoefficientDouble for values that will not overflow binomialCoefficientDouble
         */
        if (n < 1030) {
    ...
    private static void checkBinomial(final int n, final int k) throws IllegalArgumentException {
        ...
        if (n < 0) {
            throw MathRuntimeException
                    .createIllegalArgumentException("must have n >= 0 for binomial coefficient (n,k), got n = {0}", n);
        }
    }
    ...
    /**
     * Returns true iff both arguments are equal or within the range of allowed error (inclusive). Adapted from
     * <a href="http://www.cygnus-software.com/papers/comparingfloats/comparingfloats.htm"> Bruce Dawson</a>
     *
     * @param x
     *            first value
     * @param y
     *            second value
     * @param maxUlps
     *            {@code (maxUlps - 1)} is the number of floating point values between {@code x} and {@code y}.
     * @return {@code true} if there are less than {@code maxUlps} floating point values between {@code x} and {@code y}
     */
     ...
     * {@link #equals(double, double) equals}
     *
     * @param x
     *            first array
     * @param y
    ...
    /**
     * Returns n!. Shorthand for <code>n</code> <a href="http://mathworld.wolfram.com/Factorial.html"> Factorial</a>,
     * the product of the numbers <code>1,...,n</code>.
     * <p>
     * <Strong>Preconditions</strong>:
     * <ul>
     * <li><code>n >= 0</code> (otherwise <code>IllegalArgumentException</code> is thrown)</li>
     * <li>The result is small enough to fit into a <code>long</code>. The largest value of <code>n</code> for which
     * <code>n!</code> < Long.MAX_VALUE</code> is 20. If the computed value exceeds <code>Long.MAX_VALUE</code> an
     * <code>ArithMeticException </code> is thrown.</li>
     * </ul>
     * </p>
     *
     * @param n
    ...
    /**
     * Returns n!. Shorthand for <code>n</code> <a href="http://mathworld.wolfram.com/Factorial.html"> Factorial</a>,
     * the product of the numbers <code>1,...,n</code> as a <code>double</code>.
     * <p>
     * <Strong>Preconditions</strong>:
     * <ul>
     * <li><code>n >= 0</code> (otherwise <code>IllegalArgumentException</code> is thrown)</li>
     * <li>The result is small enough to fit into a <code>double</code>. The largest value of <code>n</code> for which
     * <code>n!</code> < Double.MAX_VALUE</code> is 170. If the computed value exceeds Double.MAX_VALUE,
     * Double.POSITIVE_INFINITY is returned</li>
     * </ul>
     * </p>
     *
     ...
     * <code>gcd(Integer.MIN_VALUE, 0)</code> and <code>gcd(0, Integer.MIN_VALUE)</code> throw an
     * <code>ArithmeticException</code>, because the result would be 2^31, which is too large for an int value.</li>
     * <li>The result of <code>gcd(x, x)</code>, <code>gcd(0, x)</code> and <code>gcd(x, 0)</code> is the absolute value
     * of <code>x</code>, except for the special cases above.
     * <li>The invocation <code>gcd(0, 0)</code> is the only one which returns <code>0</code>.</li>
     * </ul>
     *
     * @param p
     *            any number
     ...
     * Special cases:
     * <ul>
     * <li>The invocations <code>gcd(Long.MIN_VALUE, Long.MIN_VALUE)</code>, <code>gcd(Long.MIN_VALUE, 0L)</code> and
     * <code>gcd(0L, Long.MIN_VALUE)</code> throw an <code>ArithmeticException</code>, because the result would be 2^63,
     * which is too large for a long value.</li>
     * <li>The result of <code>gcd(x, x)</code>, <code>gcd(0L, x)</code> and <code>gcd(x, 0L)</code> is the absolute
     * value of <code>x</code>, except for the special cases above.
     * <li>The invocation <code>gcd(0L, 0L)</code> is the only one which returns <code>0L</code>.</li>
     * </ul>
     *
     * @param p
     *            any number
     ...
     * @return the greatest common divisor, never negative
     * @throws ArithmeticException
     *             if the result cannot be represented as a nonnegative long value
     * @since 2.1
     */
    ...
    /**
     * For a double precision value x, this method returns +1.0 if x >= 0 and -1.0 if x < 0. Returns <code>NaN</code> if
    ...
    /**
     * For a float value x, this method returns +1.0F if x >= 0 and -1.0F if x < 0. Returns <code>NaN</code> if
     * <code>x</code> is <code>NaN</code>.
     *
     * @param x
     *            the value, a float
     ...
     * <code>lcm(a,b) = (a / gcd(a,b)) * b</code>.
     * </p>
     * Special cases:
     * <ul>
     * <li>The invocations <code>lcm(Integer.MIN_VALUE, n)</code> and <code>lcm(n, Integer.MIN_VALUE)</code>, where
     * <code>abs(n)</code> is a power of 2, throw an <code>ArithmeticException</code>, because the result would be 2^31,
     * which is too large for an int value.</li>
     * <li>The result of <code>lcm(0, x)</code> and <code>lcm(x, 0)</code> is <code>0</code> for any <code>x</code>.
     * </ul>
     *
     * @param a
     *            any number
     ...
     * Special cases:
     * <ul>
     * <li>The invocations <code>lcm(Long.MIN_VALUE, n)</code> and <code>lcm(n, Long.MIN_VALUE)</code>, where
     * <code>abs(n)</code> is a power of 2, throw an <code>ArithmeticException</code>, because the result would be 2^63,
     * which is too large for an int value.</li>
     * <li>The result of <code>lcm(0L, x)</code> and <code>lcm(x, 0L)</code> is <code>0L</code> for any <code>x</code>.
     * </ul>
     *
     * @param a
     *            any number
     ...
     * <p>
     * If <code>direction</code> is greater than or equal to<code>d</code>, the smallest machine representable number
     * strictly greater than <code>d</code> is returned; otherwise the largest representable number strictly less than
     * <code>d</code> is returned.
     * </p>
     * <p>
     ...
     *            base number
     * @param direction
     *            (the only important thing is whether direction is greater or smaller than d)
     ...
     * <p>
     * If <code>d</code> is 0 or NaN or Infinite, it is returned unchanged.
     * </p>
     *
     * @param d
     *            base number
     ...
     * </pre>
     * 
     * applied to each non-NaN element x of the input array, where sum is the sum of the non-NaN entries in the input
     * array.
     * </p>
     * <p/>
     * <p>
     * Throws IllegalArgumentException if <code>normalizedSum</code> is infinite or NaN and ArithmeticException if the
     * input array contains any infinite elements or sums to 0
     * </p>
     * <p/>
     * <p>
    ...
    /**
     * Round the given value to the specified number of decimal places. The value is rounding using the
     * {@link BigDecimal#ROUND_HALF_UP} method.
     *
     * @param x
     *            the value to round.
    ...
    /**
     * Round the given non-negative, value to the "nearest" integer. Nearest is determined by the rounding method
    ...
    /**
     * Returns the <a href="http://mathworld.wolfram.com/Sign.html"> sign</a> for byte value <code>x</code>.
     * <p>
    ...
    /**
     * Returns the <a href="http://mathworld.wolfram.com/Sign.html"> sign</a> for double precision <code>x</code>.
     * <p>
     * For a double value <code>x</code>, this method returns <code>+1.0</code> if <code>x > 0</code>, <code>0.0</code>
     * if <code>x = 0.0</code>, and <code>-1.0</code> if <code>x < 0</code>. Returns <code>NaN</code> if <code>x</code>
     * is <code>NaN</code>.
     * </p>
     *
     * @param x
    ...
    /**
     * Returns the <a href="http://mathworld.wolfram.com/Sign.html"> sign</a> for float value <code>x</code>.
     * <p>
     * For a float value x, this method returns +1.0F if x > 0, 0.0F if x = 0.0F, and -1.0F if x < 0. Returns
    ...
    /**
     * Returns the <a href="http://mathworld.wolfram.com/Sign.html"> sign</a> for int value <code>x</code>.
     * <p>
    ...
    /**
     * Returns the <a href="http://mathworld.wolfram.com/Sign.html"> sign</a> for long value <code>x</code>.
     * <p>
