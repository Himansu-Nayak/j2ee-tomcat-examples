...
public class LazyEjbReference extends Reference {
    ...
    public LazyEjbReference(final EjbResolver.Reference info, final URI moduleUri,
            final boolean useCrossClassLoaderRef) {
        super();
        this.info = info;
    ...
    public Object getObject() throws NamingException {
        ...
        if (deploymentId == null) {
            ...
            final String message = messages.format(key, info.getName(), info.getEjbLink(), info.getHome(),
                    info.getInterface());
