...
public class ConfigurableClasspathArchive extends CompositeArchive implements ScanConstants {
    ...
    public ConfigurableClasspathArchive(final ClassLoader loader, final boolean forceDescriptor,
    ...
    public static Archive archive(final Module module, final URL location, final boolean forceDescriptor) {
        ...
        try {
            final URL scanXml = new URLClassLoader(new URL[] { location }, new EmptyResourcesClassLoader())
                    .getResource(name);
    ...
    public static Archive classesArchive(final Set<String> packages, final Set<String> classnames,
