...
public class EntityEjbObjectHandler extends EjbObjectProxyHandler {
     ...
     * BaseEjbProxyHandler.invalidateAllHandlers is invoked. The EntityEjbObjectHandler uses a compound key composed of
    ...
    public EntityEjbObjectHandler(final BeanContext beanContext, final Object pk, final InterfaceType interfaceType,
            final List<Class> interfaces, final Class mainInterface) {
        super(beanContext, pk, interfaceType, interfaces, mainInterface);
    }

    /*
     * This method generates a logically unique entity bean identifier from the primary key, deployment id, and
     * container id. This registry key is then used as an index for the associated entity bean in the
     * BaseEjbProxyHandler.liveHandleRegistry. The liveHandleRegistry tracks handler for the same bean identity so that
     * they can removed together when one of the remove() operations is called.
     */
    ...
    protected Object isIdentical(final Method method, final Object[] args, final Object proxy) throws Throwable {
        ...
        if (invocationHandler instanceof EntityEjbObjectHandler) {
            ...
            /*
             * The registry id is a compound key composed of the bean's primary key, deployment id, and container id. It
             * uniquely identifies the entity bean that is proxied by the EntityEjbObjectHandler within the IntraVM.
             */
    ...
    protected Object remove(final Class interfce, final Method method, final Object[] args, final Object proxy)
            throws Throwable {
        checkAuthorization(method);
    ...
    private static class RegistryId implements Serializable {
        ...
        public boolean equals(final Object o) {
            ...
            return containerId.equals(that.containerId) && deploymentId.equals(that.deploymentId)
