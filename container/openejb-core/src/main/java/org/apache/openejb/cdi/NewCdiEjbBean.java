...
public class NewCdiEjbBean<T> extends CdiEjbBean<T>implements NewBean<T> {
    ...
    public NewCdiEjbBean(final CdiEjbBean<T> that) {
        super(that.getBeanContext(), that.getWebBeansContext(), that.getBeanContext().getManagedClass(),
                that.getAnnotatedType(), new NewEjbInjectionTargetFactory<T>(that.getAnnotatedType(),
                        that.getWebBeansContext(), that.getInjectionTarget()),
    ...
    private static final class NewEjbInjectionTargetFactory<T> extends InjectionTargetFactoryImpl<T> {
        ...
        public NewEjbInjectionTargetFactory(final AnnotatedType<T> annotatedType, final WebBeansContext webBeansContext,
