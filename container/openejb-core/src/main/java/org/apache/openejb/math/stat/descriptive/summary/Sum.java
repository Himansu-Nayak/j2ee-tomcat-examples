...
public class Sum extends AbstractStorelessUnivariateStatistic implements Serializable {
    ...
    /**
     * Copy constructor, creates a new {@code Sum} identical to the {@code original}
     *
     * @param original
    ...
    /**
     * The sum of the entries in the specified portion of the input array, or <code>Double.NaN</code> if the designated
     * subarray is empty.
     * <p>
    ...
    /**
     * The weighted sum of the entries in the specified portion of the input array, or <code>Double.NaN</code> if the
