...
public class MainImpl implements Main {
    ...
    public void main(String[] args) {
        ...
        try {
            ...
            throw new IllegalStateException("Main class of command " + commandName + " does not exist: " + mainClass,
                    cnfe);
        }
        ...
        try {
            ...
            throw new IllegalStateException(
                    "Main class of command " + commandName + " does not have a static main method: " + mainClass, e);
        }
