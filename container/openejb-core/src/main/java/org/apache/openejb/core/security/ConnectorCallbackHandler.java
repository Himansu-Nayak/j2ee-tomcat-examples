...
/**
 * Spec 16.4.1: must support CallerPrincipalCallback, GroupPrincipalCallback, PasswordValidationCallback. Recommended to
 * support CertStoreCallback, PrivateKeyCallback, SecretKeyCallback, and TrustStoreCallback.
 *
    ...
    public void handle(final Callback[] callbacks) throws IOException, UnsupportedCallbackException {
        for (final Callback callback : callbacks) {
            ...
            if (callback instanceof CallerPrincipalCallback) {
                ...
                try {
                    final Object loginObj = securityService.login(securityRealmName, userName,
