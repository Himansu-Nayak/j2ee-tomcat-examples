...
public class OpenEJBBeanBuilder<A> extends EjbBeanBuilder<A, CdiEjbBean<A>> {
    ...
    public OpenEJBBeanBuilder(final BeanContext bc, final WebBeansContext webBeansContext,
            final AnnotatedType<A> annotatedType, final BeanAttributes<A> attributes) {
