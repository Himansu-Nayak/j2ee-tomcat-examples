...
public final class LocalMBeanServer implements MBeanServer {
    ...
    public static TabularData tabularData(final String typeName, final String typeDescription, final String[] names,
            final Object[] values) {
        if (names.length == 0) {
            return null;
        }
    ...
    public static TabularData tabularData(final String typeName, final String typeDescription, final String description,
