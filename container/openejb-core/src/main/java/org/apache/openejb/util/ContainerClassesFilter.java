...
public class ContainerClassesFilter implements Filter {
    ...
    public ContainerClassesFilter(final Properties configuration) {
        final String forcedStr = configuration == null ? null
                : configuration.getProperty("openejb.container.additional.exclude", null);
        final String skippedStr = configuration == null ? null
                : configuration.getProperty("openejb.container.additional.include", null);
