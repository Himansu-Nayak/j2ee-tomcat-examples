...
public class Base64 {
     ...
     * <code>z</code>, followed by <code>0</code> through <code>9</code>, followed by <code>+</code>, and <code>/</code>
     * .
     * </p>
     * <p>
    ...
    public Object encode(final Object pObject) throws IOException {
        if (!(pObject instanceof byte[])) {
            throw new IOException("Parameter supplied to Base64 encode is not a byte[]");
        }
