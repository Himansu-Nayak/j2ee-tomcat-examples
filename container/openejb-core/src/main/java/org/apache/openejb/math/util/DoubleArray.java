...
public interface DoubleArray {
    ...
    /**
     * Returns the number of elements currently in the array. Please note that this may be different from the length of
     ...
     * implementation is array-based, this method should always return a copy, rather than a reference to the underlying
     * array so that changes made to the returned array have no effect on the <code>DoubleArray.</code>
     *
