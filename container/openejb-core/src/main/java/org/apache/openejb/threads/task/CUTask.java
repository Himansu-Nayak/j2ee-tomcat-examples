...
public abstract class CUTask<T> extends ManagedTaskListenerTask implements Comparable<Object> {
    ...
    public CUTask(final Object task) {
        ...
        initialContext = new Context(associate, stateTmp,
                threadContext == null ? null : threadContext.get(AbstractSecurityService.SecurityContext.class),
    ...
    public static final class Context {
        ...
        /*
         * private static final Class<?>[] THREAD_SCOPES = new Class<?>[] { RequestScoped.class, SessionScoped.class,
        ...
        /*
         * propagation of CDI context seems wrong private final CdiAppContextsService contextService; private final
         * CdiAppContextsService.State cdiState;
         */
        ...
        private Context(final boolean associate, final Object initialSecurityServiceState,
            ...
            /*
             * propagation of CDI context seems wrong final ContextsService genericContextsService =
             * WebBeansContext.currentInstance().getContextsService(); if
             * (CdiAppContextsService.class.isInstance(genericContextsService)) { contextService =
             * CdiAppContextsService.class.cast(genericContextsService); cdiState = contextService.saveState(); } else {
             * contextService = null; cdiState = null; }
             */
        }
        ...
        public void enter() {
            ...
            /*
             * propagation of CDI context seems wrong if (cdiState != null) { contextService.restoreState(cdiState); }
             */
        ...
        public void exit() {
            ...
            /*
             * propagation of CDI context seems wrong if (currentContext.cdiState != null) {
             * contextService.restoreState(currentContext.cdiState); contextService.removeThreadLocals(); }
             */
