...
/**
 * Computes a statistic related to the Third Central Moment. Specifically, what is computed is the sum of cubed
...
public class ThirdMoment extends SecondMoment implements Serializable {
     ...
     * Retained to prevent repeated computation in higher order moments. nDevSq = nDev * nDev.
     */
    ...
    /**
     * Copy constructor, creates a new {@code ThirdMoment} identical to the {@code original}
     *
     * @param original
