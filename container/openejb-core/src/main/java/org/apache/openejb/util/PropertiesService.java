 ...
 * <p/>
 * It lets us track the properties used and possibly remove some. They are all scattered in many places and it's so hard
 * to keep track of them.
 * <p/>
 * The class holds all OpenEJB properties and optionally can amend the environment.
 * <p/>
 * The aim of this class is to establish one place to keep the properties and eventually remove the need to set System
 * properties to communicate between parts and possibly yet lay out a foundation for setting them up in JNDI or some
 * other means
 * <p/>
...
public class PropertiesService {
    ...
    /**
     * Set value to a property. Optionally set System property via {@link System#setProperty(String, String)}
     *
     * @param name
     *            property name
     * @param value
     *            property value
     * @return previous property value or null if the value hasn't been assigned yet
     */
    ...
    /**
     * ISSUE: It might be of help to differentiate between unavailable property and boolean property set to false
     *
     * @param name
     *            property name
