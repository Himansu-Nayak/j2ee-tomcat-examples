...
public class FirstMoment extends AbstractStorelessUnivariateStatistic implements Serializable {
    ...
    /**
     * Deviation of most recently added value from previous first moment, normalized by previous sample size. Retained
     * to prevent repeated computation in higher order moments
     */
    ...
    /**
     * Copy constructor, creates a new {@code FirstMoment} identical to the {@code original}
     *
     * @param original
