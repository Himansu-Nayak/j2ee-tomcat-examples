...
public class ServiceUtils {
    ...
    public static ServiceProvider getServiceProvider(final String idString) throws OpenEJBException {
        ...
        throw new NoSuchProviderException(
                new Messages("org.apache.openejb.util.resources").format("conf.4901", id.getName(), id.getNamespace()));
    }
    ...
    public static ServiceProvider getServiceProviderByType(final String type, Properties required)
    ...
    public static ServiceProvider getServiceProviderByType(final String providerType, final String serviceType)
            throws OpenEJBException {
        if (serviceType == null) {
            return null;
        }
