...
public class PojoSerialization implements Serializable {
    ...
    static {
        ...
        putDouble = AccessController.doPrivileged(new PrivilegedAction<Method>() {
            public Method run() {
                try {
                    final Method mtd = unsafeClass.getDeclaredMethod("putDouble", Object.class, long.class,
                            double.class);
                    mtd.setAccessible(true);
                    return mtd;
                } catch (final Exception e) {
        ...
        putBoolean = AccessController.doPrivileged(new PrivilegedAction<Method>() {
            public Method run() {
                try {
                    final Method mtd = unsafeClass.getDeclaredMethod("putBoolean", Object.class, long.class,
                            boolean.class);
                    mtd.setAccessible(true);
                    return mtd;
                } catch (final Exception e) {
