...
public class EntityContext extends BaseContext implements javax.ejb.EntityContext {
    ...
    public EJBLocalObject getEJBLocalObject() throws IllegalStateException {
        ...
        final EjbObjectProxyHandler handler = new EntityEjbObjectHandler(di, threadContext.getPrimaryKey(),
                InterfaceType.EJB_LOCAL, new ArrayList<Class>(), di.getLocalInterface());
        ...
        try {
            ...
            throw new InternalErrorException("Could not create IVM proxy for " + di.getLocalInterface() + " interface",
                    iae);
        }
    }
    ...
    public EJBObject getEJBObject() throws IllegalStateException {
        ...
        final EjbObjectProxyHandler handler = new EntityEjbObjectHandler(
                di.getContainer().getBeanContext(di.getDeploymentID()), threadContext.getPrimaryKey(),
                InterfaceType.EJB_OBJECT, new ArrayList<Class>(), di.getRemoteInterface());
        try {
            ...
            throw new InternalErrorException("Could not create IVM proxy for " + di.getRemoteInterface() + " interface",
                    iae);
        }
    }
