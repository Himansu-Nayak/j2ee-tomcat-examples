...
public class ModuleTestContext extends ModuleContext {
    ...
    public ModuleTestContext(final String id, final URI moduleURI, final String uniqueId, final AppContext appContext,
            final Context moduleJndiContext, final ClassLoader classLoader) {
