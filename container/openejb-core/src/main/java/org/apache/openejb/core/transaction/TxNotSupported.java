 ...
 * <p/>
 * The Container invokes an enterprise Bean method whose transaction attribute is set to NotSupported with an
 ...
 * association when the business method has completed. The suspended transaction context of the client is not passed to
 * the resource managers or other enterprise Bean objects that are invoked from the business method.
 * <p/>
