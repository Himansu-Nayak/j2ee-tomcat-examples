...
public class Max extends AbstractStorelessUnivariateStatistic implements Serializable {
    ...
    /**
     * Copy constructor, creates a new {@code Max} identical to the {@code original}
     *
     * @param original
    ...
    /**
     * Returns the maximum of the entries in the specified portion of the input array, or <code>Double.NaN</code> if the
