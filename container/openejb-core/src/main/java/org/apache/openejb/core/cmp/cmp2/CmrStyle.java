...
public enum CmrStyle {
    SINGLE(SingleValuedCmr.class, null, null), COLLECTION(SetValuedCmr.class, Collection.class,
            HashSet.class), SET(SetValuedCmr.class, Set.class, HashSet.class);
    ...
    public String getCmrFieldDescriptor(final Type relatedType) {
        ...
        if (collectionType != null) {
            return collectionType.getDescriptor() + "<" + relatedDescriptor + ">";
        } else {
