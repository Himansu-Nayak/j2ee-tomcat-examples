 ...
 * {@link org.apache.commons.math.stat.descriptive.moment.StandardDeviation}
 * </p>
 * <p>
...
public class Kurtosis extends AbstractStorelessUnivariateStatistic implements Serializable {
    ...
    /**
     * Copy constructor, creates a new {@code Kurtosis} identical to the {@code original}
     *
     * @param original
    ...
    public void increment(final double d) {
        if (incMoment) {
            ...
            throw MathRuntimeException
                    .createIllegalStateException("statistics constructed from external moments cannot be incremented");
        }
    }
    ...
    public double getResult() {
        ...
        if (moment.getN() > 3) {
            ...
            if (moment.n <= 3 || variance < 10E-20) {
                ...
                kurtosis = (n * (n + 1) * moment.m4 - 3 * moment.m2 * moment.m2 * (n - 1))
    ...
    public void clear() {
        if (incMoment) {
            ...
            throw MathRuntimeException
                    .createIllegalStateException("statistics constructed from external moments cannot be cleared");
        }
    }
     ...
     *             if the input array is null or the array index parameters are not valid
     */
    @Override
    public double evaluate(final double[] values, final int begin, final int length) {
        ...
        if (test(values, begin, length) && length > 3) {
            ...
            final double coefficientOne = n0 * (n0 + 1) / ((n0 - 1) * (n0 - 2) * (n0 - 3));
            final double termTwo = 3 * Math.pow(n0 - 1, 2.0) / ((n0 - 2) * (n0 - 3));
