...
public class Debug {
    ...
    public static void contextToMap(final Context context, final String baseName, final Map<String, Object> results)
    ...
    public static Map<String, Object> printContext(final Context context, final PrintStream out)
            throws NamingException {
    ...
    public static Map<String, Object> printContextValues(final Context context, final PrintStream out)
            throws NamingException {
        final Map<String, Object> map = contextToMap(context);
        for (final Entry<String, Object> entry : map.entrySet()) {
    ...
    public static class Trace {
        ...
        public static void mark() {
            ...
            final List<StackTraceElement> stackTraceElements = new ArrayList<StackTraceElement>(
        ...
        private void print(final Set<Node> seen, final PrintStream out, final Node node, final String s) {
            ...
            out.printf("<b>%s</b> <i>%s <font color='gray'>(%s)</font></i>\n", escape(e.getMethodName()),
                    reverse(e.getClassName()), e.getLineNumber());
        ...
        private static final class Event {
            ...
            public String toString() {
                return "<li>" + "time=" + time + ", elements=" + elements + "</li>";
            }
        }
