...
public class MEJBBean {
    ...
    public Object getAttribute(final ObjectName objectName, final String string)
            throws MBeanException, AttributeNotFoundException, InstanceNotFoundException, ReflectionException {
        return mbeanServer.getAttribute(objectName, string);
    }

    public AttributeList getAttributes(final ObjectName objectName, final String[] strings)
    ...
    public Object invoke(final ObjectName objectName, final String string, final Object[] objects,
            final String[] strings) throws InstanceNotFoundException, MBeanException, ReflectionException {
    ...
    public void setAttribute(final ObjectName objectName, final Attribute attribute) throws InstanceNotFoundException,
