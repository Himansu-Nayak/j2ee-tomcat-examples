...
public class ProxyInterfaceResolver {
    ...
    public static List<Class> getInterfaces(final Class implementation, final Class mainInterface,
    ...
    /**
     * Adds the interface to the list of valid interfaces for the proxy if the signatures on the interface do not
     * conflict with the method signatures already apart of the proxy's other interfaces.
     *
     * @param interfce
     * @param valid
     * @param proxySignatures
     */
    private static void addIfNotConflicting(final Class interfce, final List<Class> valid,
            final List<Signature> proxySignatures) {
