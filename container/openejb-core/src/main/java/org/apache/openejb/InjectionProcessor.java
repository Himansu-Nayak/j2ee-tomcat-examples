...
public class InjectionProcessor<T> {
    ...
    public InjectionProcessor(final Class<? extends T> beanClass, final Collection<Injection> injections,
    ...
    public InjectionProcessor(final Class<? extends T> beanClass, final Collection<Injection> injections,
            final List<Method> postConstructMethods, final List<Method> preDestroyMethods, final Context context) {
        this.beanClass = beanClass;
        this.injections = injections;
        ...
        if (context != null) {
            for (final Injection injection : injections) {
                ...
                if (value == null) { // used for testing/mocking
                    final FallbackPropertyInjector fallback = SystemInstance.get()
                            .getComponent(FallbackPropertyInjector.class);
                    if (fallback != null) {
