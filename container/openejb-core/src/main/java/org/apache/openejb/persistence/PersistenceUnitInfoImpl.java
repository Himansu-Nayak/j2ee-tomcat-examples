...
public class PersistenceUnitInfoImpl implements PersistenceUnitInfo {
    ...
    private String id;
    /**
     * Name of this persistence unit. The JPA specification has restrictions on the uniqueness of this name.
     */
    ...
    /**
     * Does this persistence unit participate in JTA transactions or does it manage resource local transactions using
     * the JDBC APIs.
     */
    ...
    /**
     * Data source used by non-jta persistence units and by jta persistence units for non-transactional operations such
     * as accessing a primary key table or sequence.
     */
    private DataSource nonJtaDataSource;
    /**
     * Location of the root of the persistent unit. The directory in which META-INF/persistence.xml is located.
     */
    ...
    public void setRootUrlAndJarUrls(final String persistenceUnitRootUrl, final List<String> jarFiles)
    ...
    public void addTransformer(final ClassTransformer classTransformer) {
        if (persistenceClassLoaderHandler != null) {
            final PersistenceClassFileTransformer classFileTransformer = new PersistenceClassFileTransformer(
                    classTransformer);
    ...
    /**
     * @param persistenceXMLSchemaVersion
     *            the persistenceXMLSchemaVersion to set
     */
    ...
    public static class PersistenceClassFileTransformer implements ClassFileTransformer {
        ...
        public byte[] transform(final ClassLoader classLoader, final String className,
            ...
            return classTransformer.transform(classLoader, replace, classBeingRedefined, protectionDomain,
                    classfileBuffer);
        }
    }
}
