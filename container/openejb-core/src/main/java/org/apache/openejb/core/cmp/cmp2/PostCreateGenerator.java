...
/**
 * Generate concrete implementations of EjbPostCreatexxx methods for a bean class. This is implemented in a separate
...
public class PostCreateGenerator {
     ...
     *
     * @param beanClass
     *            The source EJB implementation class (the user provided class).
     * @param cw
     *            The ClassWriter instance used for constructing the instantiation class. This has already gone through
     *            other generation steps, we're implementing additional stages of the process.
     */
    ...
    /**
     * Generate the ejbPostCreatexxxx methods. Inorder to be considered for generation, there must A) be a corresponding
     * ejbCreatexxxx method and B) the target method must either not exist or exist but be abstract.
     */
    ...
    /**
     * Test whether a class provides a concrete implementation of a class with the given name and parameter types.
     *
     * @param beanClass
     *            The source implementation class.
     * @param name
     *            The required method name.
     * @param args
     *            The list of argument types.
     * @return true if the method exists and is NOT abstract. Returns false if the method is not found or IS abstract.
     */
    ...
    /**
     * Generate an ejbPostCreatexxxx method corresponding to an ejbCreatexxxx method definition. These provided methods
     * are just empty stubs.
     *
     * @param ejbPostCreateName
     *            The name we're creating under.
     * @param ejbCreate
     *            The matching ejbCreate method. The post create method will match this one in terms of method
     *            signature.
     */
