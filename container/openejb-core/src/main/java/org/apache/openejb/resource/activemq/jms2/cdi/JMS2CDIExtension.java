...
public class JMS2CDIExtension implements Extension {
    public void addContextProducer(@Observes final BeforeBeanDiscovery beforeBeanDiscovery,
    ...
    public static class ContextProducer { // small hack to reuse CDI proxying and get it properly setup when injected
        ...
        private Key newKey(final InjectionPoint ip) {
            ...
            return new Key(jndi, credential != null ? credential.userName() : null,
    ...
    public static class Key {
        ...
        public Key(final String connectionFactory, final String username, final String password,
        ...
        private ConnectionFactory connectionFactory() {
            ...
            synchronized (this) {
                ...
                try {
                    return connectionFactoryInstance = ConnectionFactory.class.cast(SystemInstance.get()
                            .getComponent(ContainerSystem.class).getJNDIContext().lookup(connectionFactory));
        ...
        public boolean equals(Object o) {
            ...
            return connectionFactory != null ? connectionFactory.equals(key.connectionFactory)
                    : key.connectionFactory == null && (username != null ? username.equals(key.username)
                            : key.username == null
    ...
    public static class InternalJMSContext implements JMSContext {
        ...
        public InternalJMSContext(final Key key, final RequestAutoContextDestruction requestScoped,
                final TransactionAutoContextDestruction transactionScoped) {
            this.key = key;
        ...
        @Override
        public JMSConsumer createDurableConsumer(final Topic topic, final String name, final String messageSelector,
                final boolean noLocal) {
