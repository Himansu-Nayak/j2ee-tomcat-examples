...
/**
 * java.util.logging.Logger implementation delegating to Log4j. All methods can be used except: setLevel addHandler /
 * getHandlers setParent / getParent setUseParentHandlers / getUseParentHandlers
 *
 * @author gnodet
 */
public class Log4jLogger extends AbstractDelegatingLogger {
    ...
    private class HandlerWrapper extends AppenderSkeleton {
        ...
        protected void append(final LoggingEvent event) {
            final LogRecord lr = new LogRecord(fromL4J(event.getLevel()), event.getMessage().toString());
