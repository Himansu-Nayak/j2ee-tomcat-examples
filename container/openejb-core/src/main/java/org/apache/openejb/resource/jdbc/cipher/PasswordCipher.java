...
/**
 * In order to reuse that same interface for every passwords in TomEE, it has been moved to another package. Just
 * keeping that interface for compatibility reasons.
 *
