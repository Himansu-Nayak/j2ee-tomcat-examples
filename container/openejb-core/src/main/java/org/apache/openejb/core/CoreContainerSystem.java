...
public class CoreContainerSystem implements ContainerSystem {
    ...
    /**
     * Constructs a CoreContainerSystem and initializes the root JNDI context. It also creates three sub contexts,
     * namely
     * <ul>
     ...
     *             if there is a problem during initialization of the root context
     */
        ...
        try {
            if (!(jndiContext.lookup("openejb/local") instanceof Context)
                ...
                throw new OpenEJBRuntimeException(
                        "core openejb naming context not properly initialized.  It must have subcontexts for openejb/local, openejb/remote, openejb/client, and openejb/Deployment already present");
            }
