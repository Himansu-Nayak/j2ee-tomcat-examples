...
public class HeapDump {
    ...
    /**
     * Dumps the java heap to the specified file in hprof format. This method will not overwrite the dump file, so make
    ...
    public static void dumpHeap(final String fileName) {
        ...
        try {
            ...
            hotspotMBean = ManagementFactory.newPlatformMXBeanProxy(server, "com.sun.management:type=HotSpotDiagnostic",
                    clazz);
