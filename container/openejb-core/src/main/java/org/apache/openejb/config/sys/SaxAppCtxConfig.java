...
public class SaxAppCtxConfig {
    ...
    public static void parse(final AppModule appModule, final InputSource source,
        ...
        Saxs.factory().newSAXParser().parse(source,
                new SaxAppContextConfig(appModule, envEntriesDeployer, beanProperties));
    }
    ...
    private static class SaxAppContextConfig extends StackHandler {
        ...
        private static final Collection<String> APPLICATION_ALIASES = Arrays.asList("appcontext", "app-context",
                "application");
        ...
        private static final Collection<String> BEAN_CONTEXTS_ALIASES = Arrays.asList("beancontexts", "bean-contexts",
                "ejbs");
        private static final Collection<String> WEBAPP_ALIASES = Arrays.asList("webapps", "webcontexts", "web-contexts",
                "wars");
        ...
        private static final Collection<String> BEAN_CONTEXT_ALIASES = Arrays.asList("ejb", "beancontext",
                "bean-context");
        private static final Collection<String> CONFIGURATION_ALIASES = Arrays.asList("configuration", "properties",
                "settings");
        ...
        public SaxAppContextConfig(final AppModule appModule, final EnvEntriesPropertiesDeployer envEntriesDeployer,
                final BeanProperties beanProperties) {
        ...
        private class Root extends DefaultHandler {
            ...
            private void importFile(final String path) throws SAXException {
                ...
                if (file.exists()) {
                    try {
                        parse(module, new InputSource(new FileInputStream(file)), envEntriesDeployer,
                                beanPropertiesDeployer);
            ...
            public void setValue(final String text) {
                ...
                try {
                    for (final Properties p : properties) {
                        for (final Map.Entry<Object, Object> entry : new PropertiesAdapter().unmarshal(text)
                                .entrySet()) {
