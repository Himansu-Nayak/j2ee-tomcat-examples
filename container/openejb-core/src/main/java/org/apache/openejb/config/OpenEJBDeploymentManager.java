...
public class OpenEJBDeploymentManager implements DeploymentManager {
    ...
    public OpenEJBDeploymentManager(final Deployment deployment) throws DeploymentManagerCreationException {
        ...
        for (final Iterator<Map.Entry<Object, Object>> iterator = properties.entrySet().iterator(); iterator
                .hasNext();) {
    ...
    public static DConfigBeanVersionType parseDConfigBeanVersionType(final String string)
    ...
    public ProgressObject distribute(final Target[] targetList, final InputStream moduleArchive,
