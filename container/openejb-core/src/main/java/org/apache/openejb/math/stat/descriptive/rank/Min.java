...
public class Min extends AbstractStorelessUnivariateStatistic implements Serializable {
    ...
    /**
     * Copy constructor, creates a new {@code Min} identical to the {@code original}
     *
     * @param original
    ...
    /**
     * Returns the minimum of the entries in the specified portion of the input array, or <code>Double.NaN</code> if the
