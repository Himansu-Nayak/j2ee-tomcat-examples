...
public class OpenEJBLifecycle implements ContainerLifecycle {
    ...
    public void startApplication(final Object startupObject) {
        ...
        try {
            ...
            final CdiResourceInjectionService injectionService = (CdiResourceInjectionService) webBeansContext
            ...
            injectionService.setAppContext(stuff.getAppContext(),
                    stuff.getBeanContexts() != null ? stuff.getBeanContexts() : Collections.<BeanContext> emptyList());
            ...
            try {
                ...
                SystemInstance.get().getComponent(Assembler.class).logger.error("CDI Beans module deployment failed",
                        e1);
    ...
    private void addInternalBeans() {
        ...
        if (!hasBean(beanManager, ServletContext.class)) {
            beanManager
                    .addInternalBean(new InternalBean<>(webBeansContext, ServletContext.class, ServletContext.class));
        }
    ...
    public void stopApplication(final Object endObject) {
        ...
        try {
            ...
            final ResourceInjectionService injectionServices = webBeansContext
                    .getService(ResourceInjectionService.class);
    ...
    public static class InternalBean<T> extends BuiltInOwbBean<T> {
        ...
        protected InternalBean(final WebBeansContext webBeansContext, final Class<T> api, final Class<?> type) {
            super(webBeansContext, WebBeansType.MANAGED, api,
                    new SimpleProducerFactory<T>(new ProviderBasedProducer<>(webBeansContext, type,
                            new OpenEJBComponentProvider(webBeansContext, type), false)));
