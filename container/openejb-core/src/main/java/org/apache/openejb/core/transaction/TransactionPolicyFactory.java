...
public interface TransactionPolicyFactory {
    /**
     * Creates and begins a TransactionPolicy for the specified TransactionType. If this method returns successfully,
     * the specfied transaction type is active and must be committed.
     *
     * @param type
