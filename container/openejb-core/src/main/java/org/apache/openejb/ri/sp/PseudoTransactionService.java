...
public class PseudoTransactionService
    ...
    public void resume(final Transaction tx) throws InvalidTransactionException {
        ...
        if (status != Status.STATUS_ACTIVE && status != Status.STATUS_MARKED_ROLLBACK) {
            throw new InvalidTransactionException(
                    "Expected transaction to be STATUS_ACTIVE or STATUS_MARKED_ROLLBACK, but was " + status);
        }
    ...
    public class MyTransaction implements Transaction {
        private final List<Synchronization> registeredSynchronizations = Collections
                .synchronizedList(new ArrayList<Synchronization>());
