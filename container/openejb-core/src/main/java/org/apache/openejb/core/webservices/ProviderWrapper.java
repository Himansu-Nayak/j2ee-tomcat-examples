...
public class ProviderWrapper extends Provider {
    ...
    public static void beforeCreate(final List<PortRefData> portRefData,
            final JaxWsServiceReference.WebServiceClientCustomizer customizer, final Properties properties) {
    ...
    private static Provider createProviderInstance(final String providerClass, final ClassLoader classLoader) {
        if (providerClass != null && providerClass.length() > 0
                && !providerClass.equals(ProviderWrapper.class.getName())) {
            try {
    ...
    private class ServiceDelegateWrapper extends ServiceDelegate {
        ...
        @SuppressWarnings({ "unchecked" })
        public <T> Dispatch<T> createDispatch(final EndpointReference endpointReference, final Class<T> type,
                final Service.Mode mode, final WebServiceFeature... features) {
        ...
        public <T> T getPort(final QName portName, final Class<T> serviceEndpointInterface,
                final WebServiceFeature... features) {
            return customizePort((T) invoke21Delegate(serviceDelegate, serviceGetPortByQName, portName,
        ...
        public <T> T getPort(final EndpointReference endpointReference, final Class<T> serviceEndpointInterface,
                final WebServiceFeature... features) {
            return customizePort((T) invoke21Delegate(serviceDelegate, serviceGetPortByEndpointReference,
        ...
        public <T> T getPort(final Class<T> serviceEndpointInterface, final WebServiceFeature... features) {
            return customizePort((T) invoke21Delegate(serviceDelegate, serviceGetPortByInterface,
                    serviceEndpointInterface, features));
        }
