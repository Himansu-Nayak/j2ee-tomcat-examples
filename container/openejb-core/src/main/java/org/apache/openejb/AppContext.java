...
public class AppContext extends DeploymentContext {
    ...
    public AppContext(final String id, final SystemInstance systemInstance, final ClassLoader classLoader,
            final Context globalJndiContext, final Context appJndiContext, final boolean standaloneModule) {
