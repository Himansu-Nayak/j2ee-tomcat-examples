 ...
 * semantics provided by the two possible modes of execution. Only the enterprise beans that will execute correctly in
 * both modes should use the Supports transaction attribute.
 */
