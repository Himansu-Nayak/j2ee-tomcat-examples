...
public class OpenEjb2Conversion implements DynamicDeployer {
        ...
        for (final org.apache.openejb.jee.oejb2.EnterpriseBean bean : o2.getEnterpriseBeans()) {
            ...
            if (bean instanceof RpcBean) {
                ...
                if (rpcBean.getTssLink() != null) {
                    g2.getTssLink()
                            .add(new TssLinkType(rpcBean.getEjbName(), rpcBean.getTssLink(), rpcBean.getJndiName()));
                }
            }
    ...
    public final AppModule deploy(final AppModule appModule) {
        for (final EjbModule ejbModule : appModule.getEjbModules()) {
            ...
            if (OpenejbJarType.class.isInstance(altDD)) {
                ...
                mergeEntityMappings(ejbModule.getModuleId(), appModule.getCmpMappings(), ejbModule.getOpenejbJar(),
                        openejbJarType);
            }
        }
        return appModule;
    ...
    private OpenejbJarType getOpenejbJarType(final EjbModule ejbModule) {
        ...
        if (altDD instanceof String) {
            try {
                altDD = JaxbOpenejbJar2.unmarshal(OpenejbJarType.class,
                        new ByteArrayInputStream(((String) altDD).getBytes()), false);
    ...
    public final void convertEjbRefs(final EjbJar ejbJar, final OpenejbJar openejbJar,
            final OpenejbJarType openejbJarType) {
        ...
        for (final org.apache.openejb.jee.oejb2.EnterpriseBean enterpriseBean : openejbJarType.getEnterpriseBeans()) {
            ...
            if (enterpriseBean instanceof SessionBeanType) {
                ...
                if (sessionBean.getWebServiceAddress() != null) {
                    deployment.getProperties().put("openejb.webservice.deployment.address",
                            sessionBean.getWebServiceAddress());
                }
            }
    ...
    public final void convertMdbConfigs(final EjbJar ejbJar, final OpenejbJarType openejbJarType) {
        ...
        for (final org.apache.openejb.jee.oejb2.EnterpriseBean enterpriseBean : openejbJarType.getEnterpriseBeans()) {
            ...
            if (activationConfigType != null) {
                ...
                for (final ActivationConfigPropertyType propertyType : activationConfigType
    ...
    public final void mergeEntityMappings(final String moduleId, final EntityMappings entityMappings,
            final OpenejbJar openejbJar, final OpenejbJarType openejbJarType) {
        ...
        for (final EjbRelationType relation : openejbJarType.getEjbRelation()) {
            ...
            if (relation.getManyToManyTableName() == null) {
                ...
                final EjbRelationshipRoleType.RelationshipRoleSource leftRoleSource = leftRole
                ...
                if (leftRole.isForeignKeyColumnOnSource()) {
                    ...
                    final RelationField other = null != leftFieldName && null != leftEntityData
                            ? leftEntityData.relations.get(leftFieldName) : null;
                    // todo warn field not found
                    if (other == null) {
                        continue;
                ...
                for (final EjbRelationshipRoleType.RoleMapping.CmrFieldMapping cmrFieldMapping : roleMapping
                        .getCmrFieldMapping()) {
