 ...
 */
public abstract class AbstractStorelessUnivariateStatistic extends AbstractUnivariateStatistic
    ...
    /**
     * This default implementation just calls {@link #increment} in a loop over the specified portion of the input
     * array.
     * <p>
     * Throws IllegalArgumentException if the input values array is null.
     * </p>
