...
public class JndiReference extends Reference {
    ...
    /*
     * This constructor is used when the object to be referenced is accessible through some other JNDI name space. The
     * context is provided and the lookup name, but the object is not resolved until it's requested.
     */
    ...
    */
    ...
    public Object getObject() throws NamingException {
        ...
        synchronized (externalContext) {
            /*
             * According to the JNDI SPI specification multiple threads may not access the same JNDI Context *instance*
             * concurrently. Since we don't know the origines of the federated context we must synchonrize access to it.
             * JNDI SPI Sepecifiation 1.2 Section 2.2
             */
