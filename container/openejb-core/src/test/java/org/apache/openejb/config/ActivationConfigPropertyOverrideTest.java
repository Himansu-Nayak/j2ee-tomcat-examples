...
public class ActivationConfigPropertyOverrideTest extends TestCase {
    ...
    public void testGetOverridesShouldTrimAwayPrefixesCorrectly() {
        ...
        final Properties properties2 = ConfigurationFactory.getOverrides(properties, "mdb.activation",
                "EnterpriseBean");
    ...
    public void testOverrideActivationConfigProperty() throws OpenEJBException {
        ...
        final MessageDrivenBean mdb = new MdbBuilder().anMdb()
                .withActivationProperty("destinationType", "stringToBeOverriden").build();
    ...
    /**
     * If activation property was not present initially, then add the specified one.
     *
     * @throws OpenEJBException
     */
    ...
    private boolean containsActivationKeyValuePair(final MessageDrivenBean mdbBeingInspected,
            final String activationPropKey, final String activationPropValue) {

        for (final ActivationConfigProperty activationConfigProp : mdbBeingInspected.getActivationConfig()
    ...
    public void testNoOverrideSetShouldNotOverride() throws OpenEJBException {
        ...
        final MessageDrivenBean mdb = new MdbBuilder().anMdb()
                .withActivationProperty("destinationType", "shouldNotBeOverriddenString").build();
        final AppModule appModule = new AppModuleBuilder().anAppModule().withAnMdb(mdb).build();
        final ActivationConfigPropertyOverride activationPropertyOverride = new ActivationConfigPropertyOverride();
        activationPropertyOverride.deploy(appModule);
