...
public class JpaTestObject extends org.junit.Assert {
    ...
    private void employeeTest() throws Exception {
        ...
        david = (Employee) entityManager.createQuery("select e from Employee e where e.firstName='David'")
                .getSingleResult();
        assertTrue(entityManager.contains(david));
    ...
    public void billTest() throws Exception {
...

        {
            ...
            try {
                ...
                basicPk = new BillPk(resultSet.getLong("billNumber"), resultSet.getLong("billVersion"),
                        resultSet.getLong("billRevision"));
            } finally {
                close(statement);
                close(connection);
            }
        ...
        basic = (Bill) entityManager.createQuery("select e from Bill e where e.billDescription='Basic Model'")
                .getSingleResult();
        assertTrue(entityManager.contains(basic));
        ...
        final BillPk advancedPk = new BillPk(advanced.getBillNumber(), advanced.getBillVersion(),
                advanced.getBillRevision());
    ...
    private void cmpText() throws Exception {
        ...
        final BasicCmpBean joe = (BasicCmpBean) entityManager
                .createQuery("select e from BasicCmpBean_Subclass e where e.primaryKey=" + joeId).getSingleResult();
        ...
        final BasicCmpBean lloyd = (BasicCmpBean) entityManager
                .createQuery("select e from BasicCmpBean_Subclass e where e.primaryKey=" + lloydId).getSingleResult();
    ...
    private void complexCmpText() throws Exception {
        ...
        final ComplexCmpBean joe = (ComplexCmpBean) entityManager
                .createQuery("select e from ComplexCmpBean_Subclass e where e.firstName='Joe'").getSingleResult();
        assertTrue(entityManager.contains(joe));

        assertEquals(joe.getFirstName(), "Joe");
        assertEquals(joe.getLastName(), "Blow");

        final ComplexCmpBean lloyd = (ComplexCmpBean) entityManager
                .createQuery("select e from ComplexCmpBean_Subclass e where e.firstName='Lloyd'").getSingleResult();
        assertTrue(entityManager.contains(lloyd));
    ...
    private void unknownCmpText() throws Exception {
        ...
        final UnknownCmpBean joe = (UnknownCmpBean) entityManager
                .createQuery("select e from UnknownCmpBean_Subclass e where e.firstName='Joe'").getSingleResult();
        assertTrue(entityManager.contains(joe));
        ...
        final UnknownCmpBean lloyd = (UnknownCmpBean) entityManager
                .createQuery("select e from UnknownCmpBean_Subclass e where e.firstName='Lloyd'").getSingleResult();
        assertTrue(entityManager.contains(lloyd));
