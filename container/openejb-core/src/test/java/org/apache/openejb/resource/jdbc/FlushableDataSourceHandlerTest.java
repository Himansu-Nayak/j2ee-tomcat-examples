...
public class FlushableDataSourceHandlerTest {
    ...
    public void checkIt() throws IOException {
        ...
        final FlushableDataSourceHandler handler = FlushableDataSourceHandler.class
                .cast(Proxy.getInvocationHandler(ds));
    ...
    public Properties configuration() {
        return new PropertiesBuilder().p("ds", "new://Resource?type=DataSource").p("ds.flushable", "true")
                .p("ds.jtaManaged", "false").build();
    }
