...
public class CheckInjectionTargetsTest {
    ...
    public EjbJar test() {
        ...
        envEntry.getInjectionTarget()
                .add(new InjectionTarget(CheeseEjb.class.getName(), CheeseEjb.class.getName() + "/count"));
        ...
        envEntry2.getInjectionTarget()
                .add(new InjectionTarget(CheeseEjb.class.getName(), CheeseEjb.class.getName() + "/setColor"));
