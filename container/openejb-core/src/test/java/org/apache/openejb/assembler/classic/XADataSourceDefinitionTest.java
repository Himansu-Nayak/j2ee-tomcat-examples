...
public class XADataSourceDefinitionTest {
    ...
    @DataSourceDefinition(name = "java:app/xads", className = "org.hsqldb.jdbc.pool.JDBCXADataSource", url = "jdbc:hsqldb:mem:XADataSourceDefinitionTest", user = "sa")
    public static class Define {
    }

    @DataSourceDefinition(name = "java:app/xads2", className = "org.hsqldb.jdbc.pool.JDBCXADataSource", url = "jdbc:hsqldb:mem:XADataSourceDefinitionTest2", user = "sa", transactional = false)
