...
public class ExampleABean_ABean extends PersonBean implements Cmp2Entity {
    ...
    private final SingleValuedCmr<ExampleBBean_BBean, LicenseLocal> bCmr = new SingleValuedCmr<ExampleBBean_BBean, LicenseLocal>(
            this, "b", ExampleBBean_BBean.class, "a");
