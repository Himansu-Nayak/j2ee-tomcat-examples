...
public class EjbTimerImplSerializableTest {
    ...
    public static CalendarTimerData timerData() throws Exception {
        ...
        return new CalendarTimerData(1, (EjbTimerServiceImpl) timer, context.getDeploymentID().toString(), null,
                ctx.getBeanMethod(), sd.getConfig(), sd.getExpression(), false);
    }
