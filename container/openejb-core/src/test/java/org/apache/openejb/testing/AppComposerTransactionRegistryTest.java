        ...
        final Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    assertTrue("java:comp/TransactionSynchronizationRegistry is a TransactionSynchronizationRegistry",
                            TransactionSynchronizationRegistry.class.isInstance(lookup));
