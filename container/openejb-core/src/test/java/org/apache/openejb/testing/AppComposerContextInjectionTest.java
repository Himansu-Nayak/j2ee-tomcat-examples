...
public class AppComposerContextInjectionTest {
    ...
    public void jaxrs() throws NamingException {
        ...
        assertTrue(SecurityContext.class.cast(ThreadLocalContextManager.findThreadLocal(SecurityContext.class))
                .isUserInRole("foo"));
        assertFalse(SecurityContext.class.cast(ThreadLocalContextManager.findThreadLocal(SecurityContext.class))
                .isUserInRole("bar"));
    }
