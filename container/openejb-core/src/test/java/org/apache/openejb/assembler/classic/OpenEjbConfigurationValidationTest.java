...
/**
 * This test verifies that no architectural constraints have been violated in the Info Object tree. Basically those are:
 * <p/>
 * - Only public fields of basic data types are allowed.
 * <p/>
 * So this means *no* - methods - constructors - Complex data types (Class, ClassLoader, etc)
 * <p/>
 * Keeps the Info Objects inline with the concept of a basic AST (Abstract Syntax Tree) which is produced by the
 * ConfigurationFactory and built by the Assembler,
 * <p/>
...
public class OpenEjbConfigurationValidationTest extends TestCase {
    ...
    private void validate(final Class clazz) throws Exception {
        ...
        for (final Field field : fields) {
            ...
            assertTrue("Non-public fields are not allowed: " + simpleName + "." + field.getName(),
