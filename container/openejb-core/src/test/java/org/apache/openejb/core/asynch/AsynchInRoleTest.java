...
public class AsynchInRoleTest {
    ...
    public static class TestBeanC implements TestBean {
        ...
        public void testA(final long callerThreadId) {
            Assert.assertFalse("testA should be executed in asynchronous mode",
                    Thread.currentThread().getId() == callerThreadId);
        ...
        public Future<String> testB(final long callerThreadId) {
            Assert.assertFalse("testB should be executed in asynchronous mode",
                    Thread.currentThread().getId() == callerThreadId);
        ...
        public Future<String> testC(final long callerThreadId) {
            Assert.assertTrue("testC should be executed in blocing mode",
                    Thread.currentThread().getId() == callerThreadId);
        ...
        public void testD(final long callerThreadId) {
            Assert.assertTrue("testD should be executed in blocing mode",
                    Thread.currentThread().getId() == callerThreadId);
    ...
    public static class TestBeanB implements TestBean {
        ...
        @Override
        public void testA(final long callerThreadId) {
            Assert.assertTrue("testA should be executed in blocing mode",
                    Thread.currentThread().getId() == callerThreadId);
        ...
        @Asynchronous
        public void testD(final long callerThreadId) {
            Assert.assertFalse("testD should be executed in asynchronous mode",
                    Thread.currentThread().getId() == callerThreadId);
            Exception expectedException = null;
            try {
                sessionContext.wasCancelCalled();
