 ...
 * <p/>
 * - Ensure all abstract methods were implemented to delegate to the InvocationHandler method - Ensure all constructors
 * were carried forward to subclass
 * <p/>
 * Preservation of annotations
 * <p/>
 * - Ensure all annotations from the immediate parent class were copied - Ensure all annotations from parent
 * constructors and constructor params were copied - Ensure all annotations from abstract ancestor methods and method
 * params were copied
 *
 * @version $Rev$ $Date$
 */
