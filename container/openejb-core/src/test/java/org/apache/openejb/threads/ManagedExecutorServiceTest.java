...
public class ManagedExecutorServiceTest {
    ...
    public static class MyCallable implements Callable<Boolean> {
        /*
         * @Inject private RequestBean bean;
         */
        ...
        public Boolean call() throws Exception {
             ...
             * RequestBean.class.cast(bm.getReference(bm.resolve(bm.getBeans(RequestBean.class)), RequestBean.class,
             * null));
             */
            return /*
                    * CdiExecutorFacade.id == bean.getId() && CdiExecutorFacade.id == currentRequestBean.getId() &&
