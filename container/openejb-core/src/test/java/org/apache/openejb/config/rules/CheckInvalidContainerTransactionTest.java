...
public class CheckInvalidContainerTransactionTest {
    ...
    public EjbJar test() throws Exception {
        ...
        final ContainerTransaction tx = new ContainerTransaction(TransAttribute.REQUIRED,
                new Method((String) null, (String) null));
        ejbJar.getAssemblyDescriptor().getContainerTransaction().add(tx);
        final ContainerTransaction tx1 = new ContainerTransaction(TransAttribute.REQUIRED,
                new Method("wrongEjbName", "wrongMethodName"));
