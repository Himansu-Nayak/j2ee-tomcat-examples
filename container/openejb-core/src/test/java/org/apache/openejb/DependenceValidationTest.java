...
public class DependenceValidationTest extends TestCase {
    ...
    public void testPackageDependencies() throws Exception {
        ...
        assertNotDependentOn("org.apache.tomee", "org.apache.openejb.assembler.classic",
                "org.apache.openejb.config.typed.util", "org.apache.openejb.assembler",
                "org.apache.openejb.assembler.classic.util", "org.apache.openejb.config",
                "org.apache.openejb.assembler.dynamic", "org.apache.openejb.assembler.classic.cmd",
                "org.apache.openejb.assembler.monitoring", "org.apache.openejb.cdi", "org.apache.openejb.junit",
                "org.apache.openejb.assembler.classic.event", "org.apache.openejb.web", "org.apache.openejb.testng",
        ...
        assertNotDependentOn("org.apache.tomee", "org.apache.openejb.jee", "org.apache.openejb.config",
                "org.apache.openejb.config.rules", "org.apache.openejb.config.sys", "org.apache.openejb.cdi",
                "org.apache.openejb.junit", "org.apache.openejb.testng", "org.apache.openejb.testing",
                "org.apache.openejb.service");

        // Nothing may depend on the Config code except it's subpackages
        assertNotDependentOn("org.apache.tomee", "org.apache.openejb.config", "org.apache.openejb.config.event",
                "org.apache.openejb.config.typed.util", "org.apache.openejb.config.rules",
                "org.apache.openejb.config.sys", "org.apache.openejb.assembler", "org.apache.openejb.cdi",
                "org.apache.openejb.junit", "org.apache.openejb.testng", "org.apache.openejb.testing", dynamicAssembler,
                "org.apache.openejb.service");
    ...
    private void assertNotDependentOn(final String referringPacakge, final String referredPackage,
            final String... exemptionsArray) {
        if (referringPacakge.equals(referredPackage))
            return;
            ...
            if (packageName.startsWith(referringPacakge) && !exemptions.contains(packageName)) {
                try {
                    ...
                    if (deps.containsKey(referredPackage)) {
                        ...
                        assertEquals(packageName + " should have no dependencies on " + referredPackage + " - #ref "
