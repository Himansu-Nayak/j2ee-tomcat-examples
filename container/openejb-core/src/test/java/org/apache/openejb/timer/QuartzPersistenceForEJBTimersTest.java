...
public class QuartzPersistenceForEJBTimersTest {
    ...
    public AppModule application() {
        ...
        final Properties quartzConfig = new PropertiesBuilder()
                ...
                .p("org.apache.openejb.quartz.dataSource.QUARTZ.jndiURL",
                        "openejb:Resource/QuartzPersistenceForEJBTimersDB")
                .p("org.apache.openejb.quartz.dataSource.QUARTZ_NOTX.jndiURL",
    ...
    public Properties configuration() {
        return new PropertiesBuilder()
                ...
                .p("QuartzPersistenceForEJBTimersDB.UserName", "SA").p("QuartzPersistenceForEJBTimersDB.Password", "")
        ...
        // see src/test/resources/import-QuartzPersistenceForEJBTimersDBNoTx-.sql for the init script
                ...
                .p("QuartzPersistenceForEJBTimersDBNoTx.Password", "").build();
    }
