...
public class MappedNameBuilderTest extends TestCase {
    public void testShouldCreateJndiEntryForBeanWithMappedName() throws Exception {
        ...
        final SessionBean sessionBean = new SessionBean("SessionBean", "org.superbiz.SessionBean",
        ...
        final EjbDeployment retrievedDeployment = appModule.getEjbModules().get(0).getOpenejbJar()
                .getDeploymentsByEjbName().get("SessionBean");
    ...
    public void testShouldIgnoreMappedNameIfDeploymentDoesntExist() throws Exception {
        ...
        final EjbDeployment deployment = appModule.getEjbModules().get(0).getOpenejbJar().getDeploymentsByEjbName()
                .get("SessionBean");
