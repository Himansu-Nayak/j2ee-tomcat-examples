...
public class StatelessPoolStatsTest extends TestCase {
    ...
    public void testBasic() throws Exception {
        ...
        expectedAttributes
                .add(new MBeanAttributeInfo("AccessTimeouts.Latest", "java.lang.String", "", true, false, false));
        ...
        expectedAttributes
                .add(new MBeanAttributeInfo("GarbageCollected.Latest", "java.lang.String", "", true, false, false));
        ...
        expectedAttributes
                .add(new MBeanAttributeInfo("IdleTimeouts.Latest", "java.lang.String", "", true, false, false));
        ...
        final MBeanParameterInfo[] operations = { new MBeanParameterInfo("excludeRegex", "java.lang.String", "\"\""),
        ...
        expectedOperations.add(
                new MBeanOperationInfo("flush", "", new MBeanParameterInfo[0], "void", MBeanOperationInfo.UNKNOWN));
    ...
    /**
     * Flusing related. javax.management.MBeanAttributeInfo[description=, name=Flushed, type=long, read-only,
     * descriptor={}] javax.management.MBeanAttributeInfo[description=, name=Flushes, type=long, read-only,
     * descriptor={}] javax.management.MBeanAttributeInfo[description=, name=PoolVersion, type=int, read-only,
     * descriptor={}] javax.management.MBeanAttributeInfo[description=, name=Replaced, type=long, read-only,
     * descriptor={}]
     *
     * @throws Exception
     *             On error
     ...
     * javax.management.MBeanAttributeInfo[description=, name=Sweeps.Latest, type=java.lang.String, read-only,
     * descriptor={}]
     *
     * @throws Exception
     *             On error
    ...
    /**
     * Drain more than the max from a non-strict pool and test that Overdrafts reflects the number of instances beyond
     * the max that were created javax.management.MBeanAttributeInfo[description=, name=Overdrafts, type=long,
    ...
    private void assertAttribute(final String name, final Object value)
            throws MBeanException, AttributeNotFoundException, InstanceNotFoundException, ReflectionException {
        if (Number.class.isInstance(value)) { // TODO: should be removed when we'll find why buildbot fails here
            assertEquals(name, Number.class.cast(value).doubleValue(),
                    Number.class.cast(server.getAttribute(objectName, name)).doubleValue(), 1.1);
        } else {
    ...
    private CounterBean deploy(final String moduleId, final Properties properties) throws Exception {
        objectName = new ObjectName("openejb.management:J2EEServer=openejb,J2EEApplication=<empty>,EJBModule="
                + moduleId + ",StatelessSessionBean=CounterBean,j2eeType=Pool,name=CounterBean");
