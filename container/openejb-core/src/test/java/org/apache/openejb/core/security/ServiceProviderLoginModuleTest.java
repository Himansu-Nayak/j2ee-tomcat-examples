...
public class ServiceProviderLoginModuleTest extends TestCase {
    ...
    public void testLogin() throws LoginException {
        final LoginContext context = new LoginContext("ServiceProviderLogin",
                new UsernamePasswordCallbackHandler("paul", ""));
        context.login();
    ...
    public void testBadPWLogin() throws Exception {
        final LoginContext context = new LoginContext("ServiceProviderLogin",
                new UsernamePasswordCallbackHandler("eddie", "panama"));
        try {
            context.login();
            fail("Should have thrown a FailedLoginException");
        } catch (final FailedLoginException doNothing) {
