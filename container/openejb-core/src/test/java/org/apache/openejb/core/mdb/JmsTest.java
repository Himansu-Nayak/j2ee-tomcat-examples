...
public class JmsTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        final GeronimoWorkManager workManager = new GeronimoWorkManager(threadPool, threadPool, threadPool,
        ...
        final BootstrapContext bootstrapContext = new GeronimoBootstrapContext(workManager, transactionManager,
                transactionManager);
    ...
    private synchronized void createSender(final Connection connection, final Destination requestQueue)
            throws JMSException {
