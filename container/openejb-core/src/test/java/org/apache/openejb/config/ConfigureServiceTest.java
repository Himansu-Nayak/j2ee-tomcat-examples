...
public class ConfigureServiceTest extends TestCase {
    ...
    public void testConfigureService() throws Exception {
        ...
        final StatelessSessionContainerInfo defaultStatelessContainer = factory
        ...
        final StatelessSessionContainerInfo myStatelessContainer = factory.configureService(container,
    ...
    public void testConfigureServiceAddedPropertyViaURI_Unencoded() throws Exception {
        ...
        final Container container = (Container) factory.toConfigDeclaration("MyContainer",
                "new://Container?type=STATELESS&provider=org.acme#CheddarContainer");
    ...
    public void testQueue() throws Exception {
        ...
        final ResourceInfo resourceInfo = factory.configureService(new Resource("myQueue", "Queue"),
                ResourceInfo.class);
