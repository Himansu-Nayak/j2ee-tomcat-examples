...
public class JTADataSourceWrapperFactoryTest {
    ...
    public void test() throws SQLException {
        ...
        boolean found = false;
        for (final ResourceInfo ri : SystemInstance.get()
    ...
    public Properties configuration() {
        ...
        .p("jta",
                "new://Resource?type=DataSource&class-name=org.apache.openejb.resource.jdbc.managed.JTADataSourceWrapperFactory&factory-name=create")
                .p("jta.delegate", "raw").build();
    }
    ...
    public static class MyDataSourceFactory {
        public DataSource create() {
            return DataSource.class.cast(Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(),
