...
public class ConfigurationFactoryTest {
    ...
    public void testConfigureApplicationWebModule() throws OpenEJBException {
        ...
        final WebModule webModule = new WebModule(webApp, null, null,
                fileSeparator + "some" + fileSeparator + "where.war", moduleId);
    ...
    public void testGetOpenEJBConfigurationInitedAndNewResource() throws Exception {
        ...
        final URL configUrl = this.getClass().getClassLoader()
                .getResource("org/apache/openejb/config/configurationfactory-openejb.xml");
    ...
    public void testToConfigDeclaration() throws Exception {
        final String path = ".";
        final ConfigurationFactory factory = new ConfigurationFactory();
        final Deployments deployments = (Deployments) factory.toConfigDeclaration("",
                new URI("new://Deployments?classpath=" + path));
