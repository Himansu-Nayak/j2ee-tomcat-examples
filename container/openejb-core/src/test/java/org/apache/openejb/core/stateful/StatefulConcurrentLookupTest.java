...
/**
 * Using real non-pooled multithreaded access to test concurrent code execution on a stateful bean. The test also
 * employs a test for failure.
 */
public class StatefulConcurrentLookupTest {
    ...
    private static class TestRunnable implements Runnable {
        ...
        private TestRunnable(final String name, final boolean throwException, final CountDownLatch startingLine,
                final CountDownLatch finishingLine) {
            this.name = name;
