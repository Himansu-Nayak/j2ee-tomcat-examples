...
public class OpenEjb2ConversionTest extends TestCase {
    ...
    public void testSimple() throws Exception {
        ...
        assertJaxb(prefix + "geronimo-openejb.xml", ejbModule.getAltDDs().get("geronimo-openejb.xml"),
                GeronimoEjbJarType.class);
    }
    ...
    private void assertJaxb(final String expectedFile, final Object object, final Class<?> type)
        ...
        try {
            ...
            final org.w3c.dom.Document actualDoc = XMLUnit.buildDocument(XMLUnit.newTestParser(),
    ...
    private AppModule deploy(final String ejbJarFileName, final String openejbJarFileName) throws OpenEJBException {
        ...
        final DynamicDeployer[] deployers = { new ReadDescriptors(), new InitEjbDeployments(), new CmpJpaConversion(),
                new OpenEjb2Conversion() };
