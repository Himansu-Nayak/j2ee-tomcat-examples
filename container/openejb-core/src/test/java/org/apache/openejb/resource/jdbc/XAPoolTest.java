...
public class XAPoolTest {
    ...
    public Properties props() {
        return new PropertiesBuilder().p("openejb.jdbc.datasource-creator", DefaultDataSourceCreator.class.getName())
        ...
        // real XA datasources
                ...
                .p("xa.url", "jdbc:hsqldb:mem:dbcpxa").p("xa.user", "sa").p("xa.password", "")
        ...
        .p("xadb", "new://Resource?type=DataSource").p("xadb.xaDataSource", "xa").p("xadb.JtaManaged", "true")
                .p("xadb.MaxIdle", "25").p("xadb.MaxTotal", "25").p("xadb.InitialSize", "3")
