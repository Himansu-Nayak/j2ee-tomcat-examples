...
public class BlacklistClassResolverTest {
    ...
    public void whiteList() {
        assertFalse(new BlacklistClassResolver(null, new String[] { "org.apache.xalan" })
                .isBlacklisted("org.apache.xalan.Foo"));
    }

    @Test
    public void wildcard() {
        final BlacklistClassResolver classResolver = new BlacklistClassResolver(new String[] { "*" },
                new String[] { "white", "com.white" });
