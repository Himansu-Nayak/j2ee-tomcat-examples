...
public class Archives {
    ...
    public static File fileArchive(final Map<String, String> entries, final List<String> parts, final Class... classes)
            throws IOException {
        ...
        for (final Class clazz : classes) {
            ...
            if (!d.exists())
                assertTrue(d.getAbsolutePath(), d.mkdirs());
    ...
    public static File jarArchive(final Map<String, ?> entries, final String archiveNamePrefix, final Class... classes)
            throws IOException {
    ...
    public static File jarArchive(final File archive, final Map<String, ?> entries, final Class... classes)
            throws IOException {
        final ClassLoader loader = Archives.class.getClassLoader();
