...
import org.apache.openejb.mbeans.*;
...
public class MBeanDeployerTest {
    ...
    public void startOpenEJB() throws Exception {
        ...
        for (final Class<?> clazz : Arrays.asList(Operation.class, OperationDescription.class, Reader.class,
                ReaderWriter.class, ReaderDescription.class, Empty.class, Inheritance.class, MBeanDescription.class)) {
