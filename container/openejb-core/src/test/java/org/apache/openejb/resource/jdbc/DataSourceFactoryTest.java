...
public class DataSourceFactoryTest {
    ...
    public void run() throws Exception {
        ...
        assertTrue(Boolean.class
                .cast(mtd.invoke(null, new PropertiesBuilder().p("openejb.datasource.pool", "true").build())));
        assertFalse(Boolean.class
                .cast(mtd.invoke(null, new PropertiesBuilder().p("openejb.datasource.pool", "false").build())));
