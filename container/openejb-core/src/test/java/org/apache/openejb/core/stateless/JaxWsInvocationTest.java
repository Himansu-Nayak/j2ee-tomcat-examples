...
public class JaxWsInvocationTest extends TestCase {
    ...
    public static class EchoBean {
        ...
        public Object invoke(final InvocationContext context) throws Exception {
            ...
            /**
             * For JAX-WS invocations context.getContextData() must return the JAX-WS MessageContex. As per the
             * agreement between OpenEJB and the Web Service Provider the MessageContex should have been passed into the
             * container.invoke method and the container should then ensure it's available via getContextData() for the
            ...
            org.junit.Assert.assertEquals("msg context should be the smae", messageContext,
    ...
    /**
     * This object would be implemented by the Web Service Provider per the JAX-WS spec and supplied to us in the
