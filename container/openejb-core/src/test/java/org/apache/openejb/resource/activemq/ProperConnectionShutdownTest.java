...
public class ProperConnectionShutdownTest {
    ...
    public void run() throws Throwable {
        ...
        final Statement testInContainer = new Statement() {
            ...
            public void evaluate() throws Throwable {
                 ...
                 *
                 * // all worked, now hold a connection new Thread(new Runnable() { // not daemon!
                 *
                 * @Override public void run() { messages.blockConnection(); // oops, I forgot to close it } }).start();
                 */
            }
        };
    ...
    public Properties config() {
        return new PropertiesBuilder().p("Default JMS Resource Adapter.BrokerXmlConfig",
                "broker:(tcp://localhost:" + NetworkUtil.getNextAvailablePort() + ")?useJmx=false").build();
    }
