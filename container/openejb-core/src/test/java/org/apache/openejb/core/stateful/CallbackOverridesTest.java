...
public class CallbackOverridesTest extends TestCase {
    ...
    public void test() throws Exception {
        ...
        assertEquals(asList(ParentInterceptor.class, ChildInterceptor.class, ParentBean.class, ChildBean.class),
                callbacks);
    ...
    public static enum Callback {
        POST_CONSTRUCT, PRE_PASSIVATE, POST_ACTIVATE, PRE_DESTROY,
    }
