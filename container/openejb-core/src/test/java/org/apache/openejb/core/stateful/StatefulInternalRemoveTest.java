...
public class StatefulInternalRemoveTest extends TestCase {
    ...
    public void testBusinessLocalInterface() throws Exception {
        ...
        final Lifecycle[] expected = { Lifecycle.CONSTRUCTOR, Lifecycle.POST_CONSTRUCT, Lifecycle.BUSINESS_METHOD,
    ...
    public static enum Lifecycle {
        CONSTRUCTOR, POST_CONSTRUCT, BUSINESS_METHOD, REMOVE, PRE_DESTROY,
    }
