...
public class PojoExternalizationTest extends TestCase {
    ...
    public static class Color {
        ...
        public boolean equals(final Object o) {
            ...
            if (myboolean != color.myboolean)
                return false;
            if (mybyte != color.mybyte)
                return false;
            if (mychar != color.mychar)
                return false;
            if (Double.compare(color.mydouble, mydouble) != 0)
                return false;
            if (Float.compare(color.myfloat, myfloat) != 0)
                return false;
            if (myint != color.myint)
                return false;
            if (mylong != color.mylong)
                return false;
            if (myshort != color.myshort)
                return false;
            if (!Arrays.equals(aList, color.aList))
                return false;
            if (!Arrays.equals(aString, color.aString))
                return false;
            if (!Arrays.equals(aboolean, color.aboolean))
                return false;
            if (!Arrays.equals(abyte, color.abyte))
                return false;
            if (!Arrays.equals(achar, color.achar))
                return false;
            if (!Arrays.equals(adouble, color.adouble))
                return false;
            if (!Arrays.equals(afloat, color.afloat))
                return false;
            if (!Arrays.equals(aint, color.aint))
                return false;
            if (!Arrays.equals(along, color.along))
                return false;
            if (!Arrays.equals(ashort, color.ashort))
                return false;
            if (!myList.equals(color.myList))
                return false;
            if (!myString.equals(color.myString))
                return false;
    ...
    public static class Green extends PojoExternalizationTest.Color {
        ...
        public boolean equals(final Object o) {
            ...
            if (myboolean != green.myboolean)
                return false;
            if (mybyte != green.mybyte)
                return false;
            if (mychar != green.mychar)
                return false;
            if (Double.compare(green.mydouble, mydouble) != 0)
                return false;
            if (Float.compare(green.myfloat, myfloat) != 0)
                return false;
            if (myint != green.myint)
                return false;
            if (mylong != green.mylong)
                return false;
            if (myshort != green.myshort)
                return false;
            if (!Arrays.equals(aList, green.aList))
                return false;
            if (!Arrays.equals(aString, green.aString))
                return false;
            if (!Arrays.equals(aboolean, green.aboolean))
                return false;
            if (!Arrays.equals(abyte, green.abyte))
                return false;
            if (!Arrays.equals(achar, green.achar))
                return false;
            if (!Arrays.equals(adouble, green.adouble))
                return false;
            if (!Arrays.equals(afloat, green.afloat))
                return false;
            if (!Arrays.equals(aint, green.aint))
                return false;
            if (!Arrays.equals(along, green.along))
                return false;
            if (!Arrays.equals(ashort, green.ashort))
                return false;
            if (!myList.equals(green.myList))
                return false;
            if (!myString.equals(green.myString))
                return false;
