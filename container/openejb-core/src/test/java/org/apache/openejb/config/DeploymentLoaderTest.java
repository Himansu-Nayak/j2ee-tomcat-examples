...
public class DeploymentLoaderTest extends TestCase {
    ...
    public void testProcessesAltDdsMethod() throws Exception {
         ...
         *
         * - META-INF/ejb-jar.xml - META-INF/test.ejb-jar.xml - META-INF/footest.ejb-jar.xml -
         * META-INF/bartest.ejb-jar.xml - META-INF/persistence.xml - META-INF/test.env-entry.properties
         */
