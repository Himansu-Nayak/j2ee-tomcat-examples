...
public class AutoConfigPersistenceUnitsTest extends TestCase {
    ...
    /**
     * Existing data source "Orange", jta managed Existing data source "OrangeUnmanaged", not jta managed
     * <p/>
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <jta-data-source>Orange</jta-data-source>
     * <non-jta-data-source>OrangeUnamanged</non-jta-data-source> </persistence-unit>
     * <p/>
    ...
    public void test() throws Exception {
        ...
        final ResourceInfo nonJta = addDataSource("OrangeUnmanaged", OrangeDriver.class, "jdbc:orange:some:stuff",
                false);
    ...
    /**
     * Existing data source "Orange", jta managed Existing data source "OrangeUnmanaged", not jta managed Existing data
     * source "Lime", jta managed Existing data source "LimeUnmanaged", not jta managed
     * <p/>
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <jta-data-source>Orange</jta-data-source>
     * <non-jta-data-source>OrangeUnmanaged</non-jta-data-source> </persistence-unit>
     * <persistence-unit name="lime-unit"> <jta-data-source>Lime</jta-data-source>
     * <non-jta-data-source>LimeUnmanaged</non-jta-data-source> </persistence-unit>
     * <p/>
     * This is the happy path.
     *
     * @throws Exception
    ...
    public void testMultiple() throws Exception {
        ...
        final ResourceInfo orangeNonJta = addDataSource("OrangeUnmanaged", OrangeDriver.class, "jdbc:orange:some:stuff",
                false);
    ...
    public void testFromWebAppIdThirdParty() throws Exception {
        ...
        final ResourceInfo supplied = addDataSource("orange-id", OrangeDriver.class, "jdbc:orange-web:some:stuff",
                null);
        assertSame(supplied, resources.get(0));
    ...
    public void testFromWebAppContextThirdParty() throws Exception {
        ...
        final ResourceInfo supplied = addDataSource("orange-web", OrangeDriver.class, "jdbc:orange-web:some:stuff",
                null);
        assertSame(supplied, resources.get(0));
     ...
     * <persistence-unit name="orange-unit" />
     * <p/>
     * The app module id is orange-unit-app. The jta data source should be orange-unit-app and the non-jta-data-source
     * should be null
     *
     * @throws Exception
     */
    public void testFromAppIdThirdParty() throws Exception {
        final ResourceInfo supplied = addDataSource("orange-unit-app", OrangeDriver.class, "jdbc:orange:some:stuff",
                null);
        assertSame(supplied, resources.get(0));
    ...
    /**
     * Existing data source "Orange", not controlled by us Existing data source "OrangeUnmanaged", also not controlled
     * by us
     * <p/>
     * Persistence xml like so:
     * <p/>
     ...
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <jta-data-source>Orange</jta-data-source> </persistence-unit>
     * <p/>
     * Here we should just let them try and get by with just the one data source.
     *
     * @throws Exception
     */
     ...
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <non-jta-data-source>Orange</non-jta-data-source> </persistence-unit>
     * <p/>
     * Here we should just let them try and get by with just the one data source.
     *
     * @throws Exception
     ...
     * <p/>
     * <persistence-unit name="orange-unit"> <jta-data-source>Orange</jta-data-source>
     * <non-jta-data-source>Orange</non-jta-data-source> </persistence-unit>
     * <p/>
     * Here we should just let them try and get by with both jta and non-jta references pointed at the same data source.
     *
     * @throws Exception
     */
     ...
     * <non-jta-data-source>Orange</non-jta-data-source> </persistence-unit>
     * <p/>
     * They used the same data source for both the jta-data-source and non-jta-data-source and we can determine the data
     * source will not work as a non-jta-data-source
     * <p/>
     * We should generate the missing data source for them based on the one they supplied.
     *
     * @throws Exception
     */
     ...
     * <p/>
     * They used the same data source for both the jta-data-source and non-jta-data-source and we can determine the data
     * source will not work as a jta-data-source
     * <p/>
     * We should generate the missing data source for them based on the one they supplied.
     *
     * @throws Exception
    ...
    /**
     * Existing data source "OrangeOne", jta managed Existing data source "OrangeTwo", not jta managed
     * <p/>
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <jta-data-source>OrangeOne</jta-data-source>
     * <non-jta-data-source>OrangeOne</non-jta-data-source> </persistence-unit>
     * <p/>
     * They used the same data source for both the jta-data-source and non-jta-data-source and we can determine the data
     * source will not work as a non-jta-data-source BUT they have explicitly configured a data source that nearly
     * matches the named datasource and would be identical to what we would auto-create
     *
     * @throws Exception
     */
     ...
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <jta-data-source>OrangeTwo</jta-data-source>
     * <non-jta-data-source>OrangeTwo</non-jta-data-source> </persistence-unit>
     * <p/>
     * They used the same data source for both the jta-data-source and non-jta-data-source and we can determine the data
     * source will not work as a jta-data-source BUT they have explicitly configured a data source that nearly matches
     * the named datasource and would be identical to what we would auto-create
     *
     * @throws Exception
     */
     ...
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <jta-data-source>java:foo/bar/baz/Orange</jta-data-source>
     * <non-jta-data-source>java:foo/bar/baz/OrangeUnamanged</non-jta-data-source> </persistence-unit>
     * <p/>
     * The datasources should be mapped correctly despite the vendor specific prefix.
     *
     * @throws Exception
     */
    public void testShortName() throws Exception {
        ...
        final PersistenceUnitInfo unitInfo = addPersistenceUnit("orange-unit", "java:foo/bar/baz/orange",
                "java:foo/bar/baz/orangeUnmanaged");
     ...
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <jta-data-source>DoesNotExist</jta-data-source>
     * <non-jta-data-source>AlsoDoesNotExist</non-jta-data-source> </persistence-unit>
     * <p/>
     * We should automatically hook them up to the configured datasources that do match
     *
     * @throws Exception
     */
    ...
    /**
     * Existing data source "OrangeOne", not jta managed Existing data source "OrangeTwo", not jta managed
     * <p/>
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <jta-data-source>OrangeOne</jta-data-source>
    ...
    /**
     * Existing data source "OrangeOne", jta managed Existing data source "OrangeTwo", jta managed
     * <p/>
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <jta-data-source>OrangeOne</jta-data-source>
     ...
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <jta-data-source>OrangeOne</jta-data-source> </persistence-unit>
     * <p/>
     * This configuration should be rejected
     *
     * @throws Exception
     ...
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <non-jta-data-source>OrangeOne</non-jta-data-source> </persistence-unit>
     * <p/>
     * This configuration should be rejected
     *
     * @throws Exception
     ...
     * <persistence-unit name="orange-unit"> <non-jta-data-source>Orange</non-jta-data-source> </persistence-unit>
     * <p/>
     * We should generate a <jta-data-source> based on the <non-jta-data-source>
     *
     * @throws Exception
     */
     ...
     * <persistence-unit name="orange-unit"> <jta-data-source>Orange</jta-data-source> </persistence-unit>
     * <p/>
     * We should generate a <non-jta-data-source> based on the <jta-data-source>
     *
     * @throws Exception
     */
    ...
    /**
     * Existing data source "Orange", not jta managed Existing data source "Lime", jta managed
     * <p/>
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <non-jta-data-source>Orange</non-jta-data-source> </persistence-unit>
     * <p/>
     * We should generate a <jta-data-source> based on the <non-jta-data-source>. We should not select the Lime
     * datasource which is for a different database.
     *
     * @throws Exception
     */
    ...
    /**
     * Existing data source "Orange", jta managed Existing data source "Lime", non jta managed
     * <p/>
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <jta-data-source>Orange</jta-data-source> </persistence-unit>
     * <p/>
     * We should generate a <non-jta-data-source> based on the <jta-data-source>. We should not select the Lime
     * datasource which is for a different database.
     *
     * @throws Exception
     */
    ...
    /**
     * Existing data source "Orange", not jta managed Existing data source "Lime", jta managed Existing data source
     * "JtaOrange", jta managed
     * <p/>
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <non-jta-data-source>Orange</non-jta-data-source> </persistence-unit>
     * <p/>
     * We should select the <jta-data-source> based on the closest match to the <non-jta-data-source>
     *
     * @throws Exception
     */
    ...
    /**
     * Existing data source "Orange", jta managed Existing data source "Lime", not jta managed Existing data source
     * "OrangeUnamanged", not jta managed
     * <p/>
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> <jta-data-source>Orange</jta-data-source> </persistence-unit>
     * <p/>
     * We should select the <non-jta-data-source> based on the closest match to the <jta-data-source>
     *
     * @throws Exception
     */
    public void testPossiblyAmbiguousNonJtaOptions() throws Exception {
        ...
        final ResourceInfo supplied = addDataSource("Orange", OrangeDriver.class, "jdbc:orange:some:stuff", true);
        final ResourceInfo badMatch = addDataSource("Lime", LimeDriver.class, "jdbc:lime:some:stuff", false);
        final ResourceInfo goodMatch = addDataSource("OrangeUnmanaged", OrangeDriver.class, "jdbc:orange:some:stuff",
                false);
     ...
     * Persistence xml like so:
     * <p/>
     * <persistence-unit name="orange-unit"> </persistence-unit>
     * <p/>
     * The <non-jta-data-source> should be auto linked to the Orange data source
     * <p/>
     * We should generate a <jta-data-source> based on the <non-jta-data-source>
     *
     * @throws Exception
     ...
     * <persistence-unit name="orange-unit"> </persistence-unit>
     * <p/>
     * The <jta-data-source> should be auto linked to the Orange data source
     * <p/>
     * We should generate a <non-jta-data-source> based on the <jta-data-source>
     *
     * @throws Exception
     ...
     * <p/>
     * The <non-jta-data-source> should be auto linked to the Default JDBC Database data source
     * <p/>
     * The <jta-data-source> should be auto linked to the Default Unmanaged JDBC Database data source
     *
     * @throws Exception
     */
    ...
    private PersistenceUnitInfo addPersistenceUnit(final String unitName, final String jtaDataSource,
            final String nonJtaDataSource) throws OpenEJBException, IOException, NamingException {
    ...
    private ResourceInfo addDataSource(final String id, final Class driver, final String url, final Boolean managed)
            throws OpenEJBException {
        final Resource resource = new Resource(id, "DataSource");
        return addDataSource(driver, url, managed, resource);
    }

    private ResourceInfo addDataSource(final Class driver, final String url, final Boolean managed,
            final Resource resource) throws OpenEJBException {
