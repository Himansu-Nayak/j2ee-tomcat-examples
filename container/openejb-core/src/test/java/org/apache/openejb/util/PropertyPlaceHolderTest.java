...
public class PropertyPlaceHolderTest {
    ...
    public void tomee1509() {
        ...
        assertEquals(expected, PropertyPlaceHolderHelper
                .simpleValue("cipher:" + ReversePasswordCipher.class.getName() + ":" + new String(encoded)));
    }
    ...
    public void defaults() {
        ...
        assertEquals("tomee!", PropertyPlaceHolderHelper
                .simpleValue("${not here sorry:-to}${no more luck:-me}${last:-missed}${${end}}"));
    }
    ...
    public void composedReplace() {
        ...
        final String foo = PropertyPlaceHolderHelper
                .simpleValue("jdbc://${PropertyPlaceHolderTest1}/${PropertyPlaceHolderTest2}");
