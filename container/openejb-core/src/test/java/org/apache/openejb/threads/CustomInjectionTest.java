...
public class CustomInjectionTest {
    ...
    public Properties configuration() {
        ...
        .property("concurrent/es", "new://Resource?type=ManagedExecutorService").property("concurrent/es.core", "2")
                .property("concurrent/es.max", "10").property("concurrent/es.keepAlive", "4 minutes")
