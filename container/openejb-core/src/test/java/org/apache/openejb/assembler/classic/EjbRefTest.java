...
/**
 * A potential issue with this feature is that the stateless bean is created and the object it references does not exist
 * at the time it is instantiated and put into the pool. Later the bean is deployed yet the instances in the pool remain
 * with null references, only new instances will be able to reference the newly deployed bean.
 *
 * @version $Rev$ $Date$
 */
