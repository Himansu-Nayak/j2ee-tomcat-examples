...
public class TransactionPropagationTest {
    ...
    public static class Starter {
        ...
        public void start() {
            cs.createContextualProxy(new IWantMyOwnTransaction(),
                    Collections.singletonMap(ManagedTask.TRANSACTION, ManagedTask.SUSPEND), Runnable.class).run();
            try {
                cs.createContextualProxy(
                        new IWantMyTheCallerTransaction(txMgr.getTransaction()), Collections
                                .singletonMap(ManagedTask.TRANSACTION, ManagedTask.USE_TRANSACTION_OF_EXECUTION_THREAD),
                        Runnable.class).run();
