...
public class CheckPersistenceContextUsageTest {
    @Keys({ @Key(value = "persistenceContextExtented.nonStateful"),
            ...
            @Key(value = "persistenceContextAnnotation.onClassWithNoName"),
            @Key(value = "persistenceContextAnnotation.onEntityManagerFactory"),
    ...
    public AppModule noUnitName() {
        ...
        final org.apache.openejb.jee.jpa.unit.Persistence p = new org.apache.openejb.jee.jpa.unit.Persistence(pu, pu1,
                pu2);
