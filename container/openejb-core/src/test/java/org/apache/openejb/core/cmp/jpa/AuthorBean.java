...
public class AuthorBean implements EntityBean, Cmp2Entity {
    ...
    static {
        try {
            deploymentInfo = new BeanContext("author", null,
                    new ModuleContext("", null, "",
                            new AppContext("", SystemInstance.get(), Author.class.getClassLoader(), new IvmContext(),
                                    new IvmContext(), false),
                            new IvmContext(), null),
                    AuthorBean.class, null, null, AuthorHome.class, Author.class, null, null, null, null, String.class,
    ...
    private final Set<BookBean> books = new HashSet<BookBean>();
    ...
    public Object OpenEJB_addCmr(final String name, final Object bean) {
        ...
        throw new IllegalArgumentException(
                "Unknown cmr field " + name + " on entity bean of type " + getClass().getName());
    }
