...
public class CustomMdbContainerTest extends TestCase {
    public void test() throws Exception {
        ...
        final MessageListener listener = messageAdapter
                .addMessageListener(new MessageListener(EmailConsumer.class, EmailAccountInfo.class));
        ...
        final EmailResourceAdapter ra = (EmailResourceAdapter) initialContext
                .lookup("java:openejb/Resource/email-raRA");
