...
public class CheckInvalidAroundTimeoutTest extends TestCase {
    ...
    public EjbJar testInvalidAroundTimeoutParameter() throws Exception {
        ...
        ejbJar.addEnterpriseBean(new StatelessBean("TestInvalidAroundTimeoutParameterBean",
    ...
    @Keys({ @Key(value = "aroundInvoke.badReturnType", count = 2),
            @Key(value = "aroundInvoke.mustThrowException", count = 2) })
    public EjbJar testInvalidAroundTimeoutReturnValue() throws Exception {
        final EjbJar ejbJar = new EjbJar();
        ejbJar.addEnterpriseBean(new StatelessBean("TestInvalidAroundTimeoutReturnValueBean",
