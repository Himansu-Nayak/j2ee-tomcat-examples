...
public class HerokuDatabasePropertiesProviderResourceTest {
    @Rule
    public final TestRule rule = RuleChain.outerRule(new TestRule() {
        @Override
        public Statement apply(final Statement base, final Description description) {
            return new Statement() {
                ...
                public void evaluate() throws Throwable {
                    ...
                    server.setDatabasePath(0, Files
                            .mkdirs(new File("target/HerokuDatabasePropertiesProviderResourceTest")).getAbsolutePath());
                    server.start();
