...
public class MdbConfigTest extends TestCase {
    public void test() throws Exception {
        ...
        final ResourceInfo dataSourceInfo = config.configureService("Default Unmanaged JDBC Database",
                ResourceInfo.class);
    ...
    private MessageDrivenBean createJaxbMdb(final String ejbName, final String mdbClass,
            final String messageListenerInterface) {
        ...
        activationConfig.getActivationConfigProperty()
                .add(new ActivationConfigProperty("destinationType", "javax.jms.Queue"));
    ...
    public static class FakeRA implements ResourceAdapter {
        ...
        public void endpointActivation(final MessageEndpointFactory messageEndpointFactory,
            ...
            assertTrue("activationSpec should be an instance of FakeActivationSpec",
            ...
            assertTrue("endpoint should be an instance of FakeMessageListener",
