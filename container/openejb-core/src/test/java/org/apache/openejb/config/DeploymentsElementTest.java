...
/**
 * If an app exists in the apps/ directory in both the packed and unpacked states, only deploy the app once
 * <p/>
...
public class DeploymentsElementTest extends Assert {
     ...
     * <p/>
     * EAR file not extracted Application.xml
     *
     * @throws Exception
     */
    @Test
    public void deploymentsDir_Ear_Packed_ApplicationXml() throws Exception {
        ...
        assertEquals("Orange",
                configuration.containerSystem.applications.get(0).ejbJars.get(0).enterpriseBeans.get(0).ejbName);
    }
     ...
     * <Deployments dir="myapps"/>
     * <p/>
     * EAR file extracted Application.xml
     *
     * @throws Exception
     */
    @Test
     ...
     * <Deployments dir="myapps"/>
     * <p/>
     * EAR file packed EAR file extracted Application.xml
     *
     * @throws Exception
     */
    @Test
     ...
     * <Deployments dir="myapps"/>
     * <p/>
     * EAR file packed EAR file extracted
     *
     * @throws Exception
     */
    @Test
     ...
     * EAR file packed EAR file extracted
     * <p/>
     * The packed version is newer and an updated version of the packed version We should remove the extracted version
     * and unpack the newer ear
     *
     * @throws Exception
     */
    @Test
     ...
     * Two ejb jars
     * <p/>
     * Order should be guaranteed to be the same as they are declared in the openejb.xml
     * <p/>
     * To test, the jars are named intentionally in an order that would naturally sort to be the reverse.
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * <Deployments dir="myapps/2000.jar"/> <Deployments dir="myapps"/>
     * <p/>
     * Order should be guaranteed to be the same as they are declared in the openejb.xml
     * <p/>
     * To test, the jars are named intentionally in an order that would naturally sort to be the reverse.
    ...
    /**
     * <Deployments dir="myapps/2000.jar"/> <Deployments dir="myapps/2000.jar"/> <Deployments dir="myapps"/>
     * <Deployments dir="myapps"/>
     * <p/>
     * Order should be guaranteed to be the same as they are declared in the openejb.xml
     * <p/>
