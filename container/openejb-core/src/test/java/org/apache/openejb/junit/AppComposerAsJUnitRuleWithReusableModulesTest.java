...
public class AppComposerAsJUnitRuleWithReusableModulesTest {
    @Rule
    public final ApplicationComposerRule rule = new ApplicationComposerRule(this, new Modules());
    ...
    public void notValid() {
        try {
            ...
            final ConstraintViolationException constraintViolationException = (ConstraintViolationException) ejbException
                    .getCause();
    ...
    public void lookupValidatorFactory() throws Exception {
        final ValidatorFactory validatorFactory = (ValidatorFactory) new InitialContext()
                .lookup("java:comp/ValidatorFactory");
