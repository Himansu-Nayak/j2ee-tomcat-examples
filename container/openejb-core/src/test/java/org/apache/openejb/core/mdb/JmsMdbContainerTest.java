...
public class JmsMdbContainerTest extends TestCase {
    ...
    public void test() throws Exception {
        ...
        assembler.createResource(config.configureService(ResourceInfo.class, "Default JMS Resource Adapter", props,
                "Default JMS Resource Adapter", "ActiveMQResourceAdapter"));
        ...
        final ConnectionFactory connectionFactory = (ConnectionFactory) initialContext
                .lookup("java:openejb/Resource/Default JMS Connection Factory");
    ...
    private void sendMessage(final ConnectionFactory connectionFactory, final String bean, final String text)
