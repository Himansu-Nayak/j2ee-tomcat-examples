...
public class IvmContextTest extends TestCase {
    ...
    public void testLookups() throws Exception {
        ...
        for (final Map.Entry<String, Integer> entry : map.entrySet()) {
            ...
            visit(context, name, new Visitor() {
                public void visit(final Context context, final String name, final String parentName)
    ...
    private void assertContextEntry(final Context context, final String s, final Object expected)
    ...
    private void visit(final Context context, final String name, final String parentName, final Visitor visitor)
            throws NamingException {
