...
public class TransactionalOPENEJB2122Test {
    ...
    public static class MyTestRessource {
        ...
        public String simpleTestMethod() {
            ...
            assertEquals(0, em.createQuery("select count(e) from TransactionalOPENEJB2122Test$MyEntity e", Number.class)
                    .getSingleResult().intValue());
            myTestBean.doOnFail();
            assertEquals(1, em.createQuery("select count(e) from TransactionalOPENEJB2122Test$MyEntity e", Number.class)
                    .getSingleResult().intValue());
