...
/**
 * This test case serves as a nice tiny template for other test cases and purposely doesn't do anything very
 * complicated.
 *
 * @version $Rev$ $Date$
 */
public class StatefulBeanManagedTest {
    ...
    public static class MyBean {
        ...
        @Remove
        public void three()
                throws HeuristicRollbackException, HeuristicMixedException, RollbackException, SystemException {
            this.string = null;
