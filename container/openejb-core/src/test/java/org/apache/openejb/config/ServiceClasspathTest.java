...
import static org.apache.xbean.asm5.Opcodes.*;
...
public class ServiceClasspathTest extends Assert {
    public static File subclass(final Class<?> parent, final String subclassName) throws Exception {
        ...
        final byte[] bytes;
        {
            ...
            cw.visit(Opcodes.V1_6, Opcodes.ACC_PUBLIC + ACC_SUPER, subclassNameInternal, null, parentClassNameInternal,
                    null);
    ...
    public void testXml() throws Exception {
        ...
        out.println("<openejb>\n"
                + "  <Resource id=\"Orange\" type=\"org.superbiz.foo.Orange\" class-name=\"org.superbiz.foo.Orange\" classpath=\""
                + jar.getAbsolutePath() + "\">\n" + "    red = FF\n" + "    green = 99\n" + "    blue = 00\n"
                + "  </Resource>\n" + "</openejb>");
        out.close();
