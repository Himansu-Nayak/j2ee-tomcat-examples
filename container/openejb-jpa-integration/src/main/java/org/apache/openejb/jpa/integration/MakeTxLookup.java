...
public class MakeTxLookup implements Opcodes {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        createNewHibernateStrategy(file, HIBERNATE_NEW_FACTORY2,
    ...
    private static void createNewHibernateStrategy(final File basedir, final String target,
        ...
        cw.visit(V1_6, ACC_PUBLIC + ACC_SUPER, target.replace('.', '/'), null,
                abstractJtaPlatformPackage + "/AbstractJtaPlatform", null);
        ...
        {
            mv = cw.visitMethod(ACC_PROTECTED, "locateTransactionManager", "()Ljavax/transaction/TransactionManager;",
                    null, null);
            mv.visitCode();
            mv.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/OpenEJB", "getTransactionManager",
                    "()Ljavax/transaction/TransactionManager;", false);
            mv.visitInsn(ARETURN);
            mv.visitMaxs(1, 1);
            mv.visitEnd();
        }
        {
            mv = cw.visitMethod(ACC_PROTECTED, "locateUserTransaction", "()Ljavax/transaction/UserTransaction;", null,
                    null);
            mv.visitCode();
            ...
            mv.visitLabel(l0);
            mv.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/loader/SystemInstance", "get",
                    "()Lorg/apache/openejb/loader/SystemInstance;", false);
            mv.visitLdcInsn(Type.getType("Lorg/apache/openejb/spi/ContainerSystem;"));
            mv.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/loader/SystemInstance", "getComponent",
                    "(Ljava/lang/Class;)Ljava/lang/Object;", false);
            mv.visitTypeInsn(CHECKCAST, "org/apache/openejb/spi/ContainerSystem");
            mv.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/spi/ContainerSystem", "getJNDIContext",
                    "()Ljavax/naming/Context;", true);
            mv.visitLdcInsn("comp/UserTransaction");
            mv.visitMethodInsn(INVOKEINTERFACE, "javax/naming/Context", "lookup",
    ...
    private static void createHibernteStrategy(final File baseDir) throws Exception {
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, classFilePath, null, "java/lang/Object",
                new String[] { "org/hibernate/transaction/TransactionManagerLookup" });
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "getTransactionManager",
                    "(Ljava/util/Properties;)Ljavax/transaction/TransactionManager;", null,
                    new String[] { "org/hibernate/HibernateException" });
            mv.visitCode();
            mv.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/OpenEJB", "getTransactionManager",
                    "()Ljavax/transaction/TransactionManager;", false);
            mv.visitInsn(ARETURN);
    ...
    private static void createTopLinkStrategy(final File baseDir) throws Exception {
...

        {
            ...
            mv.visitCode();
            mv.visitVarInsn(ALOAD, 0);
            mv.visitMethodInsn(INVOKESPECIAL, "oracle/toplink/essentials/transaction/JTATransactionController",
                    "<init>", "()V", false);
            mv.visitInsn(RETURN);
            mv.visitMaxs(1, 1);
            mv.visitEnd();
        ...
        {
            mv = cw.visitMethod(ACC_PROTECTED, "acquireTransactionManager", "()Ljavax/transaction/TransactionManager;",
    ...
    private static void write(final File originalFile, final ClassWriter cw, final String originalClassFileName)
            throws IOException {
