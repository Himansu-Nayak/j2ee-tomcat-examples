...
public class OpenEJBServerPlatform extends JMXServerPlatformBase {
    public OpenEJBServerPlatform(final DatabaseSession newDatabaseSession) {
        ...
        try {
            mBeanServer = MBeanServer.class.cast(OpenEJBServerPlatform.class.getClassLoader()
                    .loadClass("org.apache.openejb.monitoring.LocalMBeanServer").getMethod("get").invoke(null));
    ...
    public static class OpenEJBJTATransactionController extends JTATransactionController {
        ...
        protected TransactionManager acquireTransactionManager() throws Exception {
            return TransactionManager.class.cast(OpenEJBJTATransactionController.class.getClassLoader()
                    .loadClass("org.apache.openejb.OpenEJB").getDeclaredMethod("getTransactionManager").invoke(null));
        }
    }
}
