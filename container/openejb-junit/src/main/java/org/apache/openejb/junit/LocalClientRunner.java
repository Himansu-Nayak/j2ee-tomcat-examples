...
public class LocalClientRunner extends BlockJUnit4ClassRunner {
    ...
    private Statement wrap(final Test test, final Statement statement, final Class<? extends AnnotationStatement> clazz,
    ...
    private BeanContext createDeployment(final Class<?> testClass) {
        try {
            final AppContext appContext = new AppContext("", SystemInstance.get(), testClass.getClassLoader(),
                    new IvmContext(), new IvmContext(), false);
            final ModuleContext moduleContext = new ModuleContext("", null, "", appContext, new IvmContext(), null);
            return new BeanContext(null, new IvmContext(), moduleContext, testClass, null, null, null, null, null, null,
                    null, null, null, BeanType.MANAGED, false, false);
    ...
    public static class TransactionAttribute extends AnnotationStatement<javax.ejb.TransactionAttribute> {
        ...
        public TransactionAttribute(final javax.ejb.TransactionAttribute annotation, final Statement next,
                final Test test) {
            super(annotation, next, test);
        }
    ...
    public static class Transaction extends AnnotationStatement<org.apache.openejb.junit.Transaction> {
        ...
        public Transaction(final org.apache.openejb.junit.Transaction annotation, final Statement next,
                final Test test) {
            super(annotation, next, test);
        }
