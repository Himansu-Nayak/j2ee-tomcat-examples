...
public class JUnit4Runner extends BlockJUnit4ClassRunner {
    ...
    /**
     * Create a method statement that executes the test for each of the specified roles, both doing authorized and
     * unauthorized tests.
     * <p/>
     ...
     * @return statement
     */
    private Statement createSecuredStatement(final FrameworkMethod method, final String role,
            final boolean failWithAccessException) {
        final Object test = newTestInstance();
