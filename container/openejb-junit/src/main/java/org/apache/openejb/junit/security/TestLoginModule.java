...
/**
 * This is used to "emulate" a login for the "securityRole" option in the JUnit runner. The TestContext should set the
 * {@link Context#SECURITY_PRINCIPAL } {@link InitialContext} property to the rolename it wants to "RunAs", and this
 * login module will do the result.
 */
