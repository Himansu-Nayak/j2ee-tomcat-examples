...
public class UtilTest {
    ...
    /**
     * Used to test failure of finding a setter, where a method with a name equal to the setter name exists. This would
     * be cases where the method doesn't match a method
     */
    ...
    /**
     * Used to test success of finding a setter, where a method with a name equal to the setter name exists and
     * findSetter returns that method.
     *
    ...
    /**
     * Checks if the addProperty method works, adding a property with the specified key/value
     *
     * @param property
     * @param key
     * @param value
     ...
     * @param property
     * @param exceptionType
     *            the type of failure that should occur
     */
