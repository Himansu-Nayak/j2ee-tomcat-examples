...
public class ContextWrapperStatementTest {
    ...
    public void testEvaluate() throws Throwable {
        ...
        final ContextWrapperStatement wrapper = new ContextWrapperStatement(new FakeTestContext(false),
                new FakeStatement(false), fakeTestObject);
        wrapper.evaluate();
    ...
    /**
     * Testing the failures, we can assert that the order of invocation is true, based on the values of the booleans
     * AFTER the failure
     *
     * @throws Throwable
     */
    ...
    public void testEvaluateFailStatement() throws Throwable {
        ...
        final ContextWrapperStatement wrapper = new ContextWrapperStatement(new FakeTestContext(false),
                new FakeStatement(true), fakeTestObject);
        try {
            wrapper.evaluate();
    ...
    public void testEvaluateFailConfigure() throws Throwable {
        ...
        final ContextWrapperStatement wrapper = new ContextWrapperStatement(new FakeTestContext(true),
                new FakeStatement(false), fakeTestObject);
        try {
            wrapper.evaluate();
            fail("Wrapper call succeeded.");
