...
@ContextConfig(properties = {
        ...
        @Property("junit.test-property=Test String from Properties"), @Property("junit.test-empty-property="),
        @Property("junit.test-null-property"), @Property(" junit.test-trim-empty-property-key = "),
