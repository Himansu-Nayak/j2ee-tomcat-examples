...
@ContextConfig(properties = { @Property("openejb.deployments.classpath.include=.*openejb-junit.*"),
        @Property("java.naming.factory.initial=org.apache.openejb.core.LocalInitialContextFactory") })
@RunWith(OpenEjbRunner.class)
@TestSecurity(authorized = { "RoleA" })
@LocalClient
public class TestEjbSecurity {
    ...
    @Test
    @TestSecurity(authorized = { "RoleA" }, unauthorized = { "RoleB" })
    ...
    @Test
    @TestSecurity(authorized = { "RoleB" }, unauthorized = { "RoleA" })
    ...
    /**
     * This test was created to ensure that the statements are created correctly. They are constructed in such a way as
     * to "incorrectly" specify the annotation options, and should fail with an access exception
     */
    @Test(expected = EJBAccessException.class)
    @TestSecurity(authorized = { "RoleB" })
    ...
    @TestSecurity(unauthorized = { "RoleA" })
     ...
     */
    @Test(expected = AssertionError.class)
    @TestSecurity(unauthorized = { "RoleB" })
     ...
     */
    @Test
    @TestSecurity(unauthorized = { TestSecurity.UNAUTHENTICATED })
