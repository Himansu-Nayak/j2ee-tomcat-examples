...
@XmlType(name = "faces-config-managed-propertyType", propOrder = { "descriptions", "displayNames", "icon",
        "propertyName", "propertyClass", "mapEntries", "nullValue", "value", "listEntries" })
public class FacesManagedProperty {
     ...
     *
     * @return possible object is {@link FacesNullValue }
     */
     ...
     *
     * @param value
     *            allowed object is {@link FacesNullValue }
     */
