...
@XmlType(name = "persistence-context-refType", propOrder = { "descriptions", "persistenceContextRefName",
        "persistenceUnitName", "persistenceContextType", "persistenceContextSynchronization", "persistenceProperty",
        "mappedName", "injectionTarget",
...
public class PersistenceContextRef implements JndiReference, PersistenceRef {
    ...
    public PersistenceContextRef(final String persistenceContextRefName, final String persistenceUnitName,
            final PersistenceContextType persistenceContextType, final List<Property> persistenceProperty) {
        this.persistenceContextRefName = persistenceContextRefName;
        this.persistenceUnitName = persistenceUnitName;
    ...
    public void setPersistenceContextSynchronization(
            PersistenceContextSynchronization persistenceContextSynchronization) {
    ...
    public String toString() {
        return "PersistenceContextRef{" + "name='" + persistenceContextRefName + '\'' + ", unit='" + persistenceUnitName
                + '\'' + ", context=" + persistenceContextType + ", mappedName='" + mappedName + '\'' + ", lookupName='"
                + lookupName + '\'' + '}';
    }
}
