...
@XmlType(name = "container-concurrencyType", propOrder = { "descriptions",
...
public class ContainerConcurrency implements AttributeBinding<ConcurrentLockType> {
    ...
    public ContainerConcurrency(final ConcurrentLockType lock, final String className, final String ejbName,
            final String methodName) {
        this(lock, new Method(ejbName, className, methodName));
    }

    public ContainerConcurrency(final ConcurrentLockType lock, final String ejbName,
