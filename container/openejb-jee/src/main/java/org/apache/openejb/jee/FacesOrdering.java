...
@XmlType(name = "faces-config-orderingType", propOrder = { "after", "before" })
public class FacesOrdering {
     ...
     *
     * @return possible object is {@link FacesOrderingOrdering }
     */
     ...
     *
     * @param value
     *            allowed object is {@link FacesOrderingOrdering }
     */
