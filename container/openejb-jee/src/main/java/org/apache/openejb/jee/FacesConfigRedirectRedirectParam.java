...
/**
 * <p>
 * The "redirect-param" element, only valid within a "redirect" element, contains child "name" and "value" elements that
 * must be included in the redirect url when the redirect is performed.
 * </p>
 * <p/>
 * <p/>
 * <p/>
...
@XmlType(name = "faces-config-redirect-redirectParamType", propOrder = { "name", "value" })
