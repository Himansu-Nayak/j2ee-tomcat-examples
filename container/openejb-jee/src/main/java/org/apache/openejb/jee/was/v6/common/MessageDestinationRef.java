...
/**
 * @since J2EE1.4 The message-destination-ref element contains a declaration of Deployment Component's reference to a
 *        message destination associated with a resource in Deployment Component's environment. It consists of:
 *        <p/>
 *        - an optional description - the message destination reference name - the message destination type - a
 *        specification as to whether the destination is used for consuming or producing messages, or both - a link to
...
@XmlType(name = "MessageDestinationRef", propOrder = { "descriptions", "extensions" })
