...
public class Scan {
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link Scan.Exclude }
     * 
     * 
     */
    ...
    public static class Exclude {
        ...
        @XmlElements({ @XmlElement(name = "if-class-available", type = Scan.Exclude.IfClassAvailable.class),
         ...
         * 
         * <p>
         * Objects of the following type(s) are allowed in the list {@link Scan.Exclude.IfClassAvailable }
         * {@link Scan.Exclude.IfClassNotAvailable } {@link Scan.Exclude.IfSystemProperty }
         * 
         * 
         */
