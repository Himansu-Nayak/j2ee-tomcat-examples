...
/**
 * @Target({TYPE}) @Retention(RUNTIME) public @interface Table { String name() default ""; String catalog() default "";
 *                 String schema() default ""; UniqueConstraint[] uniqueConstraints() default {}; }
 *                 <p/>
 *                 <p/>
 *                 <p/>
 *                 <p>
