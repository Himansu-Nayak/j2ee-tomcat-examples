...
@XmlType(name = "weblogic-rdbms-jar", propOrder = { "weblogicRdbmsBean", "weblogicRdbmsRelation",
        "orderDatabaseOperations", "enableBatchOperations", "createDefaultDbmsTables", "validateDbSchemaWith",
        "databaseType", "defaultDbmsTablesDdl", "compatibility" })
public class WeblogicRdbmsJar {
     ...
     * the weblogicRdbmsBean property.
     * <p/>
     * <p/>
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link WeblogicRdbmsBean }
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the weblogicRdbmsRelation property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * 
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link WeblogicRdbmsRelation }
     */
