...
/**
 * This element contains the entity field or property mappings. It may be sparsely populated to include only a subset of
 * the fields or properties. If metadata-complete for the entity is true then the remainder of the attributes will be
 * defaulted according to the default rules.
 * <p/>
 * <p/>
 * <p/>
 * <p>
...
@XmlType(name = "attributes", propOrder = { "description", "id", "embeddedId", "basic", "version", "manyToOne",
        "oneToMany", "oneToOne", "manyToMany", "elementCollection", "embedded", "_transient" })
public class Attributes {
     ...
     *
     * @param value
     *            allowed object is {@link EmbeddedId }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link ManyToOne }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link OneToMany }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link OneToOne }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link ManyToMany }
     */
    ...
    public Map<String, RelationField> getRelationshipFieldMap() {
        ...
        if (oneToOne != null)
            fields.addAll(oneToOne);
        if (oneToMany != null)
            fields.addAll(oneToMany);
        if (manyToMany != null)
            fields.addAll(manyToMany);
        if (manyToOne != null)
            fields.addAll(manyToOne);
        return fields.toMap();
    }
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the elementCollection property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * 
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link ElementCollection }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link Embedded }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link Transient }
     */
