...
@XmlType(name = "resource-refType", propOrder = { "descriptions", "resRefName", "resType", "resAuth", "resSharingScope",
        "mappedName", "injectionTarget", "lookupName" })
public class ResourceRef implements JndiReference {
    ...
    public ResourceRef(final String resRefName, final String resType, final ResAuth resAuth,
            final ResSharingScope resSharingScope) {
        this.resRefName = resRefName;
        this.resType = resType;
    ...
    public String toString() {
        return "ResourceRef{" + "name='" + resRefName + '\'' + ", type='" + resType + '\'' + ", mappedName='"
