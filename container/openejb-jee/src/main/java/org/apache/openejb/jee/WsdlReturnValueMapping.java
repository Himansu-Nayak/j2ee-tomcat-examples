...
/**
 * TODO what schema? The wsdl-return-value-mapping element defines the mapping for the method's return value. It defines
 * the mapping to a specific message and its part. Together they define uniquely the mapping for a specific parameter.
 * Parts within a message context are uniquely identified with their names. The wsdl-message-part-name is not specified
 * if there is no return value or OUT parameters.
 * <p/>
 * Used in: service-endpoint-method-mapping
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "wsdl-return-value-mappingType", propOrder = { "methodReturnValue", "wsdlMessage",
        "wsdlMessagePartName" })
