 ...
 * The relationships element contains an optional description; and a list of ejb-relation elements, which specify the
...
@XmlType(name = "Relationships", propOrder = { "ejbRelations", "descriptions", "extensions" })
public class Relationships {
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link EJBRelation }
     */
