...
@XmlType(name = "validation-configType", namespace = "http://jboss.org/xml/ns/javax/validation/configuration", propOrder = {
        "defaultProvider", "messageInterpolator", "traversableResolver", "constraintValidatorFactory",
        "parameterNameProvider", "executableValidation", "constraintMapping", "property" })
public class ValidationConfigType {
     ...
     * 
     * @return possible object is {@link ExecutableValidationType }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link ExecutableValidationType }
     * 
     */
     ...
     * the constraintMapping property.
     * 
     * <p>
