...
@XmlType(name = "message-destination-refType", propOrder = { "descriptions", "messageDestinationRefName",
        "messageDestinationType", "messageDestinationUsage", "messageDestinationLink", "mappedName", "injectionTarget",
        "lookupName" })
public class MessageDestinationRef implements JndiReference {
    ...
    public String toString() {
        return "MessageDestinationRef{" + "name='" + messageDestinationRefName + '\'' + ", type='"
                + messageDestinationType + '\'' + ", usage=" + messageDestinationUsage + ", link='"
                + messageDestinationLink + '\'' + ", mappedName='" + mappedName + '\'' + ", lookupName='" + lookupName
                + '\'' + '}';
    }
}
