 ...
 * <p/>
 * If the xml-mapping-metadata-complete element is specified, the complete set of mapping metadata for the persistence
 * unit is contained in the XML mapping files for the persistence unit.
 * <p/>
 * <p/>
 * <p/>
 * <p>
...
@XmlType(name = "persistence-unit-metadata", propOrder = { "description", "xmlMappingMetadataComplete",
...
public class PersistenceUnitMetadata {
     ...
     *
     * @param value
     *            allowed object is {@link PersistenceUnitDefaults }
     */
