...
@XmlType(name = "faces-config-list-entriesType", propOrder = { "valueClass", "nullValueOrValue" })
public class FacesListEntries {

    @XmlElement(name = "value-class")
    protected java.lang.String valueClass;
    @XmlElements({ @XmlElement(name = "value", type = java.lang.String.class),
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link java.lang.String } {@link FacesNullValue }
     */
