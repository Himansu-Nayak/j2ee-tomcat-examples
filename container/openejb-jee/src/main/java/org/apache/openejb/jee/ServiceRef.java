...
@XmlType(name = "service-refType", propOrder = { "descriptions", "displayNames", "icon", "serviceRefName",
        "serviceInterface", "serviceRefType", "wsdlFile", "jaxrpcMappingFile", "serviceQname", "portComponentRef",
        "handler", "handlerChains", "mappedName", "injectionTarget", "lookupName" })
public class ServiceRef implements JndiReference {
    ...
    public String toString() {
        return "ServiceRef{" + "name='" + serviceRefName + '\'' + ", interface='" + serviceInterface + '\'' + ", type='"
                + serviceRefType + '\'' + ", wsdl='" + wsdlFile + '\'' + ", qname=" + serviceQname + ", mappedName='"
                + mappedName + '\'' + ", lookupName='" + lookupName + '\'' + '}';
    }
}
