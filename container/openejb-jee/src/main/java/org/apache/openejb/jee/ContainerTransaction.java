...
@XmlType(name = "container-transactionType", propOrder = { "descriptions", "method", "transAttribute" })
public class ContainerTransaction implements AttributeBinding<TransAttribute> {
    ...
    public ContainerTransaction(final TransAttribute transAttribute, final String className, final String ejbName,
            final String methodName) {
        this(transAttribute, new Method(ejbName, className, methodName));
    }

    public ContainerTransaction(final TransAttribute transAttribute, final String ejbName,
