...
@XmlType(name = "compatibility", propOrder = { "serializeByteArrayToOracleBlob", "serializeCharArrayToBytes",
        "allowReadonlyCreateAndRemove", "disableStringTrimming", "findersReturnNulls" })
