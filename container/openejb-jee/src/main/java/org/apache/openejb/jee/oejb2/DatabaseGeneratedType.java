...
/**
 * Indicates that the database automatically populates a primary key ID in the listed column(s). Typically this is used
 * for columns with an AUTO_INCREMENT flag or the equivalent. This only makes sense if this key generator is used for an
 * EJB or something else with a corresponding database table (not if it's meant to generate unique web session IDs or
 * something like that -- see auto-increment-tableType for that case).
 * <p/>
 * <p/>
 * <p>
