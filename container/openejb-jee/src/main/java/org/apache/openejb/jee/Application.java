...
@XmlType(name = "applicationType", propOrder = { "applicationName", "descriptions", "displayNames", "icon",
        "initializeInOrder", "module", "securityRole", "libraryDirectory", "envEntry", "ejbRef", "ejbLocalRef",
        "serviceRef", "resourceRef", "resourceEnvRef", "messageDestinationRef", "persistenceContextRef",
        "persistenceUnitRef", "messageDestination", "dataSource", "jmsConnectionFactories" })
