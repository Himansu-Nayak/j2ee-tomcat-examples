...
/**
 * @since J2EE1.4 This group keeps the usage of the contained JNDI environment reference elements consistent across J2EE
...
@XmlType(name = "JNDIEnvRefsGroup", propOrder = { "environmentProperties", "resourceRefs", "ejbRefs", "resourceEnvRefs",
        "ejbLocalRefs", "messageDestinationRefs", "serviceRefs" })
public class JNDIEnvRefsGroup extends CompatibilityDescriptionGroup {
     ...
     * the environmentProperties property.
     * <p/>
     * <p/>
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the messageDestinationRefs property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * <p/>
