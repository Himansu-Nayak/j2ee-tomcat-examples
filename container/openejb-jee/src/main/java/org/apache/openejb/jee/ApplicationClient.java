...
@XmlType(name = "application-clientType", propOrder = { "moduleName", "descriptions", "displayNames", "icon",
        "envEntry", "ejbRef", "ejbLocalRef", "serviceRef", "resourceRef", "resourceEnvRef", "messageDestinationRef",
        "persistenceContextRef", "persistenceUnitRef", "postConstruct", "preDestroy", "callbackHandler",
        "messageDestination", "dataSource", "jmsConnectionFactories"
