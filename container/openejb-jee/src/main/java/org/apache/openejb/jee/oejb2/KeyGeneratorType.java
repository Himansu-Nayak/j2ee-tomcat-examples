 ...
 * <p/>
 * If this is present, a key generator GBean will be created and configured to generate IDs for the surrounding object.
 * <p/>
 * <p/>
 * <p>
...
@XmlType(name = "key-generatorType", namespace = "http://tomee.apache.org/xml/ns/pkgen-2.1", propOrder = { "uuid",
        "sequenceTable", "autoIncrementTable", "sqlGenerator", "customGenerator" })
public class KeyGeneratorType {
     ...
     *
     * @return possible object is {@link SequenceTableType }
     */
     ...
     *
     * @param value
     *            allowed object is {@link SequenceTableType }
     */
     ...
     *
     * @return possible object is {@link AutoIncrementTableType }
     */
     ...
     *
     * @param value
     *            allowed object is {@link AutoIncrementTableType }
     */
     ...
     *
     * @return possible object is {@link SqlGeneratorType }
     */
     ...
     *
     * @param value
     *            allowed object is {@link SqlGeneratorType }
     */
     ...
     *
     * @return possible object is {@link CustomGeneratorType }
     */
     ...
     *
     * @param value
     *            allowed object is {@link CustomGeneratorType }
     */
