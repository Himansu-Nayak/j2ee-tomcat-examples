...
@XmlType(name = "faces-config-validatorType", propOrder = { "descriptions", "displayNames", "icon", "validatorId",
        "validatorClass", "attribute", "property", "validatorExtension" })
public class FacesValidator {
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the validatorExtension property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * 
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesValidatorExtension }
     */
