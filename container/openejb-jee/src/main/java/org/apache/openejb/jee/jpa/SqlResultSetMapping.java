...
/**
 * @Target({TYPE}) @Retention(RUNTIME) public @interface SqlResultSetMapping { String name(); EntityResult[] entities()
 *                 default {}; ColumnResult[] columns() default {}; }
 *                 <p/>
 *                 <p/>
 *                 <p/>
 *                 <p>
