...
public interface RelationField extends Keyable {
    ...
    /**
     * This is only used for xml converters and will normally return null. Gets the field on the target entity for this
     * relationship.
     *
     ...
     *
     * @param value
     *            field on the target entity for this relationship.
     */
    void setRelatedField(RelationField value);

    /**
     * This is only used for xml converters and will normally return false. A true value indicates that this field was
     * generated for CMR back references.
     *
