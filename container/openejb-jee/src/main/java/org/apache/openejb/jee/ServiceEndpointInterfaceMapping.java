...
/**
 * The service-endpoint-interface-mapping defines a tuple to specify Service Endpoint Interfaces to WSDL port types and
 * WSDL bindings.
 * <p/>
...
@XmlType(name = "service-endpoint-interface-mappingType", propOrder = { "serviceEndpointInterface", "wsdlPortType",
        "wsdlBinding", "serviceEndpointMethodMapping" })
