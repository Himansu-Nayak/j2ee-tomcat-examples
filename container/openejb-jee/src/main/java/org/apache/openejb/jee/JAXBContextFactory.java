...
public final class JAXBContextFactory {
    ...
    private static final java.util.logging.Logger log = java.util.logging.Logger
            .getLogger(JAXBContextFactory.class.getName());
    ...
    public static JAXBContext newInstance(final String s, final ClassLoader classLoader,
    ...
    private static class Event {
        ...
        public void stop() {
            log.log(Level.FINE, String.format("JAXBContext.newInstance %s  %s",
                    TimeUnit.NANOSECONDS.toMillis(System.nanoTime() - this.start), this.description));
        }
    }
}
