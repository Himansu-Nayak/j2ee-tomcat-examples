...
@XmlType(name = "", propOrder = { "keyGeneratorFactory", "unknownPkClass", "fieldName", "readOnly", "readTimeOut",
        "columnName", "jdbcType", "sqlType", "autoIncrement" })
...
public class UnknownPk {
     ...
     *
     * @return possible object is {@link UnknownPkClass }
     */
     ...
     *
     * @param value
     *            allowed object is {@link UnknownPkClass }
     */
