...
@XmlType(name = "openejb-jarType", namespace = "http://tomee.apache.org/xml/ns/openejb-jar-2.2", propOrder = {
        "environment", "properties", "cmpConnectionFactory", "ejbQlCompilerFactory", "dbSyntaxFactory",
        "enforceForeignKeyConstraints", "enterpriseBeans", "ejbRelation", "messageDestination", "security", "service",
        "persistence" })
public class OpenejbJarType {
    ...
    @XmlElements({ @XmlElement(name = "message-driven", required = true, type = MessageDrivenBeanType.class),
