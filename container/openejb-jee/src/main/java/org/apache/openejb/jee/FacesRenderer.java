...
@XmlType(name = "faces-config-rendererType", propOrder = { "descriptions", "displayNames", "icon", "componentFamily",
        "rendererType", "rendererClass", "facet", "attribute", "rendererExtension" })
public class FacesRenderer {
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the rendererExtension property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * 
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesRendererExtension }
     */
