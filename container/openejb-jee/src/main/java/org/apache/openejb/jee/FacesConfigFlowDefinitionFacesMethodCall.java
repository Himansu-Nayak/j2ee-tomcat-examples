 ...
 * Invoke a method, passing parameters if necessary. The return from the method is used as the outcome for where to go
 * next in the flow. If the method is a void method, the default outcome is used.
 * <p>
 * <p/>
 * <p/>
 * <p/>
...
@XmlType(name = "faces-config-flow-definition-faces-method-callType", propOrder = { "method", "defaultOutcome",
        "parameter" })
public class FacesConfigFlowDefinitionFacesMethodCall {
     ...
     *
     * @return possible object is {@link FacesConfigFlowDefinitionFacesMethodCallMethod }
     */
     ...
     *
     * @param value
     *            allowed object is {@link FacesConfigFlowDefinitionFacesMethodCallMethod }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesConfigFlowDefinitionFlowCallParameter }
     */
