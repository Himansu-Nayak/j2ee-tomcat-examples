...
/**
 * TODO what schema? The variable-mapping element defines the correlation between a Java class data member or JavaBeans
 * property to an XML element or attribute name of an XML root type. If the data-member element is present, the Java
 * variable name is a public data member. If data-member is not present, the Java variable name is a JavaBeans property.
 * <p/>
 * Used in: java-xml-type-mapping
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "variable-mappingType", propOrder = { "javaVariableName", "dataMember", "xmlAttributeName",
        "xmlElementName", "xmlWildcard" })
