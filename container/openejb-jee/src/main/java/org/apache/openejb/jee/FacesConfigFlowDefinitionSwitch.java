 ...
 * <p/>
 * <p>
 * This element must contain one or more <code>&lt;case&gt;</code> elements. When control passes to the
 * <code>&lt;switch&gt;</code> node, each of the cases must be considered in order and control must past to the
 * <code>&lt;from-outcome&gt;</code> of the first one whose <code>&lt;if&gt;</code> expression evaluates to
 * <code>true</code>.
 * </p>
 * <p/>
 * </div>
...
public class FacesConfigFlowDefinitionSwitch {
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesConfigFlowDefinitionSwitchCase }
     */
