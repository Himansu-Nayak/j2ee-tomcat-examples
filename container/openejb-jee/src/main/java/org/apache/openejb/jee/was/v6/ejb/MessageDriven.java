 ...
 * <p/>
 * - an optional description - an optional display name - an optional icon element that contains a small and a large
 * icon file name. - a name assigned to the enterprise bean in the deployment descriptor - the message-driven bean's
 * implementation class - an optional declaration of the bean's messaging type - the message-driven bean's transaction
 * management type - an optional declaration of the bean's message-destination-type - an optional declaration of the
 * bean's message-destination-link - an optional declaration of the message-driven bean's activation configuration
 * properties - an optional declaration of the bean's environment entries - an optional declaration of the bean's EJB
 * references - an optional declaration of the bean's local EJB references - an optional declaration of the bean's web
 * service references - an optional declaration of the security identity to be used for the execution of the bean's
 * methods - an optional declaration of the bean's resource manager connection factory references - an optional
 * declaration of the bean's resource environment references. - an optional declaration of the bean's message
...
@XmlType(name = "MessageDriven", propOrder = { "destinations", "activationConfigs", "messageDestinations",
        "messagingTypes" })
public class MessageDriven extends EnterpriseBean {
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link MessageDrivenDestination }
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the activationConfigs property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * <p/>
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link ActivationConfig }
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the messageDestinations property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * <p/>
