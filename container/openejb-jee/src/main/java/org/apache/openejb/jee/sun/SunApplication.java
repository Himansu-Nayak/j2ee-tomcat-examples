...
@XmlType(name = "", propOrder = { "web", "passByReference", "uniqueId", "securityRoleMapping", "realm", "ejbRef",
        "resourceRef", "resourceEnvRef", "serviceRef", "messageDestinationRef", "messageDestination", "archiveName",
        "compatibility" })
