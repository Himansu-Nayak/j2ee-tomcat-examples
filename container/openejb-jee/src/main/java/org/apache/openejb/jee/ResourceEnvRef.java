...
@XmlType(name = "resource-env-refType", propOrder = { "descriptions", "resourceEnvRefName", "resourceEnvRefType",
...
public class ResourceEnvRef implements JndiReference {
    ...
    public String toString() {
        return "ResourceEnvRef{" + "name='" + resourceEnvRefName + '\'' + ", type='" + resourceEnvRefType + '\''
