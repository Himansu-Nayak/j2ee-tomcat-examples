...
@XmlType(name = "port-completionType", namespace = "http://geronimo.apache.org/xml/ns/naming-1.2", propOrder = { "port",
        "bindingName" })
public class PortCompletionType {
     ...
     *
     * @return possible object is {@link PortType }
     */
     ...
     *
     * @param value
     *            allowed object is {@link PortType }
     */
