...
@XmlType(name = "faces-config-factoryType", propOrder = { "applicationFactory", "exceptionHandlerFactory",
        "externalContextFactory", "facesContextFactory", "partialViewContextFactory", "lifecycleFactory",
        "viewDeclarationLanguageFactory", "tagHandlerDelegateFactory", "renderKitFactory", "visitContextFactory",
        "factoryExtension" })
public class FacesFactory {
     ...
     * the applicationFactory property.
     * <p/>
     * <p/>
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the facesContextFactory property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * 
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesFactoryExtension }
     */
