...
/**
 * <p>
 * Java class for caching-element complex type.
 * <p/>
 * <p>
...
@XmlType(name = "caching-element", propOrder = { "cmrField", "groupName", "cachingElement" })
public class CachingElement {
     ...
     */
    public void setCmrField(final String value) {
        this.cmrField = value;
    }
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link CachingElement }
     */
