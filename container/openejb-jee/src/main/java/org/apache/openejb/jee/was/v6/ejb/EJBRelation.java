...
/**
 * @invariant The name of the relationship, if specified, is unique within the ejb-jar file. @invariant
 *            self.relationshipRoles.size == 2
 ...
 *            </pre>
 * 
 * @since J2EE1.3 The ejb-relation element describes a relationship between two entity beans with container managed
 *        persistence. An ejb-relation element contains a description; an optional ejb-relation-name element; and
 *        exactly two relationship role declarations, defined by the ejb-relationship-roles. The name of the
 *        relationship, if specified, is unique within the ejb-jar file.
 */
...
public class EJBRelation {
     ...
     * the relationshipRoles property.
     * <p/>
     * <p/>
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link EJBRelationshipRole }
     */
