...
@XmlType(name = "", propOrder = { "ejbName", "jndiName", "localJndiName", "callByValue", "exceptionOnRollback",
        "timerPersistence", "configurationName", "invokerBindings", "securityProxy", "ejbRef", "ejbLocalRef",
        "serviceRef", "securityIdentity", "resourceRef", "resourceEnvRef", "messageDestinationRef", "clustered",
        "clusterConfig", "methodAttributes", "depends", "iorSecurityConfig", "portComponent", "ejbTimeoutIdentity" })
...
public class Session {
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link PortComponent }
     */
