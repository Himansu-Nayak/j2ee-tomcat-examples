...
/**
 * Indicates that a separate table holds a list of table name/ID pairs and the server should fetch the next ID from that
 * table.
 * <p/>
 * <p/>
 * <p>
...
@XmlType(name = "sequence-tableType", namespace = "http://tomee.apache.org/xml/ns/pkgen-2.1", propOrder = { "tableName",
        "sequenceName", "batchSize" })
