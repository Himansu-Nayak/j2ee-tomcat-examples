...
public class Method {
    ...
    /**
     * contains a name of an enterprise bean method or the asterisk (*) character. The asterisk is used when the element
     * denotes all the methods of an enterprise bean's client view interfaces.
     */
