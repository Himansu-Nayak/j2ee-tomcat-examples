...
@XmlType(name = "faces-config-componentType", propOrder = { "descriptions", "displayNames", "icon", "componentType",
        "componentClass", "facet", "attribute", "property", "componentExtension" })
public class FacesComponent {
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesFacet }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesAttribute }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesProperty }
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the componentExtension property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * 
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesComponentExtension }
     */
