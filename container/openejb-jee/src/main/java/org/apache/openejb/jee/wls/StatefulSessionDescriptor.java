...
@XmlType(name = "stateful-session-descriptor", propOrder = { "statefulSessionCache", "persistentStoreDir",
        "statefulSessionClustering", "allowConcurrentCalls", "allowRemoveDuringTransaction" })
