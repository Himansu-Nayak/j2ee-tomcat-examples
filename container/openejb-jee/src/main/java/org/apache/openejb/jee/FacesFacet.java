...
@XmlType(name = "faces-config-facetType", propOrder = { "descriptions", "displayNames", "icon", "facetName",
        "facetExtension" })
public class FacesFacet {
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesFacetExtension }
     */
