 ...
 * org.apache.bval.jsr.xml package.
 * <p>
...
public class ObjectFactory {
    ...
    private final static QName _ValidationConfig_QNAME = new QName(
            "http://jboss.org/xml/ns/javax/validation/configuration", "validation-config");
    private final static QName _ConstraintMappings_QNAME = new QName("http://jboss.org/xml/ns/javax/validation/mapping",
            "constraint-mappings");
    private final static QName _ElementTypeAnnotation_QNAME = new QName(
            "http://jboss.org/xml/ns/javax/validation/mapping", "annotation");
    private final static QName _ElementTypeValue_QNAME = new QName("http://jboss.org/xml/ns/javax/validation/mapping",
            "value");
    ...
    public JAXBElement<ConstraintMappingsType> createConstraintMappings(ConstraintMappingsType value) {
        return new JAXBElement<ConstraintMappingsType>(_ConstraintMappings_QNAME, ConstraintMappingsType.class, null,
                value);
    }
    ...
    public JAXBElement<AnnotationType> createElementTypeAnnotation(AnnotationType value) {
        return new JAXBElement<AnnotationType>(_ElementTypeAnnotation_QNAME, AnnotationType.class, ElementType.class,
                value);
    }
