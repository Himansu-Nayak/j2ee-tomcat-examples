...
@XmlType(name = "", propOrder = { "ejbName", "datasource", "datasourceMapping", "createTable", "removeTable",
        "postTableCreate", "readOnly", "readTimeOut", "rowLocking", "pkConstraint", "readAhead", "listCacheMax",
        "cleanReadAheadOnLoad", "fetchSize", "tableName", "cmpField", "loadGroups", "eagerLoadGroup", "lazyLoadGroups",
        "query", "unknownPk", "entityCommand", "optimisticLocking", "audit" })
...
public class Entity {
     ...
     *
     * @return possible object is {@link EjbName }
     */
     ...
     *
     * @param value
     *            allowed object is {@link EjbName }
     */
     ...
     *
     * @param value
     *            allowed object is {@link TableName }
     */
     ...
     *
     * @return possible object is {@link EagerLoadGroup }
     */
     ...
     *
     * @param value
     *            allowed object is {@link EagerLoadGroup }
     */
