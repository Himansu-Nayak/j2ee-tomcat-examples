...
@XmlType(name = "resourceadapterType", propOrder = { "managedConnectionFactoryClass", "connectionFactoryInterface",
        "connectionFactoryImplClass", "connectionInterface", "connectionImplClass", "transactionSupport",
        "configProperty", "authenticationMechanism", "reauthenticationSupport", "securityPermission" })
