...
@XmlType(name = "EJBJarBinding", propOrder = { "defaultDatasources", "ejbJars", "ejbBindings",
        "defaultCMPConnectionFactories", "extensions" })
public class EJBJarBinding {
     ...
     * the defaultDatasources property.
     * <p/>
     * <p/>
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link EnterpriseBeanBinding }
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the defaultCMPConnectionFactories property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * <p/>
