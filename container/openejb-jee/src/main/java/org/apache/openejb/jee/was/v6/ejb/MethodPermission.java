...
/**
 * The method-permission element specifies that one or more security roles are allowed to invoke one or more enterprise
 * bean methods. The method-permission element consists of an optional description, a list of security role names, and a
 * list of method elements. The security roles used in the method-permission element must be defined in the
 * security-role element of the deployment descriptor, and the methods must be methods defined in the enterprise bean's
...
@XmlType(name = "MethodPermission", propOrder = { "roles", "methodElements", "descriptions", "extensions" })
public class MethodPermission {
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link MethodElement }
     */
