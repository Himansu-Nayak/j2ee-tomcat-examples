...
public enum MessageDestinationUsageEnum {
    ...
    @XmlEnumValue("Consumes") CONSUMES("Consumes"), @XmlEnumValue("Produces") PRODUCES(
            "Produces"), @XmlEnumValue("ConsumesProduces") CONSUMES_PRODUCES("ConsumesProduces");
    ...
    public static MessageDestinationUsageEnum fromValue(final String v) {
        for (final MessageDestinationUsageEnum c : MessageDestinationUsageEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
