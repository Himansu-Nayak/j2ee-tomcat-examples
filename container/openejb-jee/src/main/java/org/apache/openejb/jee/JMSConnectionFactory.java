...
@XmlType(name = "jms-connection-factoryType", propOrder = { "name", "descriptions", "className", "interfaceName",
        "resourceAdapter", "user", "password", "clientId", "transactional", "maxPoolSize", "minPoolSize", "property" })
