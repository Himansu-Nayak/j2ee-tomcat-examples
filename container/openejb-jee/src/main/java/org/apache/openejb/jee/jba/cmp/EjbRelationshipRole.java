...
@XmlType(name = "", propOrder = { "ejbRelationshipRoleName", "fkConstraint", "keyFields", "readAhead",
        "batchCascadeDelete" })
...
public class EjbRelationshipRole {
     ...
     *
     * @return possible object is {@link EjbRelationshipRoleName }
     */
     ...
     *
     * @param value
     *            allowed object is {@link EjbRelationshipRoleName }
     */
