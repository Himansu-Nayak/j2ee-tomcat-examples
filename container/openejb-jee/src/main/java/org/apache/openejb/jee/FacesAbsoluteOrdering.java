...
@XmlType(name = "faces-config-absoluteOrderingType", propOrder = { "nameOrOthers" })
public class FacesAbsoluteOrdering {

    @XmlElements({ @XmlElement(name = "others", type = FacesOrderingOthers.class),
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesOrderingOthers } {@link String }
     */
