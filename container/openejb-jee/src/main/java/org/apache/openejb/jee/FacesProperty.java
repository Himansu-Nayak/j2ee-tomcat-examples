...
@XmlType(name = "faces-config-propertyType", propOrder = { "descriptions", "displayNames", "icon", "propertyName",
        "propertyClass", "defaultValue", "suggestedValue", "propertyExtension" })
public class FacesProperty {
     ...
     * the propertyExtension property.
     * <p/>
     * <p/>
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesPropertyExtension }
     */
