...
/**
 * The root element of the EJB deployment descriptor. It contains an optional description of the ejb-jar file; optional
 * display name; optional small icon file name; optional large icon file name; mandatory structural information about
 * all included enterprise beans; a descriptor for container managed relationships, if any; an optional
 * application-assembly descriptor; and an optional name of an ejb-client-jar file for the ejb-jar.
 * <p/>
 * <p/>
 * <p/>
...
public class EJBJar extends CompatibilityDescriptionGroup {
     ...
     * the assemblyDescriptors property.
     * <p/>
     * <p/>
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link AssemblyDescriptor }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link Relationships }
     */
