...
/**
 * EnterpriseJavaBean is a class. It can have instances, someone could write an instance document containing Departments
 * and Employees. It also has attributes, operations, and associations. These are actually derived/filtered from its
 * implementation classes and interfaces. For mapping and browsing purposes, though, you would like the EJB to appear as
 * a class.
 * <p/>
 * In this light, even Session Beans can have associations and properties implemented by their bean. For example, it
 * would be meaningful to describe associations from a Session to the Entities which it uses to perform its work.
 * <p/>
 * <p/>
 * <p/>
...
@XmlType(name = "EnterpriseBean", propOrder = { "securityRoleRefs", "ejbClasses", "homeInterfaces", "remoteInterfaces",
...
public class EnterpriseBean extends JNDIEnvRefsGroup {
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link SecurityRoleRef }
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the securityIdentities property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * <p/>
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link SecurityIdentity }
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the localHomeInterfaces property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * <p/>
