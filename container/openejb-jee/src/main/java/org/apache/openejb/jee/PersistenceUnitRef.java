...
@XmlType(name = "persistence-unit-refType", propOrder = { "descriptions", "persistenceUnitRefName",
        "persistenceUnitName", "mappedName", "injectionTarget",
...
public class PersistenceUnitRef implements JndiReference, PersistenceRef {
    ...
    public String toString() {
        return "PersistenceUnitRef{" + "name='" + persistenceUnitRefName + '\'' + ", unit='" + persistenceUnitName
