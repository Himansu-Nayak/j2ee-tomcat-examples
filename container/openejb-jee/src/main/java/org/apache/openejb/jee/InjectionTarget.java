...
public class InjectionTarget {
    ...
    public boolean equals(final Object o) {
        ...
        if (injectionTargetClass != null ? !injectionTargetClass.equals(that.injectionTargetClass)
                : that.injectionTargetClass != null)
            return false;
        if (injectionTargetName != null ? !injectionTargetName.equals(that.injectionTargetName)
                : that.injectionTargetName != null)
            return false;
