...
public class MethodSchedule {
    ...
    public MethodSchedule(final String className, final String ejbName, final String methodName,
            final TimerSchedule... schedules) {
        this(ejbName, new NamedMethod(className, methodName), schedules);
    }

    public MethodSchedule(final String ejbName, final java.lang.reflect.Method method,
            final TimerSchedule... schedules) {
