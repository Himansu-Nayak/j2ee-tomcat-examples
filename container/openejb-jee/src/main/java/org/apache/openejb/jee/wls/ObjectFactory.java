 ...
 * org.apache.openejb.jee.wls package.
 * <p>
...
public class ObjectFactory {
    ...
    private final static QName _SecurityRoleAssignmentPrincipalName_QNAME = new QName(
            "http://www.bea.com/ns/weblogic/90", "principal-name");
    private final static QName _WeblogicEjbJar_QNAME = new QName("http://www.bea.com/ns/weblogic/90",
            "weblogic-ejb-jar");
    private final static QName _WeblogicRdbmsRelationWeblogicRelationshipRole_QNAME = new QName(
            "http://www.bea.com/ns/weblogic/90", "weblogic-relationship-role");
    private final static QName _WeblogicRdbmsRelationTableName_QNAME = new QName("http://www.bea.com/ns/weblogic/90",
            "table-name");
    private final static QName _WeblogicRdbmsRelationRelationName_QNAME = new QName("http://www.bea.com/ns/weblogic/90",
            "relation-name");
    ...
    public JAXBElement<String> createSecurityRoleAssignmentPrincipalName(final String value) {
        return new JAXBElement<String>(_SecurityRoleAssignmentPrincipalName_QNAME, String.class,
                SecurityRoleAssignment.class, value);
    }
    ...
    public JAXBElement<WeblogicRelationshipRole> createWeblogicRdbmsRelationWeblogicRelationshipRole(
            final WeblogicRelationshipRole value) {
        return new JAXBElement<WeblogicRelationshipRole>(_WeblogicRdbmsRelationWeblogicRelationshipRole_QNAME,
                WeblogicRelationshipRole.class, WeblogicRdbmsRelation.class, value);
    }
    ...
    public JAXBElement<String> createWeblogicRdbmsRelationTableName(final String value) {
        return new JAXBElement<String>(_WeblogicRdbmsRelationTableName_QNAME, String.class, WeblogicRdbmsRelation.class,
                value);
    }
    ...
    public JAXBElement<String> createWeblogicRdbmsRelationRelationName(final String value) {
        return new JAXBElement<String>(_WeblogicRdbmsRelationRelationName_QNAME, String.class,
                WeblogicRdbmsRelation.class, value);
    }
