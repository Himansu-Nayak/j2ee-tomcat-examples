...
@XmlType(name = "faces-config-redirectType", propOrder = { "viewParam" })
public class FacesRedirect {
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesRedirectViewParam }
     */
     ...
     */
    public void setIncludeViewParams(final Boolean value) {
