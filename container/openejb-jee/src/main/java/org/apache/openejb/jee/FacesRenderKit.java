...
@XmlType(name = "faces-config-render-kitType", propOrder = { "descriptions", "displayNames", "icon", "renderKitId",
        "renderKitClass", "renderer", "clientBehaviorRenderer", "renderKitExtension" })
public class FacesRenderKit {
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesRenderer }
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the renderKitExtension property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * 
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesRenderKitExtension }
     */
