...
@XmlType(name = "web-service-securityType", propOrder = { "securityRealmName", "realmName", "transportGuarantee",
        "authMethod", "httpMethod", "properties" })
public class WebServiceSecurityType {
     ...
     *
     * @param value
     *            allowed object is {@link TransportGuaranteeType }
     */
     ...
     *
     * @param value
     *            allowed object is {@link AuthMethodType }
     */
