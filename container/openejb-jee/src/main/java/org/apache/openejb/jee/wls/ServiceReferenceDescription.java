...
@XmlType(name = "service-reference-description", propOrder = { "serviceRefName", "wsdlUrl", "callProperty",
        "portInfo" })
public class ServiceReferenceDescription {
     ...
     *            allowed object is {@link String }
     */
    public void setWsdlUrl(final String value) {
        this.wsdlUrl = value;
    }
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link PropertyNamevalue }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link PortInfo }
     */
