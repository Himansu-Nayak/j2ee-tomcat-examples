...
public enum MethodElementEnum {
    ...
    @XmlEnumValue("Unspecified") UNSPECIFIED("Unspecified"), @XmlEnumValue("Remote") REMOTE(
            "Remote"), @XmlEnumValue("Home") HOME("Home"), @XmlEnumValue("Local") LOCAL(
                    "Local"), @XmlEnumValue("LocalHome") LOCAL_HOME(
                            "LocalHome"), @XmlEnumValue("ServiceEndpoint") SERVICE_ENDPOINT("ServiceEndpoint");
