...
@XmlType(name = "session-beanType", propOrder = { "ejbName", "jndiName", "localJndiName", "jndi", "cacheSize",
        "tssLink", "tss", "abstractNamingEntry", "properties", "persistenceContextRef", "persistenceUnitRef", "ejbRef",
        "ejbLocalRef", "serviceRef", "resourceRef", "resourceEnvRef", "webServiceAddress", "webServiceVirtualHost",
        "webServiceSecurity" })
public class SessionBeanType implements EnterpriseBean, RpcBean {
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the webServiceVirtualHost property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * 
     ...
     *
     * @return possible object is {@link WebServiceSecurityType }
     */
     ...
     *
     * @param value
     *            allowed object is {@link WebServiceSecurityType }
     */
