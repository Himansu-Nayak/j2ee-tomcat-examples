...
/**
 * @Target({TYPE}) @Retention(RUNTIME) public @interface DiscriminatorColumn { String name() default "DTYPE";
 *                 DiscriminatorType discriminatorType() default STRING; String columnDefinition() default ""; int
 *                 length() default 31; }
 *                 <p/>
 *                 <p/>
 *                 <p/>
...
public class DiscriminatorColumn {
     ...
     *
     * @param value
     *            allowed object is {@link DiscriminatorType }
     */
