...
/**
 * Specifies how the container must manage transaction scopes for the enterprise bean's method invocations. It consists
 * of an optional description, a list of method elements, and a transaction attribute.The transaction attribute is to be
 * applied to all the specified methods.
 * <p/>
 * <p/>
 * <p/>
...
@XmlType(name = "MethodTransaction", propOrder = { "methodElements", "descriptions", "extensions" })
