 ...
 * The ejb-name element must be the name of one of the enterprise beans in declared in the deployment descriptor; the
 * optional method-intf element allows to distinguish between a method with the same signature that is defined in both
 * the home and remote interface; the method-name element specifies the method name; and the optional method-params
 * elements identify a
 * <p/>
 ...
 * </method>>
 * <p/>
 * This style is used to refer to the specified method of the specified enterprise bean. If there are multiple methods
 * with
 * <p/>
 * the same overloaded name, the element of this style refers to all the methods with the overloaded name.
 * <p/>
 * <p/>
 * <p/>
 * <p/>
 ...
 * <p/>
 * <p/>
 * This style is used to refer to a single method within a set of methods with an overloaded name. PARAM-1 through
 * PARAM-n are the fully-qualified Java types of the method's input parameters (if the method has no input arguments,
 * the method-params element
 * <p/>
 * contains no method-param elements). Arrays are specified by the array element's type, followed by one or more pair of
 ...
 * <p/>
 * <p/>
 * Style 1: The following method element refers to all the methods of the EmployeeService bean's home and remote
 * interfaces:
 * <p/>
 * <p/>
 * <method>
 ...
 * </method>
 * <p/>
 * Style 3: The following method element refers to the create(String firstName, String LastName) method of the
 ...
 * <p/>
 * <p/>
 * The following example illustrates a Style 3 element with more complex parameter types. The method foobar(char s, int
 * i, int[] iar, mypackage.MyClass mycl, mypackage.MyClass[][] myclaar)
 * <p/>
 ...
 * <p/>
 * <p/>
 * The optional method-intf element can be used when it becomes necessary to differentiate between a method defined in
 * the home interface and a method with the same name and signature that is defined in the remote interface.
 * <p/>
 ...
 * <p/>
 * <p/>
 * can be used to differentiate the create(String, String) method defined in the remote interface from the
 * create(String, String) method defined in the home interface, which would be defined as
 * <p/>
 * <p/>
 * <method>
 * <p/>
...
@XmlType(name = "MethodElement", propOrder = { "enterpriseBeans", "descriptions", "extensions" })
public class MethodElement {
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link EnterpriseBean }
     */
