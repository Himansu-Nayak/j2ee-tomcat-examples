...
@XmlType(name = "applicationType", namespace = "http://geronimo.apache.org/xml/ns/j2ee/application-1.2", propOrder = {
        "environment", "module", "extModule", "security", "service" })
public class ApplicationType {
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link ExtModuleType }
     */
     ...
     *
     * @return possible object is {@link AbstractSecurityType }
     */
     ...
     *
     * @param value
     *            allowed object is {@link AbstractSecurityType }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link GbeanType }{@code >}
