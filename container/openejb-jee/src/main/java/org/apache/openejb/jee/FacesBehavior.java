 ...
 * <p/>
 * <p>
 * Java class for faces-config-behaviorType complex type.
 * <p/>
 * <p>
...
@XmlType(name = "faces-config-behaviorType", propOrder = { "descriptions", "displayNames", "icon", "behaviorId",
        "behaviorClass", "attribute", "property", "behaviorExtension" })
public class FacesBehavior {
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the behaviorExtension property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * 
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesBehaviorExtension }
     */
