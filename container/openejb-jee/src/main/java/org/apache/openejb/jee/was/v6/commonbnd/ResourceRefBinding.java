...
@XmlType(name = "ResourceRefBinding", propOrder = { "defaultAuths", "bindingResourceRefs", "properties", "extensions" })
public class ResourceRefBinding {
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link AbstractAuthData }
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the bindingResourceRefs property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * <p/>
