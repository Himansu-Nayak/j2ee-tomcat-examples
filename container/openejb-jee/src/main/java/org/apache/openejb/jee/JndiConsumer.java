...
/**
 * Interface for all components that have a java: jndi context or contribute to one such as the application. The get
 * <foo>Map methods return maps keyed by normalized jndi name, that is any old-style <foo> entry is normalized to
 * java:comp/env/<foo> to match entries that are explicitly defined in a comp, module, app, or global context. The Refs
 * themselves do not have normalized referenceNames.
 *
 * @version $Rev$ $Date$
 */
