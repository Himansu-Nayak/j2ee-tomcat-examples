 ...
 * <p/>
 * 1. The persistence-unit-metadata element contains metadata for the entire persistence unit. It is undefined if this
 * element occurs in multiple mapping files within the same persistence unit.
 * <p/>
 * 2. The package, schema, catalog and access elements apply to all of the entity, mapped-superclass and embeddable
 * elements defined in the same file in which they occur.
 * <p/>
 * 3. The sequence-generator, table-generator, named-query, named-native-query and sql-result-set-mapping elements are
 * global to the persistence unit. It is undefined to have more than one sequence-generator or table-generator of the
 * same name in the same or different mapping files in a persistence unit. It is also undefined to have more than one
 * named-query, named-native-query, or result-set-mapping of the same name in the same or different mapping files in a
 * persistence unit.
 * <p/>
 * 4. The entity, mapped-superclass and embeddable elements each define the mapping information for a managed persistent
 * class. The mapping information contained in these elements may be complete or it may be partial.
 * <p/>
 * <p/>
 * <p/>
 * <p>
...
@XmlType(name = "", propOrder = { "description", "persistenceUnitMetadata", "_package", "schema", "catalog", "access",
        "sequenceGenerator", "tableGenerator", "namedQuery", "namedNativeQuery", "sqlResultSetMapping",
        "mappedSuperclass", "entity", "embeddable" })
...
public class EntityMappings {
     ...
     *
     * @param value
     *            allowed object is {@link PersistenceUnitMetadata }
     */
     ...
     * the sequenceGenerator property.
     * <p/>
     * <p/>
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link SequenceGenerator }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link TableGenerator }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link NamedQuery }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link NamedNativeQuery }
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the sqlResultSetMapping property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * 
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link SqlResultSetMapping }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link MappedSuperclass }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link Embeddable }
     */
