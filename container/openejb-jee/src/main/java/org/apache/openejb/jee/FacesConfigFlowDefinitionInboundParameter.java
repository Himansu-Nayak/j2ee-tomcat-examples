 ...
 * A named parameter whose value will be populated with a correspondingly named parameter within an "outbound-parameter"
 * element.
 * <p>
 * <p/>
 * <p/>
...
@XmlType(name = "faces-config-flow-definition-inbound-parameterType", propOrder = { "name", "value" })
public class FacesConfigFlowDefinitionInboundParameter {
     ...
     *
     * @return possible object is {@link FacesConfigFlowDefinitionParameterValue }
     */
     ...
     *
     * @param value
     *            allowed object is {@link FacesConfigFlowDefinitionParameterValue }
     */
