...
@XmlType(name = "faces-config-attributeType", propOrder = { "descriptions", "displayNames", "icon", "attributeName",
        "attributeClass", "defaultValue", "suggestedValue", "attributeExtension" })
public class FacesAttribute {
     ...
     * the attributeExtension property.
     * <p/>
     * <p/>
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FacesAttributeExtension }
     */
