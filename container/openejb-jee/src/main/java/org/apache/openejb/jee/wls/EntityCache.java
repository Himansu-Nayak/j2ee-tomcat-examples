...
@XmlType(name = "entity-cache", propOrder = { "maxBeansInCache", "maxQueriesInCache", "idleTimeoutSeconds",
        "readTimeoutSeconds", "concurrencyStrategy", "cacheBetweenTransactions" })
