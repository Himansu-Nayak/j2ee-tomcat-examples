...
@XmlType(name = "environmentType", namespace = "http://geronimo.apache.org/xml/ns/deployment-1.2", propOrder = {
        "moduleId", "dependencies", "bundleActivator", "bundleClassPath", "importPackage", "exportPackage",
        "requireBundle", "dynamicImportPackage", "hiddenClasses", "nonOverridableClasses", "privateClasses",
        "inverseClassloading", "suppressDefaultEnvironment" })
...
public class EnvironmentType {
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the dynamicImportPackage property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * 
     ...
     *
     * @return possible object is {@link ClassFilterType }
     */
     ...
     *
     * @param value
     *            allowed object is {@link ClassFilterType }
     */
