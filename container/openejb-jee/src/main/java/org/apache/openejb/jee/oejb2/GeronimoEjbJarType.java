...
@XmlType(name = "geronimo-ejb-jarType", namespace = "http://geronimo.apache.org/xml/ns/j2ee/ejb/openejb-2.0", propOrder = {
        "environment", "clustering", "openejbJar", "abstractNamingEntry", "persistenceContextRef", "persistenceUnitRef",
        "ejbRef", "ejbLocalRef", "serviceRef", "resourceRef", "resourceEnvRef", "messageDestination", "tssLink",
...
public class GeronimoEjbJarType {
     ...
     *
     * @return possible object is {@link AbstractClusteringType }
     */
     ...
     *
     * @param value
     *            allowed object is {@link AbstractClusteringType }
     */
     ...
     * the jndiEnvironmentRefsGroup property.
     * <p/>
     * <p/>
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link ResourceEnvRefType }
     * {@code >} {@link JAXBElement }{@code <}{@link EjbRefType }{@code >} {@link JAXBElement }{@code <}
     * {@link org.apache.openejb.jee.oejb2.PersistenceUnitRefType }{@code >} {@link JAXBElement }{@code <}
     * {@link org.apache.openejb.jee.oejb2.GbeanRefType }{@code >} {@link JAXBElement }{@code <}{@link EjbLocalRefType }
     * {@code >} {@link JAXBElement }{@code <}{@link ResourceRefType }{@code >} {@link JAXBElement }{@code <}
     * {@link ServiceRefType }{@code >} {@link JAXBElement }{@code <}
     * {@link org.apache.openejb.jee.oejb2.PersistenceContextRefType }{@code >} {@link JAXBElement }{@code <}
     * {@link AbstractNamingEntryType }{@code >}
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the messageDestination property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * 
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link MessageDestinationType }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link AbstractServiceType
     * }{@code >} {@link JAXBElement }{@code <}{@link org.apache.openejb.jee.oejb2.GbeanType }{@code >}
     */
