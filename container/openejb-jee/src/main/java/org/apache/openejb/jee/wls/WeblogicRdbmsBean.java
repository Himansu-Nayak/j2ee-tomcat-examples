...
@XmlType(name = "weblogic-rdbms-bean", propOrder = { "ejbName", "dataSourceJndiName", "unknownPrimaryKeyField",
        "tableMap", "fieldGroup", "relationshipCaching", "sqlShape", "weblogicQuery", "delayDatabaseInsertUntil",
        "useSelectForUpdate", "lockOrder", "instanceLockOrder", "automaticKeyGeneration", "checkExistsOnMethod",
...
public class WeblogicRdbmsBean {
     ...
     *
     * @return possible object is {@link UnknownPrimaryKeyField }
     */
     ...
     *
     * @param value
     *            allowed object is {@link UnknownPrimaryKeyField }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link FieldGroup }
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the relationshipCaching property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * 
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link RelationshipCaching }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link SqlShape }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link WeblogicQuery }
     */
