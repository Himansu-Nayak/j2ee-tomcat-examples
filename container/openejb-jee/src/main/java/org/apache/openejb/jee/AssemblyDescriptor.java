...
@XmlType(name = "assembly-descriptorType", propOrder = { "securityRole", "methodPermission", "containerTransaction",
        //TODO moved out of assembly descriptor in schema
        "containerConcurrency", "interceptorBinding", "messageDestination", "excludeList", "applicationException" })
public class AssemblyDescriptor {
    ...
    private Map<String, List<MethodAttribute>> getMethodAttributes(final String ejbName,
            final List<? extends AttributeBinding> bindings) {
