...
@XmlType(name = "message-driven-descriptor", propOrder = { "pool", "timerDescriptor", "resourceAdapterJndiName",
        "destinationJndiName", "initialContextFactory", "providerUrl", "connectionFactoryJndiName",
        "destinationResourceLink", "connectionFactoryResourceLink", "jmsPollingIntervalSeconds", "jmsClientId",
        "generateUniqueJmsClientId", "durableSubscriptionDeletion", "maxMessagesInTransaction",
        "distributedDestinationConnection", "initSuspendSeconds", "maxSuspendSeconds", "securityPlugin" })
public class MessageDrivenDescriptor {
     ...
     *
     * @return possible object is {@link TimerDescriptor }
     */
     ...
     *
     * @param value
     *            allowed object is {@link TimerDescriptor }
     */
     ...
     *
     * @return possible object is {@link DistributedDestinationConnection }
     */
     ...
     *
     * @param value
     *            allowed object is {@link DistributedDestinationConnection }
     */
     ...
     *
     * @return possible object is {@link SecurityPlugin }
     */
     ...
     *
     * @param value
     *            allowed object is {@link SecurityPlugin }
     */
