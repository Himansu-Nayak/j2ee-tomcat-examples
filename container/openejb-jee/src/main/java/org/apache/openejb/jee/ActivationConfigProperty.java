...
@XmlType(name = "activation-config-propertyType", propOrder = { "activationConfigPropertyName",
...
public class ActivationConfigProperty {
    ...
    public ActivationConfigProperty(final String activationConfigPropertyName,
