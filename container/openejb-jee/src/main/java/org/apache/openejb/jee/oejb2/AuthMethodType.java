...
/**
 * <p>
 * Java class for auth-methodType.
 * <p/>
 * <p>
...
public enum AuthMethodType {
    ...
    BASIC("BASIC"), DIGEST("DIGEST"), @XmlEnumValue("CLIENT-CERT") CLIENT_CERT(
            "CLIENT-CERT"), @XmlEnumValue("WS-SECURITY") WS_SECURITY("WS-SECURITY"), NONE("NONE");
