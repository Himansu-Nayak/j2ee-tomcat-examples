...
/**
 * The messagelistenerType specifies information about a specific message listener supported by the messaging resource
 * adapter. It contains information on the Java type of the message listener interface and an activation specification.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "messagelistenerType", propOrder = { "messageListenerType", "activationSpec" })
