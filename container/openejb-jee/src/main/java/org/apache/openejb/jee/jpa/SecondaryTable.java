...
/**
 * @Target({TYPE}) @Retention(RUNTIME) public @interface SecondaryTable { String name(); String catalog() default "";
 *                 String schema() default ""; PrimaryKeyJoinColumn[] pkJoinColumns() default {}; UniqueConstraint[]
...
public class SecondaryTable {
     ...
     * the primaryKeyJoinColumn property.
     * <p/>
     * <p/>
