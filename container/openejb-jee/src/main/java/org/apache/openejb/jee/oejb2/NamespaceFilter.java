...
public class NamespaceFilter extends XMLFilterImpl {
    ...
    static {
        ...
        duplicates.put("name", Arrays.asList("http://geronimo.apache.org/xml/ns/deployment-1.2",
                "http://geronimo.apache.org/xml/ns/naming-1.2", "http://geronimo.apache.org/xml/ns/security-2.0"));
        ...
        duplicates.put("version", Arrays.asList("http://geronimo.apache.org/xml/ns/deployment-1.2",
                "http://geronimo.apache.org/xml/ns/naming-1.2"));
        duplicates.put("table-name", Arrays.asList("http://tomee.apache.org/xml/ns/openejb-jar-2.2",
                "http://tomee.apache.org/xml/ns/pkgen-2.1"));
    }
    ...
    public void startElement(String uri, final String localName, final String qname, final Attributes atts)
            throws SAXException {
        ...
        final boolean correctable = (uri.equals("http://tomee.apache.org/xml/ns/openejb-jar-2.2")
