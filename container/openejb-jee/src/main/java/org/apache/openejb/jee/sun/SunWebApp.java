...
@XmlType(name = "", propOrder = { "contextRoot", "securityRoleMapping", "servlet", "idempotentUrlPattern",
        "sessionConfig", "ejbRef", "resourceRef", "resourceEnvRef", "serviceRef", "messageDestinationRef", "cache",
        "classLoader", "jspConfig", "localeCharsetInfo", "parameterEncoding", "property", "messageDestination",
