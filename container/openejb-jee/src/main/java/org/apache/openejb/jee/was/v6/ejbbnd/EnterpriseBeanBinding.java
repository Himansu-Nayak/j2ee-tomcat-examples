...
@XmlType(name = "EnterpriseBeanBinding", propOrder = { "enterpriseBeans", "datasources", "resRefBindings",
        "ejbRefBindings", "resourceEnvRefBindings", "cmpConnectionFactories", "serviceRefBindings",
        "messageDestinationRefBindings", "extensions" })
public class EnterpriseBeanBinding {
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link ResourceRefBinding }
     */
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link EjbRefBinding }
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the resourceEnvRefBindings property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * <p/>
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link ResourceEnvRefBinding }
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the cmpConnectionFactories property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * <p/>
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link CMPConnectionFactoryBinding }
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the serviceRefBindings property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * <p/>
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link ServiceRefBinding }
     */
     ...
     * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to
     * the returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for
     * the messageDestinationRefBindings property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * <p/>
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link MessageDestinationRefBinding }
     */
