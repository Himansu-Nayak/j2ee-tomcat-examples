...
/**
 * Designates the source of a role that participates in a relationship. A relationship-role-source element uniquely
 * identifies an entity bean. @invariant The content of each role-source element shall refer to an existing entity bean,
 * entity bean reference.
 * <p/>
 * <p/>
 * <p/>
...
@XmlType(name = "RoleSource", propOrder = { "entityBeans", "descriptions", "extensions" })
public class RoleSource {
     ...
     * <p/>
     * <p/>
     * Objects of the following type(s) are allowed in the list {@link ContainerManagedEntity }
     */
