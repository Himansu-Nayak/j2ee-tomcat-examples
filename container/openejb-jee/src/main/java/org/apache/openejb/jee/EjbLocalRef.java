...
@XmlType(name = "ejb-local-refType", propOrder = { "descriptions", "ejbRefName", "ejbRefType", "localHome", "local",
        "ejbLink", "mappedName", "injectionTarget", "lookupName" })
public class EjbLocalRef implements EjbReference {
     ...
     * Component's environment and is relative to the java:comp/env context. The name must be unique within the
    ...
    /**
     * The value of the ejb-link element must be the ejb-name of an enterprise bean in the same ejb-jar file or in
     * another ejb-jar file in the same Java EE application unit.
     * <p/>
     * Alternatively, the name in the ejb-link element may be composed of a path name specifying the ejb-jar containing
     * the referenced enterprise bean with the ejb-name of the target bean appended and separated from the path name by
     * "#". The path name is relative to the Deployment File containing Deployment Component that is referencing the
     * enterprise bean. This allows multiple enterprise beans with the same ejb-name to be uniquely identified.
     * <p/>
     * Examples:
     * <p/>
    ...
    public String toString() {
        return "EjbLocalRef{" + "name='" + ejbRefName + '\'' + ", local=" + local + ", link='" + ejbLink + '\''
                + ", mappedName='" + mappedName + '\'' + ", lookupName='" + lookupName + '\'' + '}';
    }
}
