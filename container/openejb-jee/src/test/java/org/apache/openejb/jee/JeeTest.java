...
public class JeeTest extends TestCase {
    ...
    public static <T> T marshalAndUnmarshal(final Class<T> type, final String sourceXmlFile,
    ...
    public void testEjbJar() throws Exception {
        ...
        final SAXSource source = new SAXSource(xmlFilter,
                new InputSource(new ByteArrayInputStream(expected.getBytes())));
    ...
    public void testEjbJarMdb20() throws Exception {
        ...
        /*
         * <message-selector>mySelector</message-selector> <acknowledge-mode>Auto-acknowledge</acknowledge-mode>
    ...
    public void testRar10() throws Exception {
        ...
        final String expected;
        final InputStream in2 = this.getClass().getClassLoader()
                .getResourceAsStream("connector-1.0-example-expected-1.6.xml");
        expected = readContent(in2);
    ...
    public void testWebServiceHandlers() throws Exception {
        final QName[] expectedServiceNames = { new QName("http://www.helloworld.org", "HelloService", "ns1"),
                new QName("http://www.bar.org", "HelloService", "bar"),
                new QName("http://www.bar1.org", "HelloService", "bar"),
                new QName(XMLConstants.NULL_NS_URI, "HelloService", "foo"), new QName(XMLConstants.NULL_NS_URI, "*"),
                null };
        final InputStream in = this.getClass().getClassLoader().getResourceAsStream("handler.xml");
        try {
            final HandlerChains handlerChains = (HandlerChains) JaxbJavaee.unmarshalHandlerChains(HandlerChains.class,
                    in);
            for (int index = 0; index < handlerChains.getHandlerChain().size(); index++) {
                ...
                if (expectedServiceName == null) {
                    ...
                    assertEquals("serviceNamePattern at index " + index + " mismatches", expectedServiceName,
                            serviceName);
                }
            }
