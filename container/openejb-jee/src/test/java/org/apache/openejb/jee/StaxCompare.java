            ...
            while ((eventA = nextInterestingEvent(a)) != null & (eventB = nextInterestingEvent(b)) != null) {
                ...
                if (eventType == XMLStreamConstants.START_ELEMENT) {
                    ...
                    if (!startA.getName().getLocalPart().equals(startB.getName().getLocalPart())) {
                        message.append("Different elements ").append(startA.getName()).append(", ")
                                .append(startB.getName()).append(" at location ").append(eventA.getLocation());
                        return false;
                    }
                    ...
                    if (!endA.getName().getLocalPart().equals(endB.getName().getLocalPart())) {
                        message.append("Different elements ").append(endA.getName()).append(", ").append(endB.getName())
                                .append(" at location ").append(eventA.getLocation());
                        return false;
                    }
                    ...
                    if (!endA.getData().equals(endB.getData())) {
                        message.append("Different content ").append(endA.getData()).append(", ").append(endB.getData())
                                .append(" at location ").append(eventA.getLocation());
                        return false;
                    }
                }
    ...
    private static XMLEvent nextInterestingEvent(final XMLEventReader r) throws XMLStreamException {
        do {
            ...
            if (t == XMLStreamConstants.START_ELEMENT || t == XMLStreamConstants.END_ELEMENT
                    || t == XMLStreamConstants.ATTRIBUTE) {
                return e;
            }
        } while (r.hasNext());
        return null;
