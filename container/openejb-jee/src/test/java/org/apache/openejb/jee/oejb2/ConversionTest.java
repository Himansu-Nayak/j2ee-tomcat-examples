...
public class ConversionTest extends TestCase {
    ...
    public void testConversion() throws Exception {
        final JAXBElement element = (JAXBElement) JaxbOpenejbJar2.unmarshal(OpenejbJarType.class,
                getInputStream("openejb-jar-2-full.xml"));
        ...
        final JAXBElement root = new JAXBElement(
                new QName("http://geronimo.apache.org/xml/ns/j2ee/ejb/openejb-2.0", "ejb-jar"),
    ...
    private <T> void unmarshalAndMarshal(final Class<T> type, final java.lang.String xmlFileName,
            final java.lang.String expectedFile) throws Exception {
