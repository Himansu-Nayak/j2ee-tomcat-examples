...
/**
 * This class aims to be the one and only static in the entire system A static, singleton, instance of this class can be
 * created with the {@link #init(Properties)} method
 * <p/>
 * It is assumed that only one singleton per classloader is possible in any given VM Thus loading this instance in a
 * classloader will mean there can only be one OpenEJB instance for that classloader and all children classloaders.
 *
...
public final class SystemInstance {
    ...
    static { // preload API to not fall into module hell on JVM >= 9
        ...
        if (j9hacks) {
            ...
            for (final String clazz : asList(
                    // JTA - rt.jar API
                    "javax.transaction.HeuristicCommitException", "javax.transaction.HeuristicMixedException",
                    "javax.transaction.HeuristicRollbackException", "javax.transaction.NotSupportedException",
                    "javax.transaction.RollbackException", "javax.transaction.Status",
                    "javax.transaction.Synchronization", "javax.transaction.SystemException",
                    "javax.transaction.Transaction", "javax.transaction.Transactional",
                    "javax.transaction.TransactionalException", "javax.transaction.TransactionManager",
                    "javax.transaction.TransactionScoped", "javax.transaction.TransactionSynchronizationRegistry",
                    "javax.transaction.UserTransaction",
                    // javax.annotation - rt.jar
                    "javax.annotation.security.DeclareRoles", "javax.annotation.security.DenyAll",
                    "javax.annotation.security.PermitAll", "javax.annotation.security.RolesAllowed",
                    "javax.annotation.security.RunAs", "javax.annotation.sql.DataSourceDefinition",
                    "javax.annotation.sql.DataSourceDefinitions", "javax.annotation.ManagedBean",
    ...
    private SystemInstance(final Properties properties) {
        ...
        this.classPath = ClassPathFactory
                .createClassPath(this.internalProperties.getProperty("openejb.loader", "context"));
     ...
     * @param value
     *            property value
     * @param isExternalProperty
     *            should the property be set to System by {@link System#setProperty(String, String)}
    ...
    /**
     * I'm not sure how this will play out, but I've used class instances instead of strings for lookups as class
     * instances are classloader scoped and there is an implicit "namespace" associated with that. Theoretically, you
     * can't lookup things that you can't already see in your classloader.
     *
     * @param type
     *            Class
        ...
        if (classname != null) {
            try {
                final T instance = type
                        .cast(Thread.currentThread().getContextClassLoader().loadClass(classname).newInstance());
