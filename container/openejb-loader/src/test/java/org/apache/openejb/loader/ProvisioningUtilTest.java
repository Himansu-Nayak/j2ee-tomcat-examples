...
public class ProvisioningUtilTest {
    ...
    public void mvnUrl() throws MalformedURLException {
        ...
        assertEquals(
                "https://repository.apache.org/snapshots/org/apache/tomee/apache-tomee/x.y.z-SNAPSHOT/apache-tomee-x.y.z-SNAPSHOT.jar",
                url);
    }
    ...
    @Test
    public void http() {
        final Set<String> urls = ProvisioningUtil.realLocation(
                "http://repo1.maven.org/maven2/org/apache/batchee/batchee-test/0.2-incubating/batchee-test-0.2-incubating.jar");
        assertEquals(1, urls.size());
