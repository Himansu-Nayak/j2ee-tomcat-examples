...
public class ObserverFeaturesTest {
    ...
    @Test
    @Assert({ "number.Integer", "afterObject.AfterEvent<ObserverFailed{number}>",
            "afterObject.AfterEvent<ObserverFailed{afterObject}>", "afterObject.AfterEvent<Integer>", })
    ...
    @Test
    @Assert({ "number.Integer", "afterObject.AfterEvent<Integer>", "failed.ObserverFailed{afterObject}",
