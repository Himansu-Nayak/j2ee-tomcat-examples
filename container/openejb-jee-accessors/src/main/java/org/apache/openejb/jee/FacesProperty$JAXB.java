...
public class FacesProperty$JAXB extends JAXBObject<FacesProperty> {

    public FacesProperty$JAXB() {
        super(FacesProperty.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-propertyType".intern()),
                Text$JAXB.class, Icon$JAXB.class, FacesPropertyExtension$JAXB.class);
    }
    ...
    public static void writeFacesProperty(final XoXMLStreamWriter writer, final FacesProperty facesProperty,
            final RuntimeContext context) throws Exception {
        _write(writer, facesProperty, context);
    }

    public final static FacesProperty _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-propertyType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("property-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "property-extension"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesProperty facesProperty,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesProperty, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesProperty, "propertyName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(facesProperty, "propertyClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(facesProperty, "defaultValue", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(facesProperty, "suggestedValue", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final FacesProperty read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
