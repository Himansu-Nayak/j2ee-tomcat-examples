...
public class ConcurrentMethod$JAXB extends JAXBObject<ConcurrentMethod> {

    public ConcurrentMethod$JAXB() {
        super(ConcurrentMethod.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "concurrent-methodType".intern()),
                NamedMethod$JAXB.class, ConcurrentLockType$JAXB.class, Timeout$JAXB.class);
    }
    ...
    public static void writeConcurrentMethod(final XoXMLStreamWriter writer, final ConcurrentMethod concurrentMethod,
    ...
    public final static ConcurrentMethod _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("concurrent-methodType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("method" == elementReader.getLocalName())
            ...
            } else if (("lock" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: lock
                final ConcurrentLockType lock = parseConcurrentLockType(elementReader, context,
                        elementReader.getElementAsString());
                if (lock != null) {
                    concurrentMethod.lock = lock;
                }
            } else if (("access-timeout" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "method"),
                        new QName("http://java.sun.com/xml/ns/javaee", "lock"),
                        new QName("http://java.sun.com/xml/ns/javaee", "access-timeout"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ConcurrentMethod concurrentMethod,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(concurrentMethod, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final ConcurrentMethod concurrentMethod,
            final RuntimeContext context) throws Exception {
        _write(writer, concurrentMethod, context);
    }

    public final ConcurrentMethod read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
