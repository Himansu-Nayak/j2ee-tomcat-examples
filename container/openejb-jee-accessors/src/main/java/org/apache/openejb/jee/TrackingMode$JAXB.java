...
public class TrackingMode$JAXB extends JAXBEnum<TrackingMode> {
    ...
    public TrackingMode$JAXB() {
        super(TrackingMode.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "tracking-modeType".intern()));
    }

    public static TrackingMode parseTrackingMode(final XoXMLStreamReader reader, final RuntimeContext context,
    ...
    public static String toStringTrackingMode(final Object bean, final String parameterName,
            final RuntimeContext context, final TrackingMode trackingMode) throws Exception {
        if (TrackingMode.COOKIE == trackingMode) {
            ...
            context.unexpectedEnumConst(bean, parameterName, trackingMode, TrackingMode.COOKIE, TrackingMode.URL,
                    TrackingMode.SSL);
            return null;
        }
    }
    ...
    public String toString(final Object bean, final String parameterName, final RuntimeContext context,
            final TrackingMode trackingMode) throws Exception {
