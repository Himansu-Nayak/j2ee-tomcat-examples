...
public class FacesClientBehaviorRenderer$JAXB extends JAXBObject<FacesClientBehaviorRenderer> {

    public FacesClientBehaviorRenderer$JAXB() {
        super(FacesClientBehaviorRenderer.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "faces-config-client-behavior-rendererType".intern()));
    }

    public static FacesClientBehaviorRenderer readFacesClientBehaviorRenderer(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesClientBehaviorRenderer(final XoXMLStreamWriter writer,
            final FacesClientBehaviorRenderer facesClientBehaviorRenderer, final RuntimeContext context)
                    throws Exception {
    ...
    public final static FacesClientBehaviorRenderer _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-client-behavior-rendererType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("client-behavior-renderer-type" == elementReader.getLocalName())
                ...
                try {
                    clientBehaviorRendererType = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(clientBehaviorRendererTypeRaw);
            ...
            } else if (("client-behavior-renderer-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    clientBehaviorRendererClass = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(clientBehaviorRendererClassRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "client-behavior-renderer-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "client-behavior-renderer-class"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final FacesClientBehaviorRenderer facesClientBehaviorRenderer, RuntimeContext context) throws Exception {
        ...
        try {
            ...
            context.xmlAdapterError(facesClientBehaviorRenderer, "clientBehaviorRendererType",
        ...
        try {
            clientBehaviorRendererClass = Adapters.collapsedStringAdapterAdapter
                    .marshal(clientBehaviorRendererClassRaw);
        } catch (final Exception e) {
            context.xmlAdapterError(facesClientBehaviorRenderer, "clientBehaviorRendererClass",
                    CollapsedStringAdapter.class, String.class, String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesClientBehaviorRenderer facesClientBehaviorRenderer,
            final RuntimeContext context) throws Exception {
        _write(writer, facesClientBehaviorRenderer, context);
    }
