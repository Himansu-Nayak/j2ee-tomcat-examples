...
public class ParamValue$JAXB extends JAXBObject<ParamValue> {

    public ParamValue$JAXB() {
        super(ParamValue.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "param-valueType".intern()), Text$JAXB.class);
    }
    ...
    public static void writeParamValue(final XoXMLStreamWriter writer, final ParamValue paramValue,
            final RuntimeContext context) throws Exception {
        _write(writer, paramValue, context);
    }

    public final static ParamValue _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("param-valueType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("param-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: paramName
            ...
            } else if (("param-value" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: paramValue
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "param-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "param-value"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ParamValue paramValue, RuntimeContext context)
        ...
        try {
            ...
            context.xmlAdapterError(paramValue, "paramName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (paramName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(paramValue, "paramValue", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (paramValue1 != null) {
    ...
    public final ParamValue read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
