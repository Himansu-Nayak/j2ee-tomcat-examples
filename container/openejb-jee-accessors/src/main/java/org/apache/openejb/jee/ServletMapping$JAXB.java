...
public class ServletMapping$JAXB extends JAXBObject<ServletMapping> {

    public ServletMapping$JAXB() {
        super(ServletMapping.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "servlet-mappingType".intern()));
    }
    ...
    public static void writeServletMapping(final XoXMLStreamWriter writer, final ServletMapping servletMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, servletMapping, context);
    }

    public final static ServletMapping _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("servlet-mappingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("servlet-name" == elementReader.getLocalName())
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "servlet-name"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ServletMapping servletMapping,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(servletMapping, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(servletMapping, "servletName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (servletName != null) {
        ...
        if (urlPatternRaw != null) {
            for (final String urlPatternItem : urlPatternRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(servletMapping, "urlPattern", TrimStringAdapter.class, List.class,
                            List.class, e);
                }
                if (urlPattern != null) {
    ...
    public final ServletMapping read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
