...
public class FacesManagedBean$JAXB extends JAXBObject<FacesManagedBean> {

    public FacesManagedBean$JAXB() {
        super(FacesManagedBean.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-managed-beanType".intern()),
                Text$JAXB.class, Icon$JAXB.class, FacesManagedProperty$JAXB.class, FacesMapEntries$JAXB.class,
                FacesListEntries$JAXB.class, FacesManagedBeanExtension$JAXB.class);
    }
    ...
    public static void writeFacesManagedBean(final XoXMLStreamWriter writer, final FacesManagedBean facesManagedBean,
    ...
    public final static FacesManagedBean _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-managed-beanType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("managed-bean-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("managed-bean-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("managed-bean-scope" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("managed-property" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "managed-bean-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "managed-bean-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "managed-bean-scope"),
                        new QName("http://java.sun.com/xml/ns/javaee", "managed-property"),
                        new QName("http://java.sun.com/xml/ns/javaee", "map-entries"),
                        new QName("http://java.sun.com/xml/ns/javaee", "list-entries"),
                        new QName("http://java.sun.com/xml/ns/javaee", "managed-bean-extension"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesManagedBean facesManagedBean,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesManagedBean, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesManagedBean, "managedBeanName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(facesManagedBean, "managedBeanClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(facesManagedBean, "managedBeanScope", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesManagedBean facesManagedBean,
            final RuntimeContext context) throws Exception {
        _write(writer, facesManagedBean, context);
    }

    public final FacesManagedBean read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
