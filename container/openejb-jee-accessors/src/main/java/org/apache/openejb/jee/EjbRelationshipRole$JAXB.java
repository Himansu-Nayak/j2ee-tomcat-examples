...
public class EjbRelationshipRole$JAXB extends JAXBObject<EjbRelationshipRole> {

    public EjbRelationshipRole$JAXB() {
        super(EjbRelationshipRole.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "ejb-relationship-roleType".intern()),
                Text$JAXB.class, Multiplicity$JAXB.class, Empty$JAXB.class, RelationshipRoleSource$JAXB.class,
                CmrField$JAXB.class);
    }

    public static EjbRelationshipRole readEjbRelationshipRole(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeEjbRelationshipRole(final XoXMLStreamWriter writer,
            final EjbRelationshipRole ejbRelationshipRole, final RuntimeContext context) throws Exception {
    ...
    public final static EjbRelationshipRole _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("ejb-relationship-roleType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("ejb-relationship-role-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    ejbRelationshipRoleName = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(ejbRelationshipRoleNameRaw);
            ...
            } else if (("multiplicity" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: multiplicity
                final Multiplicity multiplicity = parseMultiplicity(elementReader, context,
                        elementReader.getElementAsString());
                if (multiplicity != null) {
                    ejbRelationshipRole.multiplicity = multiplicity;
                }
            } else if (("cascade-delete" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("relationship-role-source" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: relationshipRoleSource
                final RelationshipRoleSource relationshipRoleSource = readRelationshipRoleSource(elementReader,
                        context);
                ejbRelationshipRole.relationshipRoleSource = relationshipRoleSource;
            } else if (("cmr-field" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: cmrField
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "ejb-relationship-role-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "multiplicity"),
                        new QName("http://java.sun.com/xml/ns/javaee", "cascade-delete"),
                        new QName("http://java.sun.com/xml/ns/javaee", "relationship-role-source"),
                        new QName("http://java.sun.com/xml/ns/javaee", "cmr-field"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final EjbRelationshipRole ejbRelationshipRole,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(ejbRelationshipRole, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(ejbRelationshipRole, "ejbRelationshipRoleName", CollapsedStringAdapter.class,
    ...
    public void write(final XoXMLStreamWriter writer, final EjbRelationshipRole ejbRelationshipRole,
            final RuntimeContext context) throws Exception {
        _write(writer, ejbRelationshipRole, context);
    }
