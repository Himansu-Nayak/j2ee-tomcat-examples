...
public class Empty$JAXB extends JAXBObject<Empty> {

    public Empty$JAXB() {
        super(Empty.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "emptyType".intern()));
    }

    public static Empty readEmpty(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static Empty _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("emptyType" != xsiType.getLocalPart())
    ...
    public final Empty read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
