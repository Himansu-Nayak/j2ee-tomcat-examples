...
public class FacesELExpression$JAXB extends JAXBObject<FacesELExpression> {

    public FacesELExpression$JAXB() {
        super(FacesELExpression.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-el-expressionType".intern()));
    }
    ...
    public static void writeFacesELExpression(final XoXMLStreamWriter writer, final FacesELExpression facesELExpression,
    ...
    public final static FacesELExpression _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-el-expressionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesELExpression facesELExpression,
        ...
        try {
            ...
            context.xmlAdapterError(facesELExpression, "value", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesELExpression facesELExpression,
            final RuntimeContext context) throws Exception {
        _write(writer, facesELExpression, context);
    }

    public final FacesELExpression read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
