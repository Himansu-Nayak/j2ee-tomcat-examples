...
public class RequiredConfigProperty$JAXB extends JAXBObject<RequiredConfigProperty> {

    public RequiredConfigProperty$JAXB() {
        super(RequiredConfigProperty.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "required-config-propertyType".intern()),
                Text$JAXB.class);
    }

    public static RequiredConfigProperty readRequiredConfigProperty(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeRequiredConfigProperty(final XoXMLStreamWriter writer,
            final RequiredConfigProperty requiredConfigProperty, final RuntimeContext context) throws Exception {
    ...
    public final static RequiredConfigProperty _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("required-config-propertyType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final RequiredConfigProperty requiredConfigProperty,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(requiredConfigProperty, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.getterError(requiredConfigProperty, "descriptions", RequiredConfigProperty.class, "getDescriptions",
                    e);
        }
        if (descriptions != null) {
        ...
        try {
            ...
            context.xmlAdapterError(requiredConfigProperty, "configPropertyName", CollapsedStringAdapter.class,
    ...
    public void write(final XoXMLStreamWriter writer, final RequiredConfigProperty requiredConfigProperty,
            final RuntimeContext context) throws Exception {
        _write(writer, requiredConfigProperty, context);
    }
