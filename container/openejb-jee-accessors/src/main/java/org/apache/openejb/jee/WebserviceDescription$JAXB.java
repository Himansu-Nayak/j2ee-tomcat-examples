...
public class WebserviceDescription$JAXB extends JAXBObject<WebserviceDescription> {

    public WebserviceDescription$JAXB() {
        super(WebserviceDescription.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "webservice-descriptionType".intern()),
                Icon$JAXB.class, PortComponent$JAXB.class);
    }

    public static WebserviceDescription readWebserviceDescription(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeWebserviceDescription(final XoXMLStreamWriter writer,
            final WebserviceDescription webserviceDescription, final RuntimeContext context) throws Exception {
    ...
    public final static WebserviceDescription _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("webservice-descriptionType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("webservice-description-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    webserviceDescriptionName = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(webserviceDescriptionNameRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
            ...
            } else if (("port-component" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "webservice-description-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "wsdl-file"),
                        new QName("http://java.sun.com/xml/ns/javaee", "jaxrpc-mapping-file"),
                        new QName("http://java.sun.com/xml/ns/javaee", "port-component"));
            }
        }
        if (portComponent != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final WebserviceDescription webserviceDescription,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(webserviceDescription, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(webserviceDescription, "description", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (description != null) {
        ...
        try {
            ...
            context.xmlAdapterError(webserviceDescription, "displayName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (displayName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(webserviceDescription, "webserviceDescriptionName", CollapsedStringAdapter.class,
        ...
        try {
            ...
            context.xmlAdapterError(webserviceDescription, "wsdlFile", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (wsdlFile != null) {
        ...
        try {
            ...
            context.xmlAdapterError(webserviceDescription, "jaxrpcMappingFile", CollapsedStringAdapter.class,
                    String.class, String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final WebserviceDescription webserviceDescription,
            final RuntimeContext context) throws Exception {
        _write(writer, webserviceDescription, context);
    }
