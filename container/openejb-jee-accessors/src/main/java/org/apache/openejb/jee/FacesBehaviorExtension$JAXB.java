...
public class FacesBehaviorExtension$JAXB extends JAXBObject<FacesBehaviorExtension> {

    public FacesBehaviorExtension$JAXB() {
        super(FacesBehaviorExtension.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "faces-config-behavior-extensionType".intern()));
    }

    public static FacesBehaviorExtension readFacesBehaviorExtension(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesBehaviorExtension(final XoXMLStreamWriter writer,
            final FacesBehaviorExtension facesBehaviorExtension, final RuntimeContext context) throws Exception {
    ...
    public final static FacesBehaviorExtension _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-behavior-extensionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesBehaviorExtension facesBehaviorExtension,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesBehaviorExtension, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesBehaviorExtension facesBehaviorExtension,
            final RuntimeContext context) throws Exception {
        _write(writer, facesBehaviorExtension, context);
    }
