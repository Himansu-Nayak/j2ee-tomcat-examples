...
public class FilterMapping$JAXB extends JAXBObject<FilterMapping> {

    public FilterMapping$JAXB() {
        super(FilterMapping.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "filter-mappingType".intern()),
                Dispatcher$JAXB.class);
    }
    ...
    public static void writeFilterMapping(final XoXMLStreamWriter writer, final FilterMapping filterMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, filterMapping, context);
    }

    public final static FilterMapping _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("filter-mappingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("filter-name" == elementReader.getLocalName())
            ...
            } else if (("dispatcher" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: dispatcher
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "filter-name"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FilterMapping filterMapping,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(filterMapping, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(filterMapping, "filterName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (filterName != null) {
        ...
        if (urlPatternRaw != null) {
            for (final String urlPatternItem : urlPatternRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(filterMapping, "urlPattern", TrimStringAdapter.class, List.class,
                            List.class, e);
                }
                if (urlPattern != null) {
        ...
        if (servletNameRaw != null) {
            for (final String servletNameItem : servletNameRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(filterMapping, "servletName", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (servletName != null) {
    ...
    public final FilterMapping read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
