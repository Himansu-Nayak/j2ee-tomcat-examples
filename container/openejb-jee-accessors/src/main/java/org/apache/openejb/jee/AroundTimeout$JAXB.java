...
public class AroundTimeout$JAXB extends JAXBObject<AroundTimeout> {

    public AroundTimeout$JAXB() {
        super(AroundTimeout.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "around-timeoutType".intern()));
    }
    ...
    public static void writeAroundTimeout(final XoXMLStreamWriter writer, final AroundTimeout aroundTimeout,
            final RuntimeContext context) throws Exception {
        _write(writer, aroundTimeout, context);
    }

    public final static AroundTimeout _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("around-timeoutType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("class" == elementReader.getLocalName())
            ...
            } else if (("method-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: methodName
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "method-name"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final AroundTimeout aroundTimeout,
        ...
        try {
            ...
            context.xmlAdapterError(aroundTimeout, "clazz", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (clazz != null) {
        ...
        try {
            ...
            context.xmlAdapterError(aroundTimeout, "methodName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (methodName != null) {
    ...
    public final AroundTimeout read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
