...
public class SessionType$JAXB extends JAXBEnum<SessionType> {

    public SessionType$JAXB() {
        super(SessionType.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "sessionType".intern()));
    }

    public static SessionType parseSessionType(final XoXMLStreamReader reader, final RuntimeContext context,
        ...
        if ("Stateful".equals(value)) {
            ...
            context.unexpectedEnumValue(reader, SessionType.class, value, "Stateful", "Stateless", "Singleton",
                    "Managed");
            return null;
        }
    }

    public static String toStringSessionType(final Object bean, final String parameterName,
            final RuntimeContext context, final SessionType sessionType) throws Exception {
        if (SessionType.STATEFUL == sessionType) {
            ...
            context.unexpectedEnumConst(bean, parameterName, sessionType, SessionType.STATEFUL, SessionType.STATELESS,
                    SessionType.SINGLETON, SessionType.MANAGED);
            return null;
        }
    }
    ...
    public String toString(final Object bean, final String parameterName, final RuntimeContext context,
            final SessionType sessionType) throws Exception {
