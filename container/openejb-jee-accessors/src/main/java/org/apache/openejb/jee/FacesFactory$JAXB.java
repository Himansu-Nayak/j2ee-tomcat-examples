...
public class FacesFactory$JAXB extends JAXBObject<FacesFactory> {

    public FacesFactory$JAXB() {
        super(FacesFactory.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-factoryType".intern()),
                FacesFactoryExtension$JAXB.class);
    }
    ...
    public static void writeFacesFactory(final XoXMLStreamWriter writer, final FacesFactory facesFactory,
            final RuntimeContext context) throws Exception {
        _write(writer, facesFactory, context);
    }

    public final static FacesFactory _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-factoryType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("application-factory" == elementReader.getLocalName())
                ...
                try {
                    applicationFactoryItem = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(applicationFactoryItemRaw);
            ...
            } else if (("exception-handler-factory" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    exceptionHandlerFactoryItem = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(exceptionHandlerFactoryItemRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
            ...
            } else if (("external-context-factory" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    externalContextFactoryItem = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(externalContextFactoryItemRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
            ...
            } else if (("faces-context-factory" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    facesContextFactoryItem = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(facesContextFactoryItemRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
            ...
            } else if (("partial-view-context-factory" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    partialViewContextFactoryItem = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(partialViewContextFactoryItemRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
            ...
            } else if (("lifecycle-factory" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("view-declaration-language-factory" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    viewDeclarationLanguageFactoryItem = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(viewDeclarationLanguageFactoryItemRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
            ...
            } else if (("tag-handler-delegate-factory" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    tagHandlerDelegateFactoryItem = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(tagHandlerDelegateFactoryItemRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
            ...
            } else if (("render-kit-factory" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("visit-context-factory" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    visitContextFactoryItem = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(visitContextFactoryItemRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
            ...
            } else if (("factory-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesFactory facesFactory,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesFactory, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        if (applicationFactoryRaw != null) {
            for (final String applicationFactoryItem : applicationFactoryRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesFactory, "applicationFactory", CollapsedStringAdapter.class,
                            List.class, List.class, e);
                }
                if (applicationFactory != null) {
        ...
        if (exceptionHandlerFactoryRaw != null) {
            for (final String exceptionHandlerFactoryItem : exceptionHandlerFactoryRaw) {
                ...
                try {
                    exceptionHandlerFactory = Adapters.collapsedStringAdapterAdapter
                            .marshal(exceptionHandlerFactoryItem);
                } catch (final Exception e) {
                    context.xmlAdapterError(facesFactory, "exceptionHandlerFactory", CollapsedStringAdapter.class,
                            List.class, List.class, e);
                }
                if (exceptionHandlerFactory != null) {
        ...
        if (externalContextFactoryRaw != null) {
            for (final String externalContextFactoryItem : externalContextFactoryRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesFactory, "externalContextFactory", CollapsedStringAdapter.class,
                            List.class, List.class, e);
                }
                if (externalContextFactory != null) {
        ...
        if (facesContextFactoryRaw != null) {
            for (final String facesContextFactoryItem : facesContextFactoryRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesFactory, "facesContextFactory", CollapsedStringAdapter.class,
                            List.class, List.class, e);
                }
                if (facesContextFactory != null) {
        ...
        if (partialViewContextFactoryRaw != null) {
            for (final String partialViewContextFactoryItem : partialViewContextFactoryRaw) {
                ...
                try {
                    partialViewContextFactory = Adapters.collapsedStringAdapterAdapter
                            .marshal(partialViewContextFactoryItem);
                } catch (final Exception e) {
                    context.xmlAdapterError(facesFactory, "partialViewContextFactory", CollapsedStringAdapter.class,
                            List.class, List.class, e);
                }
                if (partialViewContextFactory != null) {
                    writer.writeStartElement(prefix, "partial-view-context-factory",
        ...
        if (lifecycleFactoryRaw != null) {
            for (final String lifecycleFactoryItem : lifecycleFactoryRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesFactory, "lifecycleFactory", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (lifecycleFactory != null) {
        ...
        if (viewDeclarationLanguageFactoryRaw != null) {
            for (final String viewDeclarationLanguageFactoryItem : viewDeclarationLanguageFactoryRaw) {
                ...
                try {
                    viewDeclarationLanguageFactory = Adapters.collapsedStringAdapterAdapter
                            .marshal(viewDeclarationLanguageFactoryItem);
                } catch (final Exception e) {
                    context.xmlAdapterError(facesFactory, "viewDeclarationLanguageFactory",
                            CollapsedStringAdapter.class, List.class, List.class, e);
                }
                if (viewDeclarationLanguageFactory != null) {
                    writer.writeStartElement(prefix, "view-declaration-language-factory",
                            "http://java.sun.com/xml/ns/javaee");
        ...
        if (tagHandlerDelegateFactoryRaw != null) {
            for (final String tagHandlerDelegateFactoryItem : tagHandlerDelegateFactoryRaw) {
                ...
                try {
                    tagHandlerDelegateFactory = Adapters.collapsedStringAdapterAdapter
                            .marshal(tagHandlerDelegateFactoryItem);
                } catch (final Exception e) {
                    context.xmlAdapterError(facesFactory, "tagHandlerDelegateFactory", CollapsedStringAdapter.class,
                            List.class, List.class, e);
                }
                if (tagHandlerDelegateFactory != null) {
                    writer.writeStartElement(prefix, "tag-handler-delegate-factory",
                            "http://java.sun.com/xml/ns/javaee");
        ...
        if (renderKitFactoryRaw != null) {
            for (final String renderKitFactoryItem : renderKitFactoryRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesFactory, "renderKitFactory", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (renderKitFactory != null) {
        ...
        if (visitContextFactoryRaw != null) {
            for (final String visitContextFactoryItem : visitContextFactoryRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesFactory, "visitContextFactory", CollapsedStringAdapter.class,
                            List.class, List.class, e);
                }
                if (visitContextFactory != null) {
    ...
    public final FacesFactory read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
