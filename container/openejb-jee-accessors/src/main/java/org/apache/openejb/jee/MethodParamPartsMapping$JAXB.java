...
public class MethodParamPartsMapping$JAXB extends JAXBObject<MethodParamPartsMapping> {

    public MethodParamPartsMapping$JAXB() {
        super(MethodParamPartsMapping.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "method-param-parts-mappingType".intern()),
                WsdlMessageMapping$JAXB.class);
    }

    public static MethodParamPartsMapping readMethodParamPartsMapping(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeMethodParamPartsMapping(final XoXMLStreamWriter writer,
            final MethodParamPartsMapping methodParamPartsMapping, final RuntimeContext context) throws Exception {
    ...
    public final static MethodParamPartsMapping _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("method-param-parts-mappingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("param-position" == elementReader.getLocalName())
            ...
            } else if (("param-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: paramType
            ...
            } else if (("wsdl-message-mapping" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "param-position"),
                        new QName("http://java.sun.com/xml/ns/javaee", "param-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "wsdl-message-mapping"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final MethodParamPartsMapping methodParamPartsMapping, RuntimeContext context) throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(methodParamPartsMapping, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(methodParamPartsMapping, "paramType", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (paramType != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final MethodParamPartsMapping methodParamPartsMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, methodParamPartsMapping, context);
    }
