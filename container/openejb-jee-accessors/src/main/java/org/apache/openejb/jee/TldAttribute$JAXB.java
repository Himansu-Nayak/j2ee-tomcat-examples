...
public class TldAttribute$JAXB extends JAXBObject<TldAttribute> {

    public TldAttribute$JAXB() {
        super(TldAttribute.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "tld-attributeType".intern()), Text$JAXB.class,
                TldDeferredValue$JAXB.class, TldDeferredMethod$JAXB.class);
    }
    ...
    public static void writeTldAttribute(final XoXMLStreamWriter writer, final TldAttribute tldAttribute,
            final RuntimeContext context) throws Exception {
        _write(writer, tldAttribute, context);
    }

    public final static TldAttribute _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("tld-attributeType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("required" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: required
            ...
            } else if (("rtexprvalue" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: rtexprvalue
            ...
            } else if (("type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: type
            ...
            } else if (("deferred-value" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("deferred-method" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("fragment" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: fragment
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "required"),
                        new QName("http://java.sun.com/xml/ns/javaee", "rtexprvalue"),
                        new QName("http://java.sun.com/xml/ns/javaee", "type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "deferred-value"),
                        new QName("http://java.sun.com/xml/ns/javaee", "deferred-method"),
                        new QName("http://java.sun.com/xml/ns/javaee", "fragment"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final TldAttribute tldAttribute,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(tldAttribute, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(tldAttribute, "required", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (required != null) {
        ...
        try {
            ...
            context.xmlAdapterError(tldAttribute, "rtexprvalue", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (rtexprvalue != null) {
        ...
        try {
            ...
            context.xmlAdapterError(tldAttribute, "fragment", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (fragment != null) {
    ...
    public final TldAttribute read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
