...
public class MultipartConfig$JAXB extends JAXBObject<MultipartConfig> {

    public MultipartConfig$JAXB() {
        super(MultipartConfig.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "multipart-configType".intern()));
    }
    ...
    public static void writeMultipartConfig(final XoXMLStreamWriter writer, final MultipartConfig multipartConfig,
            final RuntimeContext context) throws Exception {
        _write(writer, multipartConfig, context);
    }

    public final static MultipartConfig _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("multipart-configType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("location" == elementReader.getLocalName())
            ...
            } else if (("file-size-threshold" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "location"),
                        new QName("http://java.sun.com/xml/ns/javaee", "max-file-size"),
                        new QName("http://java.sun.com/xml/ns/javaee", "max-request-size"),
                        new QName("http://java.sun.com/xml/ns/javaee", "file-size-threshold"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final MultipartConfig multipartConfig,
        ...
        try {
            ...
            context.xmlAdapterError(multipartConfig, "location", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (location != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final MultipartConfig multipartConfig,
            final RuntimeContext context) throws Exception {
        _write(writer, multipartConfig, context);
    }

    public final MultipartConfig read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
