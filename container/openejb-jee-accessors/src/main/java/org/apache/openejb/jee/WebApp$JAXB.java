...
public class WebApp$JAXB extends JAXBObject<WebApp> {

    public WebApp$JAXB() {
        super(WebApp.class, new QName("http://java.sun.com/xml/ns/javaee".intern(), "web-app".intern()),
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "web-appType".intern()), Text$JAXB.class,
                Icon$JAXB.class, Empty$JAXB.class, ParamValue$JAXB.class, Filter$JAXB.class, FilterMapping$JAXB.class,
                Listener$JAXB.class, Servlet$JAXB.class, ServletMapping$JAXB.class, SessionConfig$JAXB.class,
                MimeMapping$JAXB.class, WelcomeFileList$JAXB.class, ErrorPage$JAXB.class, Taglib$JAXB.class,
                JspConfig$JAXB.class, SecurityConstraint$JAXB.class, LoginConfig$JAXB.class, SecurityRole$JAXB.class,
                LocaleEncodingMappingList$JAXB.class, EnvEntry$JAXB.class, EjbRef$JAXB.class, EjbLocalRef$JAXB.class,
                ...
                LifecycleCallback$JAXB.class, MessageDestination$JAXB.class, AbsoluteOrdering$JAXB.class,
                DataSource$JAXB.class);
    }

    public static WebApp readWebApp(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static WebApp _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("web-appType" != xsiType.getLocalPart())
        ...
        for (final Attribute attribute : reader.getAttributes()) {
            if (("id" == attribute.getLocalName())
                ...
                webApp.id = id;
            } else if (("metadata-complete" == attribute.getLocalName())
                    && (("" == attribute.getNamespace()) || (attribute.getNamespace() == null))) {
                // ATTRIBUTE: metadataComplete
                final Boolean metadataComplete = ("1".equals(attribute.getValue())
                ...
                context.unexpectedAttribute(attribute, new QName("", "id"), new QName("", "metadata-complete"),
                        new QName("", "version"));
            }
        }
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("distributable" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("context-param" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("filter" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: filter
            ...
            } else if (("filter-mapping" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("listener" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: listener
            ...
            } else if (("servlet" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: servlet
            ...
            } else if (("servlet-mapping" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("session-config" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("mime-mapping" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: mimeMapping
            ...
            } else if (("welcome-file-list" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("error-page" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: errorPage
            ...
            } else if (("taglib" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: taglib
            ...
            } else if (("jsp-config" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: jspConfig
            ...
            } else if (("security-constraint" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("login-config" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: loginConfig
            ...
            } else if (("locale-encoding-mapping-list" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: localeEncodingMappingList
                final LocaleEncodingMappingList localeEncodingMappingListItem = readLocaleEncodingMappingList(
            ...
            } else if (("absolute-ordering" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("jms-connection-factory" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: dataSource
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "distributable"),
                        new QName("http://java.sun.com/xml/ns/javaee", "context-param"),
                        new QName("http://java.sun.com/xml/ns/javaee", "filter"),
                        new QName("http://java.sun.com/xml/ns/javaee", "filter-mapping"),
                        new QName("http://java.sun.com/xml/ns/javaee", "listener"),
                        new QName("http://java.sun.com/xml/ns/javaee", "servlet"),
                        new QName("http://java.sun.com/xml/ns/javaee", "servlet-mapping"),
                        new QName("http://java.sun.com/xml/ns/javaee", "session-config"),
                        new QName("http://java.sun.com/xml/ns/javaee", "mime-mapping"),
                        new QName("http://java.sun.com/xml/ns/javaee", "welcome-file-list"),
                        new QName("http://java.sun.com/xml/ns/javaee", "error-page"),
                        new QName("http://java.sun.com/xml/ns/javaee", "taglib"),
                        new QName("http://java.sun.com/xml/ns/javaee", "jsp-config"),
                        new QName("http://java.sun.com/xml/ns/javaee", "security-constraint"),
                        new QName("http://java.sun.com/xml/ns/javaee", "login-config"),
                        new QName("http://java.sun.com/xml/ns/javaee", "security-role"),
                        new QName("http://java.sun.com/xml/ns/javaee", "locale-encoding-mapping-list"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "absolute-ordering"),
                        new QName("http://java.sun.com/xml/ns/javaee", "data-source"),
                        new QName("http://java.sun.com/xml/ns/javaee", "module-name"));
            }
        }
        if (descriptions != null) {
            try {
        ...
        if (localeEncodingMappingList != null) {
            for (final LocaleEncodingMappingList localeEncodingMappingListItem : localeEncodingMappingList) {
                if (localeEncodingMappingListItem != null) {
                    writer.writeStartElement(prefix, "locale-encoding-mapping-list",
    ...
    public final WebApp read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
