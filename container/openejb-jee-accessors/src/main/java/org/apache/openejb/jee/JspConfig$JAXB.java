...
public class JspConfig$JAXB extends JAXBObject<JspConfig> {

    public JspConfig$JAXB() {
        super(JspConfig.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "jsp-configType".intern()),
                Taglib$JAXB.class, JspPropertyGroup$JAXB.class);
    }
    ...
    public static void writeJspConfig(final XoXMLStreamWriter writer, final JspConfig jspConfig,
            final RuntimeContext context) throws Exception {
        _write(writer, jspConfig, context);
    }

    public final static JspConfig _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("jsp-configType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("taglib" == elementReader.getLocalName())
            ...
            } else if (("jsp-property-group" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "taglib"),
                        new QName("http://java.sun.com/xml/ns/javaee", "jsp-property-group"));
            }
        }
        if (taglib != null) {
    ...
    public final JspConfig read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
