...
public class SecurityIdentity$JAXB extends JAXBObject<SecurityIdentity> {

    public SecurityIdentity$JAXB() {
        super(SecurityIdentity.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "security-identityType".intern()),
                Text$JAXB.class, Empty$JAXB.class, RunAs$JAXB.class);
    }
    ...
    public static void writeSecurityIdentity(final XoXMLStreamWriter writer, final SecurityIdentity securityIdentity,
    ...
    public final static SecurityIdentity _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("security-identityType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("use-caller-identity" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "use-caller-identity"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final SecurityIdentity securityIdentity,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(securityIdentity, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final SecurityIdentity securityIdentity,
            final RuntimeContext context) throws Exception {
        _write(writer, securityIdentity, context);
    }

    public final SecurityIdentity read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
