...
public class VariableMapping$JAXB extends JAXBObject<VariableMapping> {

    public VariableMapping$JAXB() {
        super(VariableMapping.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "variable-mappingType".intern()));
    }
    ...
    public static void writeVariableMapping(final XoXMLStreamWriter writer, final VariableMapping variableMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, variableMapping, context);
    }

    public final static VariableMapping _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("variable-mappingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("java-variable-name" == elementReader.getLocalName())
            ...
            } else if (("data-member" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: dataMember
                final Element dataMember = elementReader.getElementAsDomElement();
                variableMapping.dataMember = dataMember;
            } else if (("xml-attribute-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("xml-element-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("xml-wildcard" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: xmlWildcard
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "java-variable-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "data-member"),
                        new QName("http://java.sun.com/xml/ns/javaee", "xml-attribute-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "xml-element-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "xml-wildcard"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final VariableMapping variableMapping,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(variableMapping, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(variableMapping, "javaVariableName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(variableMapping, "xmlAttributeName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(variableMapping, "xmlElementName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final VariableMapping variableMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, variableMapping, context);
    }

    public final VariableMapping read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
