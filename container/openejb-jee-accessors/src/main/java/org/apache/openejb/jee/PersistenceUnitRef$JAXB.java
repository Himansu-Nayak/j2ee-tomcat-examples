...
public class PersistenceUnitRef$JAXB extends JAXBObject<PersistenceUnitRef> {

    public PersistenceUnitRef$JAXB() {
        super(PersistenceUnitRef.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "persistence-unit-refType".intern()),
                Text$JAXB.class, InjectionTarget$JAXB.class);
    }

    public static PersistenceUnitRef readPersistenceUnitRef(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writePersistenceUnitRef(final XoXMLStreamWriter writer,
            final PersistenceUnitRef persistenceUnitRef, final RuntimeContext context) throws Exception {
    ...
    public final static PersistenceUnitRef _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("persistence-unit-refType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("persistence-unit-ref-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    persistenceUnitRefName = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(persistenceUnitRefNameRaw);
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "persistence-unit-ref-name"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final PersistenceUnitRef persistenceUnitRef,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(persistenceUnitRef, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(persistenceUnitRef, "persistenceUnitRefName", CollapsedStringAdapter.class,
        ...
        try {
            ...
            context.xmlAdapterError(persistenceUnitRef, "persistenceUnitName", CollapsedStringAdapter.class,
                    String.class, String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(persistenceUnitRef, "mappedName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (mappedName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(persistenceUnitRef, "lookupName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (lookupName != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final PersistenceUnitRef persistenceUnitRef,
            final RuntimeContext context) throws Exception {
        _write(writer, persistenceUnitRef, context);
    }
