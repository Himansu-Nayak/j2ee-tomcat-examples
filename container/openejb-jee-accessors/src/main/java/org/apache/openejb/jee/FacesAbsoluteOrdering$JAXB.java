...
public class FacesAbsoluteOrdering$JAXB extends JAXBObject<FacesAbsoluteOrdering> {

    public FacesAbsoluteOrdering$JAXB() {
        super(FacesAbsoluteOrdering.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-absoluteOrderingType".intern()),
                FacesOrderingOthers$JAXB.class);
    }

    public static FacesAbsoluteOrdering readFacesAbsoluteOrdering(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesAbsoluteOrdering(final XoXMLStreamWriter writer,
            final FacesAbsoluteOrdering facesAbsoluteOrdering, final RuntimeContext context) throws Exception {
    ...
    public final static FacesAbsoluteOrdering _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-absoluteOrderingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("others" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: nameOrOthers
                final org.apache.openejb.jee.FacesOrderingOthers nameOrOthersItem = readFacesOrderingOthers(
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesAbsoluteOrdering facesAbsoluteOrdering,
        ...
        if (nameOrOthers != null) {
            for (final Object nameOrOthersItem : nameOrOthers) {
                if (nameOrOthersItem instanceof java.lang.String) {
                    ...
                    context.unexpectedElementType(writer, facesAbsoluteOrdering, "nameOrOthers", nameOrOthersItem,
                            java.lang.String.class, org.apache.openejb.jee.FacesOrderingOthers.class);
                }
            }
        }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesAbsoluteOrdering facesAbsoluteOrdering,
            final RuntimeContext context) throws Exception {
        _write(writer, facesAbsoluteOrdering, context);
    }
