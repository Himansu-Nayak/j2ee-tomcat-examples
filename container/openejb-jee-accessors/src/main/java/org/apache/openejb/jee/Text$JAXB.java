...
public class Text$JAXB extends JAXBObject<Text> {

    public Text$JAXB() {
        super(Text.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "string".intern()));
    }

    public static Text readText(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static Text _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("string" != xsiType.getLocalPart())
    ...
    public void write(final XoXMLStreamWriter writer, final Text text, final RuntimeContext context) throws Exception {
        _write(writer, text, context);
    }

    public final Text read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
