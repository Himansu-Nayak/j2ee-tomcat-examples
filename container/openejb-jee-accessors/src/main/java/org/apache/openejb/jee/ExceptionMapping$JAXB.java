...
public class ExceptionMapping$JAXB extends JAXBObject<ExceptionMapping> {

    public ExceptionMapping$JAXB() {
        super(ExceptionMapping.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "exception-mappingType".intern()),
                ConstructorParameterOrder$JAXB.class);
    }
    ...
    public static void writeExceptionMapping(final XoXMLStreamWriter writer, final ExceptionMapping exceptionMapping,
    ...
    public final static ExceptionMapping _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("exception-mappingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("exception-type" == elementReader.getLocalName())
            ...
            } else if (("wsdl-message" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: wsdlMessage
                final QName wsdlMessage = elementReader.getElementAsQName();
                exceptionMapping.wsdlMessage = wsdlMessage;
            } else if (("wsdl-message-part-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("constructor-parameter-order" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: constructorParameterOrder
                final ConstructorParameterOrder constructorParameterOrder = readConstructorParameterOrder(elementReader,
                        context);
                exceptionMapping.constructorParameterOrder = constructorParameterOrder;
            } else {
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "exception-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "wsdl-message"),
                        new QName("http://java.sun.com/xml/ns/javaee", "wsdl-message-part-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "constructor-parameter-order"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ExceptionMapping exceptionMapping,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(exceptionMapping, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(exceptionMapping, "exceptionType", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(exceptionMapping, "wsdlMessagePartName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final ExceptionMapping exceptionMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, exceptionMapping, context);
    }

    public final ExceptionMapping read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
