...
public class CmpField$JAXB extends JAXBObject<CmpField> {
    ...
    public CmpField$JAXB() {
        super(CmpField.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "cmp-fieldType".intern()),
                Text$JAXB.class);
    }

    public static CmpField readCmpField(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeCmpField(final XoXMLStreamWriter writer, final CmpField cmpField,
            final RuntimeContext context) throws Exception {
        _write(writer, cmpField, context);
    }

    public final static CmpField _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("cmp-fieldType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("field-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: fieldName
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "field-name"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final CmpField read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
