...
public class ResourceEnvRef$JAXB extends JAXBObject<ResourceEnvRef> {

    public ResourceEnvRef$JAXB() {
        super(ResourceEnvRef.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "resource-env-refType".intern()),
    ...
    public static void writeResourceEnvRef(final XoXMLStreamWriter writer, final ResourceEnvRef resourceEnvRef,
            final RuntimeContext context) throws Exception {
        _write(writer, resourceEnvRef, context);
    }

    public final static ResourceEnvRef _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("resource-env-refType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("resource-env-ref-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("resource-env-ref-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "resource-env-ref-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "resource-env-ref-type"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ResourceEnvRef resourceEnvRef,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(resourceEnvRef, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(resourceEnvRef, "resourceEnvRefName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(resourceEnvRef, "resourceEnvRefType", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(resourceEnvRef, "mappedName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (mappedName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(resourceEnvRef, "lookupName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (lookupName != null) {
    ...
    public final ResourceEnvRef read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
