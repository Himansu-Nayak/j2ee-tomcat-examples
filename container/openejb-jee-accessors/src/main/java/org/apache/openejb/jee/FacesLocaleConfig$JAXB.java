...
public class FacesLocaleConfig$JAXB extends JAXBObject<FacesLocaleConfig> {

    public FacesLocaleConfig$JAXB() {
        super(FacesLocaleConfig.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-locale-configType".intern()),
                FacesDefaultLocale$JAXB.class, FacesSupportedLocale$JAXB.class);
    }
    ...
    public static void writeFacesLocaleConfig(final XoXMLStreamWriter writer, final FacesLocaleConfig facesLocaleConfig,
    ...
    public final static FacesLocaleConfig _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-locale-configType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("default-locale" == elementReader.getLocalName())
            ...
            } else if (("supported-locale" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "default-locale"),
                        new QName("http://java.sun.com/xml/ns/javaee", "supported-locale"));
            }
        }
        if (supportedLocale != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesLocaleConfig facesLocaleConfig,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesLocaleConfig, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesLocaleConfig facesLocaleConfig,
            final RuntimeContext context) throws Exception {
        _write(writer, facesLocaleConfig, context);
    }

    public final FacesLocaleConfig read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
