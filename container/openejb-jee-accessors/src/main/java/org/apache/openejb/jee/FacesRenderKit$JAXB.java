...
public class FacesRenderKit$JAXB extends JAXBObject<FacesRenderKit> {

    public FacesRenderKit$JAXB() {
        super(FacesRenderKit.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-render-kitType".intern()),
                Text$JAXB.class, Icon$JAXB.class, FacesRenderer$JAXB.class, FacesClientBehaviorRenderer$JAXB.class,
                FacesRenderKitExtension$JAXB.class);
    }
    ...
    public static void writeFacesRenderKit(final XoXMLStreamWriter writer, final FacesRenderKit facesRenderKit,
            final RuntimeContext context) throws Exception {
        _write(writer, facesRenderKit, context);
    }

    public final static FacesRenderKit _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-render-kitType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("render-kit-id" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: renderKitId
            ...
            } else if (("render-kit-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("renderer" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: renderer
            ...
            } else if (("client-behavior-renderer" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: clientBehaviorRenderer
                final FacesClientBehaviorRenderer clientBehaviorRendererItem = readFacesClientBehaviorRenderer(
            ...
            } else if (("render-kit-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: renderKitExtension
                final FacesRenderKitExtension renderKitExtensionItem = readFacesRenderKitExtension(elementReader,
                        context);
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesRenderKit facesRenderKit,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesRenderKit, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesRenderKit, "renderKitId", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (renderKitId != null) {
        ...
        try {
            ...
            context.xmlAdapterError(facesRenderKit, "renderKitClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final FacesRenderKit read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
