...
public class Module$JAXB extends JAXBObject<Module> {

    public Module$JAXB() {
        super(Module.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "moduleType".intern()),
                Web$JAXB.class);
    }

    public static Module readModule(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static Module _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("moduleType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("connector" == elementReader.getLocalName())
            ...
            } else if (("ejb" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: ejb
                ...
                module.ejb = ejb;
            } else if (("java" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: java
                ...
                module.java = java;
            } else if (("web" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: web
                final Web web = readWeb(elementReader, context);
                module.web = web;
            } else if (("alt-dd" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: altDd
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "connector"),
                        new QName("http://java.sun.com/xml/ns/javaee", "ejb"),
                        new QName("http://java.sun.com/xml/ns/javaee", "java"),
                        new QName("http://java.sun.com/xml/ns/javaee", "web"),
                        new QName("http://java.sun.com/xml/ns/javaee", "alt-dd"));
            }
        }
    ...
    public final Module read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
