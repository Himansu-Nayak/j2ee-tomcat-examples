...
public class IsolationLevel$JAXB extends JAXBEnum<IsolationLevel> {

    public IsolationLevel$JAXB() {
        super(IsolationLevel.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "isolation-levelType".intern()));
    }

    public static IsolationLevel parseIsolationLevel(final XoXMLStreamReader reader, final RuntimeContext context,
        ...
        if ("TRANSACTION_READ_UNCOMMITTED".equals(value)) {
            ...
            context.unexpectedEnumValue(reader, IsolationLevel.class, value, "TRANSACTION_READ_UNCOMMITTED",
                    "TRANSACTION_READ_COMMITTED", "TRANSACTION_REPEATABLE_READ", "TRANSACTION_SERIALIZABLE");
            return null;
        }
    }

    public static String toStringIsolationLevel(final Object bean, final String parameterName,
            final RuntimeContext context, final IsolationLevel isolationLevel) throws Exception {
        if (IsolationLevel.TRANSACTION_READ_UNCOMMITTED == isolationLevel) {
            ...
            context.unexpectedEnumConst(bean, parameterName, isolationLevel,
                    IsolationLevel.TRANSACTION_READ_UNCOMMITTED, IsolationLevel.TRANSACTION_READ_COMMITTED,
                    IsolationLevel.TRANSACTION_REPEATABLE_READ, IsolationLevel.TRANSACTION_SERIALIZABLE);
            return null;
        }
    }
    ...
    public String toString(final Object bean, final String parameterName, final RuntimeContext context,
            final IsolationLevel isolationLevel) throws Exception {
