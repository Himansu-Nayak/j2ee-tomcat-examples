...
public class Validator$JAXB extends JAXBObject<Validator> {
    ...
    public Validator$JAXB() {
        super(Validator.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "validatorType".intern()),
                Text$JAXB.class, ParamValue$JAXB.class);
    }
    ...
    public static void writeValidator(final XoXMLStreamWriter writer, final Validator validator,
            final RuntimeContext context) throws Exception {
        _write(writer, validator, context);
    }

    public final static Validator _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("validatorType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "validator-class"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final Validator validator, RuntimeContext context)
        ...
        try {
            ...
            context.xmlAdapterError(validator, "validatorClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final Validator read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
