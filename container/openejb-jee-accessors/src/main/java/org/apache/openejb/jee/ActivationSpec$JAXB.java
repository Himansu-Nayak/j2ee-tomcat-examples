...
public class ActivationSpec$JAXB extends JAXBObject<ActivationSpec> {

    public ActivationSpec$JAXB() {
        super(ActivationSpec.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "activationspecType".intern()),
                RequiredConfigProperty$JAXB.class, ConfigProperty$JAXB.class);
    }
    ...
    public static void writeActivationSpec(final XoXMLStreamWriter writer, final ActivationSpec activationSpec,
            final RuntimeContext context) throws Exception {
        _write(writer, activationSpec, context);
    }

    public final static ActivationSpec _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("activationspecType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("activationspec-class" == elementReader.getLocalName())
            ...
            } else if (("required-config-property" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: requiredConfigProperty
                final RequiredConfigProperty requiredConfigPropertyItem = readRequiredConfigProperty(elementReader,
                        context);
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "activationspec-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "required-config-property"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ActivationSpec activationSpec,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(activationSpec, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(activationSpec, "activationSpecClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final ActivationSpec read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
