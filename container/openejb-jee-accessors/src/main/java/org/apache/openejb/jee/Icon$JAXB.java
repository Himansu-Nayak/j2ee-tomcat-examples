...
public class Icon$JAXB extends JAXBObject<Icon> {

    public Icon$JAXB() {
        super(Icon.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "iconType".intern()));
    }

    public static Icon readIcon(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static Icon _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("iconType" != xsiType.getLocalPart())
        ...
        for (final Attribute attribute : reader.getAttributes()) {
            if (("id" == attribute.getLocalName())
                ...
                icon.id = id;
            } else if (("lang" == attribute.getLocalName())
                    && ("http://www.w3.org/XML/1998/namespace" == attribute.getNamespace())) {
                // ATTRIBUTE: lang
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("small-icon" == elementReader.getLocalName())
            ...
            } else if (("large-icon" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: largeIcon
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "small-icon"),
                        new QName("http://java.sun.com/xml/ns/javaee", "large-icon"));
            }
        }
    ...
    public void write(final XoXMLStreamWriter writer, final Icon icon, final RuntimeContext context) throws Exception {
        _write(writer, icon, context);
    }

    public final Icon read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
