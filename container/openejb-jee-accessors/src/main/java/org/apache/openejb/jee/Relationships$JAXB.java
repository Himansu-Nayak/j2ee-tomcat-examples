...
public class Relationships$JAXB extends JAXBObject<Relationships> {

    public Relationships$JAXB() {
        super(Relationships.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "relationshipsType".intern()), Text$JAXB.class,
                EjbRelation$JAXB.class);
    }
    ...
    public static void writeRelationships(final XoXMLStreamWriter writer, final Relationships relationships,
            final RuntimeContext context) throws Exception {
        _write(writer, relationships, context);
    }

    public final static Relationships _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("relationshipsType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("ejb-relation" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: ejbRelation
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "ejb-relation"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final Relationships relationships,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(relationships, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
    ...
    public final Relationships read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
