...
public class PackageMapping$JAXB extends JAXBObject<PackageMapping> {

    public PackageMapping$JAXB() {
        super(PackageMapping.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "package-mappingType".intern()));
    }
    ...
    public static void writePackageMapping(final XoXMLStreamWriter writer, final PackageMapping packageMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, packageMapping, context);
    }

    public final static PackageMapping _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("package-mappingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("package-type" == elementReader.getLocalName())
            ...
            } else if (("namespaceURI" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "package-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "namespaceURI"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final PackageMapping packageMapping,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(packageMapping, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(packageMapping, "packageType", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (packageType != null) {
        ...
        try {
            ...
            context.xmlAdapterError(packageMapping, "namespaceURI", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final PackageMapping read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
