...
public class FacesConverter$JAXB extends JAXBObject<FacesConverter> {

    public FacesConverter$JAXB() {
        super(FacesConverter.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-converterType".intern()),
                Text$JAXB.class, Icon$JAXB.class, FacesAttribute$JAXB.class, FacesProperty$JAXB.class,
                FacesConverterExtension$JAXB.class);
    }
    ...
    public static void writeFacesConverter(final XoXMLStreamWriter writer, final FacesConverter facesConverter,
            final RuntimeContext context) throws Exception {
        _write(writer, facesConverter, context);
    }

    public final static FacesConverter _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-converterType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("converter-id" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: converterId
            ...
            } else if (("converter-for-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("converter-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("converter-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: converterExtension
                final FacesConverterExtension converterExtensionItem = readFacesConverterExtension(elementReader,
                        context);
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesConverter facesConverter,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesConverter, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesConverter, "converterId", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (converterId != null) {
        ...
        try {
            ...
            context.xmlAdapterError(facesConverter, "converterForClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(facesConverter, "converterClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final FacesConverter read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
