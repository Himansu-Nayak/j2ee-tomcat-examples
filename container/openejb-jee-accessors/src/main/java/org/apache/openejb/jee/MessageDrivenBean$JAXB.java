...
public class MessageDrivenBean$JAXB extends JAXBObject<MessageDrivenBean> {

    public MessageDrivenBean$JAXB() {
        super(MessageDrivenBean.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "message-driven-beanType".intern()),
                Text$JAXB.class, Icon$JAXB.class, NamedMethod$JAXB.class, Timer$JAXB.class, TransactionType$JAXB.class,
                MessageDrivenDestination$JAXB.class, ActivationConfig$JAXB.class, AroundInvoke$JAXB.class,
                AroundTimeout$JAXB.class, EnvEntry$JAXB.class, EjbRef$JAXB.class, EjbLocalRef$JAXB.class,
                ServiceRef$JAXB.class, ResourceRef$JAXB.class, ResourceEnvRef$JAXB.class,
    ...
    public static void writeMessageDrivenBean(final XoXMLStreamWriter writer, final MessageDrivenBean messageDrivenBean,
    ...
    public final static MessageDrivenBean _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("message-driven-beanType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("messaging-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("message-selector" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("acknowledge-mode" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("message-driven-destination" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: messageDrivenDestination
                final MessageDrivenDestination messageDrivenDestination = readMessageDrivenDestination(elementReader,
                        context);
                try {
                    messageDrivenBean.setMessageDrivenDestination(messageDrivenDestination);
                } catch (final Exception e) {
                    context.setterError(reader, MessageDrivenBean.class, "setMessageDrivenDestination",
                            MessageDrivenDestination.class, e);
                }
            } else if (("message-destination-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    messageDestinationType = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(messageDestinationTypeRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
            ...
            } else if (("message-destination-link" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    messageDestinationLink = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(messageDestinationLinkRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
            ...
            } else if (("activation-config" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "messaging-type"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "message-selector"),
                        new QName("http://java.sun.com/xml/ns/javaee", "acknowledge-mode"),
                        new QName("http://java.sun.com/xml/ns/javaee", "message-driven-destination"),
                        new QName("http://java.sun.com/xml/ns/javaee", "message-destination-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "message-destination-link"),
                        new QName("http://java.sun.com/xml/ns/javaee", "activation-config"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final MessageDrivenBean messageDrivenBean,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(messageDrivenBean, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(messageDrivenBean, "ejbName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (ejbName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(messageDrivenBean, "mappedName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (mappedName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(messageDrivenBean, "ejbClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (ejbClass != null) {
        ...
        try {
            ...
            context.xmlAdapterError(messageDrivenBean, "messagingType", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(messageDrivenBean, "messageSelector", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(messageDrivenBean, "acknowledgeMode", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.getterError(messageDrivenBean, "messageDrivenDestination", MessageDrivenBean.class,
                    "getMessageDrivenDestination", e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(messageDrivenBean, "messageDestinationType", CollapsedStringAdapter.class,
                    String.class, String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(messageDrivenBean, "messageDestinationLink", CollapsedStringAdapter.class,
                    String.class, String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final MessageDrivenBean messageDrivenBean,
            final RuntimeContext context) throws Exception {
        _write(writer, messageDrivenBean, context);
    }

    public final MessageDrivenBean read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
