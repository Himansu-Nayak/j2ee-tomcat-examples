...
public class ActivationConfig$JAXB extends JAXBObject<ActivationConfig> {

    public ActivationConfig$JAXB() {
        super(ActivationConfig.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "activation-configType".intern()),
                Text$JAXB.class, ActivationConfigProperty$JAXB.class);
    }
    ...
    public static void writeActivationConfig(final XoXMLStreamWriter writer, final ActivationConfig activationConfig,
    ...
    public final static ActivationConfig _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("activation-configType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("activation-config-property" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: activationConfigProperty
                final ActivationConfigProperty activationConfigPropertyItem = readActivationConfigProperty(
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "activation-config-property"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ActivationConfig activationConfig,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(activationConfig, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final ActivationConfig activationConfig,
            final RuntimeContext context) throws Exception {
        _write(writer, activationConfig, context);
    }

    public final ActivationConfig read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
