...
public class AroundInvoke$JAXB extends JAXBObject<AroundInvoke> {

    public AroundInvoke$JAXB() {
        super(AroundInvoke.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "around-invokeType".intern()));
    }
    ...
    public static void writeAroundInvoke(final XoXMLStreamWriter writer, final AroundInvoke aroundInvoke,
            final RuntimeContext context) throws Exception {
        _write(writer, aroundInvoke, context);
    }

    public final static AroundInvoke _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("around-invokeType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final AroundInvoke aroundInvoke,
        ...
        try {
            ...
            context.xmlAdapterError(aroundInvoke, "methodName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (methodName != null) {
    ...
    public final AroundInvoke read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
