...
public class CmrFieldType$JAXB extends JAXBEnum<CmrFieldType> {

    public CmrFieldType$JAXB() {
        super(CmrFieldType.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "cmrFieldType".intern()));
    }

    public static CmrFieldType parseCmrFieldType(final XoXMLStreamReader reader, final RuntimeContext context,
    ...
    public static String toStringCmrFieldType(final Object bean, final String parameterName,
            final RuntimeContext context, final CmrFieldType cmrFieldType) throws Exception {
    ...
    public String toString(final Object bean, final String parameterName, final RuntimeContext context,
            final CmrFieldType cmrFieldType) throws Exception {
