...
public class RespectBinding$JAXB extends JAXBObject<RespectBinding> {

    public RespectBinding$JAXB() {
        super(RespectBinding.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "respect-bindingType".intern()));
    }
    ...
    public static void writeRespectBinding(final XoXMLStreamWriter writer, final RespectBinding respectBinding,
            final RuntimeContext context) throws Exception {
        _write(writer, respectBinding, context);
    }

    public final static RespectBinding _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("respect-bindingType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final RespectBinding respectBinding,
    ...
    public final RespectBinding read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
