...
public class EjbRefType$JAXB extends JAXBEnum<EjbRefType> {

    public EjbRefType$JAXB() {
        super(EjbRefType.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "ejbRefType".intern()));
    }

    public static EjbRefType parseEjbRefType(final XoXMLStreamReader reader, final RuntimeContext context,
    ...
    public static String toStringEjbRefType(final Object bean, final String parameterName, final RuntimeContext context,
            final EjbRefType ejbRefType) throws Exception {
