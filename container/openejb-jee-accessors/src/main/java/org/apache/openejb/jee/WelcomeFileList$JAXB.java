...
public class WelcomeFileList$JAXB extends JAXBObject<WelcomeFileList> {
    ...
    public WelcomeFileList$JAXB() {
        super(WelcomeFileList.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "welcome-file-listType".intern()));
    }
    ...
    public static void writeWelcomeFileList(final XoXMLStreamWriter writer, final WelcomeFileList welcomeFileList,
            final RuntimeContext context) throws Exception {
        _write(writer, welcomeFileList, context);
    }

    public final static WelcomeFileList _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("welcome-file-listType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("welcome-file" == elementReader.getLocalName())
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "welcome-file"));
            }
        }
        if (welcomeFile != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final WelcomeFileList welcomeFileList,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(welcomeFileList, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        if (welcomeFileRaw != null) {
            for (final String welcomeFileItem : welcomeFileRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(welcomeFileList, "welcomeFile", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (welcomeFile != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final WelcomeFileList welcomeFileList,
            final RuntimeContext context) throws Exception {
        _write(writer, welcomeFileList, context);
    }

    public final WelcomeFileList read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
