...
public class FacesNavigationRule$JAXB extends JAXBObject<FacesNavigationRule> {

    public FacesNavigationRule$JAXB() {
        super(FacesNavigationRule.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-navigation-ruleType".intern()),
                Text$JAXB.class, Icon$JAXB.class, FacesNavigationCase$JAXB.class,
                FacesNavigationRuleExtension$JAXB.class);
    }

    public static FacesNavigationRule readFacesNavigationRule(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesNavigationRule(final XoXMLStreamWriter writer,
            final FacesNavigationRule facesNavigationRule, final RuntimeContext context) throws Exception {
    ...
    public final static FacesNavigationRule _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-navigation-ruleType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("from-view-id" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: fromViewId
            ...
            } else if (("navigation-case" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("navigation-rule-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: navigationRuleExtension
                final FacesNavigationRuleExtension navigationRuleExtensionItem = readFacesNavigationRuleExtension(
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesNavigationRule facesNavigationRule,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesNavigationRule, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesNavigationRule, "fromViewId", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (fromViewId != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final FacesNavigationRule facesNavigationRule,
            final RuntimeContext context) throws Exception {
        _write(writer, facesNavigationRule, context);
    }
