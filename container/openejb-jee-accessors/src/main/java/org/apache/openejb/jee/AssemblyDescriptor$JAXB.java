...
public class AssemblyDescriptor$JAXB extends JAXBObject<AssemblyDescriptor> {

    public AssemblyDescriptor$JAXB() {
        super(AssemblyDescriptor.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "assembly-descriptorType".intern()),
                SecurityRole$JAXB.class, MethodPermission$JAXB.class, ContainerTransaction$JAXB.class,
                ContainerConcurrency$JAXB.class, InterceptorBinding$JAXB.class, MessageDestination$JAXB.class,
                ExcludeList$JAXB.class, ApplicationException$JAXB.class);
    }

    public static AssemblyDescriptor readAssemblyDescriptor(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeAssemblyDescriptor(final XoXMLStreamWriter writer,
            final AssemblyDescriptor assemblyDescriptor, final RuntimeContext context) throws Exception {
    ...
    public final static AssemblyDescriptor _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("assembly-descriptorType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("security-role" == elementReader.getLocalName())
            ...
            } else if (("method-permission" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("container-transaction" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("container-concurrency" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("interceptor-binding" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader,
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "method-permission"),
                        new QName("http://java.sun.com/xml/ns/javaee", "container-transaction"),
                        new QName("http://java.sun.com/xml/ns/javaee", "container-concurrency"),
                        new QName("http://java.sun.com/xml/ns/javaee", "interceptor-binding"),
                        new QName("http://java.sun.com/xml/ns/javaee", "message-destination"),
                        new QName("http://java.sun.com/xml/ns/javaee", "exclude-list"),
                        new QName("http://java.sun.com/xml/ns/javaee", "application-exception"));
            }
        }
        if (securityRole != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final AssemblyDescriptor assemblyDescriptor,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(assemblyDescriptor, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final AssemblyDescriptor assemblyDescriptor,
            final RuntimeContext context) throws Exception {
        _write(writer, assemblyDescriptor, context);
    }
