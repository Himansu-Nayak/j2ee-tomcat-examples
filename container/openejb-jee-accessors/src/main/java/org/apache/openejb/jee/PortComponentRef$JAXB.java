...
public class PortComponentRef$JAXB extends JAXBObject<PortComponentRef> {

    public PortComponentRef$JAXB() {
        super(PortComponentRef.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "port-component-refType".intern()),
                Addressing$JAXB.class, RespectBinding$JAXB.class);
    }
    ...
    public static void writePortComponentRef(final XoXMLStreamWriter writer, final PortComponentRef portComponentRef,
    ...
    public final static PortComponentRef _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("port-component-refType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("service-endpoint-interface" == elementReader.getLocalName())
            ...
            } else if (("port-component-link" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader,
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "port-component-link"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final PortComponentRef portComponentRef,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(portComponentRef, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(portComponentRef, "serviceEndpointInterface", CollapsedStringAdapter.class,
        ...
        try {
            ...
            context.xmlAdapterError(portComponentRef, "portComponentLink", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final PortComponentRef portComponentRef,
            final RuntimeContext context) throws Exception {
        _write(writer, portComponentRef, context);
    }

    public final PortComponentRef read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
