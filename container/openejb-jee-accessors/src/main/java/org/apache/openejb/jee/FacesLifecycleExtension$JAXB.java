...
public class FacesLifecycleExtension$JAXB extends JAXBObject<FacesLifecycleExtension> {

    public FacesLifecycleExtension$JAXB() {
        super(FacesLifecycleExtension.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "faces-config-lifecycle-extensionType".intern()));
    }

    public static FacesLifecycleExtension readFacesLifecycleExtension(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesLifecycleExtension(final XoXMLStreamWriter writer,
            final FacesLifecycleExtension facesLifecycleExtension, final RuntimeContext context) throws Exception {
    ...
    public final static FacesLifecycleExtension _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-lifecycle-extensionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final FacesLifecycleExtension facesLifecycleExtension, RuntimeContext context) throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesLifecycleExtension, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesLifecycleExtension facesLifecycleExtension,
            final RuntimeContext context) throws Exception {
        _write(writer, facesLifecycleExtension, context);
    }
