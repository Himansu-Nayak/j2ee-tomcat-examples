...
public class FacesOrdering$JAXB extends JAXBObject<FacesOrdering> {

    public FacesOrdering$JAXB() {
        super(FacesOrdering.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-orderingType".intern()),
                FacesOrderingOrdering$JAXB.class);
    }
    ...
    public static void writeFacesOrdering(final XoXMLStreamWriter writer, final FacesOrdering facesOrdering,
            final RuntimeContext context) throws Exception {
        _write(writer, facesOrdering, context);
    }

    public final static FacesOrdering _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-orderingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("after" == elementReader.getLocalName())
            ...
            } else if (("before" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: before
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesOrdering facesOrdering,
    ...
    public final FacesOrdering read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
