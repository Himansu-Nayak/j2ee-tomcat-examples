...
public class EjbJar$JAXB extends JAXBObject<EjbJar> {

    public EjbJar$JAXB() {
        super(EjbJar.class, new QName("http://java.sun.com/xml/ns/javaee".intern(), "ejb-jar".intern()),
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "ejb-jarType".intern()), Text$JAXB.class,
                Icon$JAXB.class, MessageDrivenBean$JAXB.class, SessionBean$JAXB.class, EntityBean$JAXB.class,
                Interceptors$JAXB.class, Relationships$JAXB.class, AssemblyDescriptor$JAXB.class);
    }

    public static EjbJar readEjbJar(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static EjbJar _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("ejb-jarType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("module-name" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("enterprise-beans" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT WRAPPER: enterpriseBeans
                _readEnterpriseBeans(elementReader, context, ejbJar);
            } else if (("interceptors" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("ejb-client-jar" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "module-name"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "enterprise-beans"),
                        new QName("http://java.sun.com/xml/ns/javaee", "interceptors"),
                        new QName("http://java.sun.com/xml/ns/javaee", "relationships"),
                        new QName("http://java.sun.com/xml/ns/javaee", "assembly-descriptor"),
                        new QName("http://java.sun.com/xml/ns/javaee", "ejb-client-jar"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _readEnterpriseBeans(final XoXMLStreamReader reader, final RuntimeContext context,
            final EjbJar ejbJar) throws Exception {
        ArrayList<EnterpriseBean> enterpriseBeans = null;

        // Read elements
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("message-driven" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: enterpriseBeans
                final org.apache.openejb.jee.MessageDrivenBean enterpriseBeansItem = readMessageDrivenBean(
                        elementReader, context);
                if (enterpriseBeans == null) {
                    enterpriseBeans = new ArrayList<EnterpriseBean>();
                }
                enterpriseBeans.add(enterpriseBeansItem);
            } else if (("session" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: enterpriseBeans
            ...
            } else if (("entity" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: enterpriseBeans
    ...
    public final static void _write(final XoXMLStreamWriter writer, final EjbJar ejbJar, RuntimeContext context)
        ...
        if (enterpriseBeans != null) {
            for (final EnterpriseBean enterpriseBeansItem : enterpriseBeans) {
                if (enterpriseBeansItem instanceof org.apache.openejb.jee.EntityBean) {
                    ...
                    context.unexpectedElementType(writer, ejbJar, "enterpriseBeans", enterpriseBeansItem,
                            org.apache.openejb.jee.EntityBean.class, org.apache.openejb.jee.SessionBean.class,
        ...
        try {
            ...
            context.xmlAdapterError(ejbJar, "ejbClientJar", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
    ...
    public final EjbJar read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
