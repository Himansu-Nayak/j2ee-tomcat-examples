...
public class CmpVersion$JAXB extends JAXBEnum<CmpVersion> {

    public CmpVersion$JAXB() {
        super(CmpVersion.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "cmpVersion".intern()));
    }

    public static CmpVersion parseCmpVersion(final XoXMLStreamReader reader, final RuntimeContext context,
    ...
    public static String toStringCmpVersion(final Object bean, final String parameterName, final RuntimeContext context,
            final CmpVersion cmpVersion) throws Exception {
