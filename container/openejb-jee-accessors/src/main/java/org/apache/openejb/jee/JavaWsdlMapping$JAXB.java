...
public class JavaWsdlMapping$JAXB extends JAXBObject<JavaWsdlMapping> {

    public JavaWsdlMapping$JAXB() {
        super(JavaWsdlMapping.class,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "java-wsdl-mapping".intern()),
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "java-wsdl-mappingType".intern()),
                PackageMapping$JAXB.class, JavaXmlTypeMapping$JAXB.class, ExceptionMapping$JAXB.class,
                ServiceInterfaceMapping$JAXB.class, ServiceEndpointInterfaceMapping$JAXB.class);
    }
    ...
    public static void writeJavaWsdlMapping(final XoXMLStreamWriter writer, final JavaWsdlMapping javaWsdlMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, javaWsdlMapping, context);
    }

    public final static JavaWsdlMapping _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("java-wsdl-mappingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("package-mapping" == elementReader.getLocalName())
            ...
            } else if (("java-xml-type-mapping" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("exception-mapping" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("service-interface-mapping" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: serviceInterfaceMapping
                final ServiceInterfaceMapping serviceInterfaceMappingItem = readServiceInterfaceMapping(elementReader,
                        context);
            ...
            } else if (("service-endpoint-interface-mapping" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: serviceEndpointInterfaceMapping
                final ServiceEndpointInterfaceMapping serviceEndpointInterfaceMappingItem = readServiceEndpointInterfaceMapping(
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "package-mapping"),
                        new QName("http://java.sun.com/xml/ns/javaee", "java-xml-type-mapping"),
                        new QName("http://java.sun.com/xml/ns/javaee", "exception-mapping"),
                        new QName("http://java.sun.com/xml/ns/javaee", "service-interface-mapping"),
                        new QName("http://java.sun.com/xml/ns/javaee", "service-endpoint-interface-mapping"));
            }
        }
        if (packageMapping != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final JavaWsdlMapping javaWsdlMapping,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(javaWsdlMapping, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        if (versionRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(javaWsdlMapping, "version", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        if (serviceEndpointInterfaceMapping != null) {
            for (final ServiceEndpointInterfaceMapping serviceEndpointInterfaceMappingItem : serviceEndpointInterfaceMapping) {
                if (serviceEndpointInterfaceMappingItem != null) {
                    writer.writeStartElement(prefix, "service-endpoint-interface-mapping",
    ...
    public void write(final XoXMLStreamWriter writer, final JavaWsdlMapping javaWsdlMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, javaWsdlMapping, context);
    }

    public final JavaWsdlMapping read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
