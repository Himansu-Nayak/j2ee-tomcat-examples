...
public class FacesNavigationRuleExtension$JAXB extends JAXBObject<FacesNavigationRuleExtension> {

    public FacesNavigationRuleExtension$JAXB() {
        super(FacesNavigationRuleExtension.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "faces-config-navigation-rule-extensionType".intern()));
    }

    public static FacesNavigationRuleExtension readFacesNavigationRuleExtension(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesNavigationRuleExtension(final XoXMLStreamWriter writer,
            final FacesNavigationRuleExtension facesNavigationRuleExtension, final RuntimeContext context)
                    throws Exception {
        _write(writer, facesNavigationRuleExtension, context);
    }

    public final static FacesNavigationRuleExtension _read(final XoXMLStreamReader reader, RuntimeContext context)
            throws Exception {
        ...
        final FacesNavigationRuleExtension facesNavigationRuleExtension = new FacesNavigationRuleExtension();
        ...
        if (xsiType != null) {
            if (("faces-config-navigation-rule-extensionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final FacesNavigationRuleExtension facesNavigationRuleExtension, RuntimeContext context) throws Exception {
        ...
        // ATTRIBUTE: id
        final String idRaw = facesNavigationRuleExtension.id;
        if (idRaw != null) {
            String id = null;
            try {
                id = Adapters.collapsedStringAdapterAdapter.marshal(idRaw);
            } catch (final Exception e) {
                context.xmlAdapterError(facesNavigationRuleExtension, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesNavigationRuleExtension facesNavigationRuleExtension,
            final RuntimeContext context) throws Exception {
        _write(writer, facesNavigationRuleExtension, context);
    }
