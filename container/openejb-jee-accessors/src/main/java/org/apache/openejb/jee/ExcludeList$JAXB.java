...
public class ExcludeList$JAXB extends JAXBObject<ExcludeList> {

    public ExcludeList$JAXB() {
        super(ExcludeList.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "exclude-listType".intern()), Text$JAXB.class,
                Method$JAXB.class);
    }
    ...
    public static void writeExcludeList(final XoXMLStreamWriter writer, final ExcludeList excludeList,
            final RuntimeContext context) throws Exception {
        _write(writer, excludeList, context);
    }

    public final static ExcludeList _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("exclude-listType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ExcludeList excludeList,
    ...
    public final ExcludeList read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
