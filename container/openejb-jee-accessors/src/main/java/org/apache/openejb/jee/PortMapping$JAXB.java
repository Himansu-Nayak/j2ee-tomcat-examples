...
public class PortMapping$JAXB extends JAXBObject<PortMapping> {

    public PortMapping$JAXB() {
        super(PortMapping.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "port-mappingType".intern()));
    }
    ...
    public static void writePortMapping(final XoXMLStreamWriter writer, final PortMapping portMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, portMapping, context);
    }

    public final static PortMapping _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("port-mappingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("port-name" == elementReader.getLocalName())
            ...
            } else if (("java-port-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "port-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "java-port-name"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final PortMapping portMapping,
        ...
        try {
            ...
            context.xmlAdapterError(portMapping, "portName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (portName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(portMapping, "javaPortName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final PortMapping read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
