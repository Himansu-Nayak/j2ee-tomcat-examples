...
public class CmrField$JAXB extends JAXBObject<CmrField> {

    public CmrField$JAXB() {
        super(CmrField.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "cmr-fieldType".intern()),
                Text$JAXB.class, CmrFieldType$JAXB.class);
    }

    public static CmrField readCmrField(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeCmrField(final XoXMLStreamWriter writer, final CmrField cmrField,
            final RuntimeContext context) throws Exception {
        _write(writer, cmrField, context);
    }

    public final static CmrField _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("cmr-fieldType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("cmr-field-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("cmr-field-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: cmrFieldType
                final CmrFieldType cmrFieldType = parseCmrFieldType(elementReader, context,
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "cmr-field-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "cmr-field-type"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final CmrField cmrField, RuntimeContext context)
        ...
        try {
            ...
            context.xmlAdapterError(cmrField, "cmrFieldName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
    ...
    public final CmrField read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
