...
public class RunAs$JAXB extends JAXBObject<RunAs> {

    public RunAs$JAXB() {
        super(RunAs.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "run-asType".intern()),
                Text$JAXB.class);
    }

    public static RunAs readRunAs(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static RunAs _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("run-asType" != xsiType.getLocalPart())
    ...
    public final RunAs read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
