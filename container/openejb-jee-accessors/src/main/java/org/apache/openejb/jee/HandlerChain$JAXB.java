...
public class HandlerChain$JAXB extends JAXBObject<HandlerChain> {

    public HandlerChain$JAXB() {
        super(HandlerChain.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "handler-chainType".intern()),
                Handler$JAXB.class);
    }
    ...
    public static void writeHandlerChain(final XoXMLStreamWriter writer, final HandlerChain handlerChain,
            final RuntimeContext context) throws Exception {
        _write(writer, handlerChain, context);
    }

    public final static HandlerChain _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("handler-chainType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("service-name-pattern" == elementReader.getLocalName())
                ...
                try {
                    serviceNamePattern = Adapters.handlerChainsStringQNameAdapterAdapter
                            .unmarshal(serviceNamePatternRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, HandlerChainsStringQNameAdapter.class, QName.class,
                            QName.class, e);
                    continue;
                }

                handlerChain.serviceNamePattern = serviceNamePattern;
            } else if (("port-name-pattern" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("protocol-bindings" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                for (final String protocolBindingsItem : elementReader.getElementAsXmlList()) {
                    ...
                    try {
                        ...
                        context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class,
                                e);
                        continue;
                    }
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "service-name-pattern"),
                        new QName("http://java.sun.com/xml/ns/javaee", "port-name-pattern"),
                        new QName("http://java.sun.com/xml/ns/javaee", "protocol-bindings"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final HandlerChain handlerChain,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(handlerChain, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(handlerChain, "serviceNamePattern", HandlerChainsStringQNameAdapter.class,
                    QName.class, QName.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(handlerChain, "portNamePattern", HandlerChainsStringQNameAdapter.class, QName.class,
                    QName.class, e);
        }
        ...
        if (protocolBindingsRaw != null) {
            ...
            for (final String protocolBindingsItem : protocolBindingsRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(handlerChain, "protocolBindings", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (protocolBindings != null) {
    ...
    public final HandlerChain read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
