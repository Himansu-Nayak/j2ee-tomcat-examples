...
public class ServiceInterfaceMapping$JAXB extends JAXBObject<ServiceInterfaceMapping> {

    public ServiceInterfaceMapping$JAXB() {
        super(ServiceInterfaceMapping.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "service-interface-mappingType".intern()),
                PortMapping$JAXB.class);
    }

    public static ServiceInterfaceMapping readServiceInterfaceMapping(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeServiceInterfaceMapping(final XoXMLStreamWriter writer,
            final ServiceInterfaceMapping serviceInterfaceMapping, final RuntimeContext context) throws Exception {
    ...
    public final static ServiceInterfaceMapping _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("service-interface-mappingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("service-interface" == elementReader.getLocalName())
            ...
            } else if (("wsdl-service-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("port-mapping" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: portMapping
                ...
                context.unexpectedElement(elementReader,
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "wsdl-service-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "port-mapping"));
            }
        }
        if (portMapping != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final ServiceInterfaceMapping serviceInterfaceMapping, RuntimeContext context) throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(serviceInterfaceMapping, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(serviceInterfaceMapping, "serviceInterface", CollapsedStringAdapter.class,
    ...
    public void write(final XoXMLStreamWriter writer, final ServiceInterfaceMapping serviceInterfaceMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, serviceInterfaceMapping, context);
    }
