...
public class FacesApplication$JAXB extends JAXBObject<FacesApplication> {

    public FacesApplication$JAXB() {
        super(FacesApplication.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-applicationType".intern()),
                FacesSystemEventListener$JAXB.class, FacesLocaleConfig$JAXB.class,
                FacesApplicationResourceBundle$JAXB.class, FacesApplicationExtension$JAXB.class,
                FacesValidator$JAXB.class);
    }
    ...
    public static void writeFacesApplication(final XoXMLStreamWriter writer, final FacesApplication facesApplication,
    ...
    public final static FacesApplication _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-applicationType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("action-listener" == elementReader.getLocalName())
            ...
            } else if (("default-render-kit-id" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    defaultRenderKitIdItem = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(defaultRenderKitIdItemRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
            ...
            } else if (("message-bundle" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("navigation-handler" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("view-handler" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: viewHandler
            ...
            } else if (("state-manager" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("el-resolver" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: elResolver
            ...
            } else if (("property-resolver" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("variable-resolver" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("resource-handler" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("system-event-listener" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: systemEventListener
                final FacesSystemEventListener systemEventListenerItem = readFacesSystemEventListener(elementReader,
                        context);
            ...
            } else if (("locale-config" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("resource-bundle" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: resourceBundle
                final FacesApplicationResourceBundle resourceBundle = readFacesApplicationResourceBundle(elementReader,
                        context);
                facesApplication.resourceBundle = resourceBundle;
            } else if (("application-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: applicationExtension
                final FacesApplicationExtension applicationExtensionItem = readFacesApplicationExtension(elementReader,
                        context);
            ...
            } else if (("default-validators" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesApplication facesApplication,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesApplication, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        if (actionListenerRaw != null) {
            for (final String actionListenerItem : actionListenerRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesApplication, "actionListener", CollapsedStringAdapter.class,
        ...
        if (defaultRenderKitIdRaw != null) {
            for (final String defaultRenderKitIdItem : defaultRenderKitIdRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesApplication, "defaultRenderKitId", CollapsedStringAdapter.class,
                            List.class, List.class, e);
                }
                if (defaultRenderKitId != null) {
        ...
        if (messageBundleRaw != null) {
            for (final String messageBundleItem : messageBundleRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesApplication, "messageBundle", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (messageBundle != null) {
        ...
        if (navigationHandlerRaw != null) {
            for (final String navigationHandlerItem : navigationHandlerRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesApplication, "navigationHandler", CollapsedStringAdapter.class,
                            List.class, List.class, e);
                }
                if (navigationHandler != null) {
        ...
        if (viewHandlerRaw != null) {
            for (final String viewHandlerItem : viewHandlerRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesApplication, "viewHandler", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (viewHandler != null) {
        ...
        if (stateManagerRaw != null) {
            for (final String stateManagerItem : stateManagerRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesApplication, "stateManager", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (stateManager != null) {
        ...
        if (elResolverRaw != null) {
            for (final String elResolverItem : elResolverRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesApplication, "elResolver", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (elResolver != null) {
        ...
        if (propertyResolverRaw != null) {
            for (final String propertyResolverItem : propertyResolverRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesApplication, "propertyResolver", CollapsedStringAdapter.class,
                            List.class, List.class, e);
                }
                if (propertyResolver != null) {
        ...
        if (variableResolverRaw != null) {
            for (final String variableResolverItem : variableResolverRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesApplication, "variableResolver", CollapsedStringAdapter.class,
                            List.class, List.class, e);
                }
                if (variableResolver != null) {
        ...
        if (resourceHandlerRaw != null) {
            for (final String resourceHandlerItem : resourceHandlerRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesApplication, "resourceHandler", CollapsedStringAdapter.class,
                            List.class, List.class, e);
                }
                if (resourceHandler != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final FacesApplication facesApplication,
            final RuntimeContext context) throws Exception {
        _write(writer, facesApplication, context);
    }

    public final FacesApplication read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
