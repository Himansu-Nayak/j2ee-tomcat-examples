...
public class Function$JAXB extends JAXBObject<Function> {

    public Function$JAXB() {
        super(Function.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "functionType".intern()),
                Text$JAXB.class, Icon$JAXB.class, TldExtension$JAXB.class);
    }

    public static Function readFunction(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFunction(final XoXMLStreamWriter writer, final Function function,
            final RuntimeContext context) throws Exception {
        _write(writer, function, context);
    }

    public final static Function _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("functionType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                function.name = name;
            } else if (("function-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("function-signature" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("function-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "function-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "function-signature"),
                        new QName("http://java.sun.com/xml/ns/javaee", "example"),
                        new QName("http://java.sun.com/xml/ns/javaee", "function-extension"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final Function function, RuntimeContext context)
        ...
        try {
            ...
            context.xmlAdapterError(function, "functionClass", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(function, "functionSignature", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final Function read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
