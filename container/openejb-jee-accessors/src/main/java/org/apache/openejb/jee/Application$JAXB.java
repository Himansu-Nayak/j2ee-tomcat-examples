...
public class Application$JAXB extends JAXBObject<Application> {

    public Application$JAXB() {
        super(Application.class, new QName("http://java.sun.com/xml/ns/javaee".intern(), "application".intern()),
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "applicationType".intern()), Text$JAXB.class,
                Icon$JAXB.class, Module$JAXB.class, SecurityRole$JAXB.class, EnvEntry$JAXB.class, EjbRef$JAXB.class,
                ...
                MessageDestination$JAXB.class, DataSource$JAXB.class);
    }
    ...
    public static void writeApplication(final XoXMLStreamWriter writer, final Application application,
            final RuntimeContext context) throws Exception {
        _write(writer, application, context);
    }

    public final static Application _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("application-name" == elementReader.getLocalName())
                ...
                final Boolean initializeInOrder = ("1".equals(elementReader.getElementAsString())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final Application application,
        ...
        if (versionRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(application, "version", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(application, "applicationName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(application, "libraryDirectory", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final Application read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
