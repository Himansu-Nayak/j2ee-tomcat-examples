...
public class FacesManagedBeanExtension$JAXB extends JAXBObject<FacesManagedBeanExtension> {

    public FacesManagedBeanExtension$JAXB() {
        super(FacesManagedBeanExtension.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "faces-config-managed-bean-extensionType".intern()));
    }

    public static FacesManagedBeanExtension readFacesManagedBeanExtension(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesManagedBeanExtension(final XoXMLStreamWriter writer,
            final FacesManagedBeanExtension facesManagedBeanExtension, final RuntimeContext context) throws Exception {
    ...
    public final static FacesManagedBeanExtension _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-managed-bean-extensionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final FacesManagedBeanExtension facesManagedBeanExtension, RuntimeContext context) throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesManagedBeanExtension, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesManagedBeanExtension facesManagedBeanExtension,
            final RuntimeContext context) throws Exception {
        _write(writer, facesManagedBeanExtension, context);
    }
