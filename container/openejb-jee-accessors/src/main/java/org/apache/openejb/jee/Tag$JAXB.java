...
public class Tag$JAXB extends JAXBObject<Tag> {

    public Tag$JAXB() {
        super(Tag.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "tagType".intern()),
                Text$JAXB.class, Icon$JAXB.class, BodyContent$JAXB.class, Variable$JAXB.class, TldAttribute$JAXB.class,
                TldExtension$JAXB.class);
    }

    public static Tag readTag(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static Tag _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("tagType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                tag.name = name;
            } else if (("tag-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: tagClass
            ...
            } else if (("tei-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: teiClass
            ...
            } else if (("body-content" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: bodyContent
                final BodyContent bodyContent = parseBodyContent(elementReader, context,
                        elementReader.getElementAsString());
                if (bodyContent != null) {
                    tag.bodyContent = bodyContent;
                }
            } else if (("variable" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: variable
            ...
            } else if (("dynamic-attributes" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("example" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: example
                ...
                tag.example = example;
            } else if (("tag-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "tag-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "tei-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "body-content"),
                        new QName("http://java.sun.com/xml/ns/javaee", "variable"),
                        new QName("http://java.sun.com/xml/ns/javaee", "attribute"),
                        new QName("http://java.sun.com/xml/ns/javaee", "dynamic-attributes"),
                        new QName("http://java.sun.com/xml/ns/javaee", "example"),
                        new QName("http://java.sun.com/xml/ns/javaee", "tag-extension"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final Tag tag, RuntimeContext context)
        ...
        try {
            ...
            context.xmlAdapterError(tag, "dynamicAttributes", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final Tag tag, final RuntimeContext context) throws Exception {
        _write(writer, tag, context);
    }

    public final Tag read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
