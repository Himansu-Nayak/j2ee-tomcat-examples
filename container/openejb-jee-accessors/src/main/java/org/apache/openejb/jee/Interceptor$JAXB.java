...
public class Interceptor$JAXB extends JAXBObject<Interceptor> {

    public Interceptor$JAXB() {
        super(Interceptor.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "interceptorType".intern()), Text$JAXB.class,
    ...
    public static void writeInterceptor(final XoXMLStreamWriter writer, final Interceptor interceptor,
            final RuntimeContext context) throws Exception {
        _write(writer, interceptor, context);
    }

    public final static Interceptor _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("interceptorType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("interceptor-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("after-begin" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: afterBegin
                final org.apache.openejb.jee.LifecycleCallback afterBeginItem = readLifecycleCallback(elementReader,
                        context);
                if (afterBegin == null) {
            ...
            } else if (("before-completion" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: beforeCompletion
                final org.apache.openejb.jee.LifecycleCallback beforeCompletionItem = readLifecycleCallback(
            ...
            } else if (("after-completion" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: afterCompletion
                final org.apache.openejb.jee.LifecycleCallback afterCompletionItem = readLifecycleCallback(
                        elementReader, context);
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "interceptor-class"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "after-begin"),
                        new QName("http://java.sun.com/xml/ns/javaee", "before-completion"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final Interceptor interceptor,
        ...
        try {
            ...
            context.xmlAdapterError(interceptor, "interceptorClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final Interceptor read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
