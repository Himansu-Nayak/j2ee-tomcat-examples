...
public class Taglib$JAXB extends JAXBObject<Taglib> {

    public Taglib$JAXB() {
        super(Taglib.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "taglibType".intern()));
    }

    public static Taglib readTaglib(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static Taglib _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("taglibType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("taglib-uri" == elementReader.getLocalName())
            ...
            } else if (("taglib-location" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "taglib-uri"),
                        new QName("http://java.sun.com/xml/ns/javaee", "taglib-location"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final Taglib taglib, RuntimeContext context)
        ...
        try {
            ...
            context.xmlAdapterError(taglib, "taglibLocation", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
    ...
    public final Taglib read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
