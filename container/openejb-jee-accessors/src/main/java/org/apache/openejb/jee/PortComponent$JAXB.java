...
public class PortComponent$JAXB extends JAXBObject<PortComponent> {

    public PortComponent$JAXB() {
        super(PortComponent.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "port-componentType".intern()), Icon$JAXB.class,
                Addressing$JAXB.class, RespectBinding$JAXB.class, ServiceImplBean$JAXB.class, Handler$JAXB.class,
                HandlerChains$JAXB.class);
    }
    ...
    public static void writePortComponent(final XoXMLStreamWriter writer, final PortComponent portComponent,
            final RuntimeContext context) throws Exception {
        _write(writer, portComponent, context);
    }

    public final static PortComponent _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("port-componentType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("port-component-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("protocol-binding" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("service-endpoint-interface" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    serviceEndpointInterface = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(serviceEndpointInterfaceRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
            ...
            } else if (("service-impl-bean" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("handler" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: handler
            ...
            } else if (("handler-chains" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "port-component-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "wsdl-service"),
                        new QName("http://java.sun.com/xml/ns/javaee", "wsdl-port"),
                        new QName("http://java.sun.com/xml/ns/javaee", "enable-mtom"),
                        new QName("http://java.sun.com/xml/ns/javaee", "mtom-threshold"),
                        new QName("http://java.sun.com/xml/ns/javaee", "addressing"),
                        new QName("http://java.sun.com/xml/ns/javaee", "respect-binding"),
                        new QName("http://java.sun.com/xml/ns/javaee", "protocol-binding"),
                        new QName("http://java.sun.com/xml/ns/javaee", "service-endpoint-interface"),
                        new QName("http://java.sun.com/xml/ns/javaee", "service-impl-bean"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final PortComponent portComponent,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(portComponent, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(portComponent, "description", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (description != null) {
        ...
        try {
            ...
            context.xmlAdapterError(portComponent, "displayName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (displayName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(portComponent, "portComponentName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(portComponent, "protocolBinding", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(portComponent, "serviceEndpointInterface", CollapsedStringAdapter.class,
    ...
    public final PortComponent read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
