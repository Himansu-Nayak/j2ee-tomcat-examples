...
public class RemoveMethod$JAXB extends JAXBObject<RemoveMethod> {

    public RemoveMethod$JAXB() {
        super(RemoveMethod.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "remove-methodType".intern()),
                NamedMethod$JAXB.class);
    }
    ...
    public static void writeRemoveMethod(final XoXMLStreamWriter writer, final RemoveMethod removeMethod,
            final RuntimeContext context) throws Exception {
        _write(writer, removeMethod, context);
    }

    public final static RemoveMethod _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("remove-methodType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("bean-method" == elementReader.getLocalName())
            ...
            } else if (("retain-if-exception" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: retainIfException
                final Boolean retainIfException = ("1".equals(elementReader.getElementAsString())
                        || "true".equals(elementReader.getElementAsString()));
                removeMethod.retainIfException = retainIfException;
            } else {
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "bean-method"),
                        new QName("http://java.sun.com/xml/ns/javaee", "retain-if-exception"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final RemoveMethod removeMethod,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(removeMethod, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
    ...
    public final RemoveMethod read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
