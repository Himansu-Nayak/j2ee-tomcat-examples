...
public class FacesConverterExtension$JAXB extends JAXBObject<FacesConverterExtension> {

    public FacesConverterExtension$JAXB() {
        super(FacesConverterExtension.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "faces-config-converter-extensionType".intern()));
    }

    public static FacesConverterExtension readFacesConverterExtension(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesConverterExtension(final XoXMLStreamWriter writer,
            final FacesConverterExtension facesConverterExtension, final RuntimeContext context) throws Exception {
    ...
    public final static FacesConverterExtension _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-converter-extensionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final FacesConverterExtension facesConverterExtension, RuntimeContext context) throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesConverterExtension, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesConverterExtension facesConverterExtension,
            final RuntimeContext context) throws Exception {
        _write(writer, facesConverterExtension, context);
    }
