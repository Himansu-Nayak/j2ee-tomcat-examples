...
public class FacesFacetExtension$JAXB extends JAXBObject<FacesFacetExtension> {

    public FacesFacetExtension$JAXB() {
        super(FacesFacetExtension.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-facet-extensionType".intern()));
    }

    public static FacesFacetExtension readFacesFacetExtension(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesFacetExtension(final XoXMLStreamWriter writer,
            final FacesFacetExtension facesFacetExtension, final RuntimeContext context) throws Exception {
    ...
    public final static FacesFacetExtension _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-facet-extensionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesFacetExtension facesFacetExtension,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesFacetExtension, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesFacetExtension facesFacetExtension,
            final RuntimeContext context) throws Exception {
        _write(writer, facesFacetExtension, context);
    }
