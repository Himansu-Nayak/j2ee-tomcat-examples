...
public class FacesListEntries$JAXB extends JAXBObject<FacesListEntries> {

    public FacesListEntries$JAXB() {
        super(FacesListEntries.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-list-entriesType".intern()),
                FacesNullValue$JAXB.class);
    }
    ...
    public static void writeFacesListEntries(final XoXMLStreamWriter writer, final FacesListEntries facesListEntries,
    ...
    public final static FacesListEntries _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-list-entriesType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("value-class" == elementReader.getLocalName())
                ...
                try {
                    ...
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, java.lang.String.class,
                            java.lang.String.class, e);
                    continue;
                }
                ...
                nullValueOrValue.add(nullValueOrValueItem);
                    ...
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: nullValueOrValue
                final org.apache.openejb.jee.FacesNullValue nullValueOrValueItem1 = readFacesNullValue(elementReader,
                        context);
                if (nullValueOrValue == null) {
                    nullValueOrValue = facesListEntries.nullValueOrValue;
                    if (nullValueOrValue != null) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "value-class"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesListEntries facesListEntries,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesListEntries, "id", CollapsedStringAdapter.class, java.lang.String.class,
                        java.lang.String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesListEntries, "valueClass", CollapsedStringAdapter.class,
                    java.lang.String.class, java.lang.String.class, e);
        }
        if (valueClass != null) {
        ...
        if (nullValueOrValue != null) {
            for (final Object nullValueOrValueItem : nullValueOrValue) {
                if (nullValueOrValueItem instanceof org.apache.openejb.jee.FacesNullValue) {
                    ...
                    context.unexpectedElementType(writer, facesListEntries, "nullValueOrValue", nullValueOrValueItem,
                            org.apache.openejb.jee.FacesNullValue.class, java.lang.String.class);
                }
            }
        }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesListEntries facesListEntries,
            final RuntimeContext context) throws Exception {
        _write(writer, facesListEntries, context);
    }

    public final FacesListEntries read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
