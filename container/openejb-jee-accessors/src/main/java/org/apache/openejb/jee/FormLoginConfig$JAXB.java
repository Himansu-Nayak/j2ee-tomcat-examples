...
public class FormLoginConfig$JAXB extends JAXBObject<FormLoginConfig> {

    public FormLoginConfig$JAXB() {
        super(FormLoginConfig.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "form-login-configType".intern()));
    }
    ...
    public static void writeFormLoginConfig(final XoXMLStreamWriter writer, final FormLoginConfig formLoginConfig,
            final RuntimeContext context) throws Exception {
        _write(writer, formLoginConfig, context);
    }

    public final static FormLoginConfig _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("form-login-configType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("form-login-page" == elementReader.getLocalName())
            ...
            } else if (("form-error-page" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "form-login-page"),
                        new QName("http://java.sun.com/xml/ns/javaee", "form-error-page"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FormLoginConfig formLoginConfig,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(formLoginConfig, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(formLoginConfig, "formLoginPage", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(formLoginConfig, "formErrorPage", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final FormLoginConfig formLoginConfig,
            final RuntimeContext context) throws Exception {
        _write(writer, formLoginConfig, context);
    }

    public final FormLoginConfig read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
