...
public class Timeout$JAXB extends JAXBObject<Timeout> {

    public Timeout$JAXB() {
        super(Timeout.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "access-timeoutType".intern()));
    }

    public static Timeout readTimeout(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static Timeout _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("access-timeoutType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("timeout" == elementReader.getLocalName())
            ...
            } else if (("unit" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: unit
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "timeout"),
                        new QName("http://java.sun.com/xml/ns/javaee", "unit"));
            }
        }
    ...
    public final Timeout read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
