...
public class ApplicationException$JAXB extends JAXBObject<ApplicationException> {

    public ApplicationException$JAXB() {
        super(ApplicationException.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "application-exceptionType".intern()));
    }

    public static ApplicationException readApplicationException(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeApplicationException(final XoXMLStreamWriter writer,
            final ApplicationException applicationException, final RuntimeContext context) throws Exception {
    ...
    public final static ApplicationException _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("application-exceptionType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("exception-class" == elementReader.getLocalName())
            ...
            } else if (("rollback" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: rollback
                final Boolean rollback = ("1".equals(elementReader.getElementAsString())
                        || "true".equals(elementReader.getElementAsString()));
                applicationException.rollback = rollback;
            } else if (("inherited" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: inherited
                final Boolean inherited = ("1".equals(elementReader.getElementAsString())
                        || "true".equals(elementReader.getElementAsString()));
                applicationException.inherited = inherited;
            } else {
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "exception-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "rollback"),
                        new QName("http://java.sun.com/xml/ns/javaee", "inherited"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ApplicationException applicationException,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(applicationException, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(applicationException, "exceptionClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final ApplicationException applicationException,
            final RuntimeContext context) throws Exception {
        _write(writer, applicationException, context);
    }
