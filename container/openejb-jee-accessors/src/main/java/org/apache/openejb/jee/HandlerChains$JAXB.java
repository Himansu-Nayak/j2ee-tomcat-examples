...
public class HandlerChains$JAXB extends JAXBObject<HandlerChains> {

    public HandlerChains$JAXB() {
        super(HandlerChains.class, new QName("http://java.sun.com/xml/ns/javaee".intern(), "handler-chains".intern()),
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "handler-chainsType".intern()),
                HandlerChain$JAXB.class);
    }
    ...
    public static void writeHandlerChains(final XoXMLStreamWriter writer, final HandlerChains handlerChains,
            final RuntimeContext context) throws Exception {
        _write(writer, handlerChains, context);
    }

    public final static HandlerChains _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("handler-chainsType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("handler-chain" == elementReader.getLocalName())
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "handler-chain"));
            }
        }
        if (handlerChain != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final HandlerChains handlerChains,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(handlerChains, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
    ...
    public final HandlerChains read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
}
