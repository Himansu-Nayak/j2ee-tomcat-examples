...
public class ContainerTransaction$JAXB extends JAXBObject<ContainerTransaction> {

    public ContainerTransaction$JAXB() {
        super(ContainerTransaction.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "container-transactionType".intern()),
                Text$JAXB.class, Method$JAXB.class, TransAttribute$JAXB.class);
    }

    public static ContainerTransaction readContainerTransaction(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeContainerTransaction(final XoXMLStreamWriter writer,
            final ContainerTransaction containerTransaction, final RuntimeContext context) throws Exception {
    ...
    public final static ContainerTransaction _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("container-transactionType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("trans-attribute" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: transAttribute
                final TransAttribute transAttribute = parseTransAttribute(elementReader, context,
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "trans-attribute"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ContainerTransaction containerTransaction,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(containerTransaction, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final ContainerTransaction containerTransaction,
            final RuntimeContext context) throws Exception {
        _write(writer, containerTransaction, context);
    }
