...
public class Interceptors$JAXB extends JAXBObject<Interceptors> {

    public Interceptors$JAXB() {
        super(Interceptors.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "interceptorsType".intern()), Text$JAXB.class,
                Interceptor$JAXB.class);
    }
    ...
    public static void writeInterceptors(final XoXMLStreamWriter writer, final Interceptors interceptors,
            final RuntimeContext context) throws Exception {
        _write(writer, interceptors, context);
    }

    public final static Interceptors _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("interceptorsType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("interceptor" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: interceptor
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "interceptor"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final Interceptors interceptors,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(interceptors, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
    ...
    public final Interceptors read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
