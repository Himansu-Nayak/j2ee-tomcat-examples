...
public class TransportGuarantee$JAXB extends JAXBEnum<TransportGuarantee> {

    public TransportGuarantee$JAXB() {
        super(TransportGuarantee.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "transport-guaranteeType".intern()));
    }

    public static TransportGuarantee parseTransportGuarantee(final XoXMLStreamReader reader,
    ...
    public static String toStringTransportGuarantee(final Object bean, final String parameterName,
            final RuntimeContext context, final TransportGuarantee transportGuarantee) throws Exception {
        if (TransportGuarantee.NONE == transportGuarantee) {
            ...
            context.unexpectedEnumConst(bean, parameterName, transportGuarantee, TransportGuarantee.NONE,
    ...
    public String toString(final Object bean, final String parameterName, final RuntimeContext context,
            final TransportGuarantee transportGuarantee) throws Exception {
