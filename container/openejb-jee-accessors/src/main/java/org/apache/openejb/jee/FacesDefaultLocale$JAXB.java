...
public class FacesDefaultLocale$JAXB extends JAXBObject<FacesDefaultLocale> {
    ...
    public FacesDefaultLocale$JAXB() {
        super(FacesDefaultLocale.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-default-localeType".intern()));
    }

    public static FacesDefaultLocale readFacesDefaultLocale(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesDefaultLocale(final XoXMLStreamWriter writer,
            final FacesDefaultLocale facesDefaultLocale, final RuntimeContext context) throws Exception {
    ...
    public final static FacesDefaultLocale _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-default-localeType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesDefaultLocale facesDefaultLocale,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesDefaultLocale, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesDefaultLocale facesDefaultLocale,
            final RuntimeContext context) throws Exception {
        _write(writer, facesDefaultLocale, context);
    }
