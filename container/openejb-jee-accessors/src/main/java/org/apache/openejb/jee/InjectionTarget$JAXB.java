...
public class InjectionTarget$JAXB extends JAXBObject<InjectionTarget> {

    public InjectionTarget$JAXB() {
        super(InjectionTarget.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "injection-targetType".intern()));
    }
    ...
    public static void writeInjectionTarget(final XoXMLStreamWriter writer, final InjectionTarget injectionTarget,
            final RuntimeContext context) throws Exception {
        _write(writer, injectionTarget, context);
    }

    public final static InjectionTarget _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("injection-targetType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("injection-target-class" == elementReader.getLocalName())
            ...
            } else if (("injection-target-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "injection-target-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "injection-target-name"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final InjectionTarget injectionTarget,
        ...
        try {
            ...
            context.xmlAdapterError(injectionTarget, "injectionTargetClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(injectionTarget, "injectionTargetName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final InjectionTarget injectionTarget,
            final RuntimeContext context) throws Exception {
        _write(writer, injectionTarget, context);
    }

    public final InjectionTarget read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
