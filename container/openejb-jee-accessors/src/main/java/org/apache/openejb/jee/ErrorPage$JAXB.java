...
public class ErrorPage$JAXB extends JAXBObject<ErrorPage> {

    public ErrorPage$JAXB() {
        super(ErrorPage.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "error-pageType".intern()));
    }
    ...
    public static void writeErrorPage(final XoXMLStreamWriter writer, final ErrorPage errorPage,
            final RuntimeContext context) throws Exception {
        _write(writer, errorPage, context);
    }

    public final static ErrorPage _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("error-pageType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("error-code" == elementReader.getLocalName())
            ...
            } else if (("exception-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("location" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: location
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "error-code"),
                        new QName("http://java.sun.com/xml/ns/javaee", "exception-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "location"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ErrorPage errorPage, RuntimeContext context)
        ...
        try {
            ...
            context.xmlAdapterError(errorPage, "exceptionType", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final ErrorPage read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
