...
public class FacesOrderingOrdering$JAXB extends JAXBObject<FacesOrderingOrdering> {

    public FacesOrderingOrdering$JAXB() {
        super(FacesOrderingOrdering.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-ordering-orderingType".intern()),
                FacesOrderingOthers$JAXB.class);
    }

    public static FacesOrderingOrdering readFacesOrderingOrdering(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesOrderingOrdering(final XoXMLStreamWriter writer,
            final FacesOrderingOrdering facesOrderingOrdering, final RuntimeContext context) throws Exception {
    ...
    public final static FacesOrderingOrdering _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-ordering-orderingType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesOrderingOrdering facesOrderingOrdering,
        ...
        if (nameRaw != null) {
            for (final String nameItem : nameRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesOrderingOrdering, "name", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesOrderingOrdering facesOrderingOrdering,
            final RuntimeContext context) throws Exception {
        _write(writer, facesOrderingOrdering, context);
    }
