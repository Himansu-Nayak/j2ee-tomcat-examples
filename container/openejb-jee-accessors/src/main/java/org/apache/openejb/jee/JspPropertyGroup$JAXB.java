...
public class JspPropertyGroup$JAXB extends JAXBObject<JspPropertyGroup> {

    public JspPropertyGroup$JAXB() {
        super(JspPropertyGroup.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "jsp-property-groupType".intern()),
                Text$JAXB.class, Icon$JAXB.class);
    }
    ...
    public static void writeJspPropertyGroup(final XoXMLStreamWriter writer, final JspPropertyGroup jspPropertyGroup,
    ...
    public final static JspPropertyGroup _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("jsp-property-groupType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("url-pattern" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: urlPattern
            ...
            } else if (("el-ignored" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: elIgnored
                final Boolean elIgnored = ("1".equals(elementReader.getElementAsString())
                        || "true".equals(elementReader.getElementAsString()));
                jspPropertyGroup.elIgnored = elIgnored;
            } else if (("page-encoding" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("scripting-invalid" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: scriptingInvalid
                final Boolean scriptingInvalid = ("1".equals(elementReader.getElementAsString())
                        || "true".equals(elementReader.getElementAsString()));
                jspPropertyGroup.scriptingInvalid = scriptingInvalid;
            } else if (("is-xml" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: isXml
                final Boolean isXml = ("1".equals(elementReader.getElementAsString())
                        || "true".equals(elementReader.getElementAsString()));
                jspPropertyGroup.isXml = isXml;
            } else if (("include-prelude" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("include-coda" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: includeCoda
            ...
            } else if (("deferred-syntax-allowed-as-literal" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: deferredSyntaxAllowedAsLiteral
                final Boolean deferredSyntaxAllowedAsLiteral = ("1".equals(elementReader.getElementAsString())
                        || "true".equals(elementReader.getElementAsString()));
                jspPropertyGroup.deferredSyntaxAllowedAsLiteral = deferredSyntaxAllowedAsLiteral;
            } else if (("trim-directive-whitespaces" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: trimDirectiveWhitespaces
                final Boolean trimDirectiveWhitespaces = ("1".equals(elementReader.getElementAsString())
                        || "true".equals(elementReader.getElementAsString()));
                jspPropertyGroup.trimDirectiveWhitespaces = trimDirectiveWhitespaces;
            } else if (("default-content-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("buffer" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: buffer
            ...
            } else if (("error-on-undeclared-namespace" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: errorOnUndeclaredNamespace
                final Boolean errorOnUndeclaredNamespace = ("1".equals(elementReader.getElementAsString())
                        || "true".equals(elementReader.getElementAsString()));
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "url-pattern"),
                        new QName("http://java.sun.com/xml/ns/javaee", "el-ignored"),
                        new QName("http://java.sun.com/xml/ns/javaee", "page-encoding"),
                        new QName("http://java.sun.com/xml/ns/javaee", "scripting-invalid"),
                        new QName("http://java.sun.com/xml/ns/javaee", "is-xml"),
                        new QName("http://java.sun.com/xml/ns/javaee", "include-prelude"),
                        new QName("http://java.sun.com/xml/ns/javaee", "include-coda"),
                        new QName("http://java.sun.com/xml/ns/javaee", "deferred-syntax-allowed-as-literal"),
                        new QName("http://java.sun.com/xml/ns/javaee", "trim-directive-whitespaces"),
                        new QName("http://java.sun.com/xml/ns/javaee", "default-content-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "buffer"),
                        new QName("http://java.sun.com/xml/ns/javaee", "error-on-undeclared-namespace"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final JspPropertyGroup jspPropertyGroup,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(jspPropertyGroup, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        if (urlPatternRaw != null) {
            for (final String urlPatternItem : urlPatternRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(jspPropertyGroup, "urlPattern", TrimStringAdapter.class, List.class,
                            List.class, e);
                }
                if (urlPattern != null) {
        ...
        try {
            ...
            context.xmlAdapterError(jspPropertyGroup, "pageEncoding", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        if (includePreludeRaw != null) {
            for (final String includePreludeItem : includePreludeRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(jspPropertyGroup, "includePrelude", CollapsedStringAdapter.class,
        ...
        if (includeCodaRaw != null) {
            for (final String includeCodaItem : includeCodaRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(jspPropertyGroup, "includeCoda", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (includeCoda != null) {
        ...
        try {
            ...
            context.xmlAdapterError(jspPropertyGroup, "defaultContentType", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(jspPropertyGroup, "buffer", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (buffer != null) {
    ...
    public final JspPropertyGroup read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
