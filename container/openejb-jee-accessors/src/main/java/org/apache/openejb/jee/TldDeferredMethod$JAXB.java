...
public class TldDeferredMethod$JAXB extends JAXBObject<TldDeferredMethod> {

    public TldDeferredMethod$JAXB() {
        super(TldDeferredMethod.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "tld-deferred-methodType".intern()));
    }
    ...
    public static void writeTldDeferredMethod(final XoXMLStreamWriter writer, final TldDeferredMethod tldDeferredMethod,
    ...
    public final static TldDeferredMethod _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("tld-deferred-methodType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("method-signature" == elementReader.getLocalName())
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "method-signature"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final TldDeferredMethod tldDeferredMethod,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(tldDeferredMethod, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(tldDeferredMethod, "methodSignature", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final TldDeferredMethod tldDeferredMethod,
            final RuntimeContext context) throws Exception {
        _write(writer, tldDeferredMethod, context);
    }

    public final TldDeferredMethod read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
