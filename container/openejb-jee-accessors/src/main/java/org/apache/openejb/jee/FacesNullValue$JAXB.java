...
public class FacesNullValue$JAXB extends JAXBObject<FacesNullValue> {

    public FacesNullValue$JAXB() {
        super(FacesNullValue.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-null-valueType".intern()));
    }
    ...
    public static void writeFacesNullValue(final XoXMLStreamWriter writer, final FacesNullValue facesNullValue,
            final RuntimeContext context) throws Exception {
        _write(writer, facesNullValue, context);
    }

    public final static FacesNullValue _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-null-valueType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesNullValue facesNullValue,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesNullValue, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
    ...
    public final FacesNullValue read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
