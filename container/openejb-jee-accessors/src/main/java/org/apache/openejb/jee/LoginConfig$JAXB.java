...
public class LoginConfig$JAXB extends JAXBObject<LoginConfig> {

    public LoginConfig$JAXB() {
        super(LoginConfig.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "login-configType".intern()),
                FormLoginConfig$JAXB.class);
    }
    ...
    public static void writeLoginConfig(final XoXMLStreamWriter writer, final LoginConfig loginConfig,
            final RuntimeContext context) throws Exception {
        _write(writer, loginConfig, context);
    }

    public final static LoginConfig _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("login-configType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("auth-method" == elementReader.getLocalName())
            ...
            } else if (("realm-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: realmName
            ...
            } else if (("form-login-config" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "auth-method"),
                        new QName("http://java.sun.com/xml/ns/javaee", "realm-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "form-login-config"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final LoginConfig loginConfig,
        ...
        try {
            ...
            context.xmlAdapterError(loginConfig, "authMethod", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (authMethod != null) {
        ...
        try {
            ...
            context.xmlAdapterError(loginConfig, "realmName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (realmName != null) {
    ...
    public final LoginConfig read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
