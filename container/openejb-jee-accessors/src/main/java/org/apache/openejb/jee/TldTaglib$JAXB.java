...
public class TldTaglib$JAXB extends JAXBObject<TldTaglib> {

    public TldTaglib$JAXB() {
        super(TldTaglib.class, new QName("http://java.sun.com/xml/ns/javaee".intern(), "taglib".intern()),
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "tldTaglibType".intern()), Text$JAXB.class,
                Icon$JAXB.class, Validator$JAXB.class, Listener$JAXB.class, Tag$JAXB.class, TagFile$JAXB.class,
                Function$JAXB.class, TldExtension$JAXB.class);
    }
    ...
    public static void writeTldTaglib(final XoXMLStreamWriter writer, final TldTaglib tldTaglib,
            final RuntimeContext context) throws Exception {
        _write(writer, tldTaglib, context);
    }

    public final static TldTaglib _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("tldTaglibType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("tlib-version" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: tlibVersion
            ...
            } else if (("jsp-version" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: jspVersion
            ...
            } else if (("short-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: shortName
            ...
            } else if (("uri" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: uri
            ...
            } else if (("tag" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: tag
                ...
                tag.add(tagItem);
            } else if (("tag-file" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: tagFile
            ...
            } else if (("function" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: function
            ...
            } else if (("taglib-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "tlib-version"),
                        new QName("http://java.sun.com/xml/ns/javaee", "jsp-version"),
                        new QName("http://java.sun.com/xml/ns/javaee", "short-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "uri"),
                        new QName("http://java.sun.com/xml/ns/javaee", "validator"),
                        new QName("http://java.sun.com/xml/ns/javaee", "listener"),
                        new QName("http://java.sun.com/xml/ns/javaee", "tag"),
                        new QName("http://java.sun.com/xml/ns/javaee", "tag-file"),
                        new QName("http://java.sun.com/xml/ns/javaee", "function"),
                        new QName("http://java.sun.com/xml/ns/javaee", "taglib-extension"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final TldTaglib tldTaglib, RuntimeContext context)
        ...
        if (versionRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(tldTaglib, "version", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(tldTaglib, "tlibVersion", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (tlibVersion != null) {
        ...
        try {
            ...
            context.xmlAdapterError(tldTaglib, "jspVersion", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (jspVersion != null) {
        ...
        try {
            ...
            context.xmlAdapterError(tldTaglib, "shortName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (shortName != null) {
    ...
    public final TldTaglib read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
