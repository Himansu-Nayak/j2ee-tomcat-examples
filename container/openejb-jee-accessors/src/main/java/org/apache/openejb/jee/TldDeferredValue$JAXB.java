...
public class TldDeferredValue$JAXB extends JAXBObject<TldDeferredValue> {

    public TldDeferredValue$JAXB() {
        super(TldDeferredValue.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "tld-deferred-valueType".intern()));
    }
    ...
    public static void writeTldDeferredValue(final XoXMLStreamWriter writer, final TldDeferredValue tldDeferredValue,
    ...
    public final static TldDeferredValue _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("tld-deferred-valueType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("type" == elementReader.getLocalName())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final TldDeferredValue tldDeferredValue,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(tldDeferredValue, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(tldDeferredValue, "type", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (type != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final TldDeferredValue tldDeferredValue,
            final RuntimeContext context) throws Exception {
        _write(writer, tldDeferredValue, context);
    }

    public final TldDeferredValue read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
