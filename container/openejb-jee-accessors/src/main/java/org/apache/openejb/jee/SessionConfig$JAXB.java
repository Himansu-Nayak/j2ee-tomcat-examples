...
public class SessionConfig$JAXB extends JAXBObject<SessionConfig> {

    public SessionConfig$JAXB() {
        super(SessionConfig.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "session-configType".intern()),
                CookieConfig$JAXB.class, TrackingMode$JAXB.class);
    }
    ...
    public static void writeSessionConfig(final XoXMLStreamWriter writer, final SessionConfig sessionConfig,
            final RuntimeContext context) throws Exception {
        _write(writer, sessionConfig, context);
    }

    public final static SessionConfig _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("session-configType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("session-timeout" == elementReader.getLocalName())
            ...
            } else if (("cookie-config" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("tracking-mode" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: trackingMode
                final TrackingMode trackingModeItem = parseTrackingMode(elementReader, context,
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "session-timeout"),
                        new QName("http://java.sun.com/xml/ns/javaee", "cookie-config"),
                        new QName("http://java.sun.com/xml/ns/javaee", "tracking-mode"));
            }
        }
        if (trackingMode != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final SessionConfig sessionConfig,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(sessionConfig, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
    ...
    public final SessionConfig read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
