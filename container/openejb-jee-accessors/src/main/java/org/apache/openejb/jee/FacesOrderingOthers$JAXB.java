...
public class FacesOrderingOthers$JAXB extends JAXBObject<FacesOrderingOthers> {
    ...
    public FacesOrderingOthers$JAXB() {
        super(FacesOrderingOthers.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-ordering-othersType".intern()));
    }

    public static FacesOrderingOthers readFacesOrderingOthers(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesOrderingOthers(final XoXMLStreamWriter writer,
            final FacesOrderingOthers facesOrderingOthers, final RuntimeContext context) throws Exception {
    ...
    public final static FacesOrderingOthers _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-ordering-othersType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesOrderingOthers facesOrderingOthers,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesOrderingOthers, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesOrderingOthers facesOrderingOthers,
            final RuntimeContext context) throws Exception {
        _write(writer, facesOrderingOthers, context);
    }
