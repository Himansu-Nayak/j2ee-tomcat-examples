...
public class NamedMethod$JAXB extends JAXBObject<NamedMethod> {

    public NamedMethod$JAXB() {
        super(NamedMethod.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "named-methodType".intern()),
    ...
    public static void writeNamedMethod(final XoXMLStreamWriter writer, final NamedMethod namedMethod,
            final RuntimeContext context) throws Exception {
        _write(writer, namedMethod, context);
    }

    public final static NamedMethod _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("named-methodType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final NamedMethod namedMethod,
        ...
        try {
            ...
            context.xmlAdapterError(namedMethod, "methodName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (methodName != null) {
    ...
    public final NamedMethod read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
