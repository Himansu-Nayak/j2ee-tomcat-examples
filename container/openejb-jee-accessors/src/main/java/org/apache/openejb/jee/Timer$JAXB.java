...
public class Timer$JAXB extends JAXBObject<Timer> {
    ...
    public Timer$JAXB() {
        super(Timer.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "timerType".intern()),
                Text$JAXB.class, TimerSchedule$JAXB.class, NamedMethod$JAXB.class);
    }

    public static Timer readTimer(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static Timer _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                final XMLGregorianCalendar start = datatypeFactory
                        .newXMLGregorianCalendar(elementReader.getElementAsString());
                timer.start = start;
            } else if (("end" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: end
                final XMLGregorianCalendar end = datatypeFactory
                        .newXMLGregorianCalendar(elementReader.getElementAsString());
                timer.end = end;
                ...
                timer.timeoutMethod = timeoutMethod;
                    ...
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: persistent
                final Boolean persistent = ("1".equals(elementReader.getElementAsString())
    ...
    public final Timer read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
