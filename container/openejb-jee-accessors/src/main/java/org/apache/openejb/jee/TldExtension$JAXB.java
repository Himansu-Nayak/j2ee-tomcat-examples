...
public class TldExtension$JAXB extends JAXBObject<TldExtension> {
    ...
    public TldExtension$JAXB() {
        super(TldExtension.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "tld-extensionType".intern()));
    }
    ...
    public static void writeTldExtension(final XoXMLStreamWriter writer, final TldExtension tldExtension,
            final RuntimeContext context) throws Exception {
        _write(writer, tldExtension, context);
    }

    public final static TldExtension _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("tld-extensionType" != xsiType.getLocalPart())
        ...
        for (final Attribute attribute : reader.getAttributes()) {
            if (("id" == attribute.getLocalName())
                ...
                tldExtension.id = id;
            } else if (("namespace" == attribute.getLocalName())
                    && (("" == attribute.getNamespace()) || (attribute.getNamespace() == null))) {
                // ATTRIBUTE: namespace
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("extension-element" == elementReader.getLocalName())
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "extension-element"));
            }
        }
        if (extensionElement != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final TldExtension tldExtension,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(tldExtension, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        if (namespaceRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(tldExtension, "namespace", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        if (extensionElementRaw != null) {
            for (final String extensionElementItem : extensionElementRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(tldExtension, "extensionElement", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (extensionElement != null) {
    ...
    public final TldExtension read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
