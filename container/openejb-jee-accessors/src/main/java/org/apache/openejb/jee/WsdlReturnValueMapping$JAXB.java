...
public class WsdlReturnValueMapping$JAXB extends JAXBObject<WsdlReturnValueMapping> {

    public WsdlReturnValueMapping$JAXB() {
        super(WsdlReturnValueMapping.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "wsdl-return-value-mappingType".intern()));
    }

    public static WsdlReturnValueMapping readWsdlReturnValueMapping(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeWsdlReturnValueMapping(final XoXMLStreamWriter writer,
            final WsdlReturnValueMapping wsdlReturnValueMapping, final RuntimeContext context) throws Exception {
    ...
    public final static WsdlReturnValueMapping _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("wsdl-return-value-mappingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("method-return-value" == elementReader.getLocalName())
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "method-return-value"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final WsdlReturnValueMapping wsdlReturnValueMapping,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(wsdlReturnValueMapping, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(wsdlReturnValueMapping, "methodReturnValue", CollapsedStringAdapter.class,
        ...
        try {
            ...
            context.xmlAdapterError(wsdlReturnValueMapping, "wsdlMessagePartName", CollapsedStringAdapter.class,
                    String.class, String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final WsdlReturnValueMapping wsdlReturnValueMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, wsdlReturnValueMapping, context);
    }
