...
public class FacesApplicationResourceBundle$JAXB extends JAXBObject<FacesApplicationResourceBundle> {

    public FacesApplicationResourceBundle$JAXB() {
        super(FacesApplicationResourceBundle.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "faces-config-application-resource-bundleType".intern()), Text$JAXB.class, Icon$JAXB.class);
    }

    public static FacesApplicationResourceBundle readFacesApplicationResourceBundle(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesApplicationResourceBundle(final XoXMLStreamWriter writer,
            final FacesApplicationResourceBundle facesApplicationResourceBundle, final RuntimeContext context)
                    throws Exception {
    ...
    public final static FacesApplicationResourceBundle _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-application-resource-bundleType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("base-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: baseName
            ...
            } else if (("var" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: var
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "base-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "var"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final FacesApplicationResourceBundle facesApplicationResourceBundle, RuntimeContext context)
                    throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesApplicationResourceBundle, "id", CollapsedStringAdapter.class,
        ...
        try {
            ...
            context.getterError(facesApplicationResourceBundle, "descriptions", FacesApplicationResourceBundle.class,
                    "getDescriptions", e);
        }
        if (descriptions != null) {
        ...
        try {
            ...
            context.getterError(facesApplicationResourceBundle, "displayNames", FacesApplicationResourceBundle.class,
                    "getDisplayNames", e);
        }
        if (displayNames != null) {
        ...
        try {
            ...
            context.xmlAdapterError(facesApplicationResourceBundle, "baseName", CollapsedStringAdapter.class,
                    String.class, String.class, e);
        }
        if (baseName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(facesApplicationResourceBundle, "var", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (var != null) {
