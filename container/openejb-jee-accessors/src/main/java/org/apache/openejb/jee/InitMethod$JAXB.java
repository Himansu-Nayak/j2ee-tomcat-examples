...
public class InitMethod$JAXB extends JAXBObject<InitMethod> {
    ...
    public InitMethod$JAXB() {
        super(InitMethod.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "init-methodType".intern()),
    ...
    public static void writeInitMethod(final XoXMLStreamWriter writer, final InitMethod initMethod,
    ...
    public final static InitMethod _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("init-methodType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("create-method" == elementReader.getLocalName())
            ...
            } else if (("bean-method" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: beanMethod
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "create-method"),
                        new QName("http://java.sun.com/xml/ns/javaee", "bean-method"));
            }
        }
