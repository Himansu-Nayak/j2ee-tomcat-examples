...
public class FacesRendererExtension$JAXB extends JAXBObject<FacesRendererExtension> {

    public FacesRendererExtension$JAXB() {
        super(FacesRendererExtension.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "faces-config-renderer-extensionType".intern()));
    }

    public static FacesRendererExtension readFacesRendererExtension(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesRendererExtension(final XoXMLStreamWriter writer,
            final FacesRendererExtension facesRendererExtension, final RuntimeContext context) throws Exception {
    ...
    public final static FacesRendererExtension _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-renderer-extensionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesRendererExtension facesRendererExtension,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesRendererExtension, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesRendererExtension facesRendererExtension,
            final RuntimeContext context) throws Exception {
        _write(writer, facesRendererExtension, context);
    }
