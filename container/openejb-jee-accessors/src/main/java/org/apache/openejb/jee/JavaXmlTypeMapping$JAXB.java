...
public class JavaXmlTypeMapping$JAXB extends JAXBObject<JavaXmlTypeMapping> {

    public JavaXmlTypeMapping$JAXB() {
        super(JavaXmlTypeMapping.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "java-xml-type-mappingType".intern()),
                VariableMapping$JAXB.class);
    }

    public static JavaXmlTypeMapping readJavaXmlTypeMapping(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeJavaXmlTypeMapping(final XoXMLStreamWriter writer,
            final JavaXmlTypeMapping javaXmlTypeMapping, final RuntimeContext context) throws Exception {
    ...
    public final static JavaXmlTypeMapping _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("java-xml-type-mappingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("java-type" == elementReader.getLocalName())
            ...
            } else if (("root-type-qname" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("anonymous-type-qname" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("qname-scope" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: qnameScope
            ...
            } else if (("variable-mapping" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "java-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "root-type-qname"),
                        new QName("http://java.sun.com/xml/ns/javaee", "anonymous-type-qname"),
                        new QName("http://java.sun.com/xml/ns/javaee", "qname-scope"),
                        new QName("http://java.sun.com/xml/ns/javaee", "variable-mapping"));
            }
        }
        if (variableMapping != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final JavaXmlTypeMapping javaXmlTypeMapping,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(javaXmlTypeMapping, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(javaXmlTypeMapping, "javaType", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (javaType != null) {
        ...
        try {
            ...
            context.xmlAdapterError(javaXmlTypeMapping, "anonymousTypeQname", CollapsedStringAdapter.class,
        ...
        try {
            ...
            context.xmlAdapterError(javaXmlTypeMapping, "qnameScope", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (qnameScope != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final JavaXmlTypeMapping javaXmlTypeMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, javaXmlTypeMapping, context);
    }
