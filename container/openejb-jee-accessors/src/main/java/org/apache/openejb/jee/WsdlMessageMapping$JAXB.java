...
public class WsdlMessageMapping$JAXB extends JAXBObject<WsdlMessageMapping> {

    public WsdlMessageMapping$JAXB() {
        super(WsdlMessageMapping.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "wsdl-message-mappingType".intern()));
    }

    public static WsdlMessageMapping readWsdlMessageMapping(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeWsdlMessageMapping(final XoXMLStreamWriter writer,
            final WsdlMessageMapping wsdlMessageMapping, final RuntimeContext context) throws Exception {
    ...
    public final static WsdlMessageMapping _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("wsdl-message-mappingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("wsdl-message" == elementReader.getLocalName())
            ...
            } else if (("parameter-mode" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "wsdl-message"),
                        new QName("http://java.sun.com/xml/ns/javaee", "wsdl-message-part-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "parameter-mode"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final WsdlMessageMapping wsdlMessageMapping,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(wsdlMessageMapping, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(wsdlMessageMapping, "wsdlMessagePartName", CollapsedStringAdapter.class,
        ...
        try {
            ...
            context.xmlAdapterError(wsdlMessageMapping, "parameterMode", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final WsdlMessageMapping wsdlMessageMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, wsdlMessageMapping, context);
    }
