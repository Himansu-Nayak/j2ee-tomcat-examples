...
public class FacesFacet$JAXB extends JAXBObject<FacesFacet> {

    public FacesFacet$JAXB() {
        super(FacesFacet.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-facetType".intern()),
                Text$JAXB.class, Icon$JAXB.class, FacesFacetExtension$JAXB.class);
    }
    ...
    public static void writeFacesFacet(final XoXMLStreamWriter writer, final FacesFacet facesFacet,
            final RuntimeContext context) throws Exception {
        _write(writer, facesFacet, context);
    }

    public final static FacesFacet _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-facetType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("facet-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: facetName
            ...
            } else if (("facet-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "facet-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "facet-extension"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesFacet facesFacet, RuntimeContext context)
        ...
        try {
            ...
            context.xmlAdapterError(facesFacet, "facetName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (facetName != null) {
    ...
    public final FacesFacet read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
