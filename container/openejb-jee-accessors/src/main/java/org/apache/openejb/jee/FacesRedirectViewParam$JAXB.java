...
public class FacesRedirectViewParam$JAXB extends JAXBObject<FacesRedirectViewParam> {

    public FacesRedirectViewParam$JAXB() {
        super(FacesRedirectViewParam.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "faces-config-redirect-viewParamType".intern()));
    }

    public static FacesRedirectViewParam readFacesRedirectViewParam(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesRedirectViewParam(final XoXMLStreamWriter writer,
            final FacesRedirectViewParam facesRedirectViewParam, final RuntimeContext context) throws Exception {
    ...
    public final static FacesRedirectViewParam _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-redirect-viewParamType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesRedirectViewParam facesRedirectViewParam,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesRedirectViewParam, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesRedirectViewParam, "name", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (name != null) {
        ...
        try {
            ...
            context.xmlAdapterError(facesRedirectViewParam, "value", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (value != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final FacesRedirectViewParam facesRedirectViewParam,
            final RuntimeContext context) throws Exception {
        _write(writer, facesRedirectViewParam, context);
    }
