...
public class Handler$JAXB extends JAXBObject<Handler> {

    public Handler$JAXB() {
        super(Handler.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "handlerType".intern()),
                Text$JAXB.class, Icon$JAXB.class, ParamValue$JAXB.class);
    }

    public static Handler readHandler(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static Handler _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("handlerType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("handler-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: handlerName
            ...
            } else if (("handler-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("soap-header" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: soapHeader
            ...
            } else if (("soap-role" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: soapRole
            ...
            } else if (("port-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: portName
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "handler-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "handler-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "init-param"),
                        new QName("http://java.sun.com/xml/ns/javaee", "soap-header"),
                        new QName("http://java.sun.com/xml/ns/javaee", "soap-role"),
                        new QName("http://java.sun.com/xml/ns/javaee", "port-name"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final Handler handler, RuntimeContext context)
        ...
        try {
            ...
            context.xmlAdapterError(handler, "handlerName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (handlerName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(handler, "handlerClass", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        ...
        if (soapRoleRaw != null) {
            for (final String soapRoleItem : soapRoleRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(handler, "soapRole", CollapsedStringAdapter.class, List.class, List.class,
                            e);
                }
                if (soapRole != null) {
        ...
        if (portNameRaw != null) {
            for (final String portNameItem : portNameRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(handler, "portName", CollapsedStringAdapter.class, List.class, List.class,
                            e);
                }
                if (portName != null) {
    ...
    public final Handler read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
