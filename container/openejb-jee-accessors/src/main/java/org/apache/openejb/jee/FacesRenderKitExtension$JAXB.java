...
public class FacesRenderKitExtension$JAXB extends JAXBObject<FacesRenderKitExtension> {

    public FacesRenderKitExtension$JAXB() {
        super(FacesRenderKitExtension.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "faces-config-render-kit-extensionType".intern()));
    }

    public static FacesRenderKitExtension readFacesRenderKitExtension(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesRenderKitExtension(final XoXMLStreamWriter writer,
            final FacesRenderKitExtension facesRenderKitExtension, final RuntimeContext context) throws Exception {
    ...
    public final static FacesRenderKitExtension _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-render-kit-extensionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final FacesRenderKitExtension facesRenderKitExtension, RuntimeContext context) throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesRenderKitExtension, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesRenderKitExtension facesRenderKitExtension,
            final RuntimeContext context) throws Exception {
        _write(writer, facesRenderKitExtension, context);
    }
