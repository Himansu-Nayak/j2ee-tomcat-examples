...
public class FacesFactoryExtension$JAXB extends JAXBObject<FacesFactoryExtension> {

    public FacesFactoryExtension$JAXB() {
        super(FacesFactoryExtension.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-factory-extensionType".intern()));
    }

    public static FacesFactoryExtension readFacesFactoryExtension(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesFactoryExtension(final XoXMLStreamWriter writer,
            final FacesFactoryExtension facesFactoryExtension, final RuntimeContext context) throws Exception {
    ...
    public final static FacesFactoryExtension _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-factory-extensionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesFactoryExtension facesFactoryExtension,
        ...
        // ATTRIBUTE: id
        final String idRaw = facesFactoryExtension.id;
        if (idRaw != null) {
            String id = null;
            try {
                id = Adapters.collapsedStringAdapterAdapter.marshal(idRaw);
            } catch (final Exception e) {
                context.xmlAdapterError(facesFactoryExtension, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        // ELEMENT_REF: any
        final List<Object> any = facesFactoryExtension.any;
        if (any != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final FacesFactoryExtension facesFactoryExtension,
            final RuntimeContext context) throws Exception {
        _write(writer, facesFactoryExtension, context);
    }
