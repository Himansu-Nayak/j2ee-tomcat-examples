...
public class FacesSupportedLocale$JAXB extends JAXBObject<FacesSupportedLocale> {

    public FacesSupportedLocale$JAXB() {
        super(FacesSupportedLocale.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-supported-localeType".intern()));
    }

    public static FacesSupportedLocale readFacesSupportedLocale(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesSupportedLocale(final XoXMLStreamWriter writer,
            final FacesSupportedLocale facesSupportedLocale, final RuntimeContext context) throws Exception {
    ...
    public final static FacesSupportedLocale _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-supported-localeType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesSupportedLocale facesSupportedLocale,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesSupportedLocale, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesSupportedLocale facesSupportedLocale,
            final RuntimeContext context) throws Exception {
        _write(writer, facesSupportedLocale, context);
    }
