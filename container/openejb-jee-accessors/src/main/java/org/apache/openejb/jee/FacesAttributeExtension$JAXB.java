...
public class FacesAttributeExtension$JAXB extends JAXBObject<FacesAttributeExtension> {

    public FacesAttributeExtension$JAXB() {
        super(FacesAttributeExtension.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "faces-config-attribute-extensionType".intern()));
    }

    public static FacesAttributeExtension readFacesAttributeExtension(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesAttributeExtension(final XoXMLStreamWriter writer,
            final FacesAttributeExtension facesAttributeExtension, final RuntimeContext context) throws Exception {
    ...
    public final static FacesAttributeExtension _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-attribute-extensionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final FacesAttributeExtension facesAttributeExtension, RuntimeContext context) throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesAttributeExtension, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesAttributeExtension facesAttributeExtension,
            final RuntimeContext context) throws Exception {
        _write(writer, facesAttributeExtension, context);
    }
