...
public class FacesAttribute$JAXB extends JAXBObject<FacesAttribute> {

    public FacesAttribute$JAXB() {
        super(FacesAttribute.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-attributeType".intern()),
                Text$JAXB.class, Icon$JAXB.class, FacesAttributeExtension$JAXB.class);
    }
    ...
    public static void writeFacesAttribute(final XoXMLStreamWriter writer, final FacesAttribute facesAttribute,
            final RuntimeContext context) throws Exception {
        _write(writer, facesAttribute, context);
    }

    public final static FacesAttribute _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-attributeType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("attribute-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("attribute-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("default-value" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("suggested-value" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("attribute-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: attributeExtension
                final FacesAttributeExtension attributeExtensionItem = readFacesAttributeExtension(elementReader,
                        context);
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "attribute-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "attribute-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "default-value"),
                        new QName("http://java.sun.com/xml/ns/javaee", "suggested-value"),
                        new QName("http://java.sun.com/xml/ns/javaee", "attribute-extension"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesAttribute facesAttribute,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesAttribute, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesAttribute, "attributeName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(facesAttribute, "attributeClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(facesAttribute, "defaultValue", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(facesAttribute, "suggestedValue", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final FacesAttribute read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
