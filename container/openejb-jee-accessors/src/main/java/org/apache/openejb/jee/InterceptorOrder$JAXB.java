...
public class InterceptorOrder$JAXB extends JAXBObject<InterceptorOrder> {

    public InterceptorOrder$JAXB() {
        super(InterceptorOrder.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "interceptor-orderType".intern()));
    }
    ...
    public static void writeInterceptorOrder(final XoXMLStreamWriter writer, final InterceptorOrder interceptorOrder,
    ...
    public final static InterceptorOrder _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("interceptor-orderType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("interceptor-class" == elementReader.getLocalName())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final InterceptorOrder interceptorOrder,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(interceptorOrder, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        if (interceptorClassRaw != null) {
            for (final String interceptorClassItem : interceptorClassRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(interceptorOrder, "interceptorClass", CollapsedStringAdapter.class,
    ...
    public void write(final XoXMLStreamWriter writer, final InterceptorOrder interceptorOrder,
            final RuntimeContext context) throws Exception {
        _write(writer, interceptorOrder, context);
    }

    public final InterceptorOrder read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
