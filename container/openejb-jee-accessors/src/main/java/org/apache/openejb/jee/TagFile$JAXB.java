...
public class TagFile$JAXB extends JAXBObject<TagFile> {

    public TagFile$JAXB() {
        super(TagFile.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "tagFileType".intern()),
                Text$JAXB.class, Icon$JAXB.class, TldExtension$JAXB.class);
    }

    public static TagFile readTagFile(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static TagFile _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("tagFileType" != xsiType.getLocalPart())
    ...
    public final TagFile read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
