...
public class ServiceImplBean$JAXB extends JAXBObject<ServiceImplBean> {

    public ServiceImplBean$JAXB() {
        super(ServiceImplBean.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "service-impl-beanType".intern()));
    }
    ...
    public static void writeServiceImplBean(final XoXMLStreamWriter writer, final ServiceImplBean serviceImplBean,
            final RuntimeContext context) throws Exception {
        _write(writer, serviceImplBean, context);
    }

    public final static ServiceImplBean _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("service-impl-beanType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("ejb-link" == elementReader.getLocalName())
            ...
            } else if (("servlet-link" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: servletLink
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "ejb-link"),
                        new QName("http://java.sun.com/xml/ns/javaee", "servlet-link"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ServiceImplBean serviceImplBean,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(serviceImplBean, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(serviceImplBean, "ejbLink", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (ejbLink != null) {
        ...
        try {
            ...
            context.xmlAdapterError(serviceImplBean, "servletLink", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (servletLink != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final ServiceImplBean serviceImplBean,
            final RuntimeContext context) throws Exception {
        _write(writer, serviceImplBean, context);
    }

    public final ServiceImplBean read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
