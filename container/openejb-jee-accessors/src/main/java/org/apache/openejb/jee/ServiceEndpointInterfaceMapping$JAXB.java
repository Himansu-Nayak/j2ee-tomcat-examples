...
public class ServiceEndpointInterfaceMapping$JAXB extends JAXBObject<ServiceEndpointInterfaceMapping> {

    public ServiceEndpointInterfaceMapping$JAXB() {
        super(ServiceEndpointInterfaceMapping.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "service-endpoint-interface-mappingType".intern()), ServiceEndpointMethodMapping$JAXB.class);
    }

    public static ServiceEndpointInterfaceMapping readServiceEndpointInterfaceMapping(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeServiceEndpointInterfaceMapping(final XoXMLStreamWriter writer,
            final ServiceEndpointInterfaceMapping serviceEndpointInterfaceMapping, final RuntimeContext context)
                    throws Exception {
    ...
    public final static ServiceEndpointInterfaceMapping _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("service-endpoint-interface-mappingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("service-endpoint-interface" == elementReader.getLocalName())
            ...
            } else if (("wsdl-port-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("wsdl-binding" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: wsdlBinding
                final QName wsdlBinding = elementReader.getElementAsQName();
                serviceEndpointInterfaceMapping.wsdlBinding = wsdlBinding;
            } else if (("service-endpoint-method-mapping" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: serviceEndpointMethodMapping
                final ServiceEndpointMethodMapping serviceEndpointMethodMappingItem = readServiceEndpointMethodMapping(
                ...
                context.unexpectedElement(elementReader,
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "wsdl-port-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "wsdl-binding"),
                        new QName("http://java.sun.com/xml/ns/javaee", "service-endpoint-method-mapping"));
            }
        }
        if (serviceEndpointMethodMapping != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final ServiceEndpointInterfaceMapping serviceEndpointInterfaceMapping, RuntimeContext context)
                    throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(serviceEndpointInterfaceMapping, "id", CollapsedStringAdapter.class,
        ...
        try {
            ...
            context.xmlAdapterError(serviceEndpointInterfaceMapping, "serviceEndpointInterface",
        ...
        if (serviceEndpointMethodMapping != null) {
            for (final ServiceEndpointMethodMapping serviceEndpointMethodMappingItem : serviceEndpointMethodMapping) {
                if (serviceEndpointMethodMappingItem != null) {
                    writer.writeStartElement(prefix, "service-endpoint-method-mapping",
    ...
    public void write(final XoXMLStreamWriter writer,
            final ServiceEndpointInterfaceMapping serviceEndpointInterfaceMapping, final RuntimeContext context)
                    throws Exception {
        _write(writer, serviceEndpointInterfaceMapping, context);
    }
