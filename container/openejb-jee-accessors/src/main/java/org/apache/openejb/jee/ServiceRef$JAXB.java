...
public class ServiceRef$JAXB extends JAXBObject<ServiceRef> {

    public ServiceRef$JAXB() {
        super(ServiceRef.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "service-refType".intern()), Text$JAXB.class,
                Icon$JAXB.class, PortComponentRef$JAXB.class, Handler$JAXB.class, HandlerChains$JAXB.class,
                InjectionTarget$JAXB.class);
    }
    ...
    public static void writeServiceRef(final XoXMLStreamWriter writer, final ServiceRef serviceRef,
            final RuntimeContext context) throws Exception {
        _write(writer, serviceRef, context);
    }

    public final static ServiceRef _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("service-refType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("service-ref-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("service-interface" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("service-ref-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("wsdl-file" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: wsdlFile
            ...
            } else if (("jaxrpc-mapping-file" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "service-ref-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "service-interface"),
                        new QName("http://java.sun.com/xml/ns/javaee", "service-ref-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "wsdl-file"),
                        new QName("http://java.sun.com/xml/ns/javaee", "jaxrpc-mapping-file"),
                        new QName("http://java.sun.com/xml/ns/javaee", "service-qname"),
                        new QName("http://java.sun.com/xml/ns/javaee", "port-component-ref"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ServiceRef serviceRef, RuntimeContext context)
        ...
        try {
            ...
            context.xmlAdapterError(serviceRef, "serviceRefName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(serviceRef, "serviceInterface", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(serviceRef, "serviceRefType", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(serviceRef, "wsdlFile", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (wsdlFile != null) {
        ...
        try {
            ...
            context.xmlAdapterError(serviceRef, "jaxrpcMappingFile", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(serviceRef, "mappedName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (mappedName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(serviceRef, "lookupName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (lookupName != null) {
    ...
    public final ServiceRef read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
