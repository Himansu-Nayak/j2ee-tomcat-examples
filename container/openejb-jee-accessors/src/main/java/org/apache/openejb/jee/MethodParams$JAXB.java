...
public class MethodParams$JAXB extends JAXBObject<MethodParams> {

    public MethodParams$JAXB() {
        super(MethodParams.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "method-paramsType".intern()));
    }
    ...
    public static void writeMethodParams(final XoXMLStreamWriter writer, final MethodParams methodParams,
            final RuntimeContext context) throws Exception {
        _write(writer, methodParams, context);
    }

    public final static MethodParams _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("method-param" == elementReader.getLocalName())
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "method-param"));
            }
        }
        if (methodParam != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final MethodParams methodParams,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(methodParams, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        if (methodParamRaw != null) {
            for (final String methodParamItem : methodParamRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(methodParams, "methodParam", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (methodParam != null) {
    ...
    public final MethodParams read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
