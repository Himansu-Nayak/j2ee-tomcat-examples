...
public class QueryMethod$JAXB extends JAXBObject<QueryMethod> {
    ...
    public QueryMethod$JAXB() {
        super(QueryMethod.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "query-methodType".intern()),
    ...
    public static void writeQueryMethod(final XoXMLStreamWriter writer, final QueryMethod queryMethod,
            final RuntimeContext context) throws Exception {
        _write(writer, queryMethod, context);
    }

    public final static QueryMethod _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("query-methodType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final QueryMethod queryMethod,
        ...
        try {
            ...
            context.xmlAdapterError(queryMethod, "methodName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (methodName != null) {
    ...
    public final QueryMethod read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
