...
public class EjbLocalRef$JAXB extends JAXBObject<EjbLocalRef> {

    public EjbLocalRef$JAXB() {
        super(EjbLocalRef.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "ejb-local-refType".intern()), Text$JAXB.class,
                EjbRefType$JAXB.class, InjectionTarget$JAXB.class);
    }
    ...
    public static void writeEjbLocalRef(final XoXMLStreamWriter writer, final EjbLocalRef ejbLocalRef,
            final RuntimeContext context) throws Exception {
        _write(writer, ejbLocalRef, context);
    }

    public final static EjbLocalRef _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("ejb-local-refType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("ejb-ref-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: ejbRefName
            ...
            } else if (("ejb-ref-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: ejbRefType
                final EjbRefType ejbRefType = parseEjbRefType(elementReader, context,
            ...
            } else if (("ejb-link" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: ejbLink
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "ejb-ref-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "ejb-ref-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "local-home"),
                        new QName("http://java.sun.com/xml/ns/javaee", "local"),
                        new QName("http://java.sun.com/xml/ns/javaee", "ejb-link"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final EjbLocalRef ejbLocalRef,
        ...
        try {
            ...
            context.xmlAdapterError(ejbLocalRef, "ejbRefName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (ejbRefName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(ejbLocalRef, "localHome", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (localHome != null) {
        ...
        try {
            ...
            context.xmlAdapterError(ejbLocalRef, "ejbLink", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (ejbLink != null) {
        ...
        try {
            ...
            context.xmlAdapterError(ejbLocalRef, "mappedName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (mappedName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(ejbLocalRef, "lookupName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (lookupName != null) {
    ...
    public final EjbLocalRef read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
