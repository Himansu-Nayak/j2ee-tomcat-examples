...
public class BodyContent$JAXB extends JAXBEnum<BodyContent> {
    ...
    public static BodyContent parseBodyContent(final XoXMLStreamReader reader, final RuntimeContext context,
    ...
    public static String toStringBodyContent(final Object bean, final String parameterName,
            final RuntimeContext context, final BodyContent bodyContent) throws Exception {
        if (BodyContent.TAGDEPENDENT == bodyContent) {
            ...
            context.unexpectedEnumConst(bean, parameterName, bodyContent, BodyContent.TAGDEPENDENT, BodyContent.JSP,
                    BodyContent.EMPTY, BodyContent.SCRIPTLESS);
            return null;
        }
    }
    ...
    public String toString(final Object bean, final String parameterName, final RuntimeContext context,
            final BodyContent bodyContent) throws Exception {
