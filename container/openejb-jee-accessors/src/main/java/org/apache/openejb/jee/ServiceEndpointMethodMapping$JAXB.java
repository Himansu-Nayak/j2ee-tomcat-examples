...
public class ServiceEndpointMethodMapping$JAXB extends JAXBObject<ServiceEndpointMethodMapping> {
    ...
    public ServiceEndpointMethodMapping$JAXB() {
        super(ServiceEndpointMethodMapping.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "service-endpoint-method-mappingType".intern()),
                MethodParamPartsMapping$JAXB.class, WsdlReturnValueMapping$JAXB.class);
    }

    public static ServiceEndpointMethodMapping readServiceEndpointMethodMapping(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeServiceEndpointMethodMapping(final XoXMLStreamWriter writer,
            final ServiceEndpointMethodMapping serviceEndpointMethodMapping, final RuntimeContext context)
                    throws Exception {
    ...
    public final static ServiceEndpointMethodMapping _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("java-method-name" == elementReader.getLocalName())
                ...
                final MethodParamPartsMapping methodParamPartsMappingItem = readMethodParamPartsMapping(elementReader,
                        context);
                ...
                final WsdlReturnValueMapping wsdlReturnValueMapping = readWsdlReturnValueMapping(elementReader,
                        context);
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final ServiceEndpointMethodMapping serviceEndpointMethodMapping, RuntimeContext context) throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(serviceEndpointMethodMapping, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(serviceEndpointMethodMapping, "javaMethodName", CollapsedStringAdapter.class,
        ...
        try {
            ...
            context.xmlAdapterError(serviceEndpointMethodMapping, "wsdlOperation", CollapsedStringAdapter.class,
                    String.class, String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final ServiceEndpointMethodMapping serviceEndpointMethodMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, serviceEndpointMethodMapping, context);
    }
