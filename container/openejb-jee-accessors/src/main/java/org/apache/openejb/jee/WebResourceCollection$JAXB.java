...
public class WebResourceCollection$JAXB extends JAXBObject<WebResourceCollection> {

    public WebResourceCollection$JAXB() {
        super(WebResourceCollection.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "web-resource-collectionType".intern()),
                Text$JAXB.class);
    }

    public static WebResourceCollection readWebResourceCollection(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeWebResourceCollection(final XoXMLStreamWriter writer,
            final WebResourceCollection webResourceCollection, final RuntimeContext context) throws Exception {
    ...
    public final static WebResourceCollection _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("web-resource-collectionType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("web-resource-name" == elementReader.getLocalName())
            ...
            } else if (("http-method" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: httpMethod
            ...
            } else if (("http-method-omission" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    httpMethodOmissionItem = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(httpMethodOmissionItemRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "web-resource-name"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "http-method-omission"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final WebResourceCollection webResourceCollection,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(webResourceCollection, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(webResourceCollection, "webResourceName", CollapsedStringAdapter.class,
        ...
        try {
            ...
            context.getterError(webResourceCollection, "descriptions", WebResourceCollection.class, "getDescriptions",
                    e);
        }
        if (descriptions != null) {
        ...
        if (urlPatternRaw != null) {
            for (final String urlPatternItem : urlPatternRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(webResourceCollection, "urlPattern", TrimStringAdapter.class, List.class,
                            List.class, e);
                }
                if (urlPattern != null) {
        ...
        if (httpMethodRaw != null) {
            for (final String httpMethodItem : httpMethodRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(webResourceCollection, "httpMethod", CollapsedStringAdapter.class,
        ...
        if (httpMethodOmissionRaw != null) {
            for (final String httpMethodOmissionItem : httpMethodOmissionRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(webResourceCollection, "httpMethodOmission", CollapsedStringAdapter.class,
                            List.class, List.class, e);
                }
                if (httpMethodOmission != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final WebResourceCollection webResourceCollection,
            final RuntimeContext context) throws Exception {
        _write(writer, webResourceCollection, context);
    }
