...
public class MessageDestination$JAXB extends JAXBObject<MessageDestination> {
    ...
    public MessageDestination$JAXB() {
        super(MessageDestination.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "message-destinationType".intern()),
                Text$JAXB.class, Icon$JAXB.class);
    }

    public static MessageDestination readMessageDestination(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeMessageDestination(final XoXMLStreamWriter writer,
            final MessageDestination messageDestination, final RuntimeContext context) throws Exception {
    ...
    public final static MessageDestination _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("message-destinationType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("message-destination-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    messageDestinationName = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(messageDestinationNameRaw);
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "message-destination-name"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final MessageDestination messageDestination,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(messageDestination, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(messageDestination, "messageDestinationName", CollapsedStringAdapter.class,
        ...
        try {
            ...
            context.xmlAdapterError(messageDestination, "mappedName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (mappedName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(messageDestination, "lookupName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (lookupName != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final MessageDestination messageDestination,
            final RuntimeContext context) throws Exception {
        _write(writer, messageDestination, context);
    }
