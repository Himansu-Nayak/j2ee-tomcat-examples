...
public class FacesConfig$JAXB extends JAXBObject<FacesConfig> {

    public FacesConfig$JAXB() {
        super(FacesConfig.class, new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config".intern()),
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-configType".intern()),
                FacesApplication$JAXB.class, FacesOrdering$JAXB.class, FacesAbsoluteOrdering$JAXB.class,
                FacesFactory$JAXB.class, FacesComponent$JAXB.class, FacesConverter$JAXB.class,
                FacesManagedBean$JAXB.class, FacesNavigationRule$JAXB.class, FacesReferencedBean$JAXB.class,
                FacesRenderKit$JAXB.class, FacesLifecycle$JAXB.class, FacesValidator$JAXB.class,
                FacesBehavior$JAXB.class, FacesExtension$JAXB.class);
    }
    ...
    public static void writeFacesConfig(final XoXMLStreamWriter writer, final FacesConfig facesConfig,
            final RuntimeContext context) throws Exception {
        _write(writer, facesConfig, context);
    }

    public final static FacesConfig _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-configType" != xsiType.getLocalPart())
        ...
        for (final Attribute attribute : reader.getAttributes()) {
            if (("id" == attribute.getLocalName())
                ...
                context.unexpectedAttribute(attribute, new QName("", "id"), new QName("", "version"),
                        new QName("", "metadata-complete"));
            }
        }

        // Read elements
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("application" == elementReader.getLocalName())
            ...
            } else if (("ordering" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: ordering
            ...
            } else if (("factory" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: factory
            ...
            } else if (("component" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: component
            ...
            } else if (("converter" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: converter
            ...
            } else if (("managed-bean" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: managedBean
                ...
                name.add(nameItem);
            } else if (("navigation-rule" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("referenced-bean" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("render-kit" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: renderKit
            ...
            } else if (("lifecycle" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: lifecycle
            ...
            } else if (("validator" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: validator
            ...
            } else if (("behavior" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: behavior
            ...
            } else if (("faces-config-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "application"),
                        new QName("http://java.sun.com/xml/ns/javaee", "ordering"),
                        new QName("http://java.sun.com/xml/ns/javaee", "absolute-ordering"),
                        new QName("http://java.sun.com/xml/ns/javaee", "factory"),
                        new QName("http://java.sun.com/xml/ns/javaee", "component"),
                        new QName("http://java.sun.com/xml/ns/javaee", "converter"),
                        new QName("http://java.sun.com/xml/ns/javaee", "managed-bean"),
                        new QName("http://java.sun.com/xml/ns/javaee", "name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "navigation-rule"),
                        new QName("http://java.sun.com/xml/ns/javaee", "referenced-bean"),
                        new QName("http://java.sun.com/xml/ns/javaee", "render-kit"),
                        new QName("http://java.sun.com/xml/ns/javaee", "lifecycle"),
                        new QName("http://java.sun.com/xml/ns/javaee", "validator"),
                        new QName("http://java.sun.com/xml/ns/javaee", "behavior"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesConfig facesConfig,
        ...
        if (versionRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesConfig, "version", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        if (nameRaw != null) {
            for (final String nameItem : nameRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesConfig, "name", CollapsedStringAdapter.class, List.class, List.class,
                            e);
                }
    ...
    public final FacesConfig read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
