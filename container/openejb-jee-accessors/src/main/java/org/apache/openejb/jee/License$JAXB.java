...
public class License$JAXB extends JAXBObject<License> {

    public License$JAXB() {
        super(License.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "licenseType".intern()),
                Text$JAXB.class);
    }

    public static License readLicense(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static License _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("licenseType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("license-required" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: licenseRequired
                final Boolean licenseRequired = ("1".equals(elementReader.getElementAsString())
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "license-required"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final License read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
