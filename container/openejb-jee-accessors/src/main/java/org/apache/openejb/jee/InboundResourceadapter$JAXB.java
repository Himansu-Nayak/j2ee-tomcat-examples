...
public class InboundResourceadapter$JAXB extends JAXBObject<InboundResourceadapter> {

    public InboundResourceadapter$JAXB() {
        super(InboundResourceadapter.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "inbound-resourceadapterType".intern()),
                MessageAdapter$JAXB.class);
    }

    public static InboundResourceadapter readInboundResourceadapter(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeInboundResourceadapter(final XoXMLStreamWriter writer,
            final InboundResourceadapter inboundResourceadapter, final RuntimeContext context) throws Exception {
    ...
    public final static InboundResourceadapter _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("inbound-resourceadapterType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("messageadapter" == elementReader.getLocalName())
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "messageadapter"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final InboundResourceadapter inboundResourceadapter,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(inboundResourceadapter, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final InboundResourceadapter inboundResourceadapter,
            final RuntimeContext context) throws Exception {
        _write(writer, inboundResourceadapter, context);
    }
