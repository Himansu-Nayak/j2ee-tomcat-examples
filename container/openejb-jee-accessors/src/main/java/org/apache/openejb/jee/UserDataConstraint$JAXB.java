...
public class UserDataConstraint$JAXB extends JAXBObject<UserDataConstraint> {

    public UserDataConstraint$JAXB() {
        super(UserDataConstraint.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "user-data-constraintType".intern()),
                Text$JAXB.class, TransportGuarantee$JAXB.class);
    }

    public static UserDataConstraint readUserDataConstraint(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeUserDataConstraint(final XoXMLStreamWriter writer,
            final UserDataConstraint userDataConstraint, final RuntimeContext context) throws Exception {
    ...
    public final static UserDataConstraint _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("user-data-constraintType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("transport-guarantee" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: transportGuarantee
                final TransportGuarantee transportGuarantee = parseTransportGuarantee(elementReader, context,
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "transport-guarantee"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final UserDataConstraint userDataConstraint,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(userDataConstraint, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final UserDataConstraint userDataConstraint,
            final RuntimeContext context) throws Exception {
        _write(writer, userDataConstraint, context);
    }
