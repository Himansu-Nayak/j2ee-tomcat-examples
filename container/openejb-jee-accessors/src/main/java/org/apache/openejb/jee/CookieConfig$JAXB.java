...
public class CookieConfig$JAXB extends JAXBObject<CookieConfig> {

    public CookieConfig$JAXB() {
        super(CookieConfig.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "cookie-configType".intern()));
    }
    ...
    public static void writeCookieConfig(final XoXMLStreamWriter writer, final CookieConfig cookieConfig,
            final RuntimeContext context) throws Exception {
        _write(writer, cookieConfig, context);
    }

    public final static CookieConfig _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("cookie-configType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("name" == elementReader.getLocalName())
            ...
            } else if (("domain" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: domain
            ...
            } else if (("path" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: path
            ...
            } else if (("comment" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: comment
            ...
            } else if (("http-only" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: httpOnly
                final Boolean httpOnly = ("1".equals(elementReader.getElementAsString())
                        || "true".equals(elementReader.getElementAsString()));
                cookieConfig.httpOnly = httpOnly;
            } else if (("secure" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: secure
                final Boolean secure = ("1".equals(elementReader.getElementAsString())
                        || "true".equals(elementReader.getElementAsString()));
                cookieConfig.secure = secure;
            } else if (("max-age" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: maxAge
                final Integer maxAge = Integer.valueOf(elementReader.getElementAsString());
                cookieConfig.maxAge = maxAge;
            } else {
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "domain"),
                        new QName("http://java.sun.com/xml/ns/javaee", "path"),
                        new QName("http://java.sun.com/xml/ns/javaee", "comment"),
                        new QName("http://java.sun.com/xml/ns/javaee", "http-only"),
                        new QName("http://java.sun.com/xml/ns/javaee", "secure"),
                        new QName("http://java.sun.com/xml/ns/javaee", "max-age"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final CookieConfig cookieConfig,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(cookieConfig, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(cookieConfig, "domain", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (domain != null) {
        ...
        try {
            ...
            context.xmlAdapterError(cookieConfig, "comment", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (comment != null) {
    ...
    public final CookieConfig read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
