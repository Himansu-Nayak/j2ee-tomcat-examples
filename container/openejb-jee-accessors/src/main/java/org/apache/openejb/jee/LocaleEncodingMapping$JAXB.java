...
public class LocaleEncodingMapping$JAXB extends JAXBObject<LocaleEncodingMapping> {

    public LocaleEncodingMapping$JAXB() {
        super(LocaleEncodingMapping.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "locale-encoding-mappingType".intern()));
    }

    public static LocaleEncodingMapping readLocaleEncodingMapping(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeLocaleEncodingMapping(final XoXMLStreamWriter writer,
            final LocaleEncodingMapping localeEncodingMapping, final RuntimeContext context) throws Exception {
    ...
    public final static LocaleEncodingMapping _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("locale-encoding-mappingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("locale" == elementReader.getLocalName())
            ...
            } else if (("encoding" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: encoding
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "locale"),
                        new QName("http://java.sun.com/xml/ns/javaee", "encoding"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final LocaleEncodingMapping localeEncodingMapping,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(localeEncodingMapping, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(localeEncodingMapping, "locale", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (locale != null) {
        ...
        try {
            ...
            context.xmlAdapterError(localeEncodingMapping, "encoding", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (encoding != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final LocaleEncodingMapping localeEncodingMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, localeEncodingMapping, context);
    }
