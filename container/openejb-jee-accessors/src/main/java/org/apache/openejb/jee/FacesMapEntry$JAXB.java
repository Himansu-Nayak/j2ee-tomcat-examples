...
public class FacesMapEntry$JAXB extends JAXBObject<FacesMapEntry> {

    public FacesMapEntry$JAXB() {
        super(FacesMapEntry.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-map-entryType".intern()),
    ...
    public static void writeFacesMapEntry(final XoXMLStreamWriter writer, final FacesMapEntry facesMapEntry,
            final RuntimeContext context) throws Exception {
        _write(writer, facesMapEntry, context);
    }

    public final static FacesMapEntry _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-map-entryType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("key" == elementReader.getLocalName())
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "key"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesMapEntry facesMapEntry,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesMapEntry, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesMapEntry, "value", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (value != null) {
    ...
    public final FacesMapEntry read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
