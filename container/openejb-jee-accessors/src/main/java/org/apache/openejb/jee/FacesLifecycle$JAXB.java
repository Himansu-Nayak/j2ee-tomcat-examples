...
public class FacesLifecycle$JAXB extends JAXBObject<FacesLifecycle> {

    public FacesLifecycle$JAXB() {
        super(FacesLifecycle.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-lifecycleType".intern()),
                FacesLifecycleExtension$JAXB.class);
    }
    ...
    public static void writeFacesLifecycle(final XoXMLStreamWriter writer, final FacesLifecycle facesLifecycle,
            final RuntimeContext context) throws Exception {
        _write(writer, facesLifecycle, context);
    }

    public final static FacesLifecycle _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-lifecycleType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("phase-listener" == elementReader.getLocalName())
            ...
            } else if (("lifecycle-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: lifecycleExtension
                final FacesLifecycleExtension lifecycleExtensionItem = readFacesLifecycleExtension(elementReader,
                        context);
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesLifecycle facesLifecycle,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesLifecycle, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        if (phaseListenerRaw != null) {
            for (final String phaseListenerItem : phaseListenerRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(facesLifecycle, "phaseListener", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (phaseListener != null) {
    ...
    public final FacesLifecycle read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
