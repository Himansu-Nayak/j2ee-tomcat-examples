...
public class SecurityRoleRef$JAXB extends JAXBObject<SecurityRoleRef> {

    public SecurityRoleRef$JAXB() {
        super(SecurityRoleRef.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "security-role-refType".intern()),
                Text$JAXB.class);
    }
    ...
    public static void writeSecurityRoleRef(final XoXMLStreamWriter writer, final SecurityRoleRef securityRoleRef,
            final RuntimeContext context) throws Exception {
        _write(writer, securityRoleRef, context);
    }

    public final static SecurityRoleRef _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("security-role-refType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("role-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: roleName
            ...
            } else if (("role-link" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: roleLink
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "role-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "role-link"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final SecurityRoleRef securityRoleRef,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(securityRoleRef, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(securityRoleRef, "roleName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (roleName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(securityRoleRef, "roleLink", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (roleLink != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final SecurityRoleRef securityRoleRef,
            final RuntimeContext context) throws Exception {
        _write(writer, securityRoleRef, context);
    }

    public final SecurityRoleRef read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
