...
public class FacesManagedProperty$JAXB extends JAXBObject<FacesManagedProperty> {

    public FacesManagedProperty$JAXB() {
        super(FacesManagedProperty.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-managed-propertyType".intern()),
                Text$JAXB.class, Icon$JAXB.class, FacesMapEntries$JAXB.class, FacesNullValue$JAXB.class,
                FacesListEntries$JAXB.class);
    }

    public static FacesManagedProperty readFacesManagedProperty(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesManagedProperty(final XoXMLStreamWriter writer,
            final FacesManagedProperty facesManagedProperty, final RuntimeContext context) throws Exception {
    ...
    public final static FacesManagedProperty _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-managed-propertyType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("property-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("property-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "property-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "property-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "map-entries"),
                        new QName("http://java.sun.com/xml/ns/javaee", "null-value"),
                        new QName("http://java.sun.com/xml/ns/javaee", "value"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesManagedProperty facesManagedProperty,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesManagedProperty, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesManagedProperty, "propertyName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(facesManagedProperty, "propertyClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(facesManagedProperty, "value", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (value != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final FacesManagedProperty facesManagedProperty,
            final RuntimeContext context) throws Exception {
        _write(writer, facesManagedProperty, context);
    }
