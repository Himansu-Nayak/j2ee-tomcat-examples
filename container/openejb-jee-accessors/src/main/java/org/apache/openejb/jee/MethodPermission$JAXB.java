...
public class MethodPermission$JAXB extends JAXBObject<MethodPermission> {

    public MethodPermission$JAXB() {
        super(MethodPermission.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "method-permissionType".intern()),
                Text$JAXB.class, Empty$JAXB.class, Method$JAXB.class);
    }
    ...
    public static void writeMethodPermission(final XoXMLStreamWriter writer, final MethodPermission methodPermission,
    ...
    public final static MethodPermission _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("method-permissionType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("unchecked" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: unchecked
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "unchecked"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final MethodPermission methodPermission,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(methodPermission, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        if (roleNameRaw != null) {
            for (final String roleNameItem : roleNameRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(methodPermission, "roleName", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (roleName != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final MethodPermission methodPermission,
            final RuntimeContext context) throws Exception {
        _write(writer, methodPermission, context);
    }

    public final MethodPermission read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
