...
public class Connector$JAXB extends JAXBObject<Connector> {

    public Connector$JAXB() {
        super(Connector.class, new QName("http://java.sun.com/xml/ns/javaee".intern(), "connector".intern()),
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "connectorType".intern()), Text$JAXB.class,
                Icon$JAXB.class, License$JAXB.class, ResourceAdapter$JAXB.class);
    }
    ...
    public static void writeConnector(final XoXMLStreamWriter writer, final Connector connector,
            final RuntimeContext context) throws Exception {
        _write(writer, connector, context);
    }

    public final static Connector _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("connectorType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("module-name" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("vendor-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: vendorName
            ...
            } else if (("eis-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: eisType
            ...
            } else if (("resourceadapter-version" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    resourceAdapterVersion = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(resourceAdapterVersionRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
            ...
            } else if (("license" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: license
                final License license = readLicense(elementReader, context);
                connector.license = license;
            } else if (("resourceadapter" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("required-work-context" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    requiredWorkContextItem = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(requiredWorkContextItemRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "module-name"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "vendor-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "eis-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "resourceadapter-version"),
                        new QName("http://java.sun.com/xml/ns/javaee", "license"),
                        new QName("http://java.sun.com/xml/ns/javaee", "resourceadapter"),
                        new QName("http://java.sun.com/xml/ns/javaee", "required-work-context"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final Connector connector, RuntimeContext context)
        ...
        if (versionRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(connector, "version", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(connector, "moduleName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (moduleName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(connector, "vendorName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (vendorName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(connector, "resourceAdapterVersion", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        if (requiredWorkContextRaw != null) {
            for (final String requiredWorkContextItem : requiredWorkContextRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(connector, "requiredWorkContext", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (requiredWorkContext != null) {
    ...
    public final Connector read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
