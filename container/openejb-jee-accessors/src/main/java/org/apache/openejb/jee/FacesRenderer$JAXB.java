...
public class FacesRenderer$JAXB extends JAXBObject<FacesRenderer> {

    public FacesRenderer$JAXB() {
        super(FacesRenderer.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-rendererType".intern()),
                Text$JAXB.class, Icon$JAXB.class, FacesFacet$JAXB.class, FacesAttribute$JAXB.class,
                FacesRendererExtension$JAXB.class);
    }
    ...
    public static void writeFacesRenderer(final XoXMLStreamWriter writer, final FacesRenderer facesRenderer,
            final RuntimeContext context) throws Exception {
        _write(writer, facesRenderer, context);
    }

    public final static FacesRenderer _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-rendererType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("component-family" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("renderer-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("renderer-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("facet" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: facet
                ...
                facet.add(facetItem);
            } else if (("attribute" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: attribute
            ...
            } else if (("renderer-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "component-family"),
                        new QName("http://java.sun.com/xml/ns/javaee", "renderer-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "renderer-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "facet"),
                        new QName("http://java.sun.com/xml/ns/javaee", "attribute"),
                        new QName("http://java.sun.com/xml/ns/javaee", "renderer-extension"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesRenderer facesRenderer,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesRenderer, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesRenderer, "componentFamily", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(facesRenderer, "rendererType", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(facesRenderer, "rendererClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final FacesRenderer read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
