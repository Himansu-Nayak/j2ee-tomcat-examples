...
public class SecurityPermission$JAXB extends JAXBObject<SecurityPermission> {

    public SecurityPermission$JAXB() {
        super(SecurityPermission.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "security-permissionType".intern()),
                Text$JAXB.class);
    }

    public static SecurityPermission readSecurityPermission(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeSecurityPermission(final XoXMLStreamWriter writer,
            final SecurityPermission securityPermission, final RuntimeContext context) throws Exception {
    ...
    public final static SecurityPermission _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("security-permissionType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("security-permission-spec" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    securityPermissionSpec = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(securityPermissionSpecRaw);
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "security-permission-spec"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final SecurityPermission securityPermission,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(securityPermission, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(securityPermission, "securityPermissionSpec", CollapsedStringAdapter.class,
    ...
    public void write(final XoXMLStreamWriter writer, final SecurityPermission securityPermission,
            final RuntimeContext context) throws Exception {
        _write(writer, securityPermission, context);
    }
