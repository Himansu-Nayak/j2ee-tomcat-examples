...
public class FacesPropertyExtension$JAXB extends JAXBObject<FacesPropertyExtension> {

    public FacesPropertyExtension$JAXB() {
        super(FacesPropertyExtension.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "faces-config-property-extensionType".intern()));
    }

    public static FacesPropertyExtension readFacesPropertyExtension(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesPropertyExtension(final XoXMLStreamWriter writer,
            final FacesPropertyExtension facesPropertyExtension, final RuntimeContext context) throws Exception {
    ...
    public final static FacesPropertyExtension _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-property-extensionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesPropertyExtension facesPropertyExtension,
        ...
        // ATTRIBUTE: id
        final String idRaw = facesPropertyExtension.id;
        if (idRaw != null) {
            String id = null;
            try {
                id = Adapters.collapsedStringAdapterAdapter.marshal(idRaw);
            } catch (final Exception e) {
                context.xmlAdapterError(facesPropertyExtension, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        // ELEMENT_REF: any
        final List<Object> any = facesPropertyExtension.any;
        if (any != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final FacesPropertyExtension facesPropertyExtension,
            final RuntimeContext context) throws Exception {
        _write(writer, facesPropertyExtension, context);
    }

    public final FacesPropertyExtension read(final XoXMLStreamReader reader, final RuntimeContext context)
            throws Exception {
        return _read(reader, context);
    }
