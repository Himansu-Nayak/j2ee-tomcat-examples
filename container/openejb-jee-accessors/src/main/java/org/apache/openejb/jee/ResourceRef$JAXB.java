...
public class ResourceRef$JAXB extends JAXBObject<ResourceRef> {

    public ResourceRef$JAXB() {
        super(ResourceRef.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "resource-refType".intern()), Text$JAXB.class,
                ResAuth$JAXB.class, ResSharingScope$JAXB.class, InjectionTarget$JAXB.class);
    }
    ...
    public static void writeResourceRef(final XoXMLStreamWriter writer, final ResourceRef resourceRef,
            final RuntimeContext context) throws Exception {
        _write(writer, resourceRef, context);
    }

    public final static ResourceRef _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("resource-refType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("res-ref-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: resRefName
            ...
            } else if (("res-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: resType
            ...
            } else if (("res-auth" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: resAuth
            ...
            } else if (("res-sharing-scope" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: resSharingScope
                final ResSharingScope resSharingScope = parseResSharingScope(elementReader, context,
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "res-ref-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "res-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "res-auth"),
                        new QName("http://java.sun.com/xml/ns/javaee", "res-sharing-scope"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ResourceRef resourceRef,
        ...
        try {
            ...
            context.xmlAdapterError(resourceRef, "resRefName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (resRefName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(resourceRef, "resType", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (resType != null) {
        ...
        try {
            ...
            context.xmlAdapterError(resourceRef, "mappedName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (mappedName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(resourceRef, "lookupName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (lookupName != null) {
    ...
    public final ResourceRef read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
