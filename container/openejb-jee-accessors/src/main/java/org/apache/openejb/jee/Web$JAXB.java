...
public class Web$JAXB extends JAXBObject<Web> {

    public Web$JAXB() {
        super(Web.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "webType".intern()));
    }

    public static Web readWeb(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static Web _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("webType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("web-uri" == elementReader.getLocalName())
                ...
                web.webUri = webUri;
            } else if (("context-root" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: contextRoot
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "web-uri"),
                        new QName("http://java.sun.com/xml/ns/javaee", "context-root"));
            }
        }
    ...
    public void write(final XoXMLStreamWriter writer, final Web web, final RuntimeContext context) throws Exception {
        _write(writer, web, context);
    }

    public final Web read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
