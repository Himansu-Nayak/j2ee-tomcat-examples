...
public class DestinationType$JAXB extends JAXBObject<DestinationType> {

    public DestinationType$JAXB() {
        super(DestinationType.class,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "destination-type".intern()), null);
    }
    ...
    public static void writeDestinationType(final XoXMLStreamWriter writer, final DestinationType destinationType,
            final RuntimeContext context) throws Exception {
        _write(writer, destinationType, context);
    }

    public final static DestinationType _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final DestinationType destinationType,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(destinationType, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(destinationType, "value", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final DestinationType destinationType,
            final RuntimeContext context) throws Exception {
        _write(writer, destinationType, context);
    }

    public final DestinationType read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
