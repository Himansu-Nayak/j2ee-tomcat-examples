...
public class MessageAdapter$JAXB extends JAXBObject<MessageAdapter> {

    public MessageAdapter$JAXB() {
        super(MessageAdapter.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "messageadapterType".intern()),
                MessageListener$JAXB.class);
    }
    ...
    public static void writeMessageAdapter(final XoXMLStreamWriter writer, final MessageAdapter messageAdapter,
            final RuntimeContext context) throws Exception {
        _write(writer, messageAdapter, context);
    }

    public final static MessageAdapter _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("messageadapterType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("messagelistener" == elementReader.getLocalName())
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "messagelistener"));
            }
        }
        if (messageListener != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final MessageAdapter messageAdapter,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(messageAdapter, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
    ...
    public final MessageAdapter read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
