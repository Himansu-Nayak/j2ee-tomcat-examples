...
public class LocaleEncodingMappingList$JAXB extends JAXBObject<LocaleEncodingMappingList> {

    public LocaleEncodingMappingList$JAXB() {
        super(LocaleEncodingMappingList.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "locale-encoding-mapping-listType".intern()),
                LocaleEncodingMapping$JAXB.class);
    }

    public static LocaleEncodingMappingList readLocaleEncodingMappingList(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeLocaleEncodingMappingList(final XoXMLStreamWriter writer,
            final LocaleEncodingMappingList localeEncodingMappingList, final RuntimeContext context) throws Exception {
    ...
    public final static LocaleEncodingMappingList _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("locale-encoding-mapping-listType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("locale-encoding-mapping" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: localeEncodingMapping
                final LocaleEncodingMapping localeEncodingMappingItem = readLocaleEncodingMapping(elementReader,
                        context);
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "locale-encoding-mapping"));
            }
        }
        if (localeEncodingMapping != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final LocaleEncodingMappingList localeEncodingMappingList, RuntimeContext context) throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(localeEncodingMappingList, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        if (localeEncodingMapping != null) {
            for (final LocaleEncodingMapping localeEncodingMappingItem : localeEncodingMapping) {
                if (localeEncodingMappingItem != null) {
                    writer.writeStartElementWithAutoPrefix("http://java.sun.com/xml/ns/javaee",
    ...
    public void write(final XoXMLStreamWriter writer, final LocaleEncodingMappingList localeEncodingMappingList,
            final RuntimeContext context) throws Exception {
        _write(writer, localeEncodingMappingList, context);
    }
