...
public class AuthConstraint$JAXB extends JAXBObject<AuthConstraint> {

    public AuthConstraint$JAXB() {
        super(AuthConstraint.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "auth-constraintType".intern()),
                Text$JAXB.class);
    }
    ...
    public static void writeAuthConstraint(final XoXMLStreamWriter writer, final AuthConstraint authConstraint,
            final RuntimeContext context) throws Exception {
        _write(writer, authConstraint, context);
    }

    public final static AuthConstraint _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("auth-constraintType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final AuthConstraint authConstraint,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(authConstraint, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        if (roleNameRaw != null) {
            for (final String roleNameItem : roleNameRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(authConstraint, "roleName", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (roleName != null) {
    ...
    public final AuthConstraint read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
