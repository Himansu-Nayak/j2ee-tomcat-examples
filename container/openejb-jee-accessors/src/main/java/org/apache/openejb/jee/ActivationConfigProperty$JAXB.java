...
public class ActivationConfigProperty$JAXB extends JAXBObject<ActivationConfigProperty> {

    public ActivationConfigProperty$JAXB() {
        super(ActivationConfigProperty.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "activation-config-propertyType".intern()));
    }

    public static ActivationConfigProperty readActivationConfigProperty(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeActivationConfigProperty(final XoXMLStreamWriter writer,
            final ActivationConfigProperty activationConfigProperty, final RuntimeContext context) throws Exception {
    ...
    public final static ActivationConfigProperty _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("activation-config-propertyType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("activation-config-property-name" == elementReader.getLocalName())
                ...
                try {
                    activationConfigPropertyName = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(activationConfigPropertyNameRaw);
            ...
            } else if (("activation-config-property-value" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    activationConfigPropertyValue = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(activationConfigPropertyValueRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "activation-config-property-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "activation-config-property-value"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final ActivationConfigProperty activationConfigProperty, RuntimeContext context) throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(activationConfigProperty, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            activationConfigPropertyName = Adapters.collapsedStringAdapterAdapter
                    .marshal(activationConfigPropertyNameRaw);
        } catch (final Exception e) {
            context.xmlAdapterError(activationConfigProperty, "activationConfigPropertyName",
        ...
        try {
            activationConfigPropertyValue = Adapters.collapsedStringAdapterAdapter
                    .marshal(activationConfigPropertyValueRaw);
        } catch (final Exception e) {
            context.xmlAdapterError(activationConfigProperty, "activationConfigPropertyValue",
                    CollapsedStringAdapter.class, String.class, String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final ActivationConfigProperty activationConfigProperty,
            final RuntimeContext context) throws Exception {
        _write(writer, activationConfigProperty, context);
    }
