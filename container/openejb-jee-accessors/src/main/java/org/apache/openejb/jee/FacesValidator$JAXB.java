...
public class FacesValidator$JAXB extends JAXBObject<FacesValidator> {

    public FacesValidator$JAXB() {
        super(FacesValidator.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-validatorType".intern()),
                Text$JAXB.class, Icon$JAXB.class, FacesAttribute$JAXB.class, FacesProperty$JAXB.class,
                FacesValidatorExtension$JAXB.class);
    }
    ...
    public static void writeFacesValidator(final XoXMLStreamWriter writer, final FacesValidator facesValidator,
            final RuntimeContext context) throws Exception {
        _write(writer, facesValidator, context);
    }

    public final static FacesValidator _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-validatorType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("validator-id" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: validatorId
            ...
            } else if (("validator-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("validator-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: validatorExtension
                final FacesValidatorExtension validatorExtensionItem = readFacesValidatorExtension(elementReader,
                        context);
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesValidator facesValidator,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesValidator, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesValidator, "validatorId", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (validatorId != null) {
        ...
        try {
            ...
            context.xmlAdapterError(facesValidator, "validatorClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final FacesValidator read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
