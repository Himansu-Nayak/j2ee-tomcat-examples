...
public class FacesMapEntries$JAXB extends JAXBObject<FacesMapEntries> {

    public FacesMapEntries$JAXB() {
        super(FacesMapEntries.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-map-entriesType".intern()),
                FacesMapEntry$JAXB.class);
    }
    ...
    public static void writeFacesMapEntries(final XoXMLStreamWriter writer, final FacesMapEntries facesMapEntries,
            final RuntimeContext context) throws Exception {
        _write(writer, facesMapEntries, context);
    }

    public final static FacesMapEntries _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-map-entriesType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("key-class" == elementReader.getLocalName())
            ...
            } else if (("value-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: valueClass
            ...
            } else if (("map-entry" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: mapEntry
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "key-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "value-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "map-entry"));
            }
        }
        if (mapEntry != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesMapEntries facesMapEntries,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesMapEntries, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesMapEntries, "keyClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (keyClass != null) {
        ...
        try {
            ...
            context.xmlAdapterError(facesMapEntries, "valueClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (valueClass != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final FacesMapEntries facesMapEntries,
            final RuntimeContext context) throws Exception {
        _write(writer, facesMapEntries, context);
    }

    public final FacesMapEntries read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
