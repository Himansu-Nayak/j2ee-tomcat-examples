...
public class AbsoluteOrdering$JAXB extends JAXBObject<AbsoluteOrdering> {

    public AbsoluteOrdering$JAXB() {
        super(AbsoluteOrdering.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "absoluteOrderingType".intern()),
                OrderingOthers$JAXB.class);
    }
    ...
    public static void writeAbsoluteOrdering(final XoXMLStreamWriter writer, final AbsoluteOrdering absoluteOrdering,
    ...
    public final static AbsoluteOrdering _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("absoluteOrderingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("name" == elementReader.getLocalName())
            ...
            } else if (("others" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: nameOrOthers
                final org.apache.openejb.jee.OrderingOthers nameOrOthersItem1 = readOrderingOthers(elementReader,
                        context);
                if (nameOrOthers == null) {
                    nameOrOthers = absoluteOrdering.nameOrOthers;
                    if (nameOrOthers != null) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "others"));
            }
        }
        if (nameOrOthers != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final AbsoluteOrdering absoluteOrdering,
        ...
        if (nameOrOthers != null) {
            for (final Object nameOrOthersItem : nameOrOthers) {
                if (nameOrOthersItem instanceof org.apache.openejb.jee.OrderingOthers) {
                    ...
                    context.unexpectedElementType(writer, absoluteOrdering, "nameOrOthers", nameOrOthersItem,
                            org.apache.openejb.jee.OrderingOthers.class, java.lang.String.class);
                }
            }
        }
    ...
    public void write(final XoXMLStreamWriter writer, final AbsoluteOrdering absoluteOrdering,
            final RuntimeContext context) throws Exception {
        _write(writer, absoluteOrdering, context);
    }

    public final AbsoluteOrdering read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
