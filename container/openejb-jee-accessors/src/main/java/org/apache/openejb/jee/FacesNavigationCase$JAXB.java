...
public class FacesNavigationCase$JAXB extends JAXBObject<FacesNavigationCase> {

    public FacesNavigationCase$JAXB() {
        super(FacesNavigationCase.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-navigation-caseType".intern()),
                Text$JAXB.class, Icon$JAXB.class, FacesFromAction$JAXB.class, FacesRedirect$JAXB.class);
    }

    public static FacesNavigationCase readFacesNavigationCase(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesNavigationCase(final XoXMLStreamWriter writer,
            final FacesNavigationCase facesNavigationCase, final RuntimeContext context) throws Exception {
    ...
    public final static FacesNavigationCase _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-navigation-caseType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("if" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: _if
            ...
            } else if (("to-view-id" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: toViewId
            ...
            } else if (("redirect" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: redirect
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "from-action"),
                        new QName("http://java.sun.com/xml/ns/javaee", "from-outcome"),
                        new QName("http://java.sun.com/xml/ns/javaee", "if"),
                        new QName("http://java.sun.com/xml/ns/javaee", "to-view-id"),
                        new QName("http://java.sun.com/xml/ns/javaee", "redirect"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesNavigationCase facesNavigationCase,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesNavigationCase, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesNavigationCase, "fromOutcome", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (fromOutcome != null) {
        ...
        try {
            ...
            context.xmlAdapterError(facesNavigationCase, "_if", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (_if != null) {
        ...
        try {
            ...
            context.xmlAdapterError(facesNavigationCase, "toViewId", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (toViewId != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final FacesNavigationCase facesNavigationCase,
            final RuntimeContext context) throws Exception {
        _write(writer, facesNavigationCase, context);
    }
