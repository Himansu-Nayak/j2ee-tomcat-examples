...
public class RelationshipRoleSource$JAXB extends JAXBObject<RelationshipRoleSource> {

    public RelationshipRoleSource$JAXB() {
        super(RelationshipRoleSource.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "relationship-role-sourceType".intern()),
                Text$JAXB.class);
    }

    public static RelationshipRoleSource readRelationshipRoleSource(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeRelationshipRoleSource(final XoXMLStreamWriter writer,
            final RelationshipRoleSource relationshipRoleSource, final RuntimeContext context) throws Exception {
    ...
    public final static RelationshipRoleSource _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("relationship-role-sourceType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final RelationshipRoleSource relationshipRoleSource,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(relationshipRoleSource, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.getterError(relationshipRoleSource, "descriptions", RelationshipRoleSource.class, "getDescriptions",
                    e);
        }
        if (descriptions != null) {
        ...
        try {
            ...
            context.xmlAdapterError(relationshipRoleSource, "ejbName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (ejbName != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final RelationshipRoleSource relationshipRoleSource,
            final RuntimeContext context) throws Exception {
        _write(writer, relationshipRoleSource, context);
    }
