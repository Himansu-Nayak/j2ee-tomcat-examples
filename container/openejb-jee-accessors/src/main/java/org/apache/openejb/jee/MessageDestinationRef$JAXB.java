...
public class MessageDestinationRef$JAXB extends JAXBObject<MessageDestinationRef> {

    public MessageDestinationRef$JAXB() {
        super(MessageDestinationRef.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "message-destination-refType".intern()),
                Text$JAXB.class, MessageDestinationUsage$JAXB.class, InjectionTarget$JAXB.class);
    }

    public static MessageDestinationRef readMessageDestinationRef(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeMessageDestinationRef(final XoXMLStreamWriter writer,
            final MessageDestinationRef messageDestinationRef, final RuntimeContext context) throws Exception {
    ...
    public final static MessageDestinationRef _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("message-destination-refType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("message-destination-ref-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    messageDestinationRefName = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(messageDestinationRefNameRaw);
            ...
            } else if (("message-destination-usage" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: messageDestinationUsage
                final MessageDestinationUsage messageDestinationUsage = parseMessageDestinationUsage(elementReader,
            ...
            } else if (("injection-target" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("lookup-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: lookupName
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "message-destination-ref-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "message-destination-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "message-destination-usage"),
                        new QName("http://java.sun.com/xml/ns/javaee", "message-destination-link"),
                        new QName("http://java.sun.com/xml/ns/javaee", "mapped-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "injection-target"),
                        new QName("http://java.sun.com/xml/ns/javaee", "lookup-name"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final MessageDestinationRef messageDestinationRef,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(messageDestinationRef, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.getterError(messageDestinationRef, "descriptions", MessageDestinationRef.class, "getDescriptions",
                    e);
        }
        if (descriptions != null) {
        ...
        try {
            ...
            context.xmlAdapterError(messageDestinationRef, "messageDestinationRefName", CollapsedStringAdapter.class,
        ...
        try {
            ...
            context.xmlAdapterError(messageDestinationRef, "messageDestinationType", CollapsedStringAdapter.class,
                    String.class, String.class, e);
        }
        ...
        if (messageDestinationUsage != null) {
            ...
            writer.writeCharacters(
                    toStringMessageDestinationUsage(messageDestinationRef, null, context, messageDestinationUsage));
            writer.writeEndElement();
        }
        ...
        try {
            ...
            context.xmlAdapterError(messageDestinationRef, "messageDestinationLink", CollapsedStringAdapter.class,
                    String.class, String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(messageDestinationRef, "mappedName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (mappedName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(messageDestinationRef, "lookupName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (lookupName != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final MessageDestinationRef messageDestinationRef,
            final RuntimeContext context) throws Exception {
        _write(writer, messageDestinationRef, context);
    }
