...
public class Listener$JAXB extends JAXBObject<Listener> {
    ...
    public Listener$JAXB() {
        super(Listener.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "listenerType".intern()),
                Text$JAXB.class, Icon$JAXB.class);
    }

    public static Listener readListener(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeListener(final XoXMLStreamWriter writer, final Listener listener,
            final RuntimeContext context) throws Exception {
        _write(writer, listener, context);
    }

    public final static Listener _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final Listener listener, RuntimeContext context)
        ...
        try {
            ...
            context.xmlAdapterError(listener, "listenerClass", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
    ...
    public final Listener read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
