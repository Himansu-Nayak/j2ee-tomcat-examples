...
public class ContainerConcurrency$JAXB extends JAXBObject<ContainerConcurrency> {
    ...
    public ContainerConcurrency$JAXB() {
        super(ContainerConcurrency.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "container-concurrencyType".intern()),
                Text$JAXB.class, Method$JAXB.class, ConcurrentLockType$JAXB.class);
    }

    public static ContainerConcurrency readContainerConcurrency(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeContainerConcurrency(final XoXMLStreamWriter writer,
            final ContainerConcurrency containerConcurrency, final RuntimeContext context) throws Exception {
    ...
    public final static ContainerConcurrency _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("container-concurrencyType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("concurrency-attribute" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: lock
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "concurrency-attribute"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ContainerConcurrency containerConcurrency,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(containerConcurrency, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final ContainerConcurrency containerConcurrency,
            final RuntimeContext context) throws Exception {
        _write(writer, containerConcurrency, context);
    }
