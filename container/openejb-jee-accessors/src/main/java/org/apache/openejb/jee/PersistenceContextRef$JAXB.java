...
public class PersistenceContextRef$JAXB extends JAXBObject<PersistenceContextRef> {
    ...
    public PersistenceContextRef$JAXB() {
        super(PersistenceContextRef.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "persistence-context-refType".intern()),
                Text$JAXB.class, PersistenceContextType$JAXB.class, Property$JAXB.class, InjectionTarget$JAXB.class);
    }

    public static PersistenceContextRef readPersistenceContextRef(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writePersistenceContextRef(final XoXMLStreamWriter writer,
            final PersistenceContextRef persistenceContextRef, final RuntimeContext context) throws Exception {
    ...
    public final static PersistenceContextRef _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("persistence-context-refType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("persistence-context-ref-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                try {
                    persistenceContextRefName = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(persistenceContextRefNameRaw);
            ...
            } else if (("persistence-unit-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("persistence-context-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: persistenceContextType
                final PersistenceContextType persistenceContextType = parsePersistenceContextType(elementReader,
                ...
                if (persistenceContextType != null) {
                    ...
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: persistenceContextType
                final PersistenceContextSynchronization synchronization = parsePersistenceContextSynchronization(
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "persistence-context-ref-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "persistence-unit-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "persistence-context-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "persistence-property"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final PersistenceContextRef persistenceContextRef,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(persistenceContextRef, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.getterError(persistenceContextRef, "descriptions", PersistenceContextRef.class, "getDescriptions",
                    e);
        }
        if (descriptions != null) {
        ...
        try {
            ...
            context.xmlAdapterError(persistenceContextRef, "persistenceContextRefName", CollapsedStringAdapter.class,
        ...
        try {
            ...
            context.xmlAdapterError(persistenceContextRef, "persistenceUnitName", CollapsedStringAdapter.class,
                    String.class, String.class, e);
        }
        ...
        if (persistenceContextType != null) {
            ...
            writer.writeCharacters(
                    toStringPersistenceContextType(persistenceContextRef, null, context, persistenceContextType));
            writer.writeEndElement();
        }
        ...
        try {
            ...
            context.xmlAdapterError(persistenceContextRef, "mappedName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (mappedName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(persistenceContextRef, "lookupName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (lookupName != null) {
    ...
    public static PersistenceContextSynchronization parsePersistenceContextSynchronization(
            final XoXMLStreamReader reader, final RuntimeContext context, final String value) throws Exception {
    ...
    public void write(final XoXMLStreamWriter writer, final PersistenceContextRef persistenceContextRef,
            final RuntimeContext context) throws Exception {
        _write(writer, persistenceContextRef, context);
    }
