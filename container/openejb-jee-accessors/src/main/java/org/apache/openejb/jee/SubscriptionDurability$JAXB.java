...
public class SubscriptionDurability$JAXB extends JAXBObject<SubscriptionDurability> {

    public SubscriptionDurability$JAXB() {
        super(SubscriptionDurability.class,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "subscription-durability".intern()), null);
    }

    public static SubscriptionDurability readSubscriptionDurability(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeSubscriptionDurability(final XoXMLStreamWriter writer,
            final SubscriptionDurability subscriptionDurability, final RuntimeContext context) throws Exception {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final SubscriptionDurability subscriptionDurability,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(subscriptionDurability, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(subscriptionDurability, "value", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final SubscriptionDurability subscriptionDurability,
            final RuntimeContext context) throws Exception {
        _write(writer, subscriptionDurability, context);
    }
