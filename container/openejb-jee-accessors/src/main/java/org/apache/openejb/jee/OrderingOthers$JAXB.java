...
public class OrderingOthers$JAXB extends JAXBObject<OrderingOthers> {

    public OrderingOthers$JAXB() {
        super(OrderingOthers.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "ordering-othersType".intern()));
    }
    ...
    public static void writeOrderingOthers(final XoXMLStreamWriter writer, final OrderingOthers orderingOthers,
            final RuntimeContext context) throws Exception {
        _write(writer, orderingOthers, context);
    }

    public final static OrderingOthers _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("ordering-othersType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final OrderingOthers orderingOthers,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(orderingOthers, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
    ...
    public final OrderingOthers read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
