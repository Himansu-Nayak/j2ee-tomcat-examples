...
public class ConfigProperty$JAXB extends JAXBObject<ConfigProperty> {

    public ConfigProperty$JAXB() {
        super(ConfigProperty.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "config-propertyType".intern()),
                Text$JAXB.class);
    }
    ...
    public static void writeConfigProperty(final XoXMLStreamWriter writer, final ConfigProperty configProperty,
            final RuntimeContext context) throws Exception {
        _write(writer, configProperty, context);
    }

    public final static ConfigProperty _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("config-propertyType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("config-property-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("config-property-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("config-property-value" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("config-property-ignore" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: configPropertyIgnore
                final Boolean configPropertyIgnore = ("1".equals(elementReader.getElementAsString())
                        || "true".equals(elementReader.getElementAsString()));
                configProperty.configPropertyIgnore = configPropertyIgnore;
            } else if (("config-property-supports-dynamic-updates" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: configPropertySupportsDynamicUpdates
                final Boolean configPropertySupportsDynamicUpdates = ("1".equals(elementReader.getElementAsString())
                        || "true".equals(elementReader.getElementAsString()));
                configProperty.configPropertySupportsDynamicUpdates = configPropertySupportsDynamicUpdates;
            } else if (("config-property-confidential" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: configPropertyConfidential
                final Boolean configPropertyConfidential = ("1".equals(elementReader.getElementAsString())
                        || "true".equals(elementReader.getElementAsString()));
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "config-property-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "config-property-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "config-property-value"),
                        new QName("http://java.sun.com/xml/ns/javaee", "config-property-ignore"),
                        new QName("http://java.sun.com/xml/ns/javaee", "config-property-supports-dynamic-updates"),
                        new QName("http://java.sun.com/xml/ns/javaee", "config-property-confidential"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ConfigProperty configProperty,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(configProperty, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(configProperty, "configPropertyName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(configProperty, "configPropertyType", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(configProperty, "configPropertyValue", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        if (configPropertySupportsDynamicUpdates != null) {
            writer.writeStartElement(prefix, "config-property-supports-dynamic-updates",
    ...
    public final ConfigProperty read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
