...
public class FacesFromAction$JAXB extends JAXBObject<FacesFromAction> {

    public FacesFromAction$JAXB() {
        super(FacesFromAction.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-from-actionType".intern()));
    }
    ...
    public static void writeFacesFromAction(final XoXMLStreamWriter writer, final FacesFromAction facesFromAction,
            final RuntimeContext context) throws Exception {
        _write(writer, facesFromAction, context);
    }

    public final static FacesFromAction _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-from-actionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesFromAction facesFromAction,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesFromAction, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesFromAction facesFromAction,
            final RuntimeContext context) throws Exception {
        _write(writer, facesFromAction, context);
    }

    public final FacesFromAction read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
