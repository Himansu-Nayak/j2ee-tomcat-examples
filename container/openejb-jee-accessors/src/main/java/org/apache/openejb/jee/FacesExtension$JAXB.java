...
public class FacesExtension$JAXB extends JAXBObject<FacesExtension> {

    public FacesExtension$JAXB() {
        super(FacesExtension.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-extensionType".intern()));
    }

    public static FacesExtension readFacesExtension(final XoXMLStreamReader reader, final RuntimeContext context)
            throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesExtension(final XoXMLStreamWriter writer, final FacesExtension facesExtension,
            final RuntimeContext context) throws Exception {
        _write(writer, facesExtension, context);
    }

    public final static FacesExtension _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-extensionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesExtension facesExtension,
        ...
        // ATTRIBUTE: id
        final String idRaw = facesExtension.id;
        if (idRaw != null) {
            String id = null;
            try {
                id = Adapters.collapsedStringAdapterAdapter.marshal(idRaw);
            } catch (final Exception e) {
                context.xmlAdapterError(facesExtension, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        // ELEMENT_REF: any
        final List<Object> any = facesExtension.any;
        if (any != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final FacesExtension facesExtension, final RuntimeContext context)
            throws Exception {
        _write(writer, facesExtension, context);
    }

    public final FacesExtension read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
