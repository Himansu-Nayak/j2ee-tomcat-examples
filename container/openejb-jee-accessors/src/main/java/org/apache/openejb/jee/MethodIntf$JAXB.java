...
public class MethodIntf$JAXB extends JAXBEnum<MethodIntf> {

    public MethodIntf$JAXB() {
        super(MethodIntf.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "methodIntf".intern()));
    }

    public static MethodIntf parseMethodIntf(final XoXMLStreamReader reader, final RuntimeContext context,
        ...
        if ("Home".equals(value)) {
            ...
            context.unexpectedEnumValue(reader, MethodIntf.class, value, "Home", "Remote", "LocalHome", "Local",
                    "ServiceEndpoint", "Timer", "MessageEndpoint");
            return null;
        }
    }

    public static String toStringMethodIntf(final Object bean, final String parameterName, final RuntimeContext context,
            final MethodIntf methodIntf) throws Exception {
        if (MethodIntf.HOME == methodIntf) {
            ...
            context.unexpectedEnumConst(bean, parameterName, methodIntf, MethodIntf.HOME, MethodIntf.REMOTE,
                    MethodIntf.LOCALHOME, MethodIntf.LOCAL, MethodIntf.SERVICEENDPOINT, MethodIntf.TIMER,
                    MethodIntf.MESSAGEENDPOINT);
            return null;
        }
    }
