...
public class LifecycleCallback$JAXB extends JAXBObject<org.apache.openejb.jee.LifecycleCallback> {

    public LifecycleCallback$JAXB() {
        super(org.apache.openejb.jee.LifecycleCallback.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "lifecycle-callbackType".intern()));
    }

    public static org.apache.openejb.jee.LifecycleCallback readLifecycleCallback(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeLifecycleCallback(final XoXMLStreamWriter writer,
            final org.apache.openejb.jee.LifecycleCallback lifecycleCallback, final RuntimeContext context)
                    throws Exception {
        _write(writer, lifecycleCallback, context);
    }

    public final static org.apache.openejb.jee.LifecycleCallback _read(final XoXMLStreamReader reader,
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("lifecycle-callback-class" == elementReader.getLocalName())
                ...
                try {
                    lifecycleCallbackClass = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(lifecycleCallbackClassRaw);
                ...
                try {
                    lifecycleCallbackMethod = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(lifecycleCallbackMethodRaw);
                } catch (final Exception e) {
                    context.xmlAdapterError(elementReader, CollapsedStringAdapter.class, String.class, String.class, e);
                    continue;
                }
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final org.apache.openejb.jee.LifecycleCallback lifecycleCallback, RuntimeContext context) throws Exception {
        ...
        try {
            ...
            context.xmlAdapterError(lifecycleCallback, "lifecycleCallbackClass", CollapsedStringAdapter.class,
        ...
        try {
            ...
            context.xmlAdapterError(lifecycleCallback, "lifecycleCallbackMethod", CollapsedStringAdapter.class,
                    String.class, String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final org.apache.openejb.jee.LifecycleCallback lifecycleCallback,
            final RuntimeContext context) throws Exception {
        _write(writer, lifecycleCallback, context);
    }

    public final org.apache.openejb.jee.LifecycleCallback read(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
