...
public class TransAttribute$JAXB extends JAXBEnum<TransAttribute> {

    public TransAttribute$JAXB() {
        super(TransAttribute.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "transAttribute".intern()));
    }

    public static TransAttribute parseTransAttribute(final XoXMLStreamReader reader, final RuntimeContext context,
        ...
        if ("NotSupported".equals(value)) {
            ...
            context.unexpectedEnumValue(reader, TransAttribute.class, value, "NotSupported", "Supports", "Required",
                    "RequiresNew", "Mandatory", "Never");
            return null;
        }
    }

    public static String toStringTransAttribute(final Object bean, final String parameterName,
            final RuntimeContext context, final TransAttribute transAttribute) throws Exception {
        if (TransAttribute.NOT_SUPPORTED == transAttribute) {
            ...
            context.unexpectedEnumConst(bean, parameterName, transAttribute, TransAttribute.NOT_SUPPORTED,
                    TransAttribute.SUPPORTS, TransAttribute.REQUIRED, TransAttribute.REQUIRES_NEW,
                    TransAttribute.MANDATORY, TransAttribute.NEVER);
            return null;
        }
    }
    ...
    public String toString(final Object bean, final String parameterName, final RuntimeContext context,
            final TransAttribute transAttribute) throws Exception {
