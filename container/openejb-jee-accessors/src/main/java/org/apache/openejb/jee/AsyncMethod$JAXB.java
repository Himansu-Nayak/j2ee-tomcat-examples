...
public class AsyncMethod$JAXB extends JAXBObject<AsyncMethod> {

    public AsyncMethod$JAXB() {
        super(AsyncMethod.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "async-methodType".intern()),
                MethodParams$JAXB.class);
    }
    ...
    public static void writeAsyncMethod(final XoXMLStreamWriter writer, final AsyncMethod asyncMethod,
            final RuntimeContext context) throws Exception {
        _write(writer, asyncMethod, context);
    }

    public final static AsyncMethod _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("async-methodType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("method-name" == elementReader.getLocalName())
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "method-name"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final AsyncMethod asyncMethod,
        ...
        try {
            ...
            context.xmlAdapterError(asyncMethod, "methodName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (methodName != null) {
    ...
    public final AsyncMethod read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
