...
public class TimerSchedule$JAXB extends JAXBObject<TimerSchedule> {

    public TimerSchedule$JAXB() {
        super(TimerSchedule.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "timer-scheduleType".intern()));
    }
    ...
    public static void writeTimerSchedule(final XoXMLStreamWriter writer, final TimerSchedule timerSchedule,
            final RuntimeContext context) throws Exception {
        _write(writer, timerSchedule, context);
    }

    public final static TimerSchedule _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("second" == elementReader.getLocalName())
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "second"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final TimerSchedule timerSchedule,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(timerSchedule, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(timerSchedule, "second", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (second != null) {
        ...
        try {
            ...
            context.xmlAdapterError(timerSchedule, "minute", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (minute != null) {
        ...
        try {
            ...
            context.xmlAdapterError(timerSchedule, "dayOfMonth", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (dayOfMonth != null) {
        ...
        try {
            ...
            context.xmlAdapterError(timerSchedule, "month", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (month != null) {
        ...
        try {
            ...
            context.xmlAdapterError(timerSchedule, "dayOfWeek", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (dayOfWeek != null) {
    ...
    public final TimerSchedule read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
