...
public class MessageListener$JAXB extends JAXBObject<MessageListener> {

    public MessageListener$JAXB() {
        super(MessageListener.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "messagelistenerType".intern()),
                ActivationSpec$JAXB.class);
    }
    ...
    public static void writeMessageListener(final XoXMLStreamWriter writer, final MessageListener messageListener,
            final RuntimeContext context) throws Exception {
        _write(writer, messageListener, context);
    }

    public final static MessageListener _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("messagelistenerType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("messagelistener-type" == elementReader.getLocalName())
            ...
            } else if (("activationspec" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "messagelistener-type"),
                        new QName("http://java.sun.com/xml/ns/javaee", "activationspec"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final MessageListener messageListener,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(messageListener, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(messageListener, "messageListenerType", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final MessageListener messageListener,
            final RuntimeContext context) throws Exception {
        _write(writer, messageListener, context);
    }

    public final MessageListener read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
