...
public class EjbRelation$JAXB extends JAXBObject<EjbRelation> {

    public EjbRelation$JAXB() {
        super(EjbRelation.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "ejb-relationType".intern()), Text$JAXB.class,
    ...
    public static void writeEjbRelation(final XoXMLStreamWriter writer, final EjbRelation ejbRelation,
            final RuntimeContext context) throws Exception {
        _write(writer, ejbRelation, context);
    }

    public final static EjbRelation _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("ejb-relationType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("ejb-relation-name" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("ejb-relationship-role" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "ejb-relation-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "ejb-relationship-role"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final EjbRelation ejbRelation,
        ...
        try {
            ...
            context.xmlAdapterError(ejbRelation, "ejbRelationName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final EjbRelation read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
