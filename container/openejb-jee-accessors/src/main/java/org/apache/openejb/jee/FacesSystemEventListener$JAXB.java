...
public class FacesSystemEventListener$JAXB extends JAXBObject<FacesSystemEventListener> {

    public FacesSystemEventListener$JAXB() {
        super(FacesSystemEventListener.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "faces-config-system-event-listenerType".intern()));
    }

    public static FacesSystemEventListener readFacesSystemEventListener(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesSystemEventListener(final XoXMLStreamWriter writer,
            final FacesSystemEventListener facesSystemEventListener, final RuntimeContext context) throws Exception {
    ...
    public final static FacesSystemEventListener _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-system-event-listenerType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("system-event-listener-class" == elementReader.getLocalName())
                ...
                try {
                    systemEventListenerClass = Adapters.collapsedStringAdapterAdapter
                            .unmarshal(systemEventListenerClassRaw);
            ...
            } else if (("system-event-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("source-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: sourceClass
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "system-event-listener-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "system-event-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "source-class"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final FacesSystemEventListener facesSystemEventListener, RuntimeContext context) throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesSystemEventListener, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesSystemEventListener, "systemEventListenerClass", CollapsedStringAdapter.class,
        ...
        try {
            ...
            context.xmlAdapterError(facesSystemEventListener, "systemEventClass", CollapsedStringAdapter.class,
                    String.class, String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(facesSystemEventListener, "sourceClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (sourceClass != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final FacesSystemEventListener facesSystemEventListener,
            final RuntimeContext context) throws Exception {
        _write(writer, facesSystemEventListener, context);
    }
