...
public class FacesComponent$JAXB extends JAXBObject<FacesComponent> {

    public FacesComponent$JAXB() {
        super(FacesComponent.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-componentType".intern()),
                Text$JAXB.class, Icon$JAXB.class, FacesFacet$JAXB.class, FacesAttribute$JAXB.class,
                FacesProperty$JAXB.class, FacesComponentExtension$JAXB.class);
    }
    ...
    public static void writeFacesComponent(final XoXMLStreamWriter writer, final FacesComponent facesComponent,
            final RuntimeContext context) throws Exception {
        _write(writer, facesComponent, context);
    }

    public final static FacesComponent _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-componentType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("component-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("component-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("component-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: componentExtension
                final FacesComponentExtension componentExtensionItem = readFacesComponentExtension(elementReader,
                        context);
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesComponent facesComponent,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesComponent, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(facesComponent, "componentType", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(facesComponent, "componentClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final FacesComponent read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
