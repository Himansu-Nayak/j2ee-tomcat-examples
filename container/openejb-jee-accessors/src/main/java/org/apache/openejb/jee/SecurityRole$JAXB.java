...
public class SecurityRole$JAXB extends JAXBObject<SecurityRole> {

    public SecurityRole$JAXB() {
        super(SecurityRole.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "security-roleType".intern()), Text$JAXB.class);
    }
    ...
    public static void writeSecurityRole(final XoXMLStreamWriter writer, final SecurityRole securityRole,
            final RuntimeContext context) throws Exception {
        _write(writer, securityRole, context);
    }

    public final static SecurityRole _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("security-roleType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final SecurityRole securityRole,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(securityRole, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(securityRole, "roleName", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (roleName != null) {
    ...
    public final SecurityRole read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
