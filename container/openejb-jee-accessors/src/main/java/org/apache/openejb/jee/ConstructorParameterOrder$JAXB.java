...
public class ConstructorParameterOrder$JAXB extends JAXBObject<ConstructorParameterOrder> {

    public ConstructorParameterOrder$JAXB() {
        super(ConstructorParameterOrder.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "constructor-parameter-orderType".intern()));
    }

    public static ConstructorParameterOrder readConstructorParameterOrder(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeConstructorParameterOrder(final XoXMLStreamWriter writer,
            final ConstructorParameterOrder constructorParameterOrder, final RuntimeContext context) throws Exception {
    ...
    public final static ConstructorParameterOrder _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("constructor-parameter-orderType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("element-name" == elementReader.getLocalName())
                ...
                context.unexpectedElement(elementReader,
                        new QName("http://java.sun.com/xml/ns/javaee", "element-name"));
            }
        }
        if (elementName != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final ConstructorParameterOrder constructorParameterOrder, RuntimeContext context) throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(constructorParameterOrder, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        if (elementNameRaw != null) {
            for (final String elementNameItem : elementNameRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(constructorParameterOrder, "elementName", CollapsedStringAdapter.class,
    ...
    public void write(final XoXMLStreamWriter writer, final ConstructorParameterOrder constructorParameterOrder,
            final RuntimeContext context) throws Exception {
        _write(writer, constructorParameterOrder, context);
    }
