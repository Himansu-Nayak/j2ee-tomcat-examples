...
public class FacesRedirect$JAXB extends JAXBObject<FacesRedirect> {

    public FacesRedirect$JAXB() {
        super(FacesRedirect.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-redirectType".intern()),
                FacesRedirectViewParam$JAXB.class);
    }
    ...
    public static void writeFacesRedirect(final XoXMLStreamWriter writer, final FacesRedirect facesRedirect,
            final RuntimeContext context) throws Exception {
        _write(writer, facesRedirect, context);
    }

    public final static FacesRedirect _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-redirectType" != xsiType.getLocalPart())
        ...
        for (final Attribute attribute : reader.getAttributes()) {
            if (("id" == attribute.getLocalName())
                ...
                facesRedirect.id = id;
            } else if (("include-view-params" == attribute.getLocalName())
                    && (("" == attribute.getNamespace()) || (attribute.getNamespace() == null))) {
                // ATTRIBUTE: includeViewParams
                final Boolean includeViewParams = ("1".equals(attribute.getValue())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("view-param" == elementReader.getLocalName())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesRedirect facesRedirect,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesRedirect, "id", CollapsedStringAdapter.class, String.class, String.class,
                        e);
            }
    ...
    public final FacesRedirect read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
