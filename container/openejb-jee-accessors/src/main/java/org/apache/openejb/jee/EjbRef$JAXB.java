...
public class EjbRef$JAXB extends JAXBObject<EjbRef> {

    public EjbRef$JAXB() {
        super(EjbRef.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "ejb-refType".intern()),
                Text$JAXB.class, EjbRefType$JAXB.class, InjectionTarget$JAXB.class);
    }

    public static EjbRef readEjbRef(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
    ...
    public final static EjbRef _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("ejb-refType" != xsiType.getLocalPart())
    ...
    public final EjbRef read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
