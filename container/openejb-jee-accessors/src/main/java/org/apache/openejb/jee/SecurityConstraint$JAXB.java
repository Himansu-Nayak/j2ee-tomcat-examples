...
public class SecurityConstraint$JAXB extends JAXBObject<SecurityConstraint> {

    public SecurityConstraint$JAXB() {
        super(SecurityConstraint.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "security-constraintType".intern()),
                WebResourceCollection$JAXB.class, AuthConstraint$JAXB.class, UserDataConstraint$JAXB.class);
    }

    public static SecurityConstraint readSecurityConstraint(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeSecurityConstraint(final XoXMLStreamWriter writer,
            final SecurityConstraint securityConstraint, final RuntimeContext context) throws Exception {
    ...
    public final static SecurityConstraint _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("security-constraintType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("display-name" == elementReader.getLocalName())
            ...
            } else if (("web-resource-collection" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: webResourceCollection
                final WebResourceCollection webResourceCollectionItem = readWebResourceCollection(elementReader,
                        context);
            ...
            } else if (("auth-constraint" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("user-data-constraint" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "display-name"),
                        new QName("http://java.sun.com/xml/ns/javaee", "web-resource-collection"),
                        new QName("http://java.sun.com/xml/ns/javaee", "auth-constraint"),
                        new QName("http://java.sun.com/xml/ns/javaee", "user-data-constraint"));
            }
        }
        if (displayName != null) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final SecurityConstraint securityConstraint,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(securityConstraint, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        if (displayNameRaw != null) {
            for (final String displayNameItem : displayNameRaw) {
                ...
                try {
                    ...
                    context.xmlAdapterError(securityConstraint, "displayName", CollapsedStringAdapter.class, List.class,
                            List.class, e);
                }
                if (displayName != null) {
    ...
    public void write(final XoXMLStreamWriter writer, final SecurityConstraint securityConstraint,
            final RuntimeContext context) throws Exception {
        _write(writer, securityConstraint, context);
    }
