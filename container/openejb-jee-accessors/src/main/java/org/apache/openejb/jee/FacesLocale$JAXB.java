...
public class FacesLocale$JAXB extends JAXBObject<FacesLocale> {

    public FacesLocale$JAXB() {
        super(FacesLocale.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-localeType".intern()));
    }
    ...
    public static void writeFacesLocale(final XoXMLStreamWriter writer, final FacesLocale facesLocale,
            final RuntimeContext context) throws Exception {
        _write(writer, facesLocale, context);
    }

    public final static FacesLocale _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-localeType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesLocale facesLocale,
    ...
    public final FacesLocale read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
