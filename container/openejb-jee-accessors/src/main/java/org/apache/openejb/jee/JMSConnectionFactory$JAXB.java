...
public class JMSConnectionFactory$JAXB extends JAXBObject<JMSConnectionFactory> {

    public JMSConnectionFactory$JAXB() {
        super(JMSConnectionFactory.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "jms-connection-factoryType".intern()),
                Text$JAXB.class, Property$JAXB.class);
    }

    public static JMSConnectionFactory readJMSConnectionFactory(final XoXMLStreamReader reader,
    ...
    public final static void _write(final XoXMLStreamWriter writer, final JMSConnectionFactory JMSConnectionFactory,
            RuntimeContext context) throws Exception {
        // no-op while not useful
    }

    public void write(final XoXMLStreamWriter writer, final JMSConnectionFactory JMSConnectionFactory,
            final RuntimeContext context) throws Exception {
