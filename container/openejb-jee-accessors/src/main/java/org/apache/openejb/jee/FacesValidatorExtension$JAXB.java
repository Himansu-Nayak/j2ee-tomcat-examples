...
public class FacesValidatorExtension$JAXB extends JAXBObject<FacesValidatorExtension> {

    public FacesValidatorExtension$JAXB() {
        super(FacesValidatorExtension.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "faces-config-validator-extensionType".intern()));
    }

    public static FacesValidatorExtension readFacesValidatorExtension(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesValidatorExtension(final XoXMLStreamWriter writer,
            final FacesValidatorExtension facesValidatorExtension, final RuntimeContext context) throws Exception {
    ...
    public final static FacesValidatorExtension _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-validator-extensionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final FacesValidatorExtension facesValidatorExtension, RuntimeContext context) throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesValidatorExtension, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesValidatorExtension facesValidatorExtension,
            final RuntimeContext context) throws Exception {
        _write(writer, facesValidatorExtension, context);
    }
