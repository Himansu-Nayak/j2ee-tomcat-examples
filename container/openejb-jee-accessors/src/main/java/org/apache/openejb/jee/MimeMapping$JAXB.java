...
public class MimeMapping$JAXB extends JAXBObject<MimeMapping> {

    public MimeMapping$JAXB() {
        super(MimeMapping.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "mime-mappingType".intern()));
    }
    ...
    public static void writeMimeMapping(final XoXMLStreamWriter writer, final MimeMapping mimeMapping,
            final RuntimeContext context) throws Exception {
        _write(writer, mimeMapping, context);
    }

    public final static MimeMapping _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("mime-mappingType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("extension" == elementReader.getLocalName())
            ...
            } else if (("mime-type" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: mimeType
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "extension"),
                        new QName("http://java.sun.com/xml/ns/javaee", "mime-type"));
            }
        }
    ...
    public final static void _write(final XoXMLStreamWriter writer, final MimeMapping mimeMapping,
        ...
        try {
            ...
            context.xmlAdapterError(mimeMapping, "extension", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (extension != null) {
        ...
        try {
            ...
            context.xmlAdapterError(mimeMapping, "mimeType", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
        if (mimeType != null) {
    ...
    public final MimeMapping read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
