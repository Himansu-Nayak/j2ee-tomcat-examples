...
public class FacesBehavior$JAXB extends JAXBObject<FacesBehavior> {

    public FacesBehavior$JAXB() {
        super(FacesBehavior.class, null,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "faces-config-behaviorType".intern()),
                Text$JAXB.class, Icon$JAXB.class, FacesAttribute$JAXB.class, FacesProperty$JAXB.class,
                FacesBehaviorExtension$JAXB.class);
    }
    ...
    public static void writeFacesBehavior(final XoXMLStreamWriter writer, final FacesBehavior facesBehavior,
            final RuntimeContext context) throws Exception {
        _write(writer, facesBehavior, context);
    }

    public final static FacesBehavior _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("faces-config-behaviorType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
                ...
                icon.add(iconItem);
            } else if (("behavior-id" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: behaviorId
            ...
            } else if (("behavior-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("behavior-extension" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final FacesBehavior facesBehavior,
        ...
        try {
            ...
            context.xmlAdapterError(facesBehavior, "behaviorId", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (behaviorId != null) {
        ...
        try {
            ...
            context.xmlAdapterError(facesBehavior, "behaviorClass", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public final FacesBehavior read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
