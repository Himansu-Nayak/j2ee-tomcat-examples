...
public class Property$JAXB extends JAXBObject<Property> {

    public Property$JAXB() {
        super(Property.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "propertyType".intern()));
    }

    public static Property readProperty(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeProperty(final XoXMLStreamWriter writer, final Property property,
            final RuntimeContext context) throws Exception {
        _write(writer, property, context);
    }

    public final static Property _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("propertyType" != xsiType.getLocalPart())
    ...
    public final Property read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
