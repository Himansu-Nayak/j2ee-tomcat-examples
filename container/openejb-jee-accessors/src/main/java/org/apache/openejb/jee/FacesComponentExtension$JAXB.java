...
public class FacesComponentExtension$JAXB extends JAXBObject<FacesComponentExtension> {

    public FacesComponentExtension$JAXB() {
        super(FacesComponentExtension.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(),
                "faces-config-component-extensionType".intern()));
    }

    public static FacesComponentExtension readFacesComponentExtension(final XoXMLStreamReader reader,
            final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeFacesComponentExtension(final XoXMLStreamWriter writer,
            final FacesComponentExtension facesComponentExtension, final RuntimeContext context) throws Exception {
    ...
    public final static FacesComponentExtension _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("faces-config-component-extensionType" != xsiType.getLocalPart())
    ...
    public final static void _write(final XoXMLStreamWriter writer,
            final FacesComponentExtension facesComponentExtension, RuntimeContext context) throws Exception {
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(facesComponentExtension, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
    ...
    public void write(final XoXMLStreamWriter writer, final FacesComponentExtension facesComponentExtension,
            final RuntimeContext context) throws Exception {
        _write(writer, facesComponentExtension, context);
    }
