...
public class Variable$JAXB extends JAXBObject<Variable> {

    public Variable$JAXB() {
        super(Variable.class, null, new QName("http://java.sun.com/xml/ns/javaee".intern(), "variableType".intern()),
                Text$JAXB.class);
    }

    public static Variable readVariable(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }

    public static void writeVariable(final XoXMLStreamWriter writer, final Variable variable,
            final RuntimeContext context) throws Exception {
        _write(writer, variable, context);
    }

    public final static Variable _read(final XoXMLStreamReader reader, RuntimeContext context) throws Exception {
        ...
        if (xsiType != null) {
            if (("variableType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("description" == elementReader.getLocalName())
            ...
            } else if (("name-given" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: nameGiven
            ...
            } else if (("name-from-attribute" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("variable-class" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
            ...
            } else if (("declare" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: declare
            ...
            } else if (("scope" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                // ELEMENT: scope
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "description"),
                        new QName("http://java.sun.com/xml/ns/javaee", "name-given"),
                        new QName("http://java.sun.com/xml/ns/javaee", "name-from-attribute"),
                        new QName("http://java.sun.com/xml/ns/javaee", "variable-class"),
                        new QName("http://java.sun.com/xml/ns/javaee", "declare"),
                        new QName("http://java.sun.com/xml/ns/javaee", "scope"));
            }
        }
        if (descriptions != null) {
            try {
    ...
    public final static void _write(final XoXMLStreamWriter writer, final Variable variable, RuntimeContext context)
        ...
        try {
            ...
            context.xmlAdapterError(variable, "nameFromAttribute", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        ...
        try {
            ...
            context.xmlAdapterError(variable, "variableClass", CollapsedStringAdapter.class, String.class, String.class,
                    e);
        }
    ...
    public final Variable read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
