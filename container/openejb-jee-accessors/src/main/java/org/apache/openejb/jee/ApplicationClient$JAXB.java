...
public class ApplicationClient$JAXB extends JAXBObject<ApplicationClient> {

    public ApplicationClient$JAXB() {
        super(ApplicationClient.class,
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "application-client".intern()),
                new QName("http://java.sun.com/xml/ns/javaee".intern(), "application-clientType".intern()),
                Text$JAXB.class, Icon$JAXB.class, EnvEntry$JAXB.class, EjbRef$JAXB.class, EjbLocalRef$JAXB.class,
                ...
                LifecycleCallback$JAXB.class, MessageDestination$JAXB.class, DataSource$JAXB.class);
    }
    ...
    public static void writeApplicationClient(final XoXMLStreamWriter writer, final ApplicationClient applicationClient,
    ...
    public final static ApplicationClient _read(final XoXMLStreamReader reader, RuntimeContext context)
        ...
        if (xsiType != null) {
            if (("application-clientType" != xsiType.getLocalPart())
        ...
        for (final XoXMLStreamReader elementReader : reader.getChildElements()) {
            if (("module-name" == elementReader.getLocalName())
            ...
            } else if (("callback-handler" == elementReader.getLocalName())
                    && ("http://java.sun.com/xml/ns/javaee" == elementReader.getNamespaceURI())) {
                ...
                context.unexpectedElement(elementReader, new QName("http://java.sun.com/xml/ns/javaee", "module-name"),
                        ...
                        new QName("http://java.sun.com/xml/ns/javaee", "callback-handler"),
    ...
    public final static void _write(final XoXMLStreamWriter writer, final ApplicationClient applicationClient,
        ...
        if (idRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(applicationClient, "id", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        if (versionRaw != null) {
            ...
            try {
                ...
                context.xmlAdapterError(applicationClient, "version", CollapsedStringAdapter.class, String.class,
                        String.class, e);
            }
        ...
        try {
            ...
            context.xmlAdapterError(applicationClient, "moduleName", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
        if (moduleName != null) {
        ...
        try {
            ...
            context.xmlAdapterError(applicationClient, "callbackHandler", CollapsedStringAdapter.class, String.class,
                    String.class, e);
        }
    ...
    public void write(final XoXMLStreamWriter writer, final ApplicationClient applicationClient,
            final RuntimeContext context) throws Exception {
        _write(writer, applicationClient, context);
    }

    public final ApplicationClient read(final XoXMLStreamReader reader, final RuntimeContext context) throws Exception {
        return _read(reader, context);
    }
