...
/**
 * A test bean that is essentially the same as the BasicCmp2Bean, but with a concrete implementation of one of the
 * fields and accessors. This tests our ability to offer a migration path toward EJB3 style entity beans.
 */
public abstract class BasicCmp2PojoBean implements EntityBean {
    ...
    /**
     * Concrete implementation of the firstName accessors. The code generator should skip generating these methods and
     * generate mapped superclasses in the JPA metadata.
     *
