...
public class BeanTxStatefulBean implements javax.ejb.SessionBean {
    ...
    public void openAccount(final Account acct, final Boolean rollback) throws RemoteException, RollbackException {
        ...
        try {
            ...
            final DataSource ds = (DataSource) javax.rmi.PortableRemoteObject
                    .narrow(jndiContext.lookup("java:comp/env/datasource"), DataSource.class);
            ...
            try {
                ...
                final PreparedStatement stmt = con
                        .prepareStatement("insert into Account (SSN, First_name, Last_name, Balance) values (?,?,?,?)");
                try {
