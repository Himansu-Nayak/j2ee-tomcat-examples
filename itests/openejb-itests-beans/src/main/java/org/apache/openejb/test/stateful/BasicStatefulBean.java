...
public class BasicStatefulBean implements javax.ejb.SessionBean, SessionSynchronization {
     ...
     */
    public void ejbCreateObject(final String name) throws javax.ejb.CreateException {
    ...
    /**
     * Throws a java.lang.NullPointerException when invoked This is a system exception and should result in the
     * destruction of the instance and invalidation of the remote reference.
     */
    ...
    protected void testAllowedOperations(final String methodName) {
        ...
        /*
         * TO DO: Check for policy.Enterprise_bean_access Check for policy.JNDI_access_to_java_comp_env Check for
         * policy.Resource_manager_access
         */
