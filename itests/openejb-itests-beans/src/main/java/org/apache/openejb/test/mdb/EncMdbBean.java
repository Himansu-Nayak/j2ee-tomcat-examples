...
public class EncMdbBean implements EncMdbObject, MessageDrivenBean, MessageListener {
    ...
    public void setMessageDrivenContext(final MessageDrivenContext ctx) throws EJBException {
        this.mdbContext = ctx;
        try {
            final ConnectionFactory connectionFactory = (ConnectionFactory) new InitialContext()
                    .lookup("java:comp/env/jms");
        ...
        try {
            try {
                ...
                final BasicBmpHome home = (BasicBmpHome) javax.rmi.PortableRemoteObject
                        .narrow(ctx.lookup("java:comp/env/stateless/beanReferences/bmp_entity"), BasicBmpHome.class);
        ...
        try {
            try {
                ...
                final BasicStatefulHome home = (BasicStatefulHome) javax.rmi.PortableRemoteObject
                        .narrow(ctx.lookup("java:comp/env/stateless/beanReferences/stateful"), BasicStatefulHome.class);
                Assert.assertNotNull("The EJBHome looked up is null", home);
        ...
        try {
            try {
                ...
                final BasicStatelessHome home = (BasicStatelessHome) javax.rmi.PortableRemoteObject.narrow(
                        ctx.lookup("java:comp/env/stateless/beanReferences/stateless"), BasicStatelessHome.class);
                Assert.assertNotNull("The EJBHome looked up is null", home);
        ...
        try {
            try {
                ...
                final BasicStatelessBusinessRemote object = (BasicStatelessBusinessRemote) javax.rmi.PortableRemoteObject
                        .narrow(ctx.lookup("java:comp/env/stateless/beanReferences/stateless-business-remote"),
        ...
        try {
            try {
                ...
                final BasicStatefulBusinessLocal object = (BasicStatefulBusinessLocal) javax.rmi.PortableRemoteObject
                        .narrow(ctx.lookup("java:comp/env/stateless/beanReferences/stateful-business-local"),
        ...
        try {
            try {
                ...
                final BasicStatefulBusinessRemote object = (BasicStatefulBusinessRemote) javax.rmi.PortableRemoteObject
                        .narrow(ctx.lookup("java:comp/env/stateless/beanReferences/stateful-business-remote"),
    ...
    public void lookupMessageDrivenContext() throws TestFailureException {
        try {
            try {
                ...
                // lookup in enc
                final MessageDrivenContext messageDrivenContext = (MessageDrivenContext) ctx
                        .lookup("java:comp/env/mdbcontext");
                Assert.assertNotNull("The SessionContext got from java:comp/env/mdbcontext is null",
