        ...
        try {
            try {
                ...
                final BasicBmpHome home = (BasicBmpHome) javax.rmi.PortableRemoteObject
                        .narrow(ctx.lookup("java:comp/env/singleton/beanReferences/bmp_entity"), BasicBmpHome.class);
        ...
        try {
            try {
                ...
                final BasicStatefulHome home = (BasicStatefulHome) javax.rmi.PortableRemoteObject
                        .narrow(ctx.lookup("java:comp/env/singleton/beanReferences/stateful"), BasicStatefulHome.class);
                Assert.assertNotNull("The EJBHome looked up is null", home);
    ...
    public void lookupSingletonBean() throws TestFailureException {
        try {
            try {
                ...
                final BasicSingletonHome home = (BasicSingletonHome) javax.rmi.PortableRemoteObject.narrow(
                        ctx.lookup("java:comp/env/singleton/beanReferences/singleton"), BasicSingletonHome.class);
                Assert.assertNotNull("The EJBHome looked up is null", home);
    ...
    public void lookupSingletonBusinessRemote() throws TestFailureException {
        try {
            try {
                ...
                final BasicSingletonBusinessRemote object = (BasicSingletonBusinessRemote) javax.rmi.PortableRemoteObject
                        .narrow(ctx.lookup("java:comp/env/singleton/beanReferences/singleton-business-remote"),
                                BasicSingletonBusinessRemote.class);
        ...
        try {
            try {
                ...
                final BasicStatefulBusinessLocal object = (BasicStatefulBusinessLocal) javax.rmi.PortableRemoteObject
                        .narrow(ctx.lookup("java:comp/env/singleton/beanReferences/stateful-business-local"),
        ...
        try {
            try {
                ...
                final BasicStatefulPojoBean object = (BasicStatefulPojoBean) javax.rmi.PortableRemoteObject.narrow(
                        ctx.lookup("java:comp/env/singleton/beanReferences/stateful-business-localbean"),
        ...
        try {
            try {
                ...
                final BasicStatefulBusinessRemote object = (BasicStatefulBusinessRemote) javax.rmi.PortableRemoteObject
                        .narrow(ctx.lookup("java:comp/env/singleton/beanReferences/stateful-business-remote"),
