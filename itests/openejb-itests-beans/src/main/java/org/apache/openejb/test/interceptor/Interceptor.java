...
public class Interceptor {
    ...
    /*
     * @Resource static SessionContext sessionContext;
     */

    /**
     * This interceptor creates/updates an inner map for every method that it intercepts. The inner map contains the
     * array of method parameters in the key PARAMETERS. The inner map contains the list of interceptor methods in the
     * key INTERCEPTORS. The inner map is put back into the contextData against the method name as the key.
     *
     * @param ctx
     *            - InvocationContext
