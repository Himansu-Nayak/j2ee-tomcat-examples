...
public class BasicBmpBean implements javax.ejb.EntityBean {
        ...
        try {
            ...
            try {
                ...
                PreparedStatement stmt = con
                        .prepareStatement("insert into entity (first_name, last_name) values (?,?)");
                try {
        ...
        try {
            ...
            try {
                final PreparedStatement stmt = con
                        .prepareStatement("update entity set first_name = ?, last_name = ? where id = ?");
                try {
                    stmt.setString(1, firstName);
                    stmt.setString(2, lastName);
    ...
    protected void testAllowedOperations(final String methodName) {
        ...
        try {
            ...
            final String actual = (String) jndiContext
                    .lookup("java:comp/env/stateless/references/JNDI_access_to_java_comp_env");
