...
public class EncStatefulBean implements javax.ejb.SessionBean, SessionSynchronization {
    ...
    public void lookupEntityBean() throws TestFailureException {
        try {
            try {
                ...
                final BasicBmpHome home = (BasicBmpHome) javax.rmi.PortableRemoteObject
                        .narrow(ctx.lookup("java:comp/env/stateful/beanReferences/bmp_entity"), BasicBmpHome.class);
    ...
    public void lookupStatefulBean() throws TestFailureException {
        try {
            try {
                ...
                final BasicStatefulHome home = (BasicStatefulHome) javax.rmi.PortableRemoteObject
                        .narrow(ctx.lookup("java:comp/env/stateful/beanReferences/stateful"), BasicStatefulHome.class);
                Assert.assertNotNull("The EJBHome looked up is null", home);
        ...
        try {
            try {
                ...
                final BasicStatelessHome home = (BasicStatelessHome) javax.rmi.PortableRemoteObject.narrow(
                        ctx.lookup("java:comp/env/stateful/beanReferences/stateless"), BasicStatelessHome.class);
                Assert.assertNotNull("The EJBHome looked up is null", home);
        ...
        try {
            try {
                ...
                final BasicStatelessBusinessRemote object = (BasicStatelessBusinessRemote) javax.rmi.PortableRemoteObject
                        .narrow(ctx.lookup("java:comp/env/stateful/beanReferences/stateless-business-remote"),
        ...
        try {
            try {
                ...
                final BasicStatefulBusinessLocal object = (BasicStatefulBusinessLocal) javax.rmi.PortableRemoteObject
                        .narrow(ctx.lookup("java:comp/env/stateful/beanReferences/stateful-business-local"),
    ...
    public void lookupStatefulBusinessLocalBean() throws TestFailureException {
        try {
            try {
                ...
                final BasicStatefulPojoBean object = (BasicStatefulPojoBean) javax.rmi.PortableRemoteObject.narrow(
                        ctx.lookup("java:comp/env/stateful/beanReferences/stateful-business-localbean"),
                        BasicStatefulPojoBean.class);
                Assert.assertNotNull("The EJB BusinessLocalBean is null", object);
            } catch (final Exception e) {
                Assert.fail("Received Exception " + e.getClass() + " : " + e.getMessage());
            }
        ...
        try {
            try {
                ...
                final BasicStatefulBusinessRemote object = (BasicStatefulBusinessRemote) javax.rmi.PortableRemoteObject
                        .narrow(ctx.lookup("java:comp/env/stateful/beanReferences/stateful-business-remote"),
    ...
    /**
     * The afterBegin method notifies a session Bean instance that a new transaction has started, and that the
    ...
    /**
     * The beforeCompletion method notifies a session Bean instance that a transaction is about to be committed. The
     * instance can use this method, for example, to write any cached data to a database.
     */
    public void beforeCompletion() throws EJBException, RemoteException {
    }

    /**
     * The afterCompletion method notifies a session Bean instance that a transaction commit protocol has completed, and
