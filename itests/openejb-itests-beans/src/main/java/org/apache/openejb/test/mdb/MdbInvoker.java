        ...
        try {
            ...
            if (!(message instanceof ObjectMessage))
                throw new IllegalArgumentException(
                        "Expected a ObjectMessage request but got a " + message.getClass().getName());
            ...
            if (!(object instanceof Map)) {
                if (message instanceof ObjectMessage)
                    throw new IllegalArgumentException(
                            "Expected a Map contained in the ObjectMessage request but got a "
            ...
            if (method == null)
                throw new IllegalArgumentException(
                        "no such method " + signature + "; known methods are " + signatures.keySet());
