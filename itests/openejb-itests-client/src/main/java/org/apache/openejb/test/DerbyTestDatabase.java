    ...
    public void createEntityTable() throws java.sql.SQLException {
        try {
            ...
            if (re.detail != null && re.detail instanceof java.sql.SQLException) {
                ...
                throw new java.sql.SQLException("Cannot create entity table: " + re.getMessage(),
                        DerbyTestDatabase._createEntity);
            }
        }
    }
    ...
    public void dropEntityTable() throws java.sql.SQLException {
        try {
            ...
            if (re.detail != null && re.detail instanceof java.sql.SQLException) {
                ...
                throw new java.sql.SQLException("Unable to drop entity table: " + re.getMessage(),
                        DerbyTestDatabase._dropEntity);
            }
        }
    }
    ...
    public void createAccountTable() throws java.sql.SQLException {
        try {
            ...
            if (re.detail != null && re.detail instanceof java.sql.SQLException) {
                ...
                throw new java.sql.SQLException("Cannot create account table: " + re.getMessage(),
                        DerbyTestDatabase._createAccount);
            }
        }
    }
    ...
    public void dropAccountTable() throws java.sql.SQLException {
        try {
            ...
            if (re.detail != null && re.detail instanceof java.sql.SQLException) {
                ...
                throw new java.sql.SQLException("Cannot drop account table: " + re.getMessage(),
                        DerbyTestDatabase._dropAccount);
            }
        }
    }
    ...
    public void start() throws IllegalStateException {
        ...
        try {
            ...
            throw new IllegalStateException(
                    "Cannot find 'client/tools/DatabaseHome': " + e.getClass().getName() + " " + e.getMessage());
        }
        try {
