...
public class EjbqlLocalTest extends Cmp2TestClient {
    ...
    public void testSelectCollectionLocalEjb() throws Exception {
        ...
        for (final Object object : result) {
            assertTrue("result item should be an instance of QueryDataLocal but is instance of "
                    + Arrays.toString(object.getClass().getInterfaces()), object instanceof QueryDataLocal);
