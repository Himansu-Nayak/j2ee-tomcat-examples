...
public class PostgreSqlTestDatabase implements TestDatabase {
    ...
    public static void main(final String[] args) {
        ...
        try {
            final ClassLoader cl = (ClassLoader) java.security.AccessController
        ...
        try {
            final PreparedStatement pstmt = conn
                    .prepareStatement("insert into entity (id, first_name, last_name) values (?,?,?)");
            pstmt.setInt(1, 101);
        ...
        try {
            final PreparedStatement pstmt = conn
                    .prepareStatement("select id from entity where first_name = ? AND last_name = ?");
    ...
    public void start() throws IllegalStateException {
        try {
            ...
            final DatabaseHome databaseHome = (DatabaseHome) javax.rmi.PortableRemoteObject.narrow(obj,
                    DatabaseHome.class);
