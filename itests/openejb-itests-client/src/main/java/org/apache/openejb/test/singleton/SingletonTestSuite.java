...
public class SingletonTestSuite extends junit.framework.TestCase {
    ...
    public static junit.framework.Test suite() {
        ...
        /*
         * TO DO suite.addTest(new SingletonEjbContextTests()); suite.addTest(new BMTSingletonEjbContextTests());
         * suite.addTest(new BMTSingletonEncTests()); suite.addTest(new SingletonContainerManagedTransactionTests());
         */
        return suite;
    }
}
