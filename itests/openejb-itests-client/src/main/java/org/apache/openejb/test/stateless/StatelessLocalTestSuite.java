...
public class StatelessLocalTestSuite extends junit.framework.TestCase {
    ...
    public static junit.framework.Test suite() {
        ...
        /*
         * TO DO suite.addTest(new StatelessEjbContextTests()); suite.addTest(new BMTStatelessEjbContextTests());
         * suite.addTest(new BMTStatelessEncTests()); suite.addTest(new StatelessContainerManagedTransactionTests());
         */
        return suite;
    }
}
