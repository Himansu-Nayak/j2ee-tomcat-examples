...
public class SingletonRmiIiopTests extends SingletonTestClient {
    ...
    public void test35_returnEJBHome() {
        try {
            ...
            final EncSingletonHome expected = (EncSingletonHome) javax.rmi.PortableRemoteObject.narrow(obj,
                    EncSingletonHome.class);
            assertNotNull("The EJBHome returned from JNDI is null", expected);

            final EncSingletonHome actual = (EncSingletonHome) PortableRemoteObject
                    .narrow(ejbObject.returnEJBHome(expected), EncSingletonHome.class);
    ...
    public void test36_returnEJBHome2() {
        try {
            final EncSingletonHome actual = (EncSingletonHome) PortableRemoteObject.narrow(ejbObject.returnEJBHome(),
                    EncSingletonHome.class);
            assertNotNull("The EJBHome returned is null", actual);
    ...
    public void test37_returnNestedEJBHome() {
        try {
            ...
            final EncSingletonHome actual = (EncSingletonHome) PortableRemoteObject.narrow(graph.getObject(),
                    EncSingletonHome.class);
            assertNotNull("The EJBHome returned is null", actual);
        } catch (final Exception e) {
            fail("Received Exception " + e.getClass() + " : " + e.getMessage());
    ...
    public void test40_returnEJBObject() {
        try {
            final Object obj = initialContext.lookup("client/tests/singleton/EncBean");
            final EncSingletonHome home = (EncSingletonHome) javax.rmi.PortableRemoteObject.narrow(obj,
                    EncSingletonHome.class);
            ...
            final EncSingletonObject actual = (EncSingletonObject) PortableRemoteObject
                    .narrow(ejbObject.returnEJBObject(expected), EncSingletonObject.class);
    ...
    public void test41_returnEJBObject2() {
        try {
            final EncSingletonObject actual = (EncSingletonObject) PortableRemoteObject
                    .narrow(ejbObject.returnEJBObject(), EncSingletonObject.class);
            assertNotNull("The EJBObject returned is null", actual);
    ...
    public void test42_returnNestedEJBObject() {
        try {
            ...
            final EncSingletonObject actual = (EncSingletonObject) PortableRemoteObject.narrow(graph.getObject(),
                    EncSingletonObject.class);
            assertNotNull("The EJBObject returned is null", actual);
    ...
    public void test54_returnHandleArray() {
        try {
            ...
            for (int i = 0; i < expected.length; i++) {
                ...
                assertTrue("The EJBObjects in the Handles are not equal",
    ...
    public void test57_returnClass() {
        final Class[] primitives = { boolean.class, byte.class, char.class, short.class, int.class, long.class,
    ...
    public void test58_returnClassArray() {
        try {
            final Class[] expected = { boolean.class, byte.class, char.class, short.class, int.class, long.class,
                    float.class, double.class };
