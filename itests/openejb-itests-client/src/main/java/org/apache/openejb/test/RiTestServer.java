 ...
 * <p/>
 * <code>test.home</code> <code>server.classpath</code>
 */
public class RiTestServer implements TestServer {

    /**
     * The environment variable <code>test.home</code> sould be set to the base directory where the test suite is
     * located.
     */
    ...
    public void init(final Properties props) {
        try {
            ...
            /*
             * If we will not be starting process for the server than we don't need to read in the other properties
             */
        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    if (line == null || "[RI Server] Ready!".equals(line))
                        break;
