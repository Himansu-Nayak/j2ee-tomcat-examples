...
public class StatefulLocalTestSuite extends junit.framework.TestCase {
    ...
    public static Test suite() {
        ...
        /*
         * TO DO suite.addTest(new StatefulEjbContextTests()); suite.addTest(new BMTStatefulEjbContextTests());
         * suite.addTest(new BMTStatefulEncTests()); suite.addTest(new StatefulContainerManagedTransactionTests());
         */
