...
public class SingletonBeanTxTests extends org.apache.openejb.test.NamedTestCase {
     ...
     * <B>11.6.1 Bean-managed transaction demarcation</B>
     * <p/>
     * If a singleton session bean instance starts a transaction in a business method, it must commit the transaction
     * before the business method returns. The Container must detect the case in which a transaction was started, but
     ...
     * context. The container resumes the client's ntransaction association (T1) when the method completes.
     * </P>
     * <P>
     * --------------------------------------------------------
     * </P>
