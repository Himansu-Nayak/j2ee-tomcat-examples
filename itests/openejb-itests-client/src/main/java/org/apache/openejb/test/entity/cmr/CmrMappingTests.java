...
import org.apache.openejb.test.entity.cmr.cmrmapping.*;
...
public class CmrMappingTests extends AbstractCMRTest {
    ...
    protected void setUp() throws Exception {
        ...
        oneInverseHome = (OneInverseSideLocalHome) initialContext
                .lookup("java:openejb/local/client/tests/entity/cmp2/OneInverseSideBean/EJBHomeLocal");
        oneOwningHome = (OneOwningSideLocalHome) initialContext
                .lookup("java:openejb/local/client/tests/entity/cmp2/OneOwningSideBean/EJBHomeLocal");
        manyHome = (ManyOwningSideLocalHome) initialContext
                .lookup("java:openejb/local/client/tests/entity/cmp2/ManyOwningSideBean/EJBHomeLocal");
    }
    ...
    public void testOneToOneSetCMROnOwningSide() throws Exception {
        ...
        try {
            ...
            throw new TestFailureException(
                    new AssertionFailedError("Received Exception " + e.getClass() + " : " + e.getMessage()));
        } finally {
            completeTransaction();
            cleanDb();
        }
    ...
    private void validateOneToManyRelationship() throws NotSupportedException, SystemException, Exception,
