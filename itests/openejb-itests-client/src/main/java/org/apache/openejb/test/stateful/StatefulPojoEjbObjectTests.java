...
public class StatefulPojoEjbObjectTests extends BasicStatefulTestClient {
    ...
    /**
     * A method to test the implementation of Stateful Session Bean identity check. See EJB3.0
     * "Core Contracts and Requirements" specification, section 3.4.5.1
     */
    public void test03_isIdentical() {
        ...
        try {
            /*
             * This EJBObject reference is created to validate the identity if different EJBObject refernces of the same
             * interface type of the same session bean.
             */
