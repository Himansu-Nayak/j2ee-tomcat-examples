...
public class StatelessRmiIiopTests extends StatelessTestClient {
    ...
    public void test35_returnEJBHome() {
        try {
            ...
            final EncStatelessHome expected = (EncStatelessHome) javax.rmi.PortableRemoteObject.narrow(obj,
                    EncStatelessHome.class);
            assertNotNull("The EJBHome returned from JNDI is null", expected);

            final EncStatelessHome actual = (EncStatelessHome) PortableRemoteObject
                    .narrow(ejbObject.returnEJBHome(expected), EncStatelessHome.class);
    ...
    public void test36_returnEJBHome2() {
        try {
            final EncStatelessHome actual = (EncStatelessHome) PortableRemoteObject.narrow(ejbObject.returnEJBHome(),
                    EncStatelessHome.class);
            assertNotNull("The EJBHome returned is null", actual);
    ...
    public void test37_returnNestedEJBHome() {
        try {
            ...
            final EncStatelessHome actual = (EncStatelessHome) PortableRemoteObject.narrow(graph.getObject(),
                    EncStatelessHome.class);
            assertNotNull("The EJBHome returned is null", actual);
        } catch (final Exception e) {
            fail("Received Exception " + e.getClass() + " : " + e.getMessage());
    ...
    public void test40_returnEJBObject() {
        try {
            final Object obj = initialContext.lookup("client/tests/stateless/EncBean");
            final EncStatelessHome home = (EncStatelessHome) javax.rmi.PortableRemoteObject.narrow(obj,
                    EncStatelessHome.class);
            ...
            final EncStatelessObject actual = (EncStatelessObject) PortableRemoteObject
                    .narrow(ejbObject.returnEJBObject(expected), EncStatelessObject.class);
    ...
    public void test41_returnEJBObject2() {
        try {
            final EncStatelessObject actual = (EncStatelessObject) PortableRemoteObject
                    .narrow(ejbObject.returnEJBObject(), EncStatelessObject.class);
            assertNotNull("The EJBObject returned is null", actual);
    ...
    public void test42_returnNestedEJBObject() {
        try {
            ...
            final EncStatelessObject actual = (EncStatelessObject) PortableRemoteObject.narrow(graph.getObject(),
