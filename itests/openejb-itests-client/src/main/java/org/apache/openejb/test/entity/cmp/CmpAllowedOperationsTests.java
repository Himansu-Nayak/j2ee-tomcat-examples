...
public class CmpAllowedOperationsTests extends BasicCmpTestClient {
    ...
    protected void setUp() throws Exception {
        ...
        /*
         * These tests will only work if the specified method has already been called by the container.
         *
         * TO DO: Implement a little application senario to ensure that all methods tested for below have been called by
         * the container.
         */
        doScenario();
    }
    ...
    /**
     * This method ensures that all thee bean methods have been invoked for correct behaviour of the tests.
     */
    ...
    public void TODO_test07_ejbSelect() {
        try {
            ...
            final Object expected = policy;
            final Object actual = ejbObject.getAllowedOperationsReport("ejbSelect");
    ...
    public void TODO_test09_ejbSelectInEntity() {
        try {
            ...
            final Object expected = policy;
            final Object actual = ejbObject.getAllowedOperationsReport("ejbSelectInEntity");
