...
public class StatefulRmiIiopTests extends StatefulTestClient {
    ...
    public void test35_returnEJBHome() {
        try {
            ...
            final EncStatefulHome expected = (EncStatefulHome) javax.rmi.PortableRemoteObject.narrow(obj,
                    EncStatefulHome.class);
            assertNotNull("The EJBHome returned from JNDI is null", expected);

            final EncStatefulHome actual = (EncStatefulHome) javax.rmi.PortableRemoteObject
                    .narrow(ejbObject.returnEJBHome(expected), EncStatefulHome.class);
    ...
    public void test36_returnEJBHome2() {
        try {
            final EncStatefulHome actual = (EncStatefulHome) javax.rmi.PortableRemoteObject
                    .narrow(ejbObject.returnEJBHome(), EncStatefulHome.class);
            assertNotNull("The EJBHome returned is null", actual);
    ...
    public void test37_returnNestedEJBHome() {
        try {
            ...
            final EncStatefulHome actual = (EncStatefulHome) javax.rmi.PortableRemoteObject.narrow(graph.getObject(),
                    EncStatefulHome.class);
            assertNotNull("The EJBHome returned is null", actual);
        } catch (final Exception e) {
            fail("Received Exception " + e.getClass() + " : " + e.getMessage());
    ...
    public void test40_returnEJBObject() {
        try {
            final Object obj = initialContext.lookup("client/tests/stateful/EncBean");
            final EncStatefulHome home = (EncStatefulHome) javax.rmi.PortableRemoteObject.narrow(obj,
                    EncStatefulHome.class);
            ...
            final EncStatefulObject actual = (EncStatefulObject) javax.rmi.PortableRemoteObject
                    .narrow(ejbObject.returnEJBObject(expected), EncStatefulObject.class);
    ...
    public void test41_returnEJBObject2() {
        try {
            final EncStatefulObject actual = (EncStatefulObject) javax.rmi.PortableRemoteObject
                    .narrow(ejbObject.returnEJBObject(), EncStatefulObject.class);
            assertNotNull("The EJBObject returned is null", actual);
    ...
    public void test42_returnNestedEJBObject() {
        try {
            ...
            final EncStatefulObject actual = (EncStatefulObject) javax.rmi.PortableRemoteObject
                    .narrow(graph.getObject(), EncStatefulObject.class);
            assertNotNull("The EJBObject returned is null", actual);
