...
public class BmpRmiIiopTests extends BmpTestClient {
    ...
    public void test35_returnEJBHome() {
        try {
            ...
            final EncBmpHome actual = (EncBmpHome) javax.rmi.PortableRemoteObject
                    .narrow(ejbObject.returnEJBHome(expected), EncBmpHome.class);
    ...
    public void test36_returnEJBHome2() {
        try {
            final EncBmpHome actual = (EncBmpHome) javax.rmi.PortableRemoteObject.narrow(ejbObject.returnEJBHome(),
                    EncBmpHome.class);
            assertNotNull("The EJBHome returned is null", actual);
    ...
    public void test37_returnNestedEJBHome() {
        try {
            ...
            final EncBmpHome actual = (EncBmpHome) javax.rmi.PortableRemoteObject.narrow(graph.getObject(),
                    EncBmpHome.class);
            assertNotNull("The EJBHome returned is null", actual);
        } catch (final Exception e) {
            fail("Received Exception " + e.getClass() + " : " + e.getMessage());
    ...
    public void test40_returnEJBObject() {
        try {
            ...
            final EncBmpObject actual = (EncBmpObject) javax.rmi.PortableRemoteObject
                    .narrow(ejbObject.returnEJBObject(expected), EncBmpObject.class);
    ...
    public void test41_returnEJBObject2() {
        try {
            final EncBmpObject actual = (EncBmpObject) javax.rmi.PortableRemoteObject
                    .narrow(ejbObject.returnEJBObject(), EncBmpObject.class);
            assertNotNull("The EJBObject returned is null", actual);
    ...
    public void test42_returnNestedEJBObject() {
        try {
            ...
            final EncBmpObject actual = (EncBmpObject) (EncBmpObject) javax.rmi.PortableRemoteObject
                    .narrow(graph.getObject(), EncBmpObject.class);
            assertNotNull("The EJBObject returned is null", actual);
