...
public class CmpRmiIiopTests extends CmpTestClient {
    ...
    public void test35_returnEJBHome() {
        try {
            ...
            final EncCmpHome actual = (EncCmpHome) javax.rmi.PortableRemoteObject
                    .narrow(ejbObject.returnEJBHome(expected), EncCmpHome.class);
    ...
    public void test36_returnEJBHome2() {
        try {
            final EncCmpHome actual = (EncCmpHome) javax.rmi.PortableRemoteObject.narrow(ejbObject.returnEJBHome(),
                    EncCmpHome.class);
            assertNotNull("The EJBHome returned is null", actual);
    ...
    public void test37_returnNestedEJBHome() {
        try {
            ...
            final EncCmpHome actual = (EncCmpHome) javax.rmi.PortableRemoteObject.narrow(graph.getObject(),
                    EncCmpHome.class);
            assertNotNull("The EJBHome returned is null", actual);
        } catch (final Exception e) {
            fail("Received Exception " + e.getClass() + " : " + e.getMessage());
    ...
    public void test40_returnEJBObject() {
        try {
            ...
            final EncCmpObject actual = (EncCmpObject) javax.rmi.PortableRemoteObject
                    .narrow(ejbObject.returnEJBObject(expected), EncCmpObject.class);
    ...
    public void test41_returnEJBObject2() {
        try {
            final EncCmpObject actual = (EncCmpObject) javax.rmi.PortableRemoteObject
                    .narrow(ejbObject.returnEJBObject(), EncCmpObject.class);
            assertNotNull("The EJBObject returned is null", actual);
    ...
    public void test42_returnNestedEJBObject() {
        try {
            ...
            final EncCmpObject actual = (EncCmpObject) javax.rmi.PortableRemoteObject.narrow(graph.getObject(),
                    EncCmpObject.class);
            assertNotNull("The EJBObject returned is null", actual);
