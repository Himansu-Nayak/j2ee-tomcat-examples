...
public class HsqldbTestDatabase implements TestDatabase {
    ...
    private static final String[] AUTO_CREATED_TABLES = new String[] { "BasicCmpBean", "BasicCmpBeanX",
            "ComplexCmpBean", "ComplexCmpBeanX", "UnknownCmpBean", "UnknownCmpBeanX", "BasicCmp2Bean",
            "ComplexCmp2Bean", "UnknownCmp2Bean", "AOBasicCmpBean", "AllowedOperationsCmp2Bean", "EncCmpBean",
            "EncCmp2Bean", "ContextLookupCmpBean", "Cmp_RMI_IIOP_Bean", "RmiIiopCmp2Bean", "Person", "License",
            "ComplexPerson", "ComplexLicense", "Artist", "Song", "ComplexArtist", "Complexsong", "Game", "Platform",
            "ComplexGame", "ComplexPlatform", "Query", "QueryData", };
    ...
    public void start() throws IllegalStateException {
        try {
            ...
            throw (IllegalStateException) new IllegalStateException(
                    "Cannot create initial context: " + e.getClass().getName() + " " + e.getMessage()).initCause(e);
        }
        ...
        try {
            ...
            throw new IllegalStateException(
                    "Cannot find " + databaseHomeJndiName + ": " + e.getClass().getName() + " " + e.getMessage());
        }
        try {
