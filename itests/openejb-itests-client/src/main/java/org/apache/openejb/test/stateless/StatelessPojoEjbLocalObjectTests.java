...
public class StatelessPojoEjbLocalObjectTests extends BasicStatelessLocalTestClient {
    ...
    protected void setUp() throws Exception {
        ...
        ejbLocalHome = (BasicStatelessLocalHome) javax.rmi.PortableRemoteObject.narrow(obj,
                BasicStatelessLocalHome.class);
     ...
     * their identity as a primary key, session objects hide their identity. As a result, the
     * EJBLocalObject.getPrimaryKey() method results in a javax.ejb.EJBException, and EJBLocalHome.remove(Object
     * primaryKey) method results in a javax.ejb.RemoveException. If the EJBMetaData.getPrimaryKeyClass() method is
     * invoked on a EJBMetaData object for a Session bean, the method throws the java.lang.RuntimeException.
     */
