...
public class StandaloneServer {
    ...
    /**
     * Used as a convenience for tracking objects associated with this server. Does not affect the running server and
     * none of these objects are in any way sent or part of the server itself.
     *
     * @return Context
     */
