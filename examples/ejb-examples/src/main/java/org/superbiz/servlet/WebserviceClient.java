...
public class WebserviceClient {
    ...
    /**
     * Unfortunately, to run this example with CXF you need to have a HUGE class path. This is just what is required to
     * run CXF:
     * <p/>
     ...
     * <p/>
     * <p/>
     * cxf-api-2.0.2-incubator.jar cxf-common-utilities-2.0.2-incubator.jar cxf-rt-bindings-soap-2.0.2-incubator.jar
     * cxf-rt-core-2.0.2-incubator.jar cxf-rt-databinding-jaxb-2.0.2-incubator.jar
     * cxf-rt-frontend-jaxws-2.0.2-incubator.jar cxf-rt-frontend-simple-2.0.2-incubator.jar
     * cxf-rt-transports-http-jetty-2.0.2-incubator.jar cxf-rt-transports-http-2.0.2-incubator.jar
     * cxf-tools-common-2.0.2-incubator.jar
     * <p/>
     * geronimo-activation_1.1_spec-1.0.jar geronimo-annotation_1.0_spec-1.1.jar geronimo-ejb_3.0_spec-1.0.jar
     * geronimo-jpa_3.0_spec-1.1.jar geronimo-servlet_2.5_spec-1.1.jar geronimo-stax-api_1.0_spec-1.0.jar
     * jaxws-api-2.0.jar axis2-jws-api-1.3.jar
     * <p/>
