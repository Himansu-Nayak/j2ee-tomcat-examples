...
public class SubjectServiceTomEETest {
    ...
    public static WebArchive archive() {
        return new WebModule(SubjectServiceTomEETest.class).getArchive().addClass(VoteCounter.class)
                ...
                .addAsWebInfResource(EmptyAsset.INSTANCE, "beans.xml").addPackage(PollingRouter.class.getPackage()) // core
    ...
    public void checkThereIsSomeOutput() throws Exception {
        ...
        WebClient.create(base).path("api/subject/create").accept("application/json")
                .query("name", "SubjectServiceTomEETest").post("SubjectServiceTomEETest");
