...
/**
 * This is an EJB 3 style pojo stateful session bean it does not need to implement javax.ejb.SessionBean
 */
//START SNIPPET: code
...
public class FriendlyPerson implements FriendlyPersonLocal, FriendlyPersonRemote {
    ...
    /**
     * This method corresponds to the FriendlyPersonEjbHome.create() method and the FriendlyPersonEjbLocalHome.create()
     * <p/>
     * If you do not have an EJBHome or EJBLocalHome interface, this method can be deleted.
     */
    @Init
    public void create() {
    }
    ...
    /**
     * This method corresponds to the following methods: - EJBObject.remove() - EJBHome.remove(ejbObject) -
     * EJBLocalObject.remove() - EJBLocalHome.remove(ejbObject)
     * <p/>
     * If you do not have an EJBHome or EJBLocalHome interface, this method can be deleted.
     */
    @Remove
