...
public class TelephoneTest extends TestCase {
    ...
    private static final int port = Integer
            .parseInt(System.getProperty("ejbd.port", "" + org.apache.openejb.util.NetworkUtil.getNextAvailablePort()));
    ...
    public void testTalkOverLocalNetwork() throws Exception {
        ...
        telephone.speak(
                "Right, you really only have to use the RemoteInitialContextFactory if you're in a different vm.");
