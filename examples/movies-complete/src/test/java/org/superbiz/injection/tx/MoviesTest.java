...
/**
 * See the transaction-rollback example as it does the same thing via UserTransaction and shows more techniques for
 * rollback
 */
//START SNIPPET: code
public class MoviesTest extends TestCase {
    ...
    /**
     * This little bit of magic allows our test code to execute in the scope of a container controlled transaction.
     */
    @Stateless
    @RunAs("Manager")
