...
public class InfoBean implements Serializable {
    ...
    protected void showWelcomeMessage() {
        ...
        this.beanValidationVersion = ClassUtils
                .getJarVersion(Validation.buildDefaultValidatorFactory().getValidator().getClass());

        this.jpaVersion = ClassUtils
                .getJarVersion(Persistence.createEntityManagerFactory("demoApplicationPU").getClass());
    ...
    public boolean isInfoPage() {
        ViewConfigDescriptor viewConfigDescriptor = this.viewConfigResolver
                .getViewConfigDescriptor(this.facesContext.getViewRoot().getViewId());
