...
/**
 * Can convert anything with a: - PropertyEditor - Constructor that accepts String - public static method that returns
 * itself and takes a String
 *
...
public class Converter {
    ...
    private static boolean isInvalidMethod(Class<?> type, Method method) {
        if (!Modifier.isStatic(method.getModifiers()) || !Modifier.isPublic(method.getModifiers())
                || !method.getReturnType().equals(type) || !method.getParameterTypes()[0].equals(String.class)
