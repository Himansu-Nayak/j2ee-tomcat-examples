...
public class UserServiceTest {
    ...
    public void create() throws NamingException {
        ...
        final String uri = "http://127.0.0.1:" + System.getProperty(EmbeddedTomEEContainer.TOMEE_EJBCONTAINER_HTTP_PORT)
                + "/rest-example";
    ...
    /**
     * a simple copy of the unique method i want to use from my service. It allows to use cxf proxy to call remotely our
     * rest service. Any other way to do it is good.
     */
    @Path("/api/user")
