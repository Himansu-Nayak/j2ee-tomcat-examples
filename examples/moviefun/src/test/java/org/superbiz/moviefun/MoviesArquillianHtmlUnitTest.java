...
public class MoviesArquillianHtmlUnitTest {
    ...
    public static WebArchive createDeployment() {
        ...
        Collection<String> dependencies = Arrays
                .asList(new String[] { "javax.servlet:jstl", "taglibs:standard", "commons-lang:commons-lang" });

        File[] libs = Maven.resolver().loadPomFromFile(Basedir.basedir("pom.xml")).resolve(dependencies)
