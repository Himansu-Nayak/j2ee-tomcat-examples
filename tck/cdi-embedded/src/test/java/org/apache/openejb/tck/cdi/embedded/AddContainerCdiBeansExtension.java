...
public class AddContainerCdiBeansExtension {
    private static final URL EXT_LIB = AddContainerCdiBeansExtension.class.getClassLoader()
            .getResource(Translator.class.getName().replace(".", "/") + ".class");
    private static final List<String> BEANS = new ArrayList<>(
            asList(Strict.class.getName(), Translator.class.getName()));
