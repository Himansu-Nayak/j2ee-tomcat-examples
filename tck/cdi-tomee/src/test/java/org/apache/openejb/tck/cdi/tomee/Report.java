...
public class Report {
    ...
    private void main() throws Exception {
        ...
        final File file = new File(
                "/Users/dblevins/work/all/trunk/openejb/tck/cdi-tomee/target/failsafe-reports/testng-results.xml");
    ...
    private void passingXml(File file) throws FileNotFoundException {
        ...
        out.println(header + "<suite name=\"CDI TCK\" verbose=\"0\">\n" + "  <test name=\"CDI TCK\">\n"
    ...
    private boolean contains(TestClass testClass, Status status) {
        ...
        for (TestResult result : testClass.getResults()) {
            if (result.name.equals("beforeClass"))
                continue;
            if (result.name.equals("afterClass"))
                continue;
            if (result.name.equals("afterSuite"))
                continue;
            if (result.name.equals("beforeSuite"))
                continue;
