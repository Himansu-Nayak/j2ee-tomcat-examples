...
public class ELImpl implements org.jboss.jsr299.tck.spi.EL {
    ...
    private static final ExpressionFactory EXPRESSION_FACTORY = new WrappedExpressionFactory(
    ...
    public <T> T evaluateMethodExpression(String expression, Class<T> expectedType, Class<?>[] expectedParamTypes,
        ...
        Object object = EXPRESSION_FACTORY.createMethodExpression(context, expression, expectedType, expectedParamTypes)
