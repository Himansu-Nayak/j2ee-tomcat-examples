...
public class Installers {
    ...
    public static String replace(final String inputText, final String begin, final String newBegin, final String end,
            final String newEnd) throws IOException {
        ...
        final InputStream replacementStream = new DelimitedTokenReplacementInputStream(in, begin, end, tokenHandler,
                true);
