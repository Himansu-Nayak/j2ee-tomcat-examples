...
public class Runner {
    ...
    public synchronized List<Map<String, String>> execute(final boolean install) {
        ...
        }
        {
            ...
            try {
                final Class openejb = Class.forName("org.apache.openejb.OpenEJB", true,
            ...
            installerResults.add(
                    Common.build("wereTheOpenEJBClassesInstalled", String.valueOf(wereTheOpenEJBClassesInstalled)));
            installerResults
                    .add(Common.build("wereTheEjbClassesInstalled", String.valueOf(wereTheEjbClassesInstalled)));
