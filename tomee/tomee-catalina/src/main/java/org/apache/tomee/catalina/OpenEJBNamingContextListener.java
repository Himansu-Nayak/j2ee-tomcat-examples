...
public class OpenEJBNamingContextListener implements LifecycleListener, PropertyChangeListener {
    ...
    /**
     * Process a property change on the global naming resources, by making the corresponding addition or removal to
     * OpenEJB.
     *
     * @param name
    ...
    private void bindResource(final String name, final Object value, final String type) {
        final Assembler assembler = (Assembler) SystemInstance.get()
                .getComponent(org.apache.openejb.spi.Assembler.class);
        try {
