...
public class TomEETldScanner extends TldScanner {
    ...
    public TomEETldScanner(final ServletContext context, final boolean namespaceAware, final boolean validate,
        ...
        tldResourcePathTaglibXmlMapParent = (Map<TldResourcePath, TaglibXml>) Reflections.get(this,
        ...
        if (MYFACES_URL != null) {
            {
                ...
                taglibXml.setInfo("This tag library implements the standard JSF HTML tags.");
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("immediate", false,
                                "javax.el.ValueExpression", false, false,
                                "A boolean value that identifies the phase during which action events should fire. <p> During normal event processing, action methods and action listener methods are fired during the \"invoke application\" phase of request processing. If this attribute is set to \"true\", these methods are fired instead at the end of the \"apply request values\" phase. </p>",
                                true, false, "boolean", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("required", false,
                                "javax.el.ValueExpression", false, false,
                                "A boolean value that indicates whether an input value is required. <p> If this value is true and no input value is provided by a postback operation, then the \"requiredMessage\" text is registered as a FacesMessage for the request, and validation fails. </p> <p> Default value: false. </p>",
                                true, false, "boolean", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("converterMessage", false,
                                "javax.el.ValueExpression", false, false,
                                "Text to be displayed to the user as an error message when conversion of a submitted value to the target type fails. <p> </p>",
                                true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("requiredMessage", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("validator", false,
                                "javax.el.MethodExpression", false, false,
                                "A method-binding EL expression which is invoked during the validation phase for this component. <p> The invoked method is expected to check the submitted value for this component, and if not acceptable then report a validation error for the component. </p> <p> The method is expected to have the prototype </p> <code>public void aMethod(FacesContext, UIComponent,Object)</code>",
                                false, true, "null",
                                "void myMethod( javax.faces.context.FacesContext, javax.faces.component.UIComponent, java.lang.Object )");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("validatorMessage", false,
                                "javax.el.ValueExpression", false, false,
                                "Text which will be shown if validation fails.", true, false, "java.lang.String",
                                "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("valueChangeListener", false,
                                "javax.el.MethodExpression", false, false,
                                "A method which is invoked during postback processing for the current view if the submitted value for this component is not equal to the value which the \"value\" expression for this component returns. <p> The phase in which this method is invoked can be controlled via the immediate attribute. </p>",
                                false, true, "null", "void myMethod( javax.faces.event.ValueChangeEvent )");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, "javax.el.ValueExpression",
                                false, false, "Gets The initial value of this component.", true, false,
                                "java.lang.Object", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("converter", false,
                                "javax.el.ValueExpression", false, false,
                                "An expression that specifies the Converter for this component. <p> The value can either be a static value (ID) or an EL expression. When a static id is specified, an instance of the converter type registered with that id is used. When this is an EL expression, the result of evaluating the expression must be an object that implements the Converter interface. </p>",
                                true, false, "javax.faces.convert.Converter", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("id", false, "null", true, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("rendered", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("binding", false, "javax.el.ValueExpression",
                                false, false,
                                ...
                                true, false, "javax.faces.component.UIComponent", "null");
                        tag.getAttributes().add(attr);
                    }
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("headerClass", false,
                                "javax.el.ValueExpression", false, false, "CSS class to be used for the header.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("footerClass", false,
                                "javax.el.ValueExpression", false, false, "CSS class to be used for the footer.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("rowHeader", false,
                                "javax.el.ValueExpression", false, false,
                                "If true the column is rendered with \"th\" and scope=\"row\" attribute, instead \"td\"",
                                true, false, "boolean", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("rendered", false,
                                "javax.el.ValueExpression", false, false,
                                "A boolean value that indicates whether this component should be rendered. Default value: true.",
                                true, false, "java.lang.Boolean", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("id", false, "java.lang.String", false,
                                false,
                                "Get a string which uniquely identifies this UIComponent within the scope of the nearest ancestor NamingContainer component. The id is not necessarily unique across all components in the current view.",
                                false, false, "null", "null");
                        tag.getAttributes().add(attr);
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("image", false, "javax.el.ValueExpression",
                                false, false, "HTML: The URL of an image that renders in place of the button.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("type", false, "javax.el.ValueExpression",
                                false, false,
                                "HTML: A hint to the user agent about the content type of the linked resource.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("label", false, "javax.el.ValueExpression",
                                false, false, "A display name for this component.", true, false, "java.lang.String",
                                "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("style", false, "javax.el.ValueExpression",
                                false, false, "HTML: CSS styling instructions.", true, false, "java.lang.String",
                                "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("styleClass", false,
                                "javax.el.ValueExpression", false, false,
                                "The CSS class for this element.  Corresponds to the HTML 'class' attribute.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("alt", false, "javax.el.ValueExpression",
                                false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("tabindex", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("onblur", false, "javax.el.ValueExpression",
                                false, false, "HTML: Specifies a script to be invoked when the element loses focus.",
                                true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("onfocus", false, "javax.el.ValueExpression",
                                false, false, "HTML: Specifies a script to be invoked when the element receives focus.",
                                true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("accesskey", false,
                                "javax.el.ValueExpression", false, false, "HTML: Sets the access key for this element.",
                                true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("role", false, "javax.el.ValueExpression",
                                false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("onchange", false,
                                "javax.el.ValueExpression", false, false,
                                "HTML: Specifies a script to be invoked when the element is modified.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("onselect", false,
                                "javax.el.ValueExpression", false, false,
                                "HTML: Specifies a script to be invoked when the element is selected.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("onclick", false, "javax.el.ValueExpression",
                                false, false, "HTML: Script to be invoked when the element is clicked.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("ondblclick", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("onkeydown", false,
                                "javax.el.ValueExpression", false, false,
                                "HTML: Script to be invoked when a key is pressed down over this element.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("onkeypress", false,
                                "javax.el.ValueExpression", false, false,
                                "HTML: Script to be invoked when a key is pressed over this element.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("onkeyup", false, "javax.el.ValueExpression",
                                false, false, "HTML: Script to be invoked when a key is released over this element.",
                                true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("onmousedown", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("onmousemove", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("onmouseout", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("onmouseover", false,
                                "javax.el.ValueExpression", false, false,
                                "HTML: Script to be invoked when the pointing device is moved into this element.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("onmouseup", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("dir", false, "javax.el.ValueExpression",
                                false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("lang", false, "javax.el.ValueExpression",
                                false, false, "HTML: The base language of this document.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("title", false, "javax.el.ValueExpression",
                                false, false,
                                "HTML: An advisory title for this element.  Often used by the user agent as a tooltip.",
                                true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("disabled", false,
                                "javax.el.ValueExpression", false, false,
                                "HTML: When true, this element cannot receive focus.", true, false, "boolean", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("readonly", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, "javax.el.ValueExpression",
                                false, false, "The text to display to the user for this command component.", true,
                                false, "java.lang.Object", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("action", false, "javax.el.MethodExpression",
                                false, false,
                                "The action to take when this command is invoked. <p> If the value is an expression, it is expected to be a method binding EL expression that identifies an action method. An action method accepts no parameters and has a String return value, called the action outcome, that identifies the next view displayed. The phase that this event is fired in can be controlled via the immediate attribute. </p> <p>  If the value is a string literal, it is treated as a navigation outcome for the current view. This is functionally equivalent to a reference to an action method that returns the string literal. </p>",
                                false, true, "null", "java.lang.Object myMethod(  )");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("actionListener", false,
                                "javax.el.MethodExpression", false, false, "", false, true, "null",
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("charset", false, "javax.el.ValueExpression",
                                false, false, "HTML: Specifies the character encoding of the linked resource.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("coords", false, "javax.el.ValueExpression",
                                false, false, "HTML: The coordinates of regions within a client side image map.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("hreflang", false,
                                "javax.el.ValueExpression", false, false, "HTML: The language of the linked resource.",
                                true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("rel", false, "javax.el.ValueExpression",
                                false, false,
                                "HTML: The relationship between the current document and the linked resource.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("rev", false, "javax.el.ValueExpression",
                                false, false, "HTML: The type(s) describing the reverse link for the linked resource.",
                                true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("shape", false, "javax.el.ValueExpression",
                                false, false, "HTML: The shape of a region in a client side image map.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("target", false, "javax.el.ValueExpression",
                                false, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("bgcolor", false, "javax.el.ValueExpression",
                                false, false, "HTML: The background color of this element.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("bodyrows", false,
                                "javax.el.ValueExpression", false, false,
                                "CSV of several row index to start (and end a previous) tbody element", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("border", false, "javax.el.ValueExpression",
                                false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("cellpadding", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("cellspacing", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("columnClasses", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("footerClass", false,
                                "javax.el.ValueExpression", false, false,
                                "The CSS class to be applied to footer cells.", true, false, "java.lang.String",
                                "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("frame", false, "javax.el.ValueExpression",
                                false, false,
                    ...
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("headerClass", false,
                                "javax.el.ValueExpression", false, false,
                                "The CSS class to be applied to header cells.", true, false, "java.lang.String",
                                "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("rowClasses", false,
                                "javax.el.ValueExpression", false, false,
                                "A comma separated list of CSS class names to apply to td elements in each row.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("rules", false, "javax.el.ValueExpression",
                                false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("summary", false, "javax.el.ValueExpression",
                                false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("width", false, "javax.el.ValueExpression",
                                false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("captionClass", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("captionStyle", false,
                                "javax.el.ValueExpression", false, false,
                                "Gets The CSS class to be applied to the Caption.", true, false, "java.lang.String",
                                "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, "javax.el.ValueExpression",
                                false, false,
                                "An EL expression that specifies the data model that backs this table. <p> The value referenced by the EL expression can be of any type. </p> <ul> <li>A value of type DataModel is used directly.</li> <li>Array-like parameters of type array-of-Object, java.util.List, java.sql.ResultSet or javax.servlet.jsp.jstl.sql.Result are wrapped in a corresponding DataModel that knows how to iterate over the elements.</li> <li>Other values are wrapped in a DataModel as a single row.</li> </ul> <p> Note in particular that unordered collections, eg Set are not supported. Therefore if the value expression references such an object then the table will be considered to contain just one element - the collection itself. </p>",
                                true, false, "java.lang.Object", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("first", false, "javax.el.ValueExpression",
                                false, false, "Defines the index of the first row to be displayed, starting from 0.",
                                true, false, "int", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("rows", false, "javax.el.ValueExpression",
                                false, false,
                                "Defines the maximum number of rows of data to be displayed. <p> Specify zero to display all rows from the \"first\" row to the end of available data. </p>",
                                true, false, "int", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("var", false, "java.lang.String", false,
                                false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("accept", false, "javax.el.ValueExpression",
                                false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("acceptcharset", false,
                                "javax.el.ValueExpression", false, false,
                                "HTML: The list of character encodings accepted by the server for this form.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("enctype", false, "javax.el.ValueExpression",
                                false, false, "HTML: The content type used to submit this form to the server.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("onreset", false, "javax.el.ValueExpression",
                                false, false, "HTML: Script to be invoked when this form is reset.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("onsubmit", false,
                                "javax.el.ValueExpression", false, false,
                                "HTML: Script to be invoked when this form is submitted.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("prependId", false,
                                "javax.el.ValueExpression", false, false, "", true, false, "boolean", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("id", false, "null", true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("height", false, "javax.el.ValueExpression",
                                false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("ismap", false, "javax.el.ValueExpression",
                                false, false, "HTML: Specifies server-side image map handling for this image.", true,
                                false, "boolean", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("longdesc", false,
                                "javax.el.ValueExpression", false, false,
                                "HTML: A link to a long description of the image.", true, false, "java.lang.String",
                                "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("usemap", false, "javax.el.ValueExpression",
                                false, false, "HTML: Specifies an image map to use with this image.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("width", false, "javax.el.ValueExpression",
                                false, false,
                                "HTML: Overrides the natural width of this image, by specifying width in pixels.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("library", false, "javax.el.ValueExpression",
                                false, false, "", true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("name", false, "javax.el.ValueExpression",
                                false, false, "", true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("url", false, "javax.el.ValueExpression",
                                false, false, "An alias for the \"value\" attribute.", true, false, "java.lang.String",
                                "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, "javax.el.ValueExpression",
                                false, false,
                                "The URL of the image. <p> If the URL starts with a '/', it is relative to the context path of the web application. </p>",
                                true, false, "java.lang.Object", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("maxlength", false,
                                "javax.el.ValueExpression", false, false,
                                "HTML: The maximum number of characters allowed to be entered.", true, false, "int",
                                "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("size", false, "javax.el.ValueExpression",
                                false, false, "HTML: The initial width of this control, in characters.", true, false,
                                "int", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("autocomplete", false,
                                "javax.el.ValueExpression", false, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("redisplay", false,
                                "javax.el.ValueExpression", false, false,
                                "If true, the value will be re-sent (in plaintext) when the form is rerendered (see JSF.7.4.4). Default is false.",
                                true, false, "boolean", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("cols", false, "javax.el.ValueExpression",
                                false, false, "HTML: The width of this element, in characters.", true, false, "int",
                                "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("rows", false, "javax.el.ValueExpression",
                                false, false, "HTML: The height of this element, in characters.", true, false, "int",
                                "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("errorClass", false,
                                "javax.el.ValueExpression", false, false,
                                "CSS class to be used for messages with severity \"ERROR\".", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("errorStyle", false,
                                "javax.el.ValueExpression", false, false,
                                "CSS style to be used for messages with severity \"ERROR\".", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("fatalClass", false,
                                "javax.el.ValueExpression", false, false,
                                "CSS class to be used for messages with severity \"FATAL\".", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("fatalStyle", false,
                                "javax.el.ValueExpression", false, false,
                                "CSS style to be used for messages with severity \"FATAL\".", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("infoClass", false,
                                "javax.el.ValueExpression", false, false,
                                "CSS class to be used for messages with severity \"INFO\".", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("infoStyle", false,
                                "javax.el.ValueExpression", false, false,
                                "CSS style to be used for messages with severity \"INFO\".", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("tooltip", false, "javax.el.ValueExpression",
                                false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("warnClass", false,
                                "javax.el.ValueExpression", false, false,
                                "CSS class to be used for messages with severity \"WARN\".", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("warnStyle", false,
                                "javax.el.ValueExpression", false, false,
                                "CSS style to be used for messages with severity \"WARN\".", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("for", true, "javax.el.ValueExpression",
                                false, false,
                                "The ID of the component whose attached FacesMessage object (if present)  should be diplayed by this component. <p> This is a required property on the component. </p>",
                                true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("showDetail", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("showSummary", false,
                                "javax.el.ValueExpression", false, false,
                                "Specifies whether the summary information from the message should be shown. Defaults to false.",
                                true, false, "boolean", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("layout", false, "javax.el.ValueExpression",
                                false, false, "The layout: \"table\" or \"list\". Default: list", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("globalOnly", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("for", false, "javax.el.ValueExpression",
                                false, false,
                                "The ID of the component whose attached FacesMessage object (if present)  should be diplayed by this component. It takes precedence over globalOnly.",
                                true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("escape", false, "javax.el.ValueExpression",
                                false, false, "Indicates whether rendered markup should be escaped. Default: true",
                                true, false, "boolean", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("for", false, "javax.el.ValueExpression",
                                false, false, "The client ID of the target input element of this label.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("columns", false, "javax.el.ValueExpression",
                                false, false, "Specifies the number of columns in the grid.", true, false, "int",
                                "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("selectedClass", false,
                                "javax.el.ValueExpression", false, false, "CSS class to be applied to selected items",
                                true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("unselectedClass", false,
                                "javax.el.ValueExpression", false, false, "CSS class to be applied to unselected items",
                                true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("disabledClass", false,
                                "javax.el.ValueExpression", false, false,
                                "The CSS class assigned to the label element for enabled choices.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("enabledClass", false,
                                "javax.el.ValueExpression", false, false,
                                "The CSS class assigned to the label element for enabled choices.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("hideNoSelectionOption", false,
                                "javax.el.ValueExpression", false, false, "", true, false, "boolean", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("collectionType", false,
                                "javax.el.ValueExpression", false, false, "", true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("immediate", false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("size", false, "javax.el.ValueExpression",
                                false, false, "see JSF Spec.", true, false, "int", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("label", false, "javax.el.ValueExpression",
                ...
                }
                {
                    ...
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("layout", false, "javax.el.ValueExpression",
                                false, false,
                                "Orientation of the options list. Valid values are  \"pageDirection\" for a vertical layout, or \"lineDirection\" for horizontal. The default value is \"lineDirection\".",
                                true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
            ...
            }
            {
                ...
                taglibXml.setInfo("This tag library implements the standard JSF core tags.");
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("id", true, "null", true, false,
                                "Get a string which uniquely identifies this UIComponent within the scope of the nearest ancestor NamingContainer component. The id is not necessarily unique across all components in the current view.",
                                false, false, "null", "null");
                        tag.getAttributes().add(attr);
                    }
                ...
                }
                {
                            ...
                            "TODO: documentation on jsp and pld are not the same. It appear two params: maxlength and for, but no property getter and setter founded here.  If maxlength is used, we can put something like this:  JSFJspProperty(name = \"maxlength\", returnType = \"java.lang.String\")");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("maxlength", false,
                                "javax.el.ValueExpression", false, false,
                                "The max number or characters allowed for this param", true, false, "int", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("required", false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("afterPhase", false,
                                "javax.el.MethodExpression", false, false,
                                ...
                                false, true, "null", "void myMethod( javax.faces.event.PhaseEvent )");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("beforePhase", false,
                                "javax.el.MethodExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("locale", false, "javax.el.ValueExpression",
                                false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("renderKitId", false,
                                "javax.el.ValueExpression", false, false,
                                "Defines what renderkit should be used to render this view.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, "javax.el.ValueExpression",
                                false, false, "The value of this component.", true, false, "java.lang.Object", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("name", false, "javax.el.ValueExpression",
                                false, false, "The name under which the value is stored.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, "javax.el.ValueExpression",
                                false, false, "The initial value of this component.", true, false,
                                "javax.faces.model.SelectItem", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("itemDisabled", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("escape", false, "javax.el.ValueExpression",
                                false, false, "The escape setting for the label of this selection item.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("itemDescription", false,
                                "javax.el.ValueExpression", false, false, "For use in development tools.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("itemLabel", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("itemValue", false,
                                "javax.el.ValueExpression", false, false, "The value for this Item.", true, false,
                                "java.lang.Object", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("noSelectionOption", false,
                                "javax.el.ValueExpression", false, false,
                                "Indicate this component represent no selection option.  Default value is false.", true,
                                false, "java.lang.Boolean", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("id", false, "null", true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, "javax.el.ValueExpression",
                                false, false, "The initial value of this component.", true, false, "java.lang.Object",
                                "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("itemValue", false,
                                "javax.el.ValueExpression", false, false, "The value for the current item.", true,
                                false, "java.lang.Object", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("itemLabel", false,
                                "javax.el.ValueExpression", false, false, "The label of the current item.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("itemDescription", false,
                                "javax.el.ValueExpression", false, false, "The description of the current item.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("itemDisabled", false,
                                "javax.el.ValueExpression", false, false,
                                "Determines if the current item is selectable or not.", true, false,
                                "java.lang.Boolean", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("itemLabelEscaped", false,
                                "javax.el.ValueExpression", false, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("dateStyle", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("locale", false, "javax.el.ValueExpression",
                                false, false, "The name of the locale to be used, instead of the default.", true, false,
                                "java.lang.Object", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("pattern", false, "javax.el.ValueExpression",
                                false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("timeStyle", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("timeZone", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("binding", false, "javax.el.ValueExpression",
                                false, false, "A ValueExpression that evaluates to a DateTimeConverter.", true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("currencyCode", false,
                                "javax.el.ValueExpression", false, false, "ISO 4217 currency code", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("currencySymbol", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("groupingUsed", false,
                                "javax.el.ValueExpression", false, false,
                                "Specifies whether output will contain grouping separators.  Default: true.", true,
                                false, "java.lang.Boolean", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("integerOnly", false,
                                "javax.el.ValueExpression", false, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("maxFractionDigits", false,
                                "javax.el.ValueExpression", false, false,
                                "The maximum number of digits in the fractional portion of the number.", true, false,
                                "java.lang.Integer", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("maxIntegerDigits", false,
                                "javax.el.ValueExpression", false, false,
                                "The maximum number of digits in the integer portion of the number.", true, false,
                                "java.lang.Integer", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("minFractionDigits", false,
                                "javax.el.ValueExpression", false, false,
                                "The minimum number of digits in the fractional portion of the number.", true, false,
                                "java.lang.Integer", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("minIntegerDigits", false,
                                "javax.el.ValueExpression", false, false,
                                "The minimum number of digits in the integer portion of the number.", true, false,
                                "java.lang.Integer", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("binding", false, "javax.el.ValueExpression",
                                false, false, "A ValueExpression that evaluates to a NumberConverter.", true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("maximum", false, "javax.el.ValueExpression",
                                false, false, "The largest value that should be considered valid.", true, false,
                                "java.lang.Double", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("minimum", false, "javax.el.ValueExpression",
                                false, false, "The smallest value that should be considered valid.", true, false,
                                "java.lang.Double", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("binding", false, "javax.el.ValueExpression",
                                false, false, "A ValueExpression that evaluates to a DoubleRangeValidator.", true,
                                false, "javax.faces.validator.DoubleRangeValidator", "null");
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("binding", false, "javax.el.ValueExpression",
                                false, false, "A ValueExpression that evaluates to a LengthValidator.", true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("binding", false, "javax.el.ValueExpression",
                                false, false, "A ValueExpression that evaluates to a LongRangeValidator.", true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("binding", false, "javax.el.ValueExpression",
                                false, false, "A ValueExpression that evaluates to a RegexValidator.", true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("name", true, "java.lang.String", false,
                                false, "The name of the facet to be created. This must be a static value.", false,
                                false, "null", "null");
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("type", false, "javax.el.ValueExpression",
                                false, false, "The fully qualified class name of the ActionListener class.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("binding", false, "javax.el.ValueExpression",
                                ...
                                true, false, "javax.faces.event.ActionListener", "null");
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("name", false, "javax.el.ValueExpression",
                                false, false, "The name of the attribute.", true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, "javax.el.ValueExpression",
                                false, false, "The attribute's value.", true, false, "java.lang.Object", "null");
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("converterId", false,
                                "javax.el.ValueExpression", false, false, "The converter's registered ID.", true, false,
                                "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("binding", false, "javax.el.ValueExpression",
                                false, false, "A ValueExpression that evaluates to a Converter.", true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("basename", false,
                                "javax.el.ValueExpression", false, false, "The base name of the resource bundle.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("var", true, "java.lang.String", false,
                                false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("type", false, "javax.el.ValueExpression",
                                false, false, "Class name of the PhaseListener to be created and registered.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("binding", false, "javax.el.ValueExpression",
                                false, false, "Value binding expression that evaluates to a PhaseListener.", true,
                                false, "javax.faces.event.PhaseListener", "null");
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    tag.setInfo("");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("target", true, "javax.el.ValueExpression",
                                false, false, "ValueExpression for the destination of the value attribute.", true,
                                false, "java.lang.Object", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", true, "javax.el.ValueExpression",
                                false, false, "ValueExpression for the value of the target attribute.", true, false,
                                "java.lang.Object", "null");
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("validatorId", false,
                                "javax.el.ValueExpression", false, false, "The registered ID of the desired Validator.",
                                true, false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("binding", false, "javax.el.ValueExpression",
                                ...
                                true, false, "javax.faces.validator.Validator", "null");
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("type", false, "javax.el.ValueExpression",
                                false, false, "The name of a Java class that implements ValueChangeListener.", true,
                                false, "java.lang.String", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("binding", false, "javax.el.ValueExpression",
                                ...
                                true, false, "javax.faces.event.ValueChangeListener", "null");
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("escape", false, "javax.el.ValueExpression",
                                false, false, "If true, generated markup is escaped. Default: false.", true, false,
                                "java.lang.Boolean", "null");
                        tag.getAttributes().add(attr);
                    }
                    {
        ...
        if (JSTL_URL != null) {
            {
                ...
                taglibXml.setValidator(validator);
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, null, true, false,
                                "Name of character encoding to be applied when decoding request parameters.", false,
                                false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", true, null, true, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("variant", false, null, true, false,
                                "Vendor- or browser-specific variant. See the java.util.Locale javadocs for more information on variants.",
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("scope", false, "java.lang.String", false,
                                false, "Scope of the locale configuration variable.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("scope", false, "java.lang.String", false,
                                false, "Scope of var or the time zone configuration variable.", false, false, null,
                                null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("basename", true, null, true, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("prefix", false, null, true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("scope", false, "java.lang.String", false,
                                false, "Scope of var or the localization context configuration variable.", false, false,
                                null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("key", false, null, true, false,
                                "Message key to be looked up.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("bundle", false, null, true, false,
                                "Localization context in whose resource bundle the message key is looked up.", false,
                                false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("var", false, "java.lang.String", false,
                                false, "Name of the exported scoped variable which stores the localized message.",
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("scope", false, "java.lang.String", false,
                                false, "Scope of var.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, null, true, false,
                                "Argument used for parametric replacement.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, null, true, false,
                                "Numeric value to be formatted.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("type", false, null, true, false,
                                "Specifies whether the value is to be formatted as number, currency, or percentage.",
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("pattern", false, null, true, false,
                                "Custom formatting pattern.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("currencyCode", false, null, true, false,
                                "ISO 4217 currency code. Applied only when formatting currencies (i.e. if type is equal to \"currency\"); ignored otherwise.",
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("currencySymbol", false, null, true, false,
                                "Currency symbol. Applied only when formatting currencies (i.e. if type is equal to \"currency\"); ignored otherwise.",
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("groupingUsed", false, null, true, false,
                                "Specifies whether the formatted output will contain any grouping separators.", false,
                                false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("maxIntegerDigits", false, null, true, false,
                                "Maximum number of digits in the integer portion of the formatted output.", false,
                                false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("minIntegerDigits", false, null, true, false,
                                "Minimum number of digits in the integer portion of the formatted output.", false,
                                false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("maxFractionDigits", false, null, true,
                                false, "Maximum number of digits in the fractional portion of the formatted output.",
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("minFractionDigits", false, null, true,
                                false, "Minimum number of digits in the fractional portion of the formatted output.",
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, null, true, false,
                                "String to be parsed.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("type", false, null, true, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("parseLocale", false, null, true, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("integerOnly", false, null, true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", true, null, true, false,
                                "Date and/or time to be formatted.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("type", false, null, true, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("dateStyle", false, null, true, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("timeStyle", false, null, true, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("pattern", false, null, true, false,
                                "Custom formatting style for dates and times.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("timeZone", false, null, true, false,
                                "Time zone in which to represent the formatted time.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("var", false, "java.lang.String", false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, null, true, false,
                                "Date string to be parsed.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("type", false, null, true, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("timeZone", false, null, true, false,
                                "Time zone in which to interpret any time information in the date string.", false,
                                false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
            ...
            }
            {
                ...
                validator.setValidatorClass("org.apache.taglibs.standard.tlv.JstlFmtTLV");
                taglibXml.setValidator(validator);
                taglibXml.getValidator().addInitParam("expressionAttributes",
                                ...
                                + "parseDate:timeZone\nparseDate:parseLocale");
                {
                    ...
                    tag.setInfo("Sets the request character encoding");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, "java.lang.String", false,
                ...
                }
                {
                    ...
                    tag.setInfo("Stores the given locale in the locale configuration variable");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", true, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("variant", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    tag.setInfo("Loads a resource bundle to be used by its tag body");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("basename", true, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("prefix", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                ...
                }
                {
                    ...
                    tag.setInfo("Maps key to localized message and performs parametric replacement");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("key", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("bundle", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("type", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("pattern", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("currencyCode", false, "java.lang.String",
                                false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("currencySymbol", false, "java.lang.String",
                                false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("groupingUsed", false, "java.lang.String",
                                false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("maxIntegerDigits", false,
                                "java.lang.String", false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("minIntegerDigits", false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("parseLocale", false, "java.lang.String",
                                false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("integerOnly", false, "java.lang.String",
                                false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("dateStyle", false, "java.lang.String",
                                false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("timeStyle", false, "java.lang.String",
                                false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("timeZone", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
            ...
            }
            {
                ...
                taglibXml.setValidator(validator);
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("dataSource", false, null, true, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("isolation", false, null, true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("sql", false, null, true, false,
                                "SQL query statement.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("dataSource", false, null, true, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("startRow", false, null, true, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("maxRows", false, null, true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("sql", false, null, true, false,
                                "SQL update statement.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("dataSource", false, null, true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, null, true, false,
                                "Parameter value.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", true, null, true, false,
                                "Parameter value for DATE, TIME, or TIMESTAMP column in a database table.", false,
                                false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("type", false, null, true, false,
                                "One of \"date\", \"time\" or \"timestamp\".", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("driver", false, null, true, false,
                                "JDBC parameter: driver class name.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("url", false, null, true, false,
                                "JDBC parameter: URL associated with the database.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("user", false, null, true, false,
                                "JDBC parameter: database user on whose behalf the connection to the database is being made.",
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("password", false, null, true, false,
                                "JDBC parameter: user password", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
            ...
            }
            {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("select", true, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("escapeXml", false, "java.lang.String",
                                false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("varDom", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("scopeDom", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("xml", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("systemId", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("filter", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("select", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("result", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("xmlSystemId", false, "java.lang.String",
                                false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("xslt", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("xsltSystemId", false, "java.lang.String",
                                false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
            ...
            }
            {
                ...
                taglibXml.setValidator(validator);
                {
                    ...
                    tag.setInfo(
                            "Provides nested database action elements with a shared Connection,         set up to execute all statements as one transaction.");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("dataSource", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("isolation", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("sql", false, null, true, false, null, false,
                                false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("startRow", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("maxRows", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                ...
                }
                {
                    ...
                    tag.setInfo("Sets a parameter in an SQL statement to the specified value.");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    tag.setInfo("Sets a parameter in an SQL statement to the specified java.util.Date value.");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", true, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("type", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("driver", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("url", false, null, true, false, null, false,
                                false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("user", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("password", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
            ...
            }
            {
                ...
                taglibXml.setValidator(validator);
                taglibXml.getValidator().addInitParam("expressionAttributes",
                        "transaction:dataSource         transaction:isolation         query:sql         query:dataSource         query:startRow         query:maxRows         update:sql         update:dataSource         param:value         dateParam:value         dateParam:type         setDataSource:dataSource         setDataSource:driver         setDataSource:url         setDataSource:user         setDataSource:password");
                {
                    final TagXml tag = new TagXml();
                    tag.setName("transaction");
                    ...
                    tag.setInfo(
                            "Provides nested database action elements with a shared Connection,         set up to execute all statements as one transaction.");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("dataSource", false, "java.lang.String",
                                false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("isolation", false, "java.lang.String",
                                false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("sql", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("startRow", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("maxRows", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("driver", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("url", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("user", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("password", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
            ...
            }
            {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("default", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("test", true, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("url", true, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("varReader", false, "java.lang.String",
                                false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("context", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("charEncoding", false, "java.lang.String",
                                false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("items", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("begin", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("end", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("step", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("varStatus", false, "java.lang.String",
                                false, false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("items", true, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("delims", true, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("target", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("property", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    tag.setBodyContent("JSP");
                    tag.setInfo(
                            "Prints or exposes a URL with optional query parameters         (via the c:param tag).");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("var", false, "java.lang.String", false,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
            ...
            }
            {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("variant", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    tag.setInfo("Loads a resource bundle to be used by its tag body");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("basename", true, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("prefix", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                ...
                }
                {
                    ...
                    tag.setInfo("Maps key to localized message and performs parametric replacement");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("key", false, null, true, false, null, false,
                                false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("bundle", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("pattern", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("dateStyle", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("timeStyle", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("timeZone", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
            ...
            }
            {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("select", true, "java.lang.String", false,
                                false, "XPath expression to be evaluated.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("escapeXml", false, null, true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("scope", false, "java.lang.String", false,
                                false, "Scope for var.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("begin", false, "int", true, false,
                                "Iteration begins at the item located at the specified index. First item of the collection has index 0.",
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("end", false, "int", true, false,
                                "Iteration ends at the item located at the specified index (inclusive).", false, false,
                                null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("step", false, "int", true, false,
                ...
                }
                {
                    ...
                    tag.setInfo("Adds a parameter to a containing 'transform' tag's Transformer");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("name", true, null, true, false,
                                "Name of the transformation parameter.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, null, true, false,
                                "Value of the parameter.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("scopeDom", false, "java.lang.String", false,
                                false, "Scope for varDom.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("xml", false, null, true, false,
                                "Deprecated. Use attribute 'doc' instead.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("doc", false, null, true, false,
                                "Source XML document to be parsed.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("systemId", false, null, true, false,
                                "The system identifier (URI) for parsing the XML document.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("filter", false, null, true, false,
                                "Filter to be applied to the source document.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("result", false, null, true, false,
                                "Result Object that captures or processes the transformation result.", false, false,
                                null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("xmlSystemId", false, null, true, false,
                                "Deprecated. Use attribute 'docSystemId' instead.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("docSystemId", false, null, true, false,
                                "The system identifier (URI) for parsing the XML document.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("xslt", false, null, true, false,
                                "javax.xml.transform.Source Transformation stylesheet as a String, Reader, or Source object.",
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("xsltSystemId", false, null, true, false,
                                "The system identifier (URI) for parsing the XSLT stylesheet.", false, false, null,
                                null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
            ...
            }
            {
                ...
                }
                {
                    ...
                    tag.setInfo(
                            "Simple conditional tag, which evalutes its body if the \tsupplied condition is true and optionally exposes a Boolean \tscripting variable representing the evaluation of this condition");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("test", true, "boolean", true, false,
                ...
                }
                {
                    ...
                    tag.setInfo(
                            "Retrieves an absolute or relative URL and exposes its contents         to either the page, a String in 'var', or a Reader in 'varReader'.");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("url", true, null, true, false,
                                "The URL of the resource to import.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("var", false, "java.lang.String", false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("context", false, null, true, false,
                                "Name of the context when accessing a relative URL resource that belongs to a foreign context.",
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("charEncoding", false, null, true, false,
                                "Character encoding of the content at the input resource.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                }
                {
                    ...
                    tag.setInfo(
                            "The basic iteration tag, accepting many different         collection types and supporting subsetting and other         functionality");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("items", false, "javax.el.ValueExpression",
                                true, false, "Collection of items to iterate over.", true, false, "java.lang.Object",
                                null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    tag.setInfo("Iterates over tokens, separated by the supplied delimeters");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("items", true, "javax.el.ValueExpression",
                                true, false, "String of tokens to iterate over.", true, false, "java.lang.String",
                                null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("delims", true, "java.lang.String", true,
                                false, "The set of delimiters (the characters that separate the tokens in the string).",
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("end", false, "int", true, false,
                                "Iteration ends at the token located at the specified index (inclusive).", false, false,
                                null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", true, null, true, false,
                                "Expression to be evaluated.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("default", false, null, true, false,
                                "Default value if the resulting value is null.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("escapeXml", false, null, true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("name", true, null, true, false,
                                "Name of the query string parameter.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, null, true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("url", false, null, true, false,
                                "The URL of the resource to redirect to.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("context", false, null, true, false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("var", true, "java.lang.String", false,
                                false, "Name of the scoped variable to be removed.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("scope", false, "java.lang.String", false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, "javax.el.ValueExpression",
                                true, false, "Expression to be evaluated.", true, false, "java.lang.Object", null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("target", false, null, true, false,
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("property", false, null, true, false,
                                "Name of the property to be set in the target object.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("scope", false, "java.lang.String", false,
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("value", false, null, true, false,
                                "URL to be processed.", false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("context", false, null, true, false,
            ...
            }
            {
                ...
                }
                {
                    ...
                    tag.setInfo(
                            "Simple conditional tag, which evalutes its body if the \tsupplied condition is true and optionally exposes a Boolean \tscripting variable representing the evaluation of this condition");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("test", true, "boolean", true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    tag.setInfo(
                            "Retrieves an absolute or relative URL and exposes its contents         to either the page, a String in 'var', or a Reader in 'varReader'.");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("url", true, null, true, false, null, false,
                                false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("context", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    tag.setInfo(
                            "The basic iteration tag, accepting many different         collection types and supporting subsetting and other         functionality");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("items", false, "java.lang.Object", true,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("begin", false, "int", true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("end", false, "int", true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("step", false, "int", true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    tag.setInfo("Iterates over tokens, separated by the supplied delimeters");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("items", true, "java.lang.String", true,
                                false, null, false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("default", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("escapeXml", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                ...
                }
                {
                    ...
                    tag.setInfo("Adds a parameter to a containing 'import' tag's URL.");
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("name", true, null, true, false, null, false,
                                false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("target", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("property", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
            ...
            }
            {
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("xml", false, null, true, false, null, false,
                                false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("systemId", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("filter", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    taglibXml.addTag(tag);
                ...
                }
                {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("result", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
                    ...
                    {
                        final TagAttributeInfo attr = new TagAttributeInfo("xslt", false, null, true, false, null,
                                false, false, null, null);
                        tag.getAttributes().add(attr);
                    }
                    {
            ...
            }
            {
                ...
                {
                    final FunctionInfo function = new FunctionInfo("contains",
                            "org.apache.taglibs.standard.functions.Functions",
                            "boolean contains(java.lang.String, java.lang.String)");
                    taglibXml.getFunctions().add(function);
                }
                {
                    final FunctionInfo function = new FunctionInfo("containsIgnoreCase",
                            "org.apache.taglibs.standard.functions.Functions",
                            "boolean containsIgnoreCase(java.lang.String, java.lang.String)");
                    taglibXml.getFunctions().add(function);
                }
                {
                    final FunctionInfo function = new FunctionInfo("endsWith",
                            "org.apache.taglibs.standard.functions.Functions",
                            "boolean endsWith(java.lang.String, java.lang.String)");
                    taglibXml.getFunctions().add(function);
                }
                {
                    final FunctionInfo function = new FunctionInfo("escapeXml",
                            "org.apache.taglibs.standard.functions.Functions",
                            "java.lang.String escapeXml(java.lang.String)");
                    taglibXml.getFunctions().add(function);
                }
                {
                    final FunctionInfo function = new FunctionInfo("indexOf",
                            "org.apache.taglibs.standard.functions.Functions",
                            "int indexOf(java.lang.String, java.lang.String)");
                    taglibXml.getFunctions().add(function);
                }
                {
                    final FunctionInfo function = new FunctionInfo("join",
                            "org.apache.taglibs.standard.functions.Functions",
                            "java.lang.String join(java.lang.String[], java.lang.String)");
                    taglibXml.getFunctions().add(function);
                }
                {
                    final FunctionInfo function = new FunctionInfo("length",
                            "org.apache.taglibs.standard.functions.Functions", "int length(java.lang.Object)");
                    taglibXml.getFunctions().add(function);
                }
                {
                    final FunctionInfo function = new FunctionInfo("replace",
                            "org.apache.taglibs.standard.functions.Functions",
                            "java.lang.String replace(java.lang.String, java.lang.String, java.lang.String)");
                    taglibXml.getFunctions().add(function);
                }
                {
                    final FunctionInfo function = new FunctionInfo("split",
                            "org.apache.taglibs.standard.functions.Functions",
                            "java.lang.String[] split(java.lang.String, java.lang.String)");
                    taglibXml.getFunctions().add(function);
                }
                {
                    final FunctionInfo function = new FunctionInfo("startsWith",
                            "org.apache.taglibs.standard.functions.Functions",
                            "boolean startsWith(java.lang.String, java.lang.String)");
                    taglibXml.getFunctions().add(function);
                }
                {
                    final FunctionInfo function = new FunctionInfo("substring",
                            "org.apache.taglibs.standard.functions.Functions",
                            "java.lang.String substring(java.lang.String, int, int)");
                    taglibXml.getFunctions().add(function);
                }
                {
                    final FunctionInfo function = new FunctionInfo("substringAfter",
                            "org.apache.taglibs.standard.functions.Functions",
                            "java.lang.String substringAfter(java.lang.String, java.lang.String)");
                    taglibXml.getFunctions().add(function);
                }
                {
                    final FunctionInfo function = new FunctionInfo("substringBefore",
                            "org.apache.taglibs.standard.functions.Functions",
                            "java.lang.String substringBefore(java.lang.String, java.lang.String)");
                    taglibXml.getFunctions().add(function);
                }
                {
                    final FunctionInfo function = new FunctionInfo("toLowerCase",
                            "org.apache.taglibs.standard.functions.Functions",
                            "java.lang.String toLowerCase(java.lang.String)");
                    taglibXml.getFunctions().add(function);
                }
                {
                    final FunctionInfo function = new FunctionInfo("toUpperCase",
                            "org.apache.taglibs.standard.functions.Functions",
                            "java.lang.String toUpperCase(java.lang.String)");
                    taglibXml.getFunctions().add(function);
                }
                {
                    final FunctionInfo function = new FunctionInfo("trim",
                            "org.apache.taglibs.standard.functions.Functions",
            ...
            }
            {
                ...
                taglibXml.setValidator(validator);
                taglibXml.getValidator().addInitParam("permittedTaglibs",
    ...
    private static URL findJar(final String s, final String api) {
        try {
            ...
            return (tomEELibJar == null ? jarLocation(TomEETldScanner.class.getClassLoader().loadClass(api))
                    : tomEELibJar).toURI().toURL();
    ...
    protected void scanPlatform() {
        super.scanPlatform();
        if (URLClassLoaderFirst.shouldSkipJsf(Thread.currentThread().getContextClassLoader(),
    ...
    /*
     * private void sysout() { System.out.println(); System.out.println(); System.out.println(); System.out.println();
     * for (final Map.Entry<String, TldResourcePath> entry : uriTldResourcePathMapParent.entrySet()) {
     * System.out.println("{"); System.out.println("final TldResourcePath path = new TldResourcePath(" +
     * (entry.getValue().getUrl().toExternalForm().contains("myfaces")? "MYFACES_URL" :
     * (entry.getValue().getUrl().toExternalForm().contains("openejb-jstl")? "JSTL_URL" : "???")) + ", null, \"" +
     * entry.getValue().getEntryName() + "\");"); System.out.println("URI_TLD_RESOURCE.put(\"" + entry.getKey() +
     * "\", path);");
     * 
     * final TaglibXml tagLibs = tldResourcePathTaglibXmlMapParent.get(entry.getValue()); if (tagLibs != null) {
     * System.out.println("final TaglibXml taglibXml = new TaglibXml();"); if (tagLibs.getTlibVersion() != null)
     * System.out.println("taglibXml.setTlibVersion(\"" + tagLibs.getTlibVersion() + "\");"); if
     * (tagLibs.getJspVersion() != null) System.out.println("taglibXml.setJspVersion(\"" + tagLibs.getJspVersion() +
     * "\");"); if (tagLibs.getShortName() != null) System.out.println("taglibXml.setShortName(\"" +
     * tagLibs.getShortName() + "\");"); if (tagLibs.getUri() != null) System.out.println("taglibXml.setUri(\"" +
     * tagLibs.getUri() + "\");"); if (tagLibs.getInfo() != null) System.out.println("taglibXml.setInfo(\"" +
     * t(tagLibs.getInfo()) + "\");"); if (tagLibs.getValidator() != null) { System.out.println(
     * "final ValidatorXml validator = new ValidatorXml();"); System.out.println("validator.setValidatorClass(\"" +
     * tagLibs.getValidator().getValidatorClass() + "\");"); System.out.println("taglibXml.setValidator(validator);");
     ...
     * "\");"); } } for (final TagXml xml : tagLibs.getTags()) { System.out.println("{"); System.out.println(
     * "final TagXml tag = new TagXml();"); if (xml.getName() != null) System.out.println("tag.setName(\"" +
     * xml.getName() + "\");"); if (xml.getTagClass() != null) System.out.println("tag.setTagClass(\"" +
     * xml.getTagClass() + "\");"); if (xml.getTeiClass() != null) System.out.println("tag.setTeiClass(\"" +
     * xml.getTeiClass() + "\");"); if (xml.getBodyContent() != null) System.out.println("tag.setBodyContent(\"" +
     * xml.getBodyContent() + "\");"); if (xml.getDisplayName() != null) System.out.println("tag.setDisplayName(\"" +
     * xml.getDisplayName() + "\");"); if (xml.getSmallIcon() != null) System.out.println("tag.setSmallIcon(\"" +
     * xml.getSmallIcon() + "\");"); if (xml.getLargeIcon() != null) System.out.println("tag.setLargeIcon(\"" +
     * xml.getLargeIcon() + "\");"); if (xml.getInfo() != null) System.out.println("tag.setInfo(\"" + t(xml.getInfo()) +
     * "\");"); if (xml.hasDynamicAttributes()) System.out.println("tag.setDynamicAttributes(" +
     * xml.hasDynamicAttributes() + ");"); for (final TagAttributeInfo attr : xml.getAttributes()) {
     * System.out.println("{"); System.out.println("final TagAttributeInfo attr = new TagAttributeInfo(" + "\"" +
     * attr.getName() + "\", " + attr.isRequired() + ", \"" + attr.getTypeName() + "\", " + attr.canBeRequestTime() +
     * ", " + attr.isFragment() + ", \"" + t(attr.getDescription()) + "\", " + attr.isDeferredValue() + ", " +
     * attr.isDeferredMethod() + ", \"" + attr.getExpectedTypeName() + "\", \"" + attr.getMethodSignature() + "\");");
     * System.out.println("tag.getAttributes().add(attr);"); System.out.println("}"); } for (final TagVariableInfo var :
     * xml.getVariables()) { System.out.println("{"); System.out.println(
     * "final TagVariableInfo var = new TagVariableInfo(\"" + var.getNameGiven() + "\", \"" + var.getNameFromAttribute()
     * + "\", \"" + var.getClassName() + "\", " + var.getDeclare() + ", " + var.getScope() + ");");
     * System.out.println("tag.getVariables().add(var);"); System.out.println("}"); }
     * System.out.println("taglibXml.addTag(tag);"); System.out.println("}"); } for (final TagFileXml file :
     * tagLibs.getTagFiles()) { System.out.println("{"); System.out.println("final TagFileXml file = new TagFileXml();"
     * ); if (file.getName() != null) System.out.println("file.setName(\"" + file.getName() + "\");"); if
     * (file.getPath() != null) System.out.println("file.setPath(\"" + file.getPath() + "\");"); if
     * (file.getDisplayName() != null) System.out.println("file.setDisplayName(\"" + file.getDisplayName() + "\");"); if
     * (file.getSmallIcon() != null) System.out.println("file.setSmallIcon(\"" + file.getSmallIcon() + "\");"); if
     * (file.getLargeIcon() != null) System.out.println("file.setLargeIcon(\"" + file.getLargeIcon() + "\");"); if
     * (file.getInfo() != null) System.out.println("file.setInfo(\"" + t(file.getInfo()) + "\");");
     * System.out.println("taglibXml.getTagFiles().add(file);"); System.out.println("}"); } for (final String listener :
     * tagLibs.getListeners()) { System.out.println("taglibXml.getListeners().add(\"" + listener + "\");"); } for (final
     * FunctionInfo function : tagLibs.getFunctions()) { System.out.println("{"); System.out.println(
     * "final FunctionInfo function = new FunctionInfo(\"" + function.getName() + "\", \"" + function.getFunctionClass()
     * + "\", \"" + function.getFunctionSignature() + "\");");
     * System.out.println("taglibXml.getFunctions().add(function);"); System.out.println("}"); } }
     * 
     * System.out.println("TLD_RESOURCE_TAG_LIB.put(path, taglibXml);"); System.out.println("}"); }
     * System.out.println(); System.out.println(); System.out.println(); System.out.println(); }
     * 
     * private String t(String info) { return info == null ? info : info.replace("\n", " ").replace("\"", "\\\""); }
     * 
     * @Override public void scan() throws IOException, SAXException { super.scan(); sysout(); }
     */
}
