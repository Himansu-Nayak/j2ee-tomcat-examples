...
public final class Registrations {
    ...
    public static void addFilterConfig(final Context context, final FilterDef filterDef) {
        try {
            final Constructor<ApplicationFilterConfig> cons = ApplicationFilterConfig.class
            ...
            ((Map<String, ApplicationFilterConfig>) Reflections.get(context, "filterConfigs"))
                    .put(filterDef.getFilterName(), config);
