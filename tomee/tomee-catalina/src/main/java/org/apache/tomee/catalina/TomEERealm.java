...
public class TomEERealm extends CombinedRealm {
    ...
    @Override
    public Principal authenticate(final String username, final String clientDigest, final String nonce, final String nc,
            final String cnonce, final String qop, final String realmName, final String md5a2) {
    ...
    private Principal logInTomEE(final Principal pcp) {
        ...
        if (request != null) {
            final Object securityContext = securityService.enterWebApp(this, pcp,
            ...
            if (context != null) {
                ...
                if (instance.isDebugEnabled()) {
                    instance.debug("No request or concurrency-utilities context so skipping login context propagation, "
