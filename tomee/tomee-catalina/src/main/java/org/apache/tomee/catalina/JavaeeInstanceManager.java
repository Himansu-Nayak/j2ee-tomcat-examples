...
public class JavaeeInstanceManager implements InstanceManager {
    ...
    public WebContext.Instance newWeakableInstance(final Class<?> clazz)
            throws IllegalAccessException, InvocationTargetException, NamingException, InstantiationException {
        try {
    ...
    @Override
    public Object newInstance(final String className, final ClassLoader classLoader) throws IllegalAccessException,
     ...
     *
     * @param instance
     *            object to call postconstruct methods on
     * @param clazz
        ...
        private WebSocketTypes() {
            ...
            try {
                tmp = WebSocketTypes.class.getClassLoader()
                        .loadClass("org.apache.tomcat.websocket.pojo.PojoEndpointBase").getDeclaredMethod("getPojo");
    ...
    private static final class TomcatInjections { // load when needed
        ...
        private static void addInjectionTarget(final Injectable resource,
