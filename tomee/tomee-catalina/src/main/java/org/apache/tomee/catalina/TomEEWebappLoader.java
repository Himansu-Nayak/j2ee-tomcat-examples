 ...
 * <p/>
 * <p/>
 * <Context antiJARLocking="true" > <Loader className="org.apache.tomee.catalina.ProvisioningWebappLoader"
 * searchExternalFirst="true" virtualClasspath="mvn:commons-el:commons-el:1.0;mvn:commons-el:commons-el:1.0"
 * searchVirtualFirst="true" /> </Context>
 */
public class TomEEWebappLoader extends WebappLoader {
    public static final boolean SKIP_BACKGROUND_PROCESS = "true"
            .equals(SystemInstance.get().getProperty("tomee.classloader.skip-background-process", "false"));
