...
public class GlobalListenerSupport implements PropertyChangeListener, LifecycleListener {
    ...
    private static boolean hasChild(final StandardHost host, final String name) {
        for (final Container child : host.findChildren()) {
            ...
            if (name.equals(child.getName()) || (StandardContext.class.isInstance(child)
                    && ("/" + name).equals(StandardContext.class.cast(child).getPath()))) {
                return true;
            }
        }
        return false;
    ...
    public void lifecycleEvent(final LifecycleEvent event) {
        ...
        if (source instanceof StandardContext) {
            ...
            if (Lifecycle.BEFORE_STOP_EVENT.equals(type)) {
                ...
                final TomEEClusterListener tomEEClusterListener = SystemInstance.get()
                        .getComponent(TomEEClusterListener.class);
    ...
    public static class MoniterableHashMap extends LinkedHashMap<Object, Object> {
        ...
        public MoniterableHashMap(final Map<Object, Object> m, final Object source, final String propertyName,
