...
public class Filters {
     ...
     *
     * If the passed in filter is already wrapped, it will be unwrapped and returned. This is to prevent endless
     * wrapping if the invert method is called many times.
     * 
     * @param filter
     * @return
     */
