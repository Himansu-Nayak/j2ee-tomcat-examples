...
class BackgroundTaskRunner {
    ...
    static {
        ...
        SYNCHRONOUS = Boolean
                .parseBoolean(getProperty(logManager, BackgroundTaskRunner.class.getName() + ".synchronous"));
        if (SYNCHRONOUS) {
            ...
            final Duration shutdownTimeout = new Duration(
                    shutdownTimeoutStr == null ? "30 seconds" : shutdownTimeoutStr);
            EXECUTOR_SERVICE = Executors.newFixedThreadPool(Integer.parseInt(threadCount == null ? "2" : threadCount),
                    new ThreadFactory() {
