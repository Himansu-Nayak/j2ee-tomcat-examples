...
public final class ReloadableLog {
    ...
    public static Log newLog(final String name, final String factory) {
        return Log.class.cast(Proxy.newProxyInstance(ReloadableLog.class.getClassLoader(), INTERFACES,
                new ReloadableLogHandler(factory, name)));
    }
    ...
    private static final class ReloadableLogHandler implements InvocationHandler {
        ...
        private Log newInstance(final String impl) throws InstantiationException, IllegalAccessException,
                InvocationTargetException, NoSuchMethodException, ClassNotFoundException {
            return Log.class.cast(Thread.currentThread().getContextClassLoader().loadClass(impl)
